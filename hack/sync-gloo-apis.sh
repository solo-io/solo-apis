...
mv ./api/gloo/gloo/v1/enterprise/options/extauth/v1/extauth.proto ./api/gloo/enterprise.gloo.apis/v1/auth_config.proto
...
# Gloo Enterprise API changes
  sed "s|gloo/v1/enterprise/options/extauth/v1/extauth.proto|enterprise.gloo.apis/v1/auth_config.proto|g" "$file" > "$file".tmp && mv "$file".tmp "$file"
