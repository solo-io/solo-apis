...
#   sed "s|github.com/solo-io/solo-apis/api|github.com/solo-io/solo-apis/api/gloo-fed|g" "$file" > "$file".tmp && mv "$file".tmp "$file"
...
# # Rate Limiter Api changes
#   sed "s|github.com/solo-io/solo-apis/api/gloo-fed/rate-limiter|github.com/solo-io/solo-apis/api/rate-limiter|g" "$file" > "$file".tmp && mv "$file".tmp "$file"
