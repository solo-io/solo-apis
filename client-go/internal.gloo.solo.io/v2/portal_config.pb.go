...
// ExtAuthType is the type of authentication that is used to authorize clients.
type PortalConfigSpec_ExtAuthType int32

const (
	PortalConfigSpec_API_KEY_AUTH PortalConfigSpec_ExtAuthType = 0
)

// Enum value maps for PortalConfigSpec_ExtAuthType.
var (
	PortalConfigSpec_ExtAuthType_name = map[int32]string{
		0: "API_KEY_AUTH",
	}
	PortalConfigSpec_ExtAuthType_value = map[string]int32{
		"API_KEY_AUTH": 0,
	}
)

func (x PortalConfigSpec_ExtAuthType) Enum() *PortalConfigSpec_ExtAuthType {
	p := new(PortalConfigSpec_ExtAuthType)
	*p = x
	return p
}

func (x PortalConfigSpec_ExtAuthType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (PortalConfigSpec_ExtAuthType) Descriptor() protoreflect.EnumDescriptor {
...
func (PortalConfigSpec_ExtAuthType) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_enumTypes[0]
}

func (x PortalConfigSpec_ExtAuthType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use PortalConfigSpec_ExtAuthType.Descriptor instead.
func (PortalConfigSpec_ExtAuthType) EnumDescriptor() ([]byte, []int) {
...
func (PortalConfigSpec_Unit) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_enumTypes[1].Descriptor()
}

func (PortalConfigSpec_Unit) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_enumTypes[1]
}
...
type PortalConfigSpec_API struct {
	...
	ApiSchema      *v2.ObjectReference              `protobuf:"bytes,10,opt,name=api_schema,json=apiSchema,proto3" json:"api_schema,omitempty"`
	RouteTable     *v2.ObjectReference              `protobuf:"bytes,11,opt,name=route_table,json=routeTable,proto3" json:"route_table,omitempty"`
	UsagePlans     []*PortalConfigSpec_UsagePlanRef `protobuf:"bytes,12,rep,name=usage_plans,json=usagePlans,proto3" json:"usage_plans,omitempty"`
	...
	CustomMetadata map[string]string `protobuf:"bytes,14,rep,name=custom_metadata,json=customMetadata,proto3" json:"custom_metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type PortalConfigSpec_ExtAuthPolicy struct {
	...
	ExtAuthType          PortalConfigSpec_ExtAuthType             `protobuf:"varint,1,opt,name=ext_auth_type,json=extAuthType,proto3,enum=internal.gloo.solo.io.PortalConfigSpec_ExtAuthType" json:"ext_auth_type,omitempty"`
	ExtAuthLabelSelector []*PortalConfigSpec_ExtAuthLabelSelector `protobuf:"bytes,2,rep,name=ext_auth_label_selector,json=extAuthLabelSelector,proto3" json:"ext_auth_label_selector,omitempty"`
	ExtAuthPolicyRef     *v2.ObjectReference                      `protobuf:"bytes,3,opt,name=ext_auth_policy_ref,json=extAuthPolicyRef,proto3" json:"ext_auth_policy_ref,omitempty"`
	AuthConfigId         string                                   `protobuf:"bytes,4,opt,name=auth_config_id,json=authConfigId,proto3" json:"auth_config_id,omitempty"`
}
...
func (x *PortalConfigSpec_ExtAuthPolicy) GetExtAuthType() PortalConfigSpec_ExtAuthType {
	if x != nil {
		return x.ExtAuthType
	}
	return PortalConfigSpec_API_KEY_AUTH
}

func (x *PortalConfigSpec_ExtAuthPolicy) GetExtAuthLabelSelector() []*PortalConfigSpec_ExtAuthLabelSelector {
	if x != nil {
...
type PortalConfigSpec_ExtAuthLabelSelector struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *PortalConfigSpec_ExtAuthLabelSelector) Reset() {
	*x = PortalConfigSpec_ExtAuthLabelSelector{}
	if protoimpl.UnsafeEnabled {
...
func (x *PortalConfigSpec_ExtAuthLabelSelector) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PortalConfigSpec_ExtAuthLabelSelector) ProtoMessage() {}

func (x *PortalConfigSpec_ExtAuthLabelSelector) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PortalConfigSpec_ExtAuthLabelSelector.ProtoReflect.Descriptor instead.
func (*PortalConfigSpec_ExtAuthLabelSelector) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_rawDescGZIP(), []int{0, 5}
}

func (x *PortalConfigSpec_ExtAuthLabelSelector) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
func (x *PortalConfigSpec_ExtAuthLabelSelector) GetValue() string {
	if x != nil {
		return x.Value
	}
	return ""
...
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x6c, 0x2f, 0x76, 0x32, 0x2f, 0x70, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x5f, 0x63, 0x6f,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x53, 0x67, 0x69, 0x74,
	...
	,
	...
	0x67, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x55, 0x73, 0x61, 0x67, 0x65, 0x50, 0x6c, 0x61, 0x6e, 0x52,
	0x0a, 0x75, 0x73, 0x61, 0x67, 0x65, 0x50, 0x6c, 0x61, 0x6e, 0x73, 0x12, 0x43, 0x0a, 0x0a, 0x70,
	0x6f, 0x72, 0x74, 0x61, 0x6c, 0x5f, 0x72, 0x65, 0x66, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	,
	...
	0x63, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x74, 0x65, 0x72, 0x6d, 0x73, 0x4f,
	0x66, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6e, 0x74,
	0x61, 0x63, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x61,
	0x63, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x18, 0x09, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x12, 0x43, 0x0a, 0x0a,
	0x61, 0x70, 0x69, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0xac, 0x02, 0x0a, 0x09,
	0x55, 0x73, 0x61, 0x67, 0x65, 0x50, 0x6c, 0x61, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d,
	...
	0x6f, 0x6e, 0x12, 0x61, 0x0a, 0x11, 0x65, 0x78, 0x74, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x5f, 0x70,
	0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x35, 0x2e,
	0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f,
	0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x45, 0x78, 0x74, 0x41, 0x75, 0x74, 0x68, 0x50, 0x6f,
	0x6c, 0x69, 0x63, 0x79, 0x52, 0x0f, 0x65, 0x78, 0x74, 0x41, 0x75, 0x74, 0x68, 0x50, 0x6f, 0x6c,
	...
	,
	...
	,
	...
	0x65, 0x73, 0x74, 0x73, 0x50, 0x65, 0x72, 0x55, 0x6e, 0x69, 0x74, 0x12, 0x57, 0x0a, 0x15, 0x72,
	0x61, 0x74, 0x65, 0x5f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x5f, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79,
	0x5f, 0x72, 0x65, 0x66, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x63, 0x6f, 0x6d,
	...
	,
	...
	0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x6f, 0x77,
	0x6e, 0x65, 0x64, 0x42, 0x79, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0xf4,
	0x01, 0x0a, 0x12, 0x50, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52,
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x59, 0x0a, 0x0a, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61,
	0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x39, 0x2e, 0x69, 0x6e, 0x74, 0x65,
	0x72, 0x6e, 0x61, 0x6c, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69,
	0x6f, 0x2e, 0x50, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x65,
	...
	0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x1a, 0x5a, 0x0a, 0x0f, 0x57, 0x6f, 0x72,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x56, 0x5a, 0x48, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6f, 0x6c, 0x6f, 0x2d, 0x69, 0x6f, 0x2f, 0x67, 0x6c, 0x6f, 0x6f,
	0x2d, 0x6d, 0x65, 0x73, 0x68, 0x2d, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65,
	0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61,
	0x6c, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2f, 0x76,
...
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_goTypes = []interface{}{
	(PortalConfigSpec_ExtAuthType)(0),             // 0: internal.gloo.solo.io.PortalConfigSpec.ExtAuthType
	...
	(*PortalConfigReport)(nil),                    // 4: internal.gloo.solo.io.PortalConfigReport
	(*PortalConfigSpec_Group)(nil),                // 5: internal.gloo.solo.io.PortalConfigSpec.Group
	...
	(*PortalConfigSpec_ExtAuthPolicy)(nil),        // 9: internal.gloo.solo.io.PortalConfigSpec.ExtAuthPolicy
	(*PortalConfigSpec_ExtAuthLabelSelector)(nil), // 10: internal.gloo.solo.io.PortalConfigSpec.ExtAuthLabelSelector
	(*PortalConfigSpec_RateLimitPolicy)(nil),      // 11: internal.gloo.solo.io.PortalConfigSpec.RateLimitPolicy
	nil,                                           // 12: internal.gloo.solo.io.PortalConfigSpec.API.CustomMetadataEntry
	nil,                                           // 13: internal.gloo.solo.io.PortalConfigReport.WorkspacesEntry
	...
	(*v21.Membership)(nil),                        // 17: apimanagement.gloo.solo.io.Membership
...
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_depIdxs = []int32{
	14, // 0: internal.gloo.solo.io.PortalConfigSpec.portal_custom_metadata:type_name -> google.protobuf.Value
	...
	15, // 3: internal.gloo.solo.io.PortalConfigSpec.portal_ref:type_name -> common.gloo.solo.io.ObjectReference
	5,  // 4: internal.gloo.solo.io.PortalConfigSpec.groups:type_name -> internal.gloo.solo.io.PortalConfigSpec.Group
	16, // 5: internal.gloo.solo.io.PortalConfigStatus.common:type_name -> common.gloo.solo.io.Status
	13, // 6: internal.gloo.solo.io.PortalConfigReport.workspaces:type_name -> internal.gloo.solo.io.PortalConfigReport.WorkspacesEntry
	15, // 7: internal.gloo.solo.io.PortalConfigSpec.Group.apis:type_name -> common.gloo.solo.io.ObjectReference
	17, // 8: internal.gloo.solo.io.PortalConfigSpec.Group.membership_claims:type_name -> apimanagement.gloo.solo.io.Membership
	15, // 9: internal.gloo.solo.io.PortalConfigSpec.API.api_schema:type_name -> common.gloo.solo.io.ObjectReference
	15, // 10: internal.gloo.solo.io.PortalConfigSpec.API.route_table:type_name -> common.gloo.solo.io.ObjectReference
	8,  // 11: internal.gloo.solo.io.PortalConfigSpec.API.usage_plans:type_name -> internal.gloo.solo.io.PortalConfigSpec.UsagePlanRef
	12, // 12: internal.gloo.solo.io.PortalConfigSpec.API.custom_metadata:type_name -> internal.gloo.solo.io.PortalConfigSpec.API.CustomMetadataEntry
	9,  // 13: internal.gloo.solo.io.PortalConfigSpec.UsagePlan.ext_auth_policies:type_name -> internal.gloo.solo.io.PortalConfigSpec.ExtAuthPolicy
	11, // 14: internal.gloo.solo.io.PortalConfigSpec.UsagePlan.rate_limit_policy:type_name -> internal.gloo.solo.io.PortalConfigSpec.RateLimitPolicy
	0,  // 15: internal.gloo.solo.io.PortalConfigSpec.ExtAuthPolicy.ext_auth_type:type_name -> internal.gloo.solo.io.PortalConfigSpec.ExtAuthType
	10, // 16: internal.gloo.solo.io.PortalConfigSpec.ExtAuthPolicy.ext_auth_label_selector:type_name -> internal.gloo.solo.io.PortalConfigSpec.ExtAuthLabelSelector
	15, // 17: internal.gloo.solo.io.PortalConfigSpec.ExtAuthPolicy.ext_auth_policy_ref:type_name -> common.gloo.solo.io.ObjectReference
	1,  // 18: internal.gloo.solo.io.PortalConfigSpec.RateLimitPolicy.unit:type_name -> internal.gloo.solo.io.PortalConfigSpec.Unit
	15, // 19: internal.gloo.solo.io.PortalConfigSpec.RateLimitPolicy.rate_limit_policy_ref:type_name -> common.gloo.solo.io.ObjectReference
	18, // 20: internal.gloo.solo.io.PortalConfigReport.WorkspacesEntry.value:type_name -> common.gloo.solo.io.Report
...
func file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_internal_v2_portal_config_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PortalConfigSpec_ExtAuthLabelSelector); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
