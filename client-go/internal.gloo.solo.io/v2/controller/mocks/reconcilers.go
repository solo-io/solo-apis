...
func (m *MockSpireRegistrationEntryReconciler) ReconcileSpireRegistrationEntry(obj *v2.SpireRegistrationEntry) (reconcile.Result, error) {
	m.ctrl.T.Helper()
...
func (m *MockSpireRegistrationEntryFinalizer) FinalizeSpireRegistrationEntry(obj *v2.SpireRegistrationEntry) error {
	m.ctrl.T.Helper()
...
// ReconcileSpireRegistrationEntry mocks base method.
func (m *MockSpireRegistrationEntryFinalizer) ReconcileSpireRegistrationEntry(obj *v2.SpireRegistrationEntry) (reconcile.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReconcileSpireRegistrationEntry", obj)
	ret0, _ := ret[0].(reconcile.Result)
	ret1, _ := ret[1].(error)
