...
type MulticlusterSpireRegistrationEntryReconciler interface {
	ReconcileSpireRegistrationEntry(clusterName string, obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) (reconcile.Result, error)
}
...
type MulticlusterSpireRegistrationEntryReconcilerFuncs struct {
	OnReconcileSpireRegistrationEntry         func(clusterName string, obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) (reconcile.Result, error)
	OnReconcileSpireRegistrationEntryDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterSpireRegistrationEntryReconcilerFuncs) ReconcileSpireRegistrationEntry(clusterName string, obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) (reconcile.Result, error) {
...
func NewMulticlusterSpireRegistrationEntryReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterSpireRegistrationEntryReconcileLoop {
	return &multiclusterSpireRegistrationEntryReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &internal_gloo_solo_io_v2.SpireRegistrationEntry{}, options)}
}
