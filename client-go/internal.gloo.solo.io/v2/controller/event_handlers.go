...
type SpireRegistrationEntryEventHandler interface {
	CreateSpireRegistrationEntry(obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) error
	UpdateSpireRegistrationEntry(old, new *internal_gloo_solo_io_v2.SpireRegistrationEntry) error
	DeleteSpireRegistrationEntry(obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) error
	GenericSpireRegistrationEntry(obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) error
}

type SpireRegistrationEntryEventHandlerFuncs struct {
	OnCreate  func(obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) error
	OnUpdate  func(old, new *internal_gloo_solo_io_v2.SpireRegistrationEntry) error
	OnDelete  func(obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) error
	OnGeneric func(obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) error
}

func (f *SpireRegistrationEntryEventHandlerFuncs) CreateSpireRegistrationEntry(obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *SpireRegistrationEntryEventHandlerFuncs) DeleteSpireRegistrationEntry(obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *SpireRegistrationEntryEventHandlerFuncs) UpdateSpireRegistrationEntry(objOld, objNew *internal_gloo_solo_io_v2.SpireRegistrationEntry) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *SpireRegistrationEntryEventHandlerFuncs) GenericSpireRegistrationEntry(obj *internal_gloo_solo_io_v2.SpireRegistrationEntry) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewSpireRegistrationEntryEventWatcher(name string, mgr manager.Manager) SpireRegistrationEntryEventWatcher {
	return &spireRegistrationEntryEventWatcher{
		watcher: events.NewWatcher(name, mgr, &internal_gloo_solo_io_v2.SpireRegistrationEntry{}),
	}
}
...
func (h genericSpireRegistrationEntryHandler) Create(object client.Object) error {
	obj, ok := object.(*internal_gloo_solo_io_v2.SpireRegistrationEntry)
	if !ok {
...
func (h genericSpireRegistrationEntryHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*internal_gloo_solo_io_v2.SpireRegistrationEntry)
	if !ok {
		return errors.Errorf("internal error: SpireRegistrationEntry handler received event for %T", old)
	}
	objNew, ok := new.(*internal_gloo_solo_io_v2.SpireRegistrationEntry)
	if !ok {
