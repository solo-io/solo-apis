...
func (mr *MockMulticlusterApiProductReconcilerMockRecorder) ReconcileApiProduct(clusterName, obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMulticlusterApiProductDeletionReconcilerMockRecorder) ReconcileApiProductDeletion(clusterName, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMulticlusterApiProductReconcileLoopMockRecorder) AddMulticlusterApiProductReconciler(ctx, rec interface{}, predicates ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, rec}, predicates...)
