...
type RateLimitPolicySpec struct {
	...
	//
	// </br>**Configuration constraints**: Rate limit policies are only applied to routes on a VirtualGateway.
	// East-west routes that are configured with the `workloadSelectors` field in the RouteTable cannot be selected.
