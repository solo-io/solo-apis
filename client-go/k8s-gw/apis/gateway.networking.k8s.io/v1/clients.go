...
type Clientset interface {
	...
	// clienset for the gateway.networking.k8s.io/v1/v1 APIs
	ListenerSets() ListenerSetClient
}
...
// clienset for the gateway.networking.k8s.io/v1/v1 APIs
func (c *clientSet) ListenerSets() ListenerSetClient {
	return NewListenerSetClient(c.client)
}
...
// Reader knows how to read and list ListenerSets.
type ListenerSetReader interface {
	// Get retrieves a ListenerSet for the given object key
	GetListenerSet(ctx context.Context, key client.ObjectKey) (*gateway_networking_k8s_io_v1.ListenerSet, error)

	// List retrieves list of ListenerSets for a given namespace and list options.
	ListListenerSet(ctx context.Context, opts ...client.ListOption) (*gateway_networking_k8s_io_v1.ListenerSetList, error)
}

// ListenerSetTransitionFunction instructs the ListenerSetWriter how to transition between an existing
// ListenerSet object and a desired on an Upsert
type ListenerSetTransitionFunction func(existing, desired *gateway_networking_k8s_io_v1.ListenerSet) error

// Writer knows how to create, delete, and update ListenerSets.
type ListenerSetWriter interface {
	// Create saves the ListenerSet object.
	CreateListenerSet(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, opts ...client.CreateOption) error

	// Delete deletes the ListenerSet object.
	DeleteListenerSet(ctx context.Context, key client.ObjectKey, opts ...client.DeleteOption) error

	// Update updates the given ListenerSet object.
	UpdateListenerSet(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, opts ...client.UpdateOption) error

	// Patch patches the given ListenerSet object.
	PatchListenerSet(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, patch client.Patch, opts ...client.PatchOption) error

	// DeleteAllOf deletes all ListenerSet objects matching the given options.
	DeleteAllOfListenerSet(ctx context.Context, opts ...client.DeleteAllOfOption) error

	// Create or Update the ListenerSet object.
	UpsertListenerSet(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, transitionFuncs ...ListenerSetTransitionFunction) error
}

// StatusWriter knows how to update status subresource of a ListenerSet object.
type ListenerSetStatusWriter interface {
	// Update updates the fields corresponding to the status subresource for the
	// given ListenerSet object.
	UpdateListenerSetStatus(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, opts ...client.SubResourceUpdateOption) error

	// Patch patches the given ListenerSet object's subresource.
	PatchListenerSetStatus(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, patch client.Patch, opts ...client.SubResourcePatchOption) error
}

// Client knows how to perform CRUD operations on ListenerSets.
type ListenerSetClient interface {
	ListenerSetReader
	ListenerSetWriter
	ListenerSetStatusWriter
}

type listenerSetClient struct {
	client client.Client
}

func NewListenerSetClient(client client.Client) *listenerSetClient {
	return &listenerSetClient{client: client}
}

func (c *listenerSetClient) GetListenerSet(ctx context.Context, key client.ObjectKey) (*gateway_networking_k8s_io_v1.ListenerSet, error) {
	obj := &gateway_networking_k8s_io_v1.ListenerSet{}
	if err := c.client.Get(ctx, key, obj); err != nil {
		return nil, err
	}
	return obj, nil
...
func (c *listenerSetClient) ListListenerSet(ctx context.Context, opts ...client.ListOption) (*gateway_networking_k8s_io_v1.ListenerSetList, error) {
	list := &gateway_networking_k8s_io_v1.ListenerSetList{}
	if err := c.client.List(ctx, list, opts...); err != nil {
		return nil, err
	}
	return list, nil
...
func (c *listenerSetClient) CreateListenerSet(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, opts ...client.CreateOption) error {
	return c.client.Create(ctx, obj, opts...)
}

func (c *listenerSetClient) DeleteListenerSet(ctx context.Context, key client.ObjectKey, opts ...client.DeleteOption) error {
	obj := &gateway_networking_k8s_io_v1.ListenerSet{}
	obj.SetName(key.Name)
	obj.SetNamespace(key.Namespace)
	return c.client.Delete(ctx, obj, opts...)
...
func (c *listenerSetClient) UpdateListenerSet(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, opts ...client.UpdateOption) error {
	return c.client.Update(ctx, obj, opts...)
}

func (c *listenerSetClient) PatchListenerSet(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, patch client.Patch, opts ...client.PatchOption) error {
	return c.client.Patch(ctx, obj, patch, opts...)
}

func (c *listenerSetClient) DeleteAllOfListenerSet(ctx context.Context, opts ...client.DeleteAllOfOption) error {
	obj := &gateway_networking_k8s_io_v1.ListenerSet{}
	return c.client.DeleteAllOf(ctx, obj, opts...)
}

func (c *listenerSetClient) UpsertListenerSet(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, transitionFuncs ...ListenerSetTransitionFunction) error {
	genericTxFunc := func(existing, desired runtime.Object) error {
		for _, txFunc := range transitionFuncs {
			if err := txFunc(existing.(*gateway_networking_k8s_io_v1.ListenerSet), desired.(*gateway_networking_k8s_io_v1.ListenerSet)); err != nil {
				return err
			}
		}
		return nil
...
func (c *listenerSetClient) UpdateListenerSetStatus(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, opts ...client.SubResourceUpdateOption) error {
	return c.client.Status().Update(ctx, obj, opts...)
}

func (c *listenerSetClient) PatchListenerSetStatus(ctx context.Context, obj *gateway_networking_k8s_io_v1.ListenerSet, patch client.Patch, opts ...client.SubResourcePatchOption) error {
	return c.client.Status().Patch(ctx, obj, patch, opts...)
}

// Provides ListenerSetClients for multiple clusters.
type MulticlusterListenerSetClient interface {
	// Cluster returns a ListenerSetClient for the given cluster
	Cluster(cluster string) (ListenerSetClient, error)
}

type multiclusterListenerSetClient struct {
	client multicluster.Client
}

func NewMulticlusterListenerSetClient(client multicluster.Client) MulticlusterListenerSetClient {
	return &multiclusterListenerSetClient{client: client}
}

func (m *multiclusterListenerSetClient) Cluster(cluster string) (ListenerSetClient, error) {
	client, err := m.client.Cluster(cluster)
	if err != nil {
		return nil, err
	}
	return NewListenerSetClient(client), nil
}
