...
type MulticlusterExternalWorkloadReconciler interface {
	ReconcileExternalWorkload(clusterName string, obj *networking_gloo_solo_io_v2.ExternalWorkload) (reconcile.Result, error)
}
...
type MulticlusterExternalWorkloadReconcilerFuncs struct {
	OnReconcileExternalWorkload         func(clusterName string, obj *networking_gloo_solo_io_v2.ExternalWorkload) (reconcile.Result, error)
	OnReconcileExternalWorkloadDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterExternalWorkloadReconcilerFuncs) ReconcileExternalWorkload(clusterName string, obj *networking_gloo_solo_io_v2.ExternalWorkload) (reconcile.Result, error) {
...
func NewMulticlusterExternalWorkloadReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterExternalWorkloadReconcileLoop {
	return &multiclusterExternalWorkloadReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_gloo_solo_io_v2.ExternalWorkload{}, options)}
}
