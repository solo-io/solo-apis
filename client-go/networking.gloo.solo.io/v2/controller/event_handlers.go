...
type ExternalWorkloadEventHandler interface {
	CreateExternalWorkload(obj *networking_gloo_solo_io_v2.ExternalWorkload) error
	UpdateExternalWorkload(old, new *networking_gloo_solo_io_v2.ExternalWorkload) error
	DeleteExternalWorkload(obj *networking_gloo_solo_io_v2.ExternalWorkload) error
	GenericExternalWorkload(obj *networking_gloo_solo_io_v2.ExternalWorkload) error
}

type ExternalWorkloadEventHandlerFuncs struct {
	OnCreate  func(obj *networking_gloo_solo_io_v2.ExternalWorkload) error
	OnUpdate  func(old, new *networking_gloo_solo_io_v2.ExternalWorkload) error
	OnDelete  func(obj *networking_gloo_solo_io_v2.ExternalWorkload) error
	OnGeneric func(obj *networking_gloo_solo_io_v2.ExternalWorkload) error
}

func (f *ExternalWorkloadEventHandlerFuncs) CreateExternalWorkload(obj *networking_gloo_solo_io_v2.ExternalWorkload) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *ExternalWorkloadEventHandlerFuncs) DeleteExternalWorkload(obj *networking_gloo_solo_io_v2.ExternalWorkload) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *ExternalWorkloadEventHandlerFuncs) UpdateExternalWorkload(objOld, objNew *networking_gloo_solo_io_v2.ExternalWorkload) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *ExternalWorkloadEventHandlerFuncs) GenericExternalWorkload(obj *networking_gloo_solo_io_v2.ExternalWorkload) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewExternalWorkloadEventWatcher(name string, mgr manager.Manager) ExternalWorkloadEventWatcher {
	return &externalWorkloadEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_gloo_solo_io_v2.ExternalWorkload{}),
	}
}
...
func (h genericExternalWorkloadHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*networking_gloo_solo_io_v2.ExternalWorkload)
	if !ok {
		return errors.Errorf("internal error: ExternalWorkload handler received event for %T", old)
	}
	objNew, ok := new.(*networking_gloo_solo_io_v2.ExternalWorkload)
	if !ok {
