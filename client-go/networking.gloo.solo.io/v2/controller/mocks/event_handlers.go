...
func (m *MockExternalWorkloadEventHandler) CreateExternalWorkload(obj *v2.ExternalWorkload) error {
	m.ctrl.T.Helper()
...
func (m *MockExternalWorkloadEventHandler) DeleteExternalWorkload(obj *v2.ExternalWorkload) error {
	m.ctrl.T.Helper()
...
func (m *MockExternalWorkloadEventHandler) GenericExternalWorkload(obj *v2.ExternalWorkload) error {
	m.ctrl.T.Helper()
...
func (m *MockExternalWorkloadEventHandler) UpdateExternalWorkload(old, new *v2.ExternalWorkload) error {
	m.ctrl.T.Helper()
