...
func (m *MockMulticlusterExternalWorkloadReconciler) ReconcileExternalWorkload(clusterName string, obj *v2.ExternalWorkload) (reconcile.Result, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMulticlusterExternalWorkloadReconcilerMockRecorder) ReconcileExternalWorkload(clusterName, obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMulticlusterExternalWorkloadDeletionReconcilerMockRecorder) ReconcileExternalWorkloadDeletion(clusterName, req interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMulticlusterExternalWorkloadReconcileLoopMockRecorder) AddMulticlusterExternalWorkloadReconciler(ctx, rec interface{}, predicates ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, rec}, predicates...)
