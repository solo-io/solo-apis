...
type CloudProviderReconciler interface {
	ReconcileCloudProvider(obj *networking_gloo_solo_io_v2.CloudProvider) (reconcile.Result, error)
}
...
type CloudProviderReconcilerFuncs struct {
	OnReconcileCloudProvider         func(obj *networking_gloo_solo_io_v2.CloudProvider) (reconcile.Result, error)
	OnReconcileCloudProviderDeletion func(req reconcile.Request) error
}

func (f *CloudProviderReconcilerFuncs) ReconcileCloudProvider(obj *networking_gloo_solo_io_v2.CloudProvider) (reconcile.Result, error) {
...
type CloudProviderFinalizer interface {
	...
	FinalizeCloudProvider(obj *networking_gloo_solo_io_v2.CloudProvider) error
}
...
func NewCloudProviderReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) CloudProviderReconcileLoop {
	return &cloudProviderReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &networking_gloo_solo_io_v2.CloudProvider{}, options),
	}
}
...
type CloudResourcesReconciler interface {
	ReconcileCloudResources(obj *networking_gloo_solo_io_v2.CloudResources) (reconcile.Result, error)
}
...
type CloudResourcesReconcilerFuncs struct {
	OnReconcileCloudResources         func(obj *networking_gloo_solo_io_v2.CloudResources) (reconcile.Result, error)
	OnReconcileCloudResourcesDeletion func(req reconcile.Request) error
}

func (f *CloudResourcesReconcilerFuncs) ReconcileCloudResources(obj *networking_gloo_solo_io_v2.CloudResources) (reconcile.Result, error) {
...
type CloudResourcesFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeCloudResources(obj *networking_gloo_solo_io_v2.CloudResources) error
}
...
func NewCloudResourcesReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) CloudResourcesReconcileLoop {
	return &cloudResourcesReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &networking_gloo_solo_io_v2.CloudResources{}, options),
	}
}
