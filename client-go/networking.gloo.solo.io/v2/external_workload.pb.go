...
func (ExternalWorkloadSpec_Probe_HTTPGetConfig_Scheme) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_enumTypes[0].Descriptor()
}

func (ExternalWorkloadSpec_Probe_HTTPGetConfig_Scheme) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_enumTypes[0]
}
...
func (ExternalWorkloadSpec_Probe_HTTPGetConfig_Scheme) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 2, 0, 0}
}
...
// When an ExternalWorkload is defined for a given workspace, it can be used as a
// destination in a VirtualDestination and RouteTable resource, and selected using
// an IdentitySelector in an AccessPolicy.
type ExternalWorkloadSpec struct {
	...
	// Network segment the external workload belongs to. It determines how traffic
	// is routed to an external workload. If the client app and the external workload
	// are in the same network segment, traffic is directly routed to the workload,
	// whereas an east-west gateway is used when the external workload belongs to
	// a different network segment than the client app.
	Network string `protobuf:"bytes,2,opt,name=network,proto3" json:"network,omitempty"`
	// IdentitySelector define the conditions under which an external workload is selected and attested.
	...
	IdentitySelector *ExternalWorkloadSpec_IdentitySelector `protobuf:"bytes,3,opt,name=identity_selector,json=identitySelector,proto3" json:"identity_selector,omitempty"`
	// Optional: The hostname for which the external workload will serve traffic.
	// Defaults to <external-workload-name>.<namespace>.ext.<trust-domain>.
	Host string `protobuf:"bytes,4,opt,name=Host,proto3" json:"Host,omitempty"`
	// Optional: Readiness probe for the external workload.
	ReadinessProbe *ExternalWorkloadSpec_Probe `protobuf:"bytes,5,opt,name=readiness_probe,json=readinessProbe,proto3" json:"readiness_probe,omitempty"`
}

func (x *ExternalWorkloadSpec) Reset() {
	*x = ExternalWorkloadSpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[0]
...
func (*ExternalWorkloadSpec) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0}
}
...
func (x *ExternalWorkloadSpec) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *ExternalWorkloadSpec) GetHost() string {
	if x != nil {
		return x.Host
	}
	return ""
...
func (x *ExternalWorkloadStatus) Reset() {
	*x = ExternalWorkloadStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{1}
}
...
func (x *ExternalWorkloadReport) Reset() {
	*x = ExternalWorkloadReport{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadReport) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{2}
}
...
func (x *ExternalWorkloadSpec_Port) Reset() {
	*x = ExternalWorkloadSpec_Port{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_Port) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 0}
}
...
type ExternalWorkloadSpec_IdentitySelector struct {
	...
	JoinTokenSpiffeId []string `protobuf:"bytes,4,rep,name=join_token_spiffe_id,json=joinTokenSpiffeId,proto3" json:"join_token_spiffe_id,omitempty"`
}

func (x *ExternalWorkloadSpec_IdentitySelector) Reset() {
	*x = ExternalWorkloadSpec_IdentitySelector{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_IdentitySelector) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 1}
}
...
func (x *ExternalWorkloadSpec_IdentitySelector) GetJoinTokenSpiffeId() []string {
	if x != nil {
		return x.JoinTokenSpiffeId
	}
	return nil
}
...
func (x *ExternalWorkloadSpec_Probe) Reset() {
	*x = ExternalWorkloadSpec_Probe{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_Probe) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 2}
}
...
type ExternalWorkloadSpec_IdentitySelector_AWS struct {
	...
	Tag *ExternalWorkloadSpec_IdentitySelector_AWS_Tag `protobuf:"bytes,7,opt,name=tag,proto3" json:"tag,omitempty"`
}

func (x *ExternalWorkloadSpec_IdentitySelector_AWS) Reset() {
	*x = ExternalWorkloadSpec_IdentitySelector_AWS{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_IdentitySelector_AWS) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 1, 0}
}
...
func (x *ExternalWorkloadSpec_IdentitySelector_AWS) GetSecurityGroup() string {
	if x != nil {
...
func (x *ExternalWorkloadSpec_IdentitySelector_GCP) Reset() {
	*x = ExternalWorkloadSpec_IdentitySelector_GCP{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_IdentitySelector_GCP) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 1, 1}
}
...
func (x *ExternalWorkloadSpec_IdentitySelector_Azure) Reset() {
	*x = ExternalWorkloadSpec_IdentitySelector_Azure{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_IdentitySelector_Azure) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 1, 2}
}
...
func (x *ExternalWorkloadSpec_IdentitySelector_AWS_Tag) Reset() {
	*x = ExternalWorkloadSpec_IdentitySelector_AWS_Tag{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_IdentitySelector_AWS_Tag) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 1, 0, 0}
}
...
func (x *ExternalWorkloadSpec_IdentitySelector_GCP_Label) Reset() {
	*x = ExternalWorkloadSpec_IdentitySelector_GCP_Label{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_IdentitySelector_GCP_Label) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 1, 1, 0}
}
...
func (x *ExternalWorkloadSpec_Probe_HTTPGetConfig) Reset() {
	*x = ExternalWorkloadSpec_Probe_HTTPGetConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_Probe_HTTPGetConfig) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 2, 0}
}
...
func (x *ExternalWorkloadSpec_Probe_HTTPHeader) Reset() {
	*x = ExternalWorkloadSpec_Probe_HTTPHeader{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[12]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_Probe_HTTPHeader) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 2, 1}
}
...
func (x *ExternalWorkloadSpec_Probe_TCPSocketConfig) Reset() {
	*x = ExternalWorkloadSpec_Probe_TCPSocketConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_Probe_TCPSocketConfig) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 2, 2}
}
...
func (x *ExternalWorkloadSpec_Probe_ExecConfig) Reset() {
	*x = ExternalWorkloadSpec_Probe_ExecConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ExternalWorkloadSpec_Probe_ExecConfig) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP(), []int{0, 2, 3}
}
...
var File_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto protoreflect.FileDescriptor

var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDesc = []byte{
	...
	0x6c, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x12, 0x17, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x67, 0x6c, 0x6f,
	...
	0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x52, 0x67,
	...
	0x77, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x81, 0x15, 0x0a, 0x14, 0x45, 0x78, 0x74, 0x65,
	0x72, 0x6e, 0x61, 0x6c, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x70, 0x65, 0x63,
	0x12, 0x48, 0x0a, 0x05, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x32, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x67, 0x6c, 0x6f,
	0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x45, 0x78, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x50,
	...
	0x77, 0x6f, 0x72, 0x6b, 0x12, 0x6b, 0x0a, 0x11, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79,
	...
	0x04, 0x48, 0x6f, 0x73, 0x74, 0x12, 0x5c, 0x0a, 0x0f, 0x72, 0x65, 0x61, 0x64, 0x69, 0x6e, 0x65,
	0x73, 0x73, 0x5f, 0x70, 0x72, 0x6f, 0x62, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33,
	...
	,
	...
	0x53, 0x70, 0x65, 0x63, 0x2e, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x53, 0x65, 0x6c,
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x41, 0x57, 0x53, 0x52, 0x03, 0x61, 0x77, 0x73, 0x12, 0x54,
	0x0a, 0x03, 0x67, 0x63, 0x70, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x42, 0x2e, 0x6e, 0x65,
	...
	0x69, 0x74, 0x79, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x2e, 0x47, 0x43, 0x50, 0x52,
	0x03, 0x67, 0x63, 0x70, 0x12, 0x5a, 0x0a, 0x05, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x18, 0x03, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x44, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67,
	...
	,
	...
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x7a, 0x6f, 0x6e, 0x65, 0x18,
	...
	0x69, 0x6f, 0x6e, 0x12, 0x58, 0x0a, 0x03, 0x74, 0x61, 0x67, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b,
	...
	0x6e, 0x61, 0x6c, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x53, 0x70, 0x65, 0x63, 0x2e,
	0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72,
	0x2e, 0x41, 0x57, 0x53, 0x2e, 0x54, 0x61, 0x67, 0x52, 0x03, 0x74, 0x61, 0x67, 0x1a, 0x2d, 0x0a,
	0x03, 0x54, 0x61, 0x67, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x1a, 0x98, 0x02, 0x0a,
	0x03, 0x47, 0x43, 0x50, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f,
	...
	0x74, 0x61, 0x67, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x69,
	...
	,
	...
	0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x25, 0x0a, 0x0e, 0x73, 0x65,
	0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x5f, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0d, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74, 0x79, 0x47, 0x72, 0x6f, 0x75,
	0x70, 0x12, 0x27, 0x0a, 0x0f, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x5f, 0x6e, 0x65, 0x74,
	0x77, 0x6f, 0x72, 0x6b, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x76, 0x69, 0x72, 0x74,
	0x75, 0x61, 0x6c, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x75,
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x1a, 0xdb, 0x08,
	0x0a, 0x05, 0x50, 0x72, 0x6f, 0x62, 0x65, 0x12, 0x50, 0x0a, 0x15, 0x69, 0x6e, 0x69, 0x74, 0x69,
	0x61, 0x6c, 0x5f, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x5f, 0x73, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x55, 0x49, 0x6e, 0x74, 0x33, 0x32, 0x56,
	0x61, 0x6c, 0x75, 0x65, 0x52, 0x13, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x44, 0x65, 0x6c,
	0x61, 0x79, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x45, 0x0a, 0x0f, 0x74, 0x69, 0x6d,
	...
	0x12, 0x43, 0x0a, 0x0e, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x5f, 0x73, 0x65, 0x63, 0x6f, 0x6e,
	0x64, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x55, 0x49, 0x6e, 0x74, 0x33,
	0x32, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x0d, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x53, 0x65,
	0x63, 0x6f, 0x6e, 0x64, 0x73, 0x12, 0x49, 0x0a, 0x11, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73,
	...
	,
	...
	0x54, 0x54, 0x50, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x52, 0x0b, 0x68, 0x74, 0x74, 0x70, 0x48,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x22, 0x1d, 0x0a, 0x06, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x65,
	0x12, 0x08, 0x0a, 0x04, 0x48, 0x54, 0x54, 0x50, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x48, 0x54,
	0x54, 0x50, 0x53, 0x10, 0x01, 0x1a, 0x36, 0x0a, 0x0a, 0x48, 0x54, 0x54, 0x50, 0x48, 0x65, 0x61,
	...
	0x0f, 0x54, 0x43, 0x50, 0x53, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x12, 0x12, 0x0a, 0x04, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x68, 0x6f, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x1a, 0x26, 0x0a, 0x0a, 0x45, 0x78, 0x65, 0x63,
	...
	0x42, 0x09, 0x0a, 0x07, 0x68, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x72, 0x22, 0xbd, 0x02, 0x0a, 0x16,
	0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64,
	...
	,
	...
	0x70, 0x61, 0x63, 0x65, 0x1a, 0x45, 0x0a, 0x17, 0x4e, 0x75, 0x6d, 0x41, 0x70, 0x70, 0x6c, 0x69,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x97, 0x04, 0x0a, 0x16,
	0x45, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64,
	0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x5f, 0x0a, 0x0a, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70,
	0x61, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x3f, 0x2e, 0x6e, 0x65, 0x74,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x12, 0x27, 0x0a, 0x0f, 0x6f,
	...
	0x70, 0x61, 0x63, 0x65, 0x1a, 0x5a, 0x0a, 0x0f, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63,
	...
	0x1a, 0x82, 0x01, 0x0a, 0x1f, 0x41, 0x70, 0x70, 0x6c, 0x69, 0x65, 0x64, 0x44, 0x65, 0x73, 0x74,
	0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x49, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x33, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x67,
	...
	0x72, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x69, 0x65, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75,
...
var (
	file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescOnce sync.Once
	file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescData = file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDesc
)

func file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescData)
	})
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDescData
}

var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_goTypes = []interface{}{
	...
	(*ExternalWorkloadSpec_Port)(nil),                       // 4: networking.gloo.solo.io.ExternalWorkloadSpec.Port
	(*ExternalWorkloadSpec_IdentitySelector)(nil),           // 5: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector
	(*ExternalWorkloadSpec_Probe)(nil),                      // 6: networking.gloo.solo.io.ExternalWorkloadSpec.Probe
	(*ExternalWorkloadSpec_IdentitySelector_AWS)(nil),       // 7: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.AWS
	(*ExternalWorkloadSpec_IdentitySelector_GCP)(nil),       // 8: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.GCP
	(*ExternalWorkloadSpec_IdentitySelector_Azure)(nil),     // 9: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.Azure
	(*ExternalWorkloadSpec_IdentitySelector_AWS_Tag)(nil),   // 10: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.AWS.Tag
	(*ExternalWorkloadSpec_IdentitySelector_GCP_Label)(nil), // 11: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.GCP.Label
	(*ExternalWorkloadSpec_Probe_HTTPGetConfig)(nil),        // 12: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.HTTPGetConfig
	(*ExternalWorkloadSpec_Probe_HTTPHeader)(nil),           // 13: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.HTTPHeader
	(*ExternalWorkloadSpec_Probe_TCPSocketConfig)(nil),      // 14: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.TCPSocketConfig
	(*ExternalWorkloadSpec_Probe_ExecConfig)(nil),           // 15: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.ExecConfig
	nil,                          // 16: networking.gloo.solo.io.ExternalWorkloadStatus.NumAppliedPoliciesEntry
	nil,                          // 17: networking.gloo.solo.io.ExternalWorkloadReport.WorkspacesEntry
	nil,                          // 18: networking.gloo.solo.io.ExternalWorkloadReport.AppliedDestinationPoliciesEntry
	(*v2.Status)(nil),            // 19: common.gloo.solo.io.Status
	(*wrappers.UInt32Value)(nil), // 20: google.protobuf.UInt32Value
	(*v2.Report)(nil),            // 21: common.gloo.solo.io.Report
	(*v2.AppliedDestinationPortPolicies)(nil), // 22: common.gloo.solo.io.AppliedDestinationPortPolicies
}
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_depIdxs = []int32{
	4,  // 0: networking.gloo.solo.io.ExternalWorkloadSpec.ports:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.Port
	5,  // 1: networking.gloo.solo.io.ExternalWorkloadSpec.identity_selector:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector
	6,  // 2: networking.gloo.solo.io.ExternalWorkloadSpec.readiness_probe:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.Probe
	19, // 3: networking.gloo.solo.io.ExternalWorkloadStatus.common:type_name -> common.gloo.solo.io.Status
	16, // 4: networking.gloo.solo.io.ExternalWorkloadStatus.num_applied_policies:type_name -> networking.gloo.solo.io.ExternalWorkloadStatus.NumAppliedPoliciesEntry
	17, // 5: networking.gloo.solo.io.ExternalWorkloadReport.workspaces:type_name -> networking.gloo.solo.io.ExternalWorkloadReport.WorkspacesEntry
	18, // 6: networking.gloo.solo.io.ExternalWorkloadReport.applied_destination_policies:type_name -> networking.gloo.solo.io.ExternalWorkloadReport.AppliedDestinationPoliciesEntry
	7,  // 7: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.aws:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.AWS
	8,  // 8: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.gcp:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.GCP
	9,  // 9: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.azure:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.Azure
	20, // 10: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.initial_delay_seconds:type_name -> google.protobuf.UInt32Value
	20, // 11: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.timeout_seconds:type_name -> google.protobuf.UInt32Value
	20, // 12: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.period_seconds:type_name -> google.protobuf.UInt32Value
	20, // 13: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.success_threshold:type_name -> google.protobuf.UInt32Value
	20, // 14: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.failure_threshold:type_name -> google.protobuf.UInt32Value
	12, // 15: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.http_get:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.Probe.HTTPGetConfig
	14, // 16: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.tcp_socket:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.Probe.TCPSocketConfig
	15, // 17: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.exec:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.Probe.ExecConfig
	10, // 18: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.AWS.tag:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.AWS.Tag
	11, // 19: networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.GCP.label:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.IdentitySelector.GCP.Label
	0,  // 20: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.HTTPGetConfig.scheme:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.Probe.HTTPGetConfig.Scheme
	13, // 21: networking.gloo.solo.io.ExternalWorkloadSpec.Probe.HTTPGetConfig.http_headers:type_name -> networking.gloo.solo.io.ExternalWorkloadSpec.Probe.HTTPHeader
	21, // 22: networking.gloo.solo.io.ExternalWorkloadReport.WorkspacesEntry.value:type_name -> common.gloo.solo.io.Report
	22, // 23: networking.gloo.solo.io.ExternalWorkloadReport.AppliedDestinationPoliciesEntry.value:type_name -> common.gloo.solo.io.AppliedDestinationPortPolicies
...
func init() {
	file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_init()
}
func file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_init() {
	if File_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes[5].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_goTypes,
		DependencyIndexes: file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_depIdxs,
		EnumInfos:         file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_enumTypes,
		MessageInfos:      file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_msgTypes,
	}.Build()
	File_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto = out.File
	file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_rawDesc = nil
	file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_goTypes = nil
	file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_external_workload_proto_depIdxs = nil
}
