...
//
// </br>**Configuration constraints**: If the appProtocol is HTTP, GRPC, GRPC-WEB, or HTTP2, this value must be PASSTHROUGH or AUTO_PASSTHROUGH.
...
const (
	...
	// Similar to the PASSTHROUGH mode, except that servers with this TLS mode do not require an associated VirtualService
	// to map from the SNI value to a service in the registry. The destination details such as the service/subset/port
	...
	//
	// </br>**Implementation notes**: When using this TLS mode, the source and destination are assumed to use Istio mTLS to secure traffic.
	...
	// Compared to MUTUAL mode, this mode uses certificates that represents the gateway workload identity
	// and are automatically generated by Istio for mTLS authentication.
	//
	// </br>**Implementation notes**: All other fields in `tlsConfig` must be empty.
...
// <li>This field is required if the appProtocol is HTTPS or TLS.</li>
// <li>This field must be empty if the appProtocol is TCP or MONGO.</li></ul>
type TLSConfig struct {
	...
	//
	// </br>**Configuration constraints**: If you specify this field, you must also specify `caCerts`.
...
type VirtualGatewaySpec_Listener struct {
	...
	// The first `host` is the `host` on the first `allowedRouteTables` entry, or on the first `exposedExternalServices` entry
	// if no `allowedRouteTables` are provided. If no `allowedRouteTables` and no `exposedExternalServices` are provided,
	// the first `host` is the wildcard '*'.</li></ul>
	...
	// If empty, any ExternalService is exposed by this VirtualGateway.
	...
	// Optional: Application protocol to use when adding additional capabilities, such as routing and rich metrics, to
	// the gateway. If no protocol is selected, the protocol is inferred
	// from the listener type and its TLS settings. For example, for an `http` listener, the `app_protocol` defaults to
	// `HTTP` if no TLS settings are defined, and `HTTPS` if TLS settings are defined. For a `tcp` listener, the `app_protocol`
	// defaults to `TCP` or `TLS`, depending on the presence of TLS settings.
	//
	// </br>**Configuration constraints**:<ul>
	// <li>The following values are supported: `HTTP`, `HTTPS`, `GRPC`, `GRPC-WEB`, `HTTP2`, `MONGO`, `TCP`, `TLS`</li>
...
type VirtualGatewaySpec_Listener_HttpsRedirect struct {
	...
	//
	// </br>**Configuration constraints**:<ul>
	// <li>This field must be false if `appProtocol` is HTTPS, MONGO, TCP, or TLS.</li>
	// <li>This field must be false if `appProtocol` is empty. Exception: If neither `appProtocol`
	// nor `tls` are specified, and the `http` field is populated, then this field can be `true`.</li></ul>
...
type VirtualGatewaySpec_Listener_RouteTableFilter struct {
	...
	//
	// <br>**Implementation notes**:<ul>
	// <li>If this field is `nil`, all RouteTables in this workspace are selected.</li>
	// <li>If a selector is empty or nil, it matches all RouteTables in this workspace.</li>
...
type TLSConfig_Files struct {
	...
	//
	// </br>**Configuration constraints**:<ul>
	// <li>This field must be empty if the `appProtocol` is HTTP, GRPC, GRPC-WEB, or HTTP2.</li>
	// <li>This field must be empty if the `tlsMode` is ISTIO_MUTUAL.</li>
	// <li>This field is required if the `tlsMode` is SIMPLE or MUTUAL, and `secretName` is not set.</li>
	// <li>This field is ignored if the `tlsMode` is PASSTHROUGH or AUTO_PASSTHROUGH.</li></ul>
	...
	// <li>This field must be empty if the `tlsMode` is ISTIO_MUTUAL.</li>
	// <li>This field is required if the `tlsMode` is SIMPLE or MUTUAL, and `secretName` is not set.</li>
	// <li>This field is ignored if the `tlsMode` is PASSTHROUGH or AUTO_PASSTHROUGH.</li>
	...
	// <li>This field must be empty if the `appProtocol` is HTTP, GRPC, GRPC-WEB, or HTTP2.</li>
	// <li>This field must be empty if the `tlsMode` is ISTIO_MUTUAL.</li>
	// <li>This field is required if the `tlsMode` is MUTUAL, and `secretName` is not set.</li>
	// <li>This field is ignored if the `tlsMode` is PASSTHROUGH or AUTO_PASSTHROUGH.</li></ul>
...
type TLSConfig_Parameters struct {
	...
	// Note: Using TLS protocol versions below `TLSV1_2` can pose serious security risks.
	...
	//
	// </br>**Configuration constraints**:<ul>
	// <li>This field is required if the `minimumProtocolVersion` is TLSv1_0 or TLSv1_1.
	...
	// <li>This field is ignored if the `minimumProtocolVersion` is TLSv1_3.</li>
...
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDesc = []byte{
	...
	0x5f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x17,
	...
	0x70, 0x6f, 0x72, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x53, 0x67, 0x69, 0x74, 0x68,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xff, 0x08, 0x0a, 0x12, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c,
	0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x70, 0x65, 0x63, 0x12, 0x43, 0x0a, 0x09, 0x77,
	0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25,
	...
	0x03, 0x28, 0x0b, 0x32, 0x34, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67,
	...
	0x6e, 0x65, 0x72, 0x73, 0x1a, 0xcf, 0x07, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65,
	0x72, 0x12, 0x35, 0x0a, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	0x53, 0x70, 0x65, 0x63, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x2e, 0x48, 0x54,
	0x54, 0x50, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x48, 0x01, 0x52, 0x04, 0x68, 0x74, 0x74, 0x70,
	0x12, 0x52, 0x0a, 0x03, 0x74, 0x63, 0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3e, 0x2e,
	0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e,
	...
	0x6e, 0x65, 0x72, 0x2e, 0x54, 0x43, 0x50, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x48, 0x01, 0x52,
	0x03, 0x74, 0x63, 0x70, 0x12, 0x77, 0x0a, 0x14, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x5f,
	...
	0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x54, 0x61,
	0x62, 0x6c, 0x65, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x52, 0x12, 0x61, 0x6c, 0x6c, 0x6f, 0x77,
	0x65, 0x64, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x12, 0x86, 0x01,
	0x0a, 0x19, 0x65, 0x78, 0x70, 0x6f, 0x73, 0x65, 0x64, 0x5f, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x4a, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x67,
	...
	,
	...
	,
	...
	0x65, 0x63, 0x74, 0x6f, 0x72, 0x42, 0x0e, 0x0a, 0x0c, 0x74, 0x6c, 0x73, 0x5f, 0x73, 0x65, 0x74,
	0x74, 0x69, 0x6e, 0x67, 0x73, 0x42, 0x0f, 0x0a, 0x0d, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65,
	0x72, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x22, 0x83, 0x07, 0x0a, 0x09, 0x54, 0x4c, 0x53, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x12, 0x21, 0x0a, 0x0b, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x5f, 0x6e,
	0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0a, 0x73, 0x65, 0x63,
	0x72, 0x65, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x40, 0x0a, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73,
	...
	0x2e, 0x54, 0x4c, 0x53, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x73,
	0x48, 0x00, 0x52, 0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x35, 0x0a, 0x17, 0x76, 0x65, 0x72,
	0x69, 0x66, 0x79, 0x5f, 0x73, 0x75, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x5f, 0x61, 0x6c, 0x74, 0x5f,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x14, 0x76, 0x65, 0x72, 0x69,
	...
	,
	...
	0x5f, 0x63, 0x65, 0x72, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x61,
	0x43, 0x65, 0x72, 0x74, 0x73, 0x1a, 0xf8, 0x02, 0x0a, 0x0a, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65,
	0x74, 0x65, 0x72, 0x73, 0x12, 0x77, 0x0a, 0x18, 0x6d, 0x69, 0x6e, 0x69, 0x6d, 0x75, 0x6d, 0x5f,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x3d, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	0x69, 0x6e, 0x67, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f,
	0x2e, 0x54, 0x4c, 0x53, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x77, 0x0a,
	...
	0x3d, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x67, 0x6c, 0x6f,
	0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x54, 0x4c, 0x53, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x2e, 0x50,
	...
	0x69, 0x70, 0x68, 0x65, 0x72, 0x53, 0x75, 0x69, 0x74, 0x65, 0x73, 0x22, 0x53, 0x0a, 0x0f, 0x50,
	0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x0c,
	...
	0x22, 0x5a, 0x0a, 0x07, 0x54, 0x4c, 0x53, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x0f, 0x0a, 0x0b, 0x50,
	...
	0x54, 0x49, 0x4f, 0x5f, 0x4d, 0x55, 0x54, 0x55, 0x41, 0x4c, 0x10, 0x04, 0x42, 0x0e, 0x0a, 0x0c,
	0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x22, 0xeb, 0x01, 0x0a,
	0x14, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53,
	...
	0x75, 0x73, 0x52, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x12, 0x2c, 0x0a, 0x12, 0x72, 0x6f,
	0x75, 0x74, 0x65, 0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x10, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x54, 0x61, 0x62,
	0x6c, 0x65, 0x73, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x38, 0x0a, 0x18, 0x73, 0x65, 0x6c, 0x65,
	0x63, 0x74, 0x65, 0x64, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x5f, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x16, 0x73, 0x65, 0x6c, 0x65,
	0x63, 0x74, 0x65, 0x64, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x43, 0x6f, 0x75,
	...
	0x60, 0x0a, 0x19, 0x65, 0x78, 0x70, 0x6f, 0x73, 0x65, 0x64, 0x5f, 0x65, 0x78, 0x74, 0x65, 0x72,
	0x6e, 0x61, 0x6c, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03,
