...
type CloudProviderSet interface {
	...
	List(filterResource ...func(*networking_gloo_solo_io_v2.CloudProvider) bool) []*networking_gloo_solo_io_v2.CloudProvider
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*networking_gloo_solo_io_v2.CloudProvider) bool) []*networking_gloo_solo_io_v2.CloudProvider
	// Return the Set as a map of key to resource.
	Map() map[string]*networking_gloo_solo_io_v2.CloudProvider
	// Insert a resource into the set.
	Insert(cloudProvider ...*networking_gloo_solo_io_v2.CloudProvider)
	...
	Find(id ezkube.ResourceId) (*networking_gloo_solo_io_v2.CloudProvider, error)
...
func makeGenericCloudProviderSet(cloudProviderList []*networking_gloo_solo_io_v2.CloudProvider) sksets.ResourceSet {
...
func NewCloudProviderSet(cloudProviderList ...*networking_gloo_solo_io_v2.CloudProvider) CloudProviderSet {
	return &cloudProviderSet{set: makeGenericCloudProviderSet(cloudProviderList)}
}

func NewCloudProviderSetFromList(cloudProviderList *networking_gloo_solo_io_v2.CloudProviderList) CloudProviderSet {
	list := make([]*networking_gloo_solo_io_v2.CloudProvider, 0, len(cloudProviderList.Items))
...
func (s *cloudProviderSet) List(filterResource ...func(*networking_gloo_solo_io_v2.CloudProvider) bool) []*networking_gloo_solo_io_v2.CloudProvider {
	if s == nil {
		return nil
	}
	...
	for _, filter := range filterResource {
		...
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*networking_gloo_solo_io_v2.CloudProvider))
		})
	}

	objs := s.Generic().List(genericFilters...)
	cloudProviderList := make([]*networking_gloo_solo_io_v2.CloudProvider, 0, len(objs))
	for _, obj := range objs {
		cloudProviderList = append(cloudProviderList, obj.(*networking_gloo_solo_io_v2.CloudProvider))
	}
	return cloudProviderList
}

func (s *cloudProviderSet) UnsortedList(filterResource ...func(*networking_gloo_solo_io_v2.CloudProvider) bool) []*networking_gloo_solo_io_v2.CloudProvider {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var cloudProviderList []*networking_gloo_solo_io_v2.CloudProvider
...
func (s *cloudProviderSet) Map() map[string]*networking_gloo_solo_io_v2.CloudProvider {
	if s == nil {
		return nil
	}

	newMap := map[string]*networking_gloo_solo_io_v2.CloudProvider{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*networking_gloo_solo_io_v2.CloudProvider)
	}
	return newMap
}

func (s *cloudProviderSet) Insert(
	cloudProviderList ...*networking_gloo_solo_io_v2.CloudProvider,
) {
	if s == nil {
...
func (s *cloudProviderSet) Find(id ezkube.ResourceId) (*networking_gloo_solo_io_v2.CloudProvider, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find CloudProvider %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&networking_gloo_solo_io_v2.CloudProvider{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*networking_gloo_solo_io_v2.CloudProvider), nil
}
...
type CloudResourcesSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*networking_gloo_solo_io_v2.CloudResources) bool) []*networking_gloo_solo_io_v2.CloudResources
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*networking_gloo_solo_io_v2.CloudResources) bool) []*networking_gloo_solo_io_v2.CloudResources
	// Return the Set as a map of key to resource.
	Map() map[string]*networking_gloo_solo_io_v2.CloudResources
	// Insert a resource into the set.
	Insert(cloudResources ...*networking_gloo_solo_io_v2.CloudResources)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*networking_gloo_solo_io_v2.CloudResources, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericCloudResourcesSet(cloudResourcesList []*networking_gloo_solo_io_v2.CloudResources) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewCloudResourcesSet(cloudResourcesList ...*networking_gloo_solo_io_v2.CloudResources) CloudResourcesSet {
	return &cloudResourcesSet{set: makeGenericCloudResourcesSet(cloudResourcesList)}
}

func NewCloudResourcesSetFromList(cloudResourcesList *networking_gloo_solo_io_v2.CloudResourcesList) CloudResourcesSet {
	list := make([]*networking_gloo_solo_io_v2.CloudResources, 0, len(cloudResourcesList.Items))
...
func (s *cloudResourcesSet) List(filterResource ...func(*networking_gloo_solo_io_v2.CloudResources) bool) []*networking_gloo_solo_io_v2.CloudResources {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		filter := filter
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*networking_gloo_solo_io_v2.CloudResources))
		})
	}

	objs := s.Generic().List(genericFilters...)
	cloudResourcesList := make([]*networking_gloo_solo_io_v2.CloudResources, 0, len(objs))
	for _, obj := range objs {
		cloudResourcesList = append(cloudResourcesList, obj.(*networking_gloo_solo_io_v2.CloudResources))
	}
	return cloudResourcesList
}

func (s *cloudResourcesSet) UnsortedList(filterResource ...func(*networking_gloo_solo_io_v2.CloudResources) bool) []*networking_gloo_solo_io_v2.CloudResources {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var cloudResourcesList []*networking_gloo_solo_io_v2.CloudResources
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		cloudResourcesList = append(cloudResourcesList, obj.(*networking_gloo_solo_io_v2.CloudResources))
	}
	return cloudResourcesList
...
func (s *cloudResourcesSet) Map() map[string]*networking_gloo_solo_io_v2.CloudResources {
	if s == nil {
		return nil
	}

	newMap := map[string]*networking_gloo_solo_io_v2.CloudResources{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*networking_gloo_solo_io_v2.CloudResources)
	}
	return newMap
}

func (s *cloudResourcesSet) Insert(
	cloudResourcesList ...*networking_gloo_solo_io_v2.CloudResources,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *cloudResourcesSet) Find(id ezkube.ResourceId) (*networking_gloo_solo_io_v2.CloudResources, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find CloudResources %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&networking_gloo_solo_io_v2.CloudResources{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*networking_gloo_solo_io_v2.CloudResources), nil
}
