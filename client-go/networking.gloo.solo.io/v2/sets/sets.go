...
type ExternalWorkloadSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*networking_gloo_solo_io_v2.ExternalWorkload) bool) []*networking_gloo_solo_io_v2.ExternalWorkload
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*networking_gloo_solo_io_v2.ExternalWorkload) bool) []*networking_gloo_solo_io_v2.ExternalWorkload
	// Return the Set as a map of key to resource.
	Map() map[string]*networking_gloo_solo_io_v2.ExternalWorkload
	// Insert a resource into the set.
	Insert(externalWorkload ...*networking_gloo_solo_io_v2.ExternalWorkload)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*networking_gloo_solo_io_v2.ExternalWorkload, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericExternalWorkloadSet(externalWorkloadList []*networking_gloo_solo_io_v2.ExternalWorkload) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewExternalWorkloadSet(externalWorkloadList ...*networking_gloo_solo_io_v2.ExternalWorkload) ExternalWorkloadSet {
	return &externalWorkloadSet{set: makeGenericExternalWorkloadSet(externalWorkloadList)}
}

func NewExternalWorkloadSetFromList(externalWorkloadList *networking_gloo_solo_io_v2.ExternalWorkloadList) ExternalWorkloadSet {
	list := make([]*networking_gloo_solo_io_v2.ExternalWorkload, 0, len(externalWorkloadList.Items))
...
func (s *externalWorkloadSet) List(filterResource ...func(*networking_gloo_solo_io_v2.ExternalWorkload) bool) []*networking_gloo_solo_io_v2.ExternalWorkload {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		filter := filter
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*networking_gloo_solo_io_v2.ExternalWorkload))
		})
	}

	objs := s.Generic().List(genericFilters...)
	externalWorkloadList := make([]*networking_gloo_solo_io_v2.ExternalWorkload, 0, len(objs))
	for _, obj := range objs {
		externalWorkloadList = append(externalWorkloadList, obj.(*networking_gloo_solo_io_v2.ExternalWorkload))
	}
	return externalWorkloadList
}

func (s *externalWorkloadSet) UnsortedList(filterResource ...func(*networking_gloo_solo_io_v2.ExternalWorkload) bool) []*networking_gloo_solo_io_v2.ExternalWorkload {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var externalWorkloadList []*networking_gloo_solo_io_v2.ExternalWorkload
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		externalWorkloadList = append(externalWorkloadList, obj.(*networking_gloo_solo_io_v2.ExternalWorkload))
	}
	return externalWorkloadList
...
func (s *externalWorkloadSet) Map() map[string]*networking_gloo_solo_io_v2.ExternalWorkload {
	if s == nil {
		return nil
	}

	newMap := map[string]*networking_gloo_solo_io_v2.ExternalWorkload{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*networking_gloo_solo_io_v2.ExternalWorkload)
	}
	return newMap
}

func (s *externalWorkloadSet) Insert(
	externalWorkloadList ...*networking_gloo_solo_io_v2.ExternalWorkload,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *externalWorkloadSet) Find(id ezkube.ResourceId) (*networking_gloo_solo_io_v2.ExternalWorkload, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find ExternalWorkload %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&networking_gloo_solo_io_v2.ExternalWorkload{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*networking_gloo_solo_io_v2.ExternalWorkload), nil
}
