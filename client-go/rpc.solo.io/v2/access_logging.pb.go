// The logging service provides structured retrieval of event logs captured by Gloo Platform. For more information, see the [access logging documentation]({{< versioned_link_path fromRoot="/observability/mesh/access-logs/" >}}).
