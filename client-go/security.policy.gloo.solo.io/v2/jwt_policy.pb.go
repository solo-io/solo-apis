...
type JWTPolicySpec struct {
	...
	//
	// </br>**Configuration constraints**: Only one JWT policy can apply to a destination.
	// Subsequent policies (sorted by creation time) are ignored and put into a FAILED state.
	// If a JWT policy is applied to a VirtualDestination and another is applied to a Kubernetes Service backing the VD,
	// the policy applied to the Service directly takes precedence. The other is ignored and put into a FAILED state.
...
type JWTPolicySpec_Config_Provider_Local struct {
	...
	// such as a Kubernetes secret or an inline PEM-formatted public key.
...
type JWTPolicySpec_Config_Provider_RemoteJWKS struct {
	...
	// Configure retry behavior when a JWKS fetch fails.
	RetryPolicy *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy `protobuf:"bytes,6,opt,name=retry_policy,json=retryPolicy,proto3" json:"retry_policy,omitempty"`
	// The duration to wait after a failed fetch cycle (retries exhausted)
	// before starting a new fetch cycle. Only applies when
	// `enableAsyncFetch` is true; otherwise this field is ignored.
	//
	// If omitted, defaults to 1 second per Envoy default behavior, which
	// can produce request storms against the JWKS server during outages.
	// Set this to a higher value (for example, 5 minutes) to limit the
	// rate of failed fetches.
	FailedRefetchDuration *durationpb.Duration `protobuf:"bytes,7,opt,name=failed_refetch_duration,json=failedRefetchDuration,proto3" json:"failed_refetch_duration,omitempty"`
}
...
func (x *JWTPolicySpec_Config_Provider_RemoteJWKS) GetRetryPolicy() *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy {
	if x != nil {
...
func (x *JWTPolicySpec_Config_Provider_RemoteJWKS) GetFailedRefetchDuration() *durationpb.Duration {
	if x != nil {
...
// Configure retry behavior when a JWKS fetch fails. Applies to both
// async and on-demand fetching. If omitted, the underlying filter
// retries once with no backoff, which can overwhelm the JWKS server
// when the URL is misconfigured or the server is unavailable.
type JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The maximum number of retries to attempt per failed fetch.
	...
	// Configure exponential backoff between retries.
	// If omitted, retries occur with a fixed 1 second interval.
	Backoff *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff `protobuf:"bytes,2,opt,name=backoff,proto3" json:"backoff,omitempty"`
}

func (x *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy) Reset() {
	*x = JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_msgTypes[13]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy) ProtoMessage() {}

func (x *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy.ProtoReflect.Descriptor instead.
func (*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_rawDescGZIP(), []int{0, 0, 0, 2, 0}
}

func (x *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy) GetNumRetries() *wrapperspb.UInt32Value {
	if x != nil {
		return x.NumRetries
	}
	return nil
...
func (x *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy) GetBackoff() *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff {
	if x != nil {
		return x.Backoff
	}
	return nil
...
type JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The base interval before the first retry. Must be greater than 0
	// and less than or equal to `maxInterval`.
	// If omitted, defaults to 1 second.
	...
	// If omitted, defaults to 10 times `baseInterval`.
...
func (x *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff) Reset() {
	*x = JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff) ProtoMessage() {}

func (x *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff.ProtoReflect.Descriptor instead.
func (*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_rawDescGZIP(), []int{0, 0, 0, 2, 0, 0}
}

func (x *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff) GetBaseInterval() *durationpb.Duration {
	if x != nil {
...
func (x *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff) GetMaxInterval() *durationpb.Duration {
	if x != nil {
...
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x93, 0x1a, 0x0a, 0x0d, 0x4a, 0x57,
	...
	0x67, 0x1a, 0x8b, 0x18, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x5f, 0x0a, 0x09,
	...
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x1a, 0xb3, 0x10, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64,
	...
	0x72, 0x1a, 0xb0, 0x06, 0x0a, 0x0a, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x4a, 0x57, 0x4b, 0x53,
	...
	,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0xcc, 0x02, 0x0a, 0x0b, 0x52, 0x65, 0x74, 0x72, 0x79, 0x50,
	...
	,
	...
	0x72, 0x76, 0x61, 0x6c, 0x1a, 0x56, 0x0a, 0x0e, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x54, 0x6f,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x61, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x42, 0x0d, 0x0a, 0x0b,
	0x6a, 0x77, 0x6b, 0x73, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0x79, 0x0a, 0x0e, 0x50,
	...
	0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x4a, 0x57,
	0x54, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x2e, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x52, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x8d, 0x01, 0x0a, 0x0c, 0x43, 0x6c, 0x61, 0x69, 0x6d,
	0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01,
	...
	,
	...
	,
	...
	0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x12, 0x67,
	0x0a, 0x1a, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x64, 0x65, 0x73, 0x74, 0x69,
	0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03,
	...
	0x02, 0x38, 0x01, 0x42, 0x60, 0x5a, 0x52, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x73, 0x6f, 0x6c, 0x6f, 0x2d, 0x69, 0x6f, 0x2f, 0x67, 0x6c, 0x6f, 0x6f, 0x2d, 0x6d,
	0x65, 0x73, 0x68, 0x2d, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x2f, 0x76,
...
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_goTypes = []interface{}{
	...
	(*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy)(nil),         // 15: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.RetryPolicy
	(*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff)(nil), // 16: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.RetryPolicy.Backoff
	nil,                             // 17: security.policy.gloo.solo.io.JWTPolicyReport.WorkspacesEntry
	(*v2.RouteSelector)(nil),        // 18: common.gloo.solo.io.RouteSelector
	(*v2.DestinationSelector)(nil),  // 19: common.gloo.solo.io.DestinationSelector
	(*v2.Status)(nil),               // 20: common.gloo.solo.io.Status
	(*v2.RouteReference)(nil),       // 21: common.gloo.solo.io.RouteReference
	(*v2.DestinationReference)(nil), // 22: common.gloo.solo.io.DestinationReference
	(*v2.PrioritizedPhase)(nil),     // 23: common.gloo.solo.io.PrioritizedPhase
	(*wrapperspb.UInt32Value)(nil),  // 24: google.protobuf.UInt32Value
	(*durationpb.Duration)(nil),     // 25: google.protobuf.Duration
	(*v2.ObjectReference)(nil),      // 26: common.gloo.solo.io.ObjectReference
	(*v2.Report)(nil),               // 27: common.gloo.solo.io.Report
}
var file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_depIdxs = []int32{
	18, // 0: security.policy.gloo.solo.io.JWTPolicySpec.apply_to_routes:type_name -> common.gloo.solo.io.RouteSelector
	19, // 1: security.policy.gloo.solo.io.JWTPolicySpec.apply_to_destinations:type_name -> common.gloo.solo.io.DestinationSelector
	5,  // 2: security.policy.gloo.solo.io.JWTPolicySpec.config:type_name -> security.policy.gloo.solo.io.JWTPolicySpec.Config
	20, // 3: security.policy.gloo.solo.io.JWTPolicyStatus.common:type_name -> common.gloo.solo.io.Status
	17, // 4: security.policy.gloo.solo.io.JWTPolicyReport.workspaces:type_name -> security.policy.gloo.solo.io.JWTPolicyReport.WorkspacesEntry
	21, // 5: security.policy.gloo.solo.io.JWTPolicyReport.selected_routes:type_name -> common.gloo.solo.io.RouteReference
	22, // 6: security.policy.gloo.solo.io.JWTPolicyReport.selected_destination_ports:type_name -> common.gloo.solo.io.DestinationReference
	...
	23, // 8: security.policy.gloo.solo.io.JWTPolicySpec.Config.phase:type_name -> common.gloo.solo.io.PrioritizedPhase
	...
	24, // 16: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.clock_skew_seconds:type_name -> google.protobuf.UInt32Value
	...
	22, // 20: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.destination_ref:type_name -> common.gloo.solo.io.DestinationReference
	25, // 21: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.cache_duration:type_name -> google.protobuf.Duration
	25, // 22: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.timeout:type_name -> google.protobuf.Duration
	15, // 23: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.retry_policy:type_name -> security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.RetryPolicy
	25, // 24: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.failed_refetch_duration:type_name -> google.protobuf.Duration
	26, // 25: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.LocalJWKS.SecretRef.objectRef:type_name -> common.gloo.solo.io.ObjectReference
	24, // 26: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.RetryPolicy.num_retries:type_name -> google.protobuf.UInt32Value
	16, // 27: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.RetryPolicy.backoff:type_name -> security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.RetryPolicy.Backoff
	25, // 28: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.RetryPolicy.Backoff.base_interval:type_name -> google.protobuf.Duration
	25, // 29: security.policy.gloo.solo.io.JWTPolicySpec.Config.Provider.RemoteJWKS.RetryPolicy.Backoff.max_interval:type_name -> google.protobuf.Duration
	27, // 30: security.policy.gloo.solo.io.JWTPolicyReport.WorkspacesEntry.value:type_name -> common.gloo.solo.io.Report
...
func file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_gloo_mesh_solo_apis_api_gloo_solo_io_policy_v2_security_jwt_policy_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
