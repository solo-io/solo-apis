...
func (m *JWTPolicySpec_Config_Provider_RemoteJWKS) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetFailedRefetchDuration()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("FailedRefetchDuration")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetFailedRefetchDuration(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("FailedRefetchDuration")); err != nil {
				return 0, err
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/gloo-mesh-enterprise/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetBackoff()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("Backoff")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetBackoff(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("Backoff")); err != nil {
				return 0, err
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/gloo-mesh-enterprise/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff")); err != nil {
		return 0, err
	}
