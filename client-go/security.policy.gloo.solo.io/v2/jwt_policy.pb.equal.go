...
func (m *JWTPolicySpec_Config_Provider_RemoteJWKS) Equal(that interface{}) bool {
	...
	if h, ok := interface{}(m.GetFailedRefetchDuration()).(equality.Equalizer); ok {
		if !h.Equal(target.GetFailedRefetchDuration()) {
			return false
		}
	} else {
		if !proto.Equal(m.GetFailedRefetchDuration(), target.GetFailedRefetchDuration()) {
			return false
		}
	}
...
// Equal function
func (m *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy)
	if !ok {
		that2, ok := that.(JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy)
		if ok {
			target = &that2
		} else {
			return false
	...
	if h, ok := interface{}(m.GetBackoff()).(equality.Equalizer); ok {
		if !h.Equal(target.GetBackoff()) {
			return false
		}
	} else {
		if !proto.Equal(m.GetBackoff(), target.GetBackoff()) {
			return false
		}
	}
...
// Equal function
func (m *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff)
	if !ok {
		that2, ok := that.(JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff)
		if ok {
			target = &that2
		} else {
			return false
