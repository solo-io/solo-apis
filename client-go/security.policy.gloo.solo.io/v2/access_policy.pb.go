...
//
// **Examples**:
// The following example is a simple access policy that allows
// only the productpage app to access the ratings app through
// the ratings app's port number.
// ```yaml
// {{% readfile file="/content/mesh/static/content/examples/generated/e2e/access_policy_same_workspace_block/cluster-1/access-policy_bookinfo_ratings-access.yaml" %}}
// ```
//
...
// How clients are authorized to access the workload.
// A request is allowed when it matches ALL of the requirements specified (logically AND'd together).
