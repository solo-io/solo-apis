...
func (m *JWTPolicySpec_Config_Provider_RemoteJWKS) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetRetryPolicy()).(clone.Cloner); ok {
		target.RetryPolicy = h.Clone().(*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy)
	} else {
		target.RetryPolicy = proto.Clone(m.GetRetryPolicy()).(*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy)
	}

	if h, ok := interface{}(m.GetFailedRefetchDuration()).(clone.Cloner); ok {
		target.FailedRefetchDuration = h.Clone().(*google_golang_org_protobuf_types_known_durationpb.Duration)
	} else {
		target.FailedRefetchDuration = proto.Clone(m.GetFailedRefetchDuration()).(*google_golang_org_protobuf_types_known_durationpb.Duration)
	}
...
// Clone function
func (m *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy) Clone() proto.Message {
	var target *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy
	if m == nil {
		return target
	}
	target = &JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy{}
	...
	if h, ok := interface{}(m.GetBackoff()).(clone.Cloner); ok {
		target.Backoff = h.Clone().(*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff)
	} else {
		target.Backoff = proto.Clone(m.GetBackoff()).(*JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff)
	}
...
// Clone function
func (m *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff) Clone() proto.Message {
	var target *JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff
	if m == nil {
		return target
	}
	target = &JWTPolicySpec_Config_Provider_RemoteJWKS_RetryPolicy_Backoff{}
