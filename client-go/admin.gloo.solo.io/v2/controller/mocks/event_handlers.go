...
func (mr *MockGatewayLifecycleManagerEventHandlerMockRecorder) CreateGatewayLifecycleManager(obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGatewayLifecycleManagerEventHandlerMockRecorder) DeleteGatewayLifecycleManager(obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGatewayLifecycleManagerEventHandlerMockRecorder) GenericGatewayLifecycleManager(obj interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGatewayLifecycleManagerEventHandlerMockRecorder) UpdateGatewayLifecycleManager(old, new interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// AddEventHandler indicates an expected call of AddEventHandler.
func (mr *MockGatewayLifecycleManagerEventWatcherMockRecorder) AddEventHandler(ctx, h interface{}, predicates ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, h}, predicates...)
