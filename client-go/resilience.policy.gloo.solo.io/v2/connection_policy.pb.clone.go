...
func (m *ConnectionPolicyStatus) Clone() proto.Message {
	...
	if m.GetSelectedDestiantionPorts() != nil {
		target.SelectedDestiantionPorts = make([]*github_com_solo_io_gloo_mesh_solo_apis_client_go_common_gloo_solo_io_v2.DestinationReference, len(m.GetSelectedDestiantionPorts()))
		for idx, v := range m.GetSelectedDestiantionPorts() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.SelectedDestiantionPorts[idx] = h.Clone().(*github_com_solo_io_gloo_mesh_solo_apis_client_go_common_gloo_solo_io_v2.DestinationReference)
			} else {
				target.SelectedDestiantionPorts[idx] = proto.Clone(v).(*github_com_solo_io_gloo_mesh_solo_apis_client_go_common_gloo_solo_io_v2.DestinationReference)
			}
