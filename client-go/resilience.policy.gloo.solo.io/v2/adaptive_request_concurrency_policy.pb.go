// {{% readfile file="static/content/policies/ov_adaptive_request_concurrency" %}}
//
...
//
// **Example**: This example applies to the `httpbin` destination and dynamically adjusts
...
// ```yaml
// {{% readfile file="/content/mesh/static/content/examples/generated/int/adaptive_concurrency_on_virtual_destination/cluster-1/adaptive-request-concurrency-policy_httpbin_simple-adaptive-request-concurrency-policy.yaml" %}}
// ```
...
type AdaptiveRequestConcurrencyPolicySpec_Config struct {
	...
	SampleAggregatePercentile *wrappers.DoubleValue `protobuf:"bytes,2,opt,name=sample_aggregate_percentile,json=sampleAggregatePercentile,proto3" json:"sample_aggregate_percentile,omitempty"`
	...
	MaxConcurrencyLimit *wrappers.UInt32Value `protobuf:"bytes,3,opt,name=max_concurrency_limit,json=maxConcurrencyLimit,proto3" json:"max_concurrency_limit,omitempty"`
...
func (x *AdaptiveRequestConcurrencyPolicySpec_Config) GetSampleAggregatePercentile() *wrappers.DoubleValue {
	if x != nil {
...
func (x *AdaptiveRequestConcurrencyPolicySpec_Config) GetMaxConcurrencyLimit() *wrappers.UInt32Value {
	if x != nil {
...
type AdaptiveRequestConcurrencyPolicySpec_Config_MinRoundtripTimeCalculationParams struct {
	...
	MinConcurrency *wrappers.UInt32Value `protobuf:"bytes,3,opt,name=min_concurrency,json=minConcurrency,proto3" json:"min_concurrency,omitempty"`
	...
	JitterPercentile *wrappers.DoubleValue `protobuf:"bytes,4,opt,name=jitter_percentile,json=jitterPercentile,proto3" json:"jitter_percentile,omitempty"`
	...
	BufferPercentile *wrappers.DoubleValue `protobuf:"bytes,5,opt,name=buffer_percentile,json=bufferPercentile,proto3" json:"buffer_percentile,omitempty"`
}
...
func (x *AdaptiveRequestConcurrencyPolicySpec_Config_MinRoundtripTimeCalculationParams) GetRequestCount() *wrappers.UInt32Value {
	if x != nil {
...
func (x *AdaptiveRequestConcurrencyPolicySpec_Config_MinRoundtripTimeCalculationParams) GetMinConcurrency() *wrappers.UInt32Value {
	if x != nil {
...
func (x *AdaptiveRequestConcurrencyPolicySpec_Config_MinRoundtripTimeCalculationParams) GetJitterPercentile() *wrappers.DoubleValue {
	if x != nil {
...
func (x *AdaptiveRequestConcurrencyPolicySpec_Config_MinRoundtripTimeCalculationParams) GetBufferPercentile() *wrappers.DoubleValue {
	if x != nil {
