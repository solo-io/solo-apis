...
func (m *ApiKeyHmac) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo-mesh-enterprise/pkg/api/enterprise.gloo.solo.io/v1.ApiKeyHmac")); err != nil {
		return 0, err
	}
...
func (m *ApiKeyDigest) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo-mesh-enterprise/pkg/api/enterprise.gloo.solo.io/v1.ApiKeyDigest")); err != nil {
		return 0, err
	}
...
func (m *ApiKeyMatch) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo-mesh-enterprise/pkg/api/enterprise.gloo.solo.io/v1.ApiKeyMatch")); err != nil {
		return 0, err
	}
...
func (m *HeaderMatch) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo-mesh-enterprise/pkg/api/enterprise.gloo.solo.io/v1.HeaderMatch")); err != nil {
		return 0, err
	}
...
func (m *PassThroughHttpTLSConfig) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo-mesh-enterprise/pkg/api/enterprise.gloo.solo.io/v1.PassThroughHttpTLSConfig")); err != nil {
		return 0, err
	}
...
func (m *SslParameters) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo-mesh-enterprise/pkg/api/enterprise.gloo.solo.io/v1.SslParameters")); err != nil {
		return 0, err
	}
...
func (m *PassThroughHttp_ConnectionPool) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/gloo-mesh-enterprise/pkg/api/enterprise.gloo.solo.io/v1.PassThroughHttp_ConnectionPool")); err != nil {
		return 0, err
	}
