...
func (m *RateLimitConfigSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.RateLimitConfigSpec")); err != nil {
		return 0, err
	}
...
func (m *RateLimitConfigStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.RateLimitConfigStatus")); err != nil {
		return 0, err
	}
...
func (m *Descriptor) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Descriptor")); err != nil {
		return 0, err
	}
...
func (m *Action) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Action")); err != nil {
		return 0, err
	}
...
func (m *RateLimitConfigSpec_Envoy) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.RateLimitConfigSpec_Envoy")); err != nil {
		return 0, err
	}
...
func (m *RateLimitConfigSpec_Envoy_RateLimit) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.RateLimitConfigSpec_Envoy_RateLimit")); err != nil {
		return 0, err
	}
...
func (m *Descriptor_RateLimit) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Descriptor_RateLimit")); err != nil {
		return 0, err
	}
...
func (m *Action_SourceCluster) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Action_SourceCluster")); err != nil {
		return 0, err
	}
...
func (m *Action_DestinationCluster) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Action_DestinationCluster")); err != nil {
		return 0, err
	}
...
func (m *Action_RequestHeaders) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Action_RequestHeaders")); err != nil {
		return 0, err
	}
...
func (m *Action_RemoteAddress) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Action_RemoteAddress")); err != nil {
		return 0, err
	}
...
func (m *Action_GenericKey) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Action_GenericKey")); err != nil {
		return 0, err
	}
...
func (m *Action_HeaderValueMatch) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Action_HeaderValueMatch")); err != nil {
		return 0, err
	}
...
func (m *Action_HeaderValueMatch_HeaderMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Action_HeaderValueMatch_HeaderMatcher")); err != nil {
		return 0, err
	}
...
func (m *Action_HeaderValueMatch_HeaderMatcher_Int64Range) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/api/v1alpha1.Action_HeaderValueMatch_HeaderMatcher_Int64Range")); err != nil {
		return 0, err
	}
