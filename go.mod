...
require (
	...
	github.com/kgateway-dev/kgateway/v2 v2.2.0-beta.5.0.20260109202503-38addc8c1548
	github.com/solo-io/gloo v1.17.15
	github.com/solo-io/gloo-gateway/v2 v2.0.0-20260112183720-d8e3a11b2a54
...
replace (
	...
	istio.io/istio => github.com/solo-io/istio v1.29.0-rc.2-solo.0.20260414234439-a3bb97b536a1
)
