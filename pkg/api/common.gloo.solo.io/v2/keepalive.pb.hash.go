...
func (m *TCPKeepalive) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("common.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/common.gloo.solo.io/v2.TCPKeepalive")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetTime()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetTime(), nil); err != nil {
			return 0, err
		} else {
