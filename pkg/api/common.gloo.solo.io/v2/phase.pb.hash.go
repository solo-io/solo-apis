...
func (m *PrioritizedPhase) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("common.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/common.gloo.solo.io/v2.PrioritizedPhase")); err != nil {
		return 0, err
	}
...
func (m *PrioritizedPhase_Phase) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("common.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/common.gloo.solo.io/v2.PrioritizedPhase_Phase")); err != nil {
		return 0, err
	}
