...
func (m *GatewaySpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.GatewaySpec")); err != nil {
		return 0, err
	}
...
func (m *HttpGateway) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.HttpGateway")); err != nil {
		return 0, err
	}
...
func (m *TcpGateway) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.TcpGateway")); err != nil {
		return 0, err
	}
...
func (m *VirtualServiceSelectorExpressions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.VirtualServiceSelectorExpressions")); err != nil {
		return 0, err
	}
...
func (m *GatewayStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.GatewayStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *GatewayNamespacedStatuses) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.GatewayNamespacedStatuses")); err != nil {
		return 0, err
	}
...
func (m *VirtualServiceSelectorExpressions_Expression) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.VirtualServiceSelectorExpressions_Expression")); err != nil {
		return 0, err
	}
