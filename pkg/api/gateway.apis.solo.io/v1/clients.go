...
// MulticlusterClientset for the gateway.apis.solo.io/v1 APIs
...
// clienset for the gateway.apis.solo.io/v1 APIs
type Clientset interface {
	// clienset for the gateway.apis.solo.io/v1/v1 APIs
