...
func (m *RouteTableSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.RouteTableSpec")); err != nil {
		return 0, err
	}
...
func (m *RouteTableStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.RouteTableStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *RouteTableNamespacedStatuses) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.RouteTableNamespacedStatuses")); err != nil {
		return 0, err
	}
