...
type GatewayReconciler interface {
	ReconcileGateway(obj *gateway_apis_solo_io_v1.Gateway) (reconcile.Result, error)
}
...
type GatewayReconcilerFuncs struct {
	OnReconcileGateway         func(obj *gateway_apis_solo_io_v1.Gateway) (reconcile.Result, error)
	OnReconcileGatewayDeletion func(req reconcile.Request) error
}

func (f *GatewayReconcilerFuncs) ReconcileGateway(obj *gateway_apis_solo_io_v1.Gateway) (reconcile.Result, error) {
...
type GatewayFinalizer interface {
	...
	FinalizeGateway(obj *gateway_apis_solo_io_v1.Gateway) error
}
...
func NewGatewayReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) GatewayReconcileLoop {
	return &gatewayReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &gateway_apis_solo_io_v1.Gateway{}, options),
	}
}
...
type RouteTableReconciler interface {
	ReconcileRouteTable(obj *gateway_apis_solo_io_v1.RouteTable) (reconcile.Result, error)
}
...
type RouteTableReconcilerFuncs struct {
	OnReconcileRouteTable         func(obj *gateway_apis_solo_io_v1.RouteTable) (reconcile.Result, error)
	OnReconcileRouteTableDeletion func(req reconcile.Request) error
}

func (f *RouteTableReconcilerFuncs) ReconcileRouteTable(obj *gateway_apis_solo_io_v1.RouteTable) (reconcile.Result, error) {
...
type RouteTableFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeRouteTable(obj *gateway_apis_solo_io_v1.RouteTable) error
}
...
func NewRouteTableReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) RouteTableReconcileLoop {
	return &routeTableReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &gateway_apis_solo_io_v1.RouteTable{}, options),
	}
}
...
type VirtualServiceReconciler interface {
	ReconcileVirtualService(obj *gateway_apis_solo_io_v1.VirtualService) (reconcile.Result, error)
}
...
type VirtualServiceReconcilerFuncs struct {
	OnReconcileVirtualService         func(obj *gateway_apis_solo_io_v1.VirtualService) (reconcile.Result, error)
	OnReconcileVirtualServiceDeletion func(req reconcile.Request) error
}

func (f *VirtualServiceReconcilerFuncs) ReconcileVirtualService(obj *gateway_apis_solo_io_v1.VirtualService) (reconcile.Result, error) {
...
type VirtualServiceFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeVirtualService(obj *gateway_apis_solo_io_v1.VirtualService) error
}
...
func NewVirtualServiceReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) VirtualServiceReconcileLoop {
	return &virtualServiceReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &gateway_apis_solo_io_v1.VirtualService{}, options),
	}
}
...
type VirtualHostOptionReconciler interface {
	ReconcileVirtualHostOption(obj *gateway_apis_solo_io_v1.VirtualHostOption) (reconcile.Result, error)
}
...
type VirtualHostOptionReconcilerFuncs struct {
	OnReconcileVirtualHostOption         func(obj *gateway_apis_solo_io_v1.VirtualHostOption) (reconcile.Result, error)
	OnReconcileVirtualHostOptionDeletion func(req reconcile.Request) error
}

func (f *VirtualHostOptionReconcilerFuncs) ReconcileVirtualHostOption(obj *gateway_apis_solo_io_v1.VirtualHostOption) (reconcile.Result, error) {
...
type VirtualHostOptionFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeVirtualHostOption(obj *gateway_apis_solo_io_v1.VirtualHostOption) error
}
...
func NewVirtualHostOptionReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) VirtualHostOptionReconcileLoop {
	return &virtualHostOptionReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &gateway_apis_solo_io_v1.VirtualHostOption{}, options),
	}
}
...
type RouteOptionReconciler interface {
	ReconcileRouteOption(obj *gateway_apis_solo_io_v1.RouteOption) (reconcile.Result, error)
}
...
type RouteOptionReconcilerFuncs struct {
	OnReconcileRouteOption         func(obj *gateway_apis_solo_io_v1.RouteOption) (reconcile.Result, error)
	OnReconcileRouteOptionDeletion func(req reconcile.Request) error
}

func (f *RouteOptionReconcilerFuncs) ReconcileRouteOption(obj *gateway_apis_solo_io_v1.RouteOption) (reconcile.Result, error) {
...
type RouteOptionFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeRouteOption(obj *gateway_apis_solo_io_v1.RouteOption) error
}
...
func NewRouteOptionReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) RouteOptionReconcileLoop {
	return &routeOptionReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &gateway_apis_solo_io_v1.RouteOption{}, options),
	}
}
