...
type GatewayEventHandler interface {
	CreateGateway(obj *gateway_apis_solo_io_v1.Gateway) error
	UpdateGateway(old, new *gateway_apis_solo_io_v1.Gateway) error
	DeleteGateway(obj *gateway_apis_solo_io_v1.Gateway) error
	GenericGateway(obj *gateway_apis_solo_io_v1.Gateway) error
}

type GatewayEventHandlerFuncs struct {
	OnCreate  func(obj *gateway_apis_solo_io_v1.Gateway) error
	OnUpdate  func(old, new *gateway_apis_solo_io_v1.Gateway) error
	OnDelete  func(obj *gateway_apis_solo_io_v1.Gateway) error
	OnGeneric func(obj *gateway_apis_solo_io_v1.Gateway) error
}

func (f *GatewayEventHandlerFuncs) CreateGateway(obj *gateway_apis_solo_io_v1.Gateway) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *GatewayEventHandlerFuncs) DeleteGateway(obj *gateway_apis_solo_io_v1.Gateway) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *GatewayEventHandlerFuncs) UpdateGateway(objOld, objNew *gateway_apis_solo_io_v1.Gateway) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *GatewayEventHandlerFuncs) GenericGateway(obj *gateway_apis_solo_io_v1.Gateway) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewGatewayEventWatcher(name string, mgr manager.Manager) GatewayEventWatcher {
	return &gatewayEventWatcher{
		watcher: events.NewWatcher(name, mgr, &gateway_apis_solo_io_v1.Gateway{}),
	}
}
...
func (h genericGatewayHandler) Create(object client.Object) error {
	obj, ok := object.(*gateway_apis_solo_io_v1.Gateway)
	if !ok {
...
func (h genericGatewayHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*gateway_apis_solo_io_v1.Gateway)
	if !ok {
		return errors.Errorf("internal error: Gateway handler received event for %T", old)
	}
	objNew, ok := new.(*gateway_apis_solo_io_v1.Gateway)
	if !ok {
...
type RouteTableEventHandler interface {
	CreateRouteTable(obj *gateway_apis_solo_io_v1.RouteTable) error
	UpdateRouteTable(old, new *gateway_apis_solo_io_v1.RouteTable) error
	DeleteRouteTable(obj *gateway_apis_solo_io_v1.RouteTable) error
	GenericRouteTable(obj *gateway_apis_solo_io_v1.RouteTable) error
}

type RouteTableEventHandlerFuncs struct {
	OnCreate  func(obj *gateway_apis_solo_io_v1.RouteTable) error
	OnUpdate  func(old, new *gateway_apis_solo_io_v1.RouteTable) error
	OnDelete  func(obj *gateway_apis_solo_io_v1.RouteTable) error
	OnGeneric func(obj *gateway_apis_solo_io_v1.RouteTable) error
}

func (f *RouteTableEventHandlerFuncs) CreateRouteTable(obj *gateway_apis_solo_io_v1.RouteTable) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *RouteTableEventHandlerFuncs) DeleteRouteTable(obj *gateway_apis_solo_io_v1.RouteTable) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *RouteTableEventHandlerFuncs) UpdateRouteTable(objOld, objNew *gateway_apis_solo_io_v1.RouteTable) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *RouteTableEventHandlerFuncs) GenericRouteTable(obj *gateway_apis_solo_io_v1.RouteTable) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewRouteTableEventWatcher(name string, mgr manager.Manager) RouteTableEventWatcher {
	return &routeTableEventWatcher{
		watcher: events.NewWatcher(name, mgr, &gateway_apis_solo_io_v1.RouteTable{}),
	}
}
...
func (h genericRouteTableHandler) Create(object client.Object) error {
	obj, ok := object.(*gateway_apis_solo_io_v1.RouteTable)
	if !ok {
...
func (h genericRouteTableHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*gateway_apis_solo_io_v1.RouteTable)
	if !ok {
		return errors.Errorf("internal error: RouteTable handler received event for %T", old)
	}
	objNew, ok := new.(*gateway_apis_solo_io_v1.RouteTable)
	if !ok {
...
type VirtualServiceEventHandler interface {
	CreateVirtualService(obj *gateway_apis_solo_io_v1.VirtualService) error
	UpdateVirtualService(old, new *gateway_apis_solo_io_v1.VirtualService) error
	DeleteVirtualService(obj *gateway_apis_solo_io_v1.VirtualService) error
	GenericVirtualService(obj *gateway_apis_solo_io_v1.VirtualService) error
}

type VirtualServiceEventHandlerFuncs struct {
	OnCreate  func(obj *gateway_apis_solo_io_v1.VirtualService) error
	OnUpdate  func(old, new *gateway_apis_solo_io_v1.VirtualService) error
	OnDelete  func(obj *gateway_apis_solo_io_v1.VirtualService) error
	OnGeneric func(obj *gateway_apis_solo_io_v1.VirtualService) error
}

func (f *VirtualServiceEventHandlerFuncs) CreateVirtualService(obj *gateway_apis_solo_io_v1.VirtualService) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *VirtualServiceEventHandlerFuncs) DeleteVirtualService(obj *gateway_apis_solo_io_v1.VirtualService) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *VirtualServiceEventHandlerFuncs) UpdateVirtualService(objOld, objNew *gateway_apis_solo_io_v1.VirtualService) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *VirtualServiceEventHandlerFuncs) GenericVirtualService(obj *gateway_apis_solo_io_v1.VirtualService) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewVirtualServiceEventWatcher(name string, mgr manager.Manager) VirtualServiceEventWatcher {
	return &virtualServiceEventWatcher{
		watcher: events.NewWatcher(name, mgr, &gateway_apis_solo_io_v1.VirtualService{}),
	}
}
...
func (h genericVirtualServiceHandler) Create(object client.Object) error {
	obj, ok := object.(*gateway_apis_solo_io_v1.VirtualService)
	if !ok {
...
func (h genericVirtualServiceHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*gateway_apis_solo_io_v1.VirtualService)
	if !ok {
		return errors.Errorf("internal error: VirtualService handler received event for %T", old)
	}
	objNew, ok := new.(*gateway_apis_solo_io_v1.VirtualService)
	if !ok {
...
type VirtualHostOptionEventHandler interface {
	CreateVirtualHostOption(obj *gateway_apis_solo_io_v1.VirtualHostOption) error
	UpdateVirtualHostOption(old, new *gateway_apis_solo_io_v1.VirtualHostOption) error
	DeleteVirtualHostOption(obj *gateway_apis_solo_io_v1.VirtualHostOption) error
	GenericVirtualHostOption(obj *gateway_apis_solo_io_v1.VirtualHostOption) error
}

type VirtualHostOptionEventHandlerFuncs struct {
	OnCreate  func(obj *gateway_apis_solo_io_v1.VirtualHostOption) error
	OnUpdate  func(old, new *gateway_apis_solo_io_v1.VirtualHostOption) error
	OnDelete  func(obj *gateway_apis_solo_io_v1.VirtualHostOption) error
	OnGeneric func(obj *gateway_apis_solo_io_v1.VirtualHostOption) error
}

func (f *VirtualHostOptionEventHandlerFuncs) CreateVirtualHostOption(obj *gateway_apis_solo_io_v1.VirtualHostOption) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *VirtualHostOptionEventHandlerFuncs) DeleteVirtualHostOption(obj *gateway_apis_solo_io_v1.VirtualHostOption) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *VirtualHostOptionEventHandlerFuncs) UpdateVirtualHostOption(objOld, objNew *gateway_apis_solo_io_v1.VirtualHostOption) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *VirtualHostOptionEventHandlerFuncs) GenericVirtualHostOption(obj *gateway_apis_solo_io_v1.VirtualHostOption) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewVirtualHostOptionEventWatcher(name string, mgr manager.Manager) VirtualHostOptionEventWatcher {
	return &virtualHostOptionEventWatcher{
		watcher: events.NewWatcher(name, mgr, &gateway_apis_solo_io_v1.VirtualHostOption{}),
	}
}
...
func (h genericVirtualHostOptionHandler) Create(object client.Object) error {
	obj, ok := object.(*gateway_apis_solo_io_v1.VirtualHostOption)
	if !ok {
...
func (h genericVirtualHostOptionHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*gateway_apis_solo_io_v1.VirtualHostOption)
	if !ok {
		return errors.Errorf("internal error: VirtualHostOption handler received event for %T", old)
	}
	objNew, ok := new.(*gateway_apis_solo_io_v1.VirtualHostOption)
	if !ok {
...
type RouteOptionEventHandler interface {
	CreateRouteOption(obj *gateway_apis_solo_io_v1.RouteOption) error
	UpdateRouteOption(old, new *gateway_apis_solo_io_v1.RouteOption) error
	DeleteRouteOption(obj *gateway_apis_solo_io_v1.RouteOption) error
	GenericRouteOption(obj *gateway_apis_solo_io_v1.RouteOption) error
}

type RouteOptionEventHandlerFuncs struct {
	OnCreate  func(obj *gateway_apis_solo_io_v1.RouteOption) error
	OnUpdate  func(old, new *gateway_apis_solo_io_v1.RouteOption) error
	OnDelete  func(obj *gateway_apis_solo_io_v1.RouteOption) error
	OnGeneric func(obj *gateway_apis_solo_io_v1.RouteOption) error
}

func (f *RouteOptionEventHandlerFuncs) CreateRouteOption(obj *gateway_apis_solo_io_v1.RouteOption) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *RouteOptionEventHandlerFuncs) DeleteRouteOption(obj *gateway_apis_solo_io_v1.RouteOption) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *RouteOptionEventHandlerFuncs) UpdateRouteOption(objOld, objNew *gateway_apis_solo_io_v1.RouteOption) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *RouteOptionEventHandlerFuncs) GenericRouteOption(obj *gateway_apis_solo_io_v1.RouteOption) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewRouteOptionEventWatcher(name string, mgr manager.Manager) RouteOptionEventWatcher {
	return &routeOptionEventWatcher{
		watcher: events.NewWatcher(name, mgr, &gateway_apis_solo_io_v1.RouteOption{}),
	}
}
...
func (h genericRouteOptionHandler) Create(object client.Object) error {
	obj, ok := object.(*gateway_apis_solo_io_v1.RouteOption)
	if !ok {
...
func (h genericRouteOptionHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*gateway_apis_solo_io_v1.RouteOption)
	if !ok {
		return errors.Errorf("internal error: RouteOption handler received event for %T", old)
	}
	objNew, ok := new.(*gateway_apis_solo_io_v1.RouteOption)
	if !ok {
