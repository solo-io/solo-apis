...
type MulticlusterGatewayReconciler interface {
	ReconcileGateway(clusterName string, obj *gateway_apis_solo_io_v1.Gateway) (reconcile.Result, error)
}
...
type MulticlusterGatewayReconcilerFuncs struct {
	OnReconcileGateway         func(clusterName string, obj *gateway_apis_solo_io_v1.Gateway) (reconcile.Result, error)
	OnReconcileGatewayDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterGatewayReconcilerFuncs) ReconcileGateway(clusterName string, obj *gateway_apis_solo_io_v1.Gateway) (reconcile.Result, error) {
...
func NewMulticlusterGatewayReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterGatewayReconcileLoop {
	return &multiclusterGatewayReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gateway_apis_solo_io_v1.Gateway{}, options)}
}
...
type MulticlusterRouteTableReconciler interface {
	ReconcileRouteTable(clusterName string, obj *gateway_apis_solo_io_v1.RouteTable) (reconcile.Result, error)
}
...
type MulticlusterRouteTableReconcilerFuncs struct {
	OnReconcileRouteTable         func(clusterName string, obj *gateway_apis_solo_io_v1.RouteTable) (reconcile.Result, error)
	OnReconcileRouteTableDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterRouteTableReconcilerFuncs) ReconcileRouteTable(clusterName string, obj *gateway_apis_solo_io_v1.RouteTable) (reconcile.Result, error) {
...
func NewMulticlusterRouteTableReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRouteTableReconcileLoop {
	return &multiclusterRouteTableReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gateway_apis_solo_io_v1.RouteTable{}, options)}
}
...
type MulticlusterVirtualServiceReconciler interface {
	ReconcileVirtualService(clusterName string, obj *gateway_apis_solo_io_v1.VirtualService) (reconcile.Result, error)
}
...
type MulticlusterVirtualServiceReconcilerFuncs struct {
	OnReconcileVirtualService         func(clusterName string, obj *gateway_apis_solo_io_v1.VirtualService) (reconcile.Result, error)
	OnReconcileVirtualServiceDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterVirtualServiceReconcilerFuncs) ReconcileVirtualService(clusterName string, obj *gateway_apis_solo_io_v1.VirtualService) (reconcile.Result, error) {
...
func NewMulticlusterVirtualServiceReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterVirtualServiceReconcileLoop {
	return &multiclusterVirtualServiceReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gateway_apis_solo_io_v1.VirtualService{}, options)}
}
...
type MulticlusterVirtualHostOptionReconciler interface {
	ReconcileVirtualHostOption(clusterName string, obj *gateway_apis_solo_io_v1.VirtualHostOption) (reconcile.Result, error)
}
...
type MulticlusterVirtualHostOptionReconcilerFuncs struct {
	OnReconcileVirtualHostOption         func(clusterName string, obj *gateway_apis_solo_io_v1.VirtualHostOption) (reconcile.Result, error)
	OnReconcileVirtualHostOptionDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterVirtualHostOptionReconcilerFuncs) ReconcileVirtualHostOption(clusterName string, obj *gateway_apis_solo_io_v1.VirtualHostOption) (reconcile.Result, error) {
...
func NewMulticlusterVirtualHostOptionReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterVirtualHostOptionReconcileLoop {
	return &multiclusterVirtualHostOptionReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gateway_apis_solo_io_v1.VirtualHostOption{}, options)}
}
...
type MulticlusterRouteOptionReconciler interface {
	ReconcileRouteOption(clusterName string, obj *gateway_apis_solo_io_v1.RouteOption) (reconcile.Result, error)
}
...
type MulticlusterRouteOptionReconcilerFuncs struct {
	OnReconcileRouteOption         func(clusterName string, obj *gateway_apis_solo_io_v1.RouteOption) (reconcile.Result, error)
	OnReconcileRouteOptionDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterRouteOptionReconcilerFuncs) ReconcileRouteOption(clusterName string, obj *gateway_apis_solo_io_v1.RouteOption) (reconcile.Result, error) {
...
func NewMulticlusterRouteOptionReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRouteOptionReconcileLoop {
	return &multiclusterRouteOptionReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gateway_apis_solo_io_v1.RouteOption{}, options)}
}
