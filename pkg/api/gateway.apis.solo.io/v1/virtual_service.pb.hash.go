...
func (m *VirtualServiceSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.VirtualServiceSpec")); err != nil {
		return 0, err
	}
...
func (m *VirtualHost) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.VirtualHost")); err != nil {
		return 0, err
	}
...
func (m *Route) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.Route")); err != nil {
		return 0, err
	}
...
func (m *DelegateOptionsRefs) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.DelegateOptionsRefs")); err != nil {
		return 0, err
	}
...
func (m *DelegateAction) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.DelegateAction")); err != nil {
		return 0, err
	}
...
func (m *RouteTableSelector) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.RouteTableSelector")); err != nil {
		return 0, err
	}
...
func (m *VirtualServiceStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.VirtualServiceStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *VirtualServiceNamespacedStatuses) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.VirtualServiceNamespacedStatuses")); err != nil {
		return 0, err
	}
...
func (m *RouteTableSelector_Expression) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.RouteTableSelector_Expression")); err != nil {
		return 0, err
	}
