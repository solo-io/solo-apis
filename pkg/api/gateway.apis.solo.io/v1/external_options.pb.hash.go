...
func (m *VirtualHostOptionSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.VirtualHostOptionSpec")); err != nil {
		return 0, err
	}
...
func (m *RouteOptionSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.RouteOptionSpec")); err != nil {
		return 0, err
	}
...
func (m *VirtualHostOptionStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.VirtualHostOptionStatus")); err != nil {
		return 0, err
	}
...
func (m *VirtualHostOptionNamespacedStatuses) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.VirtualHostOptionNamespacedStatuses")); err != nil {
		return 0, err
	}
...
func (m *RouteOptionStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.RouteOptionStatus")); err != nil {
		return 0, err
	}
...
func (m *RouteOptionNamespacedStatuses) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.apis.solo.io/v1.RouteOptionNamespacedStatuses")); err != nil {
		return 0, err
	}
