...
func (m *WorkspaceSettingsSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsSpec")); err != nil {
		return 0, err
	}
...
func (m *WorkspaceSettingsStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *WorkspaceSettingsNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsNewStatus")); err != nil {
		return 0, err
	}
	...
	err = binary.Write(hasher, binary.LittleEndian, m.GetSelectedEastWestGateways())
	if err != nil {
		return 0, err
	}

	err = binary.Write(hasher, binary.LittleEndian, m.GetFederatedServices())
	if err != nil {
		return 0, err
	}
...
func (m *WorkspaceSettingsReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsReport")); err != nil {
		return 0, err
	}
...
func (m *WorkspaceSettingsSpec_WorkspaceObjectSelector) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsSpec_WorkspaceObjectSelector")); err != nil {
		return 0, err
	}
...
func (m *WorkspaceSettingsSpec_Options) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsSpec_Options")); err != nil {
		return 0, err
	}
...
func (m *WorkspaceSettingsSpec_WorkspaceObjectSelector_TypedObjectSelector) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsSpec_WorkspaceObjectSelector_TypedObjectSelector")); err != nil {
		return 0, err
	}
...
func (m *WorkspaceSettingsSpec_Options_ServiceIsolation) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsSpec_Options_ServiceIsolation")); err != nil {
		return 0, err
	}
...
func (m *WorkspaceSettingsSpec_Options_Federation) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsSpec_Options_Federation")); err != nil {
		return 0, err
	}
...
func (m *WorkspaceSettingsSpec_Options_EastWestGatewaySelector) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsSpec_Options_EastWestGatewaySelector")); err != nil {
		return 0, err
	}
...
func (m *WorkspaceSettingsSpec_Options_EastWestGatewaySelector_HostInfo) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.WorkspaceSettingsSpec_Options_EastWestGatewaySelector_HostInfo")); err != nil {
		return 0, err
	}
