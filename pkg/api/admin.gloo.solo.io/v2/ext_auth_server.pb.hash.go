...
func (m *ExtAuthServerSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.ExtAuthServerSpec")); err != nil {
		return 0, err
	}
...
func (m *ExtAuthServerStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.ExtAuthServerStatus")); err != nil {
		return 0, err
	}
...
func (m *ExtAuthServerSpec_HttpService) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.ExtAuthServerSpec_HttpService")); err != nil {
		return 0, err
	}
...
func (m *ExtAuthServerSpec_BufferSettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.ExtAuthServerSpec_BufferSettings")); err != nil {
		return 0, err
	}
...
func (m *ExtAuthServerSpec_HttpService_Request) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.ExtAuthServerSpec_HttpService_Request")); err != nil {
		return 0, err
	}
...
func (m *ExtAuthServerSpec_HttpService_Response) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2.ExtAuthServerSpec_HttpService_Response")); err != nil {
		return 0, err
	}
