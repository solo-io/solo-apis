...
func (m *RootTrustPolicySpec) Clone() proto.Message {
	...
	if m.GetApplyToMeshes() != nil {
		target.ApplyToMeshes = make([]*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.MeshSelector, len(m.GetApplyToMeshes()))
		for idx, v := range m.GetApplyToMeshes() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.ApplyToMeshes[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.MeshSelector)
			} else {
				target.ApplyToMeshes[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.MeshSelector)
			}
...
func (m *RootTrustPolicySpec_Config) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetIntermediateCertOptions()).(clone.Cloner); ok {
		target.IntermediateCertOptions = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_security_policy_gloo_solo_io_v2_tls.CommonCertOptions)
	} else {
		target.IntermediateCertOptions = proto.Clone(m.GetIntermediateCertOptions()).(*github_com_solo_io_solo_apis_pkg_api_security_policy_gloo_solo_io_v2_tls.CommonCertOptions)
	}
	...
	case *RootTrustPolicySpec_Config_MgmtServerCertificateAuthority_Generated:
		...
		if h, ok := interface{}(m.GetGenerated()).(clone.Cloner); ok {
			target.CaSource = &RootTrustPolicySpec_Config_MgmtServerCertificateAuthority_Generated{
				Generated: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_security_policy_gloo_solo_io_v2_tls.CommonCertOptions),
			}
		} else {
			target.CaSource = &RootTrustPolicySpec_Config_MgmtServerCertificateAuthority_Generated{
				Generated: proto.Clone(m.GetGenerated()).(*github_com_solo_io_solo_apis_pkg_api_security_policy_gloo_solo_io_v2_tls.CommonCertOptions),
			}
		}
