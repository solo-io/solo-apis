...
func (m *WaypointLifecycleManagerSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2alpha1.WaypointLifecycleManagerSpec")); err != nil {
		return 0, err
	}
...
func (m *WaypointLifecycleManagerStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2alpha1.WaypointLifecycleManagerStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *WaypointLifecycleManagerNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2alpha1.WaypointLifecycleManagerNewStatus")); err != nil {
		return 0, err
	}
...
func (m *WaypointLifecycleManagerReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("admin.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/admin.gloo.solo.io/v2alpha1.WaypointLifecycleManagerReport")); err != nil {
		return 0, err
	}
