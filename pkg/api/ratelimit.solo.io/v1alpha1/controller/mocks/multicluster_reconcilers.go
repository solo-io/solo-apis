...
func (mr *MockMulticlusterRateLimitConfigReconcilerMockRecorder) ReconcileRateLimitConfig(clusterName, obj any) *gomock.Call {
...
func (mr *MockMulticlusterRateLimitConfigDeletionReconcilerMockRecorder) ReconcileRateLimitConfigDeletion(clusterName, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMulticlusterRateLimitConfigReconcileLoopMockRecorder) AddMulticlusterRateLimitConfigReconciler(ctx, rec any, predicates ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
