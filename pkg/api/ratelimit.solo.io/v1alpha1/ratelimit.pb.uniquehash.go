...
func (m *MetaData) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.api.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1.MetaData")); err != nil {
		return 0, err
	}
...
func (m *Override) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.api.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1.Override")); err != nil {
		return 0, err
	}
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *Action_CEL) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.api.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1.Action_CEL")); err != nil {
		return 0, err
	}

	if _, err = hasher.Write([]byte("Expression")); err != nil {
		return 0, err
	}
...
func (m *MetaData_MetadataKey) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.api.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1.MetaData_MetadataKey")); err != nil {
		return 0, err
	}
...
func (m *MetaData_MetadataKey_PathSegment) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.api.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1.MetaData_MetadataKey_PathSegment")); err != nil {
		return 0, err
	}
...
func (m *Override_DynamicMetadata) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.api.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1.Override_DynamicMetadata")); err != nil {
		return 0, err
	}
