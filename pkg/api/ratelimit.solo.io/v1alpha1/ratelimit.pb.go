...
func (MetaData_Source) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_enumTypes[3].Descriptor()
}

func (MetaData_Source) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_enumTypes[3]
}
...
type RateLimitActions struct {
	...
	// Defaults to REQUEST if not specified.
	Type          LimitType `protobuf:"varint,4,opt,name=type,proto3,enum=ratelimit.api.solo.io.LimitType" json:"type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Action) GetCel() *Action_CEL {
	if x != nil {
		if x, ok := x.ActionSpecifier.(*Action_Cel); ok {
			return x.Cel
		}
	}
	return nil
...
func (*MetaData_MetadataKey_PathSegment) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_rawDescGZIP(), []int{8, 0, 0}
}
...
const file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_rawDesc = "" +
	...
	"setActions\x125\n" +
	"\x05limit\x18\x03 \x01(\v2\x1f.ratelimit.api.solo.io.OverrideR\x05limit\x124\n" +
	"\x04type\x18\x04 \x01(\x0e2 .ratelimit.api.solo.io.LimitTypeR\x04type\"\xd1\x01\n" +
	"\tRateLimit\x129\n" +
	...
	"\bmetadata\x18\b \x01(\v2\x1f.ratelimit.api.solo.io.MetaDataH\x00R\bmetadata\x125\n" +
	"\x03cel\x18\t \x01(\v2!.ratelimit.api.solo.io.Action.CELH\x00R\x03cel\x1a\x0f\n" +
	...
	"\x16header_match_specifierJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04\x1a7\n" +
	"\x03CEL\x12\x1e\n" +
	"\n" +
	"expression\x18\x01 \x01(\tR\n" +
	"expression\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03keyB\x12\n" +
	...
	"\x12override_specifier*#\n" +
	"\tLimitType\x12\v\n" +
	"\aREQUEST\x10\x00\x12\t\n" +
	"\x05TOKEN\x10\x01BI\xb8\xf5\x04\x01\xc0\xf5\x04\x01Z?github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1b\x06proto3"
...
var file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_goTypes = []any{
	(LimitType)(0),                                           // 0: ratelimit.api.solo.io.LimitType
	(RateLimitConfigStatus_State)(0),                         // 1: ratelimit.api.solo.io.RateLimitConfigStatus.State
	(RateLimit_Unit)(0),                                      // 2: ratelimit.api.solo.io.RateLimit.Unit
	(MetaData_Source)(0),                                     // 3: ratelimit.api.solo.io.MetaData.Source
	(*RateLimitConfigSpec)(nil),                              // 4: ratelimit.api.solo.io.RateLimitConfigSpec
	(*RateLimitConfigStatus)(nil),                            // 5: ratelimit.api.solo.io.RateLimitConfigStatus
	...
	(*Action_CEL)(nil),                                       // 21: ratelimit.api.solo.io.Action.CEL
...
var file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_depIdxs = []int32{
	...
	1,  // 1: ratelimit.api.solo.io.RateLimitConfigStatus.state:type_name -> ratelimit.api.solo.io.RateLimitConfigStatus.State
	10, // 2: ratelimit.api.solo.io.Descriptor.rate_limit:type_name -> ratelimit.api.solo.io.RateLimit
	6,  // 3: ratelimit.api.solo.io.Descriptor.descriptors:type_name -> ratelimit.api.solo.io.Descriptor
	8,  // 4: ratelimit.api.solo.io.SetDescriptor.simple_descriptors:type_name -> ratelimit.api.solo.io.SimpleDescriptor
	10, // 5: ratelimit.api.solo.io.SetDescriptor.rate_limit:type_name -> ratelimit.api.solo.io.RateLimit
	11, // 6: ratelimit.api.solo.io.RateLimitActions.actions:type_name -> ratelimit.api.solo.io.Action
	11, // 7: ratelimit.api.solo.io.RateLimitActions.set_actions:type_name -> ratelimit.api.solo.io.Action
	13, // 8: ratelimit.api.solo.io.RateLimitActions.limit:type_name -> ratelimit.api.solo.io.Override
	0,  // 9: ratelimit.api.solo.io.RateLimitActions.type:type_name -> ratelimit.api.solo.io.LimitType
	2,  // 10: ratelimit.api.solo.io.RateLimit.unit:type_name -> ratelimit.api.solo.io.RateLimit.Unit
	...
	21, // 18: ratelimit.api.solo.io.Action.cel:type_name -> ratelimit.api.solo.io.Action.CEL
	24, // 19: ratelimit.api.solo.io.MetaData.metadata_key:type_name -> ratelimit.api.solo.io.MetaData.MetadataKey
	3,  // 20: ratelimit.api.solo.io.MetaData.source:type_name -> ratelimit.api.solo.io.MetaData.Source
	26, // 21: ratelimit.api.solo.io.Override.dynamic_metadata:type_name -> ratelimit.api.solo.io.Override.DynamicMetadata
	6,  // 22: ratelimit.api.solo.io.RateLimitConfigSpec.Raw.descriptors:type_name -> ratelimit.api.solo.io.Descriptor
	9,  // 23: ratelimit.api.solo.io.RateLimitConfigSpec.Raw.rate_limits:type_name -> ratelimit.api.solo.io.RateLimitActions
	7,  // 24: ratelimit.api.solo.io.RateLimitConfigSpec.Raw.set_descriptors:type_name -> ratelimit.api.solo.io.SetDescriptor
...
func file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_init() {
	...
	file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_msgTypes[7].OneofWrappers = []any{
	...
	file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_msgTypes[9].OneofWrappers = []any{
		(*Override_DynamicMetadata_)(nil),
	}
	file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_msgTypes[18].OneofWrappers = []any{
	...
	file_github_com_solo_io_solo_apis_api_rate_limiter_v1alpha1_ratelimit_proto_msgTypes[21].OneofWrappers = []any{
