...
func (m *RateLimitConfigSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.RateLimitConfigSpec")); err != nil {
		return 0, err
	}
...
func (m *RateLimitConfigStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.RateLimitConfigStatus")); err != nil {
		return 0, err
	}
...
func (m *Descriptor) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.Descriptor")); err != nil {
		return 0, err
	}
...
func (m *RateLimitActions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.RateLimitActions")); err != nil {
		return 0, err
	}
...
func (m *RateLimit) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.RateLimit")); err != nil {
		return 0, err
	}
...
func (m *Action) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.Action")); err != nil {
		return 0, err
	}
...
func (m *RateLimitConfigSpec_Raw) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.RateLimitConfigSpec_Raw")); err != nil {
		return 0, err
	}
...
func (m *Action_SourceCluster) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_SourceCluster")); err != nil {
		return 0, err
	}
...
func (m *Action_DestinationCluster) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_DestinationCluster")); err != nil {
		return 0, err
	}
...
func (m *Action_RequestHeaders) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_RequestHeaders")); err != nil {
		return 0, err
	}
...
func (m *Action_RemoteAddress) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_RemoteAddress")); err != nil {
		return 0, err
	}
...
func (m *Action_GenericKey) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_GenericKey")); err != nil {
		return 0, err
	}
...
func (m *Action_HeaderValueMatch) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_HeaderValueMatch")); err != nil {
		return 0, err
	}
...
func (m *Action_HeaderValueMatch_HeaderMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_HeaderValueMatch_HeaderMatcher")); err != nil {
		return 0, err
	}
...
func (m *Action_HeaderValueMatch_HeaderMatcher_Int64Range) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.solo.io.github.com/solo-io/solo-apis/pkg/api/ratelimit.solo.io/v1alpha1/types.Action_HeaderValueMatch_HeaderMatcher_Int64Range")); err != nil {
		return 0, err
	}
