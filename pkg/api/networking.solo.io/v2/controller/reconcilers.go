...
type ExternalServiceReconciler interface {
	ReconcileExternalService(obj *networking_solo_io_v2.ExternalService) (reconcile.Result, error)
}
...
type ExternalServiceReconcilerFuncs struct {
	OnReconcileExternalService         func(obj *networking_solo_io_v2.ExternalService) (reconcile.Result, error)
	OnReconcileExternalServiceDeletion func(req reconcile.Request) error
}

func (f *ExternalServiceReconcilerFuncs) ReconcileExternalService(obj *networking_solo_io_v2.ExternalService) (reconcile.Result, error) {
...
type ExternalServiceFinalizer interface {
	...
	FinalizeExternalService(obj *networking_solo_io_v2.ExternalService) error
}
...
func NewExternalServiceReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) ExternalServiceReconcileLoop {
	return &externalServiceReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &networking_solo_io_v2.ExternalService{}, options),
	}
}
...
type ExternalEndpointReconciler interface {
	ReconcileExternalEndpoint(obj *networking_solo_io_v2.ExternalEndpoint) (reconcile.Result, error)
}
...
type ExternalEndpointReconcilerFuncs struct {
	OnReconcileExternalEndpoint         func(obj *networking_solo_io_v2.ExternalEndpoint) (reconcile.Result, error)
	OnReconcileExternalEndpointDeletion func(req reconcile.Request) error
}

func (f *ExternalEndpointReconcilerFuncs) ReconcileExternalEndpoint(obj *networking_solo_io_v2.ExternalEndpoint) (reconcile.Result, error) {
...
type ExternalEndpointFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeExternalEndpoint(obj *networking_solo_io_v2.ExternalEndpoint) error
}
...
func NewExternalEndpointReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) ExternalEndpointReconcileLoop {
	return &externalEndpointReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &networking_solo_io_v2.ExternalEndpoint{}, options),
	}
}
...
type RouteTableReconciler interface {
	ReconcileRouteTable(obj *networking_solo_io_v2.RouteTable) (reconcile.Result, error)
}
...
type RouteTableReconcilerFuncs struct {
	OnReconcileRouteTable         func(obj *networking_solo_io_v2.RouteTable) (reconcile.Result, error)
	OnReconcileRouteTableDeletion func(req reconcile.Request) error
}

func (f *RouteTableReconcilerFuncs) ReconcileRouteTable(obj *networking_solo_io_v2.RouteTable) (reconcile.Result, error) {
...
type RouteTableFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeRouteTable(obj *networking_solo_io_v2.RouteTable) error
}
...
func NewRouteTableReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) RouteTableReconcileLoop {
	return &routeTableReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &networking_solo_io_v2.RouteTable{}, options),
	}
}
...
type VirtualDestinationReconciler interface {
	ReconcileVirtualDestination(obj *networking_solo_io_v2.VirtualDestination) (reconcile.Result, error)
}
...
type VirtualDestinationReconcilerFuncs struct {
	OnReconcileVirtualDestination         func(obj *networking_solo_io_v2.VirtualDestination) (reconcile.Result, error)
	OnReconcileVirtualDestinationDeletion func(req reconcile.Request) error
}

func (f *VirtualDestinationReconcilerFuncs) ReconcileVirtualDestination(obj *networking_solo_io_v2.VirtualDestination) (reconcile.Result, error) {
...
type VirtualDestinationFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeVirtualDestination(obj *networking_solo_io_v2.VirtualDestination) error
}
...
func NewVirtualDestinationReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) VirtualDestinationReconcileLoop {
	return &virtualDestinationReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &networking_solo_io_v2.VirtualDestination{}, options),
	}
}
...
type VirtualGatewayReconciler interface {
	ReconcileVirtualGateway(obj *networking_solo_io_v2.VirtualGateway) (reconcile.Result, error)
}
...
type VirtualGatewayReconcilerFuncs struct {
	OnReconcileVirtualGateway         func(obj *networking_solo_io_v2.VirtualGateway) (reconcile.Result, error)
	OnReconcileVirtualGatewayDeletion func(req reconcile.Request) error
}

func (f *VirtualGatewayReconcilerFuncs) ReconcileVirtualGateway(obj *networking_solo_io_v2.VirtualGateway) (reconcile.Result, error) {
...
type VirtualGatewayFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeVirtualGateway(obj *networking_solo_io_v2.VirtualGateway) error
}
...
func NewVirtualGatewayReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) VirtualGatewayReconcileLoop {
	return &virtualGatewayReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &networking_solo_io_v2.VirtualGateway{}, options),
	}
}
