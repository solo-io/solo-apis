...
type MulticlusterExternalServiceReconciler interface {
	ReconcileExternalService(clusterName string, obj *networking_solo_io_v2.ExternalService) (reconcile.Result, error)
}
...
type MulticlusterExternalServiceReconcilerFuncs struct {
	OnReconcileExternalService         func(clusterName string, obj *networking_solo_io_v2.ExternalService) (reconcile.Result, error)
	OnReconcileExternalServiceDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterExternalServiceReconcilerFuncs) ReconcileExternalService(clusterName string, obj *networking_solo_io_v2.ExternalService) (reconcile.Result, error) {
...
func NewMulticlusterExternalServiceReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterExternalServiceReconcileLoop {
	return &multiclusterExternalServiceReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_solo_io_v2.ExternalService{}, options)}
}
...
type MulticlusterExternalEndpointReconciler interface {
	ReconcileExternalEndpoint(clusterName string, obj *networking_solo_io_v2.ExternalEndpoint) (reconcile.Result, error)
}
...
type MulticlusterExternalEndpointReconcilerFuncs struct {
	OnReconcileExternalEndpoint         func(clusterName string, obj *networking_solo_io_v2.ExternalEndpoint) (reconcile.Result, error)
	OnReconcileExternalEndpointDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterExternalEndpointReconcilerFuncs) ReconcileExternalEndpoint(clusterName string, obj *networking_solo_io_v2.ExternalEndpoint) (reconcile.Result, error) {
...
func NewMulticlusterExternalEndpointReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterExternalEndpointReconcileLoop {
	return &multiclusterExternalEndpointReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_solo_io_v2.ExternalEndpoint{}, options)}
}
...
type MulticlusterRouteTableReconciler interface {
	ReconcileRouteTable(clusterName string, obj *networking_solo_io_v2.RouteTable) (reconcile.Result, error)
}
...
type MulticlusterRouteTableReconcilerFuncs struct {
	OnReconcileRouteTable         func(clusterName string, obj *networking_solo_io_v2.RouteTable) (reconcile.Result, error)
	OnReconcileRouteTableDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterRouteTableReconcilerFuncs) ReconcileRouteTable(clusterName string, obj *networking_solo_io_v2.RouteTable) (reconcile.Result, error) {
...
func NewMulticlusterRouteTableReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRouteTableReconcileLoop {
	return &multiclusterRouteTableReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_solo_io_v2.RouteTable{}, options)}
}
...
type MulticlusterVirtualDestinationReconciler interface {
	ReconcileVirtualDestination(clusterName string, obj *networking_solo_io_v2.VirtualDestination) (reconcile.Result, error)
}
...
type MulticlusterVirtualDestinationReconcilerFuncs struct {
	OnReconcileVirtualDestination         func(clusterName string, obj *networking_solo_io_v2.VirtualDestination) (reconcile.Result, error)
	OnReconcileVirtualDestinationDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterVirtualDestinationReconcilerFuncs) ReconcileVirtualDestination(clusterName string, obj *networking_solo_io_v2.VirtualDestination) (reconcile.Result, error) {
...
func NewMulticlusterVirtualDestinationReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterVirtualDestinationReconcileLoop {
	return &multiclusterVirtualDestinationReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_solo_io_v2.VirtualDestination{}, options)}
}
...
type MulticlusterVirtualGatewayReconciler interface {
	ReconcileVirtualGateway(clusterName string, obj *networking_solo_io_v2.VirtualGateway) (reconcile.Result, error)
}
...
type MulticlusterVirtualGatewayReconcilerFuncs struct {
	OnReconcileVirtualGateway         func(clusterName string, obj *networking_solo_io_v2.VirtualGateway) (reconcile.Result, error)
	OnReconcileVirtualGatewayDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterVirtualGatewayReconcilerFuncs) ReconcileVirtualGateway(clusterName string, obj *networking_solo_io_v2.VirtualGateway) (reconcile.Result, error) {
...
func NewMulticlusterVirtualGatewayReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterVirtualGatewayReconcileLoop {
	return &multiclusterVirtualGatewayReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &networking_solo_io_v2.VirtualGateway{}, options)}
}
