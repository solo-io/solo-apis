...
type ExternalServiceEventHandler interface {
	CreateExternalService(obj *networking_solo_io_v2.ExternalService) error
	UpdateExternalService(old, new *networking_solo_io_v2.ExternalService) error
	DeleteExternalService(obj *networking_solo_io_v2.ExternalService) error
	GenericExternalService(obj *networking_solo_io_v2.ExternalService) error
}

type ExternalServiceEventHandlerFuncs struct {
	OnCreate  func(obj *networking_solo_io_v2.ExternalService) error
	OnUpdate  func(old, new *networking_solo_io_v2.ExternalService) error
	OnDelete  func(obj *networking_solo_io_v2.ExternalService) error
	OnGeneric func(obj *networking_solo_io_v2.ExternalService) error
}

func (f *ExternalServiceEventHandlerFuncs) CreateExternalService(obj *networking_solo_io_v2.ExternalService) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *ExternalServiceEventHandlerFuncs) DeleteExternalService(obj *networking_solo_io_v2.ExternalService) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *ExternalServiceEventHandlerFuncs) UpdateExternalService(objOld, objNew *networking_solo_io_v2.ExternalService) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *ExternalServiceEventHandlerFuncs) GenericExternalService(obj *networking_solo_io_v2.ExternalService) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewExternalServiceEventWatcher(name string, mgr manager.Manager) ExternalServiceEventWatcher {
	return &externalServiceEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_solo_io_v2.ExternalService{}),
	}
}
...
func (h genericExternalServiceHandler) Create(object client.Object) error {
	obj, ok := object.(*networking_solo_io_v2.ExternalService)
	if !ok {
...
func (h genericExternalServiceHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*networking_solo_io_v2.ExternalService)
	if !ok {
		return errors.Errorf("internal error: ExternalService handler received event for %T", old)
	}
	objNew, ok := new.(*networking_solo_io_v2.ExternalService)
	if !ok {
...
type ExternalEndpointEventHandler interface {
	CreateExternalEndpoint(obj *networking_solo_io_v2.ExternalEndpoint) error
	UpdateExternalEndpoint(old, new *networking_solo_io_v2.ExternalEndpoint) error
	DeleteExternalEndpoint(obj *networking_solo_io_v2.ExternalEndpoint) error
	GenericExternalEndpoint(obj *networking_solo_io_v2.ExternalEndpoint) error
}

type ExternalEndpointEventHandlerFuncs struct {
	OnCreate  func(obj *networking_solo_io_v2.ExternalEndpoint) error
	OnUpdate  func(old, new *networking_solo_io_v2.ExternalEndpoint) error
	OnDelete  func(obj *networking_solo_io_v2.ExternalEndpoint) error
	OnGeneric func(obj *networking_solo_io_v2.ExternalEndpoint) error
}

func (f *ExternalEndpointEventHandlerFuncs) CreateExternalEndpoint(obj *networking_solo_io_v2.ExternalEndpoint) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *ExternalEndpointEventHandlerFuncs) DeleteExternalEndpoint(obj *networking_solo_io_v2.ExternalEndpoint) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *ExternalEndpointEventHandlerFuncs) UpdateExternalEndpoint(objOld, objNew *networking_solo_io_v2.ExternalEndpoint) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *ExternalEndpointEventHandlerFuncs) GenericExternalEndpoint(obj *networking_solo_io_v2.ExternalEndpoint) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewExternalEndpointEventWatcher(name string, mgr manager.Manager) ExternalEndpointEventWatcher {
	return &externalEndpointEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_solo_io_v2.ExternalEndpoint{}),
	}
}
...
func (h genericExternalEndpointHandler) Create(object client.Object) error {
	obj, ok := object.(*networking_solo_io_v2.ExternalEndpoint)
	if !ok {
...
func (h genericExternalEndpointHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*networking_solo_io_v2.ExternalEndpoint)
	if !ok {
		return errors.Errorf("internal error: ExternalEndpoint handler received event for %T", old)
	}
	objNew, ok := new.(*networking_solo_io_v2.ExternalEndpoint)
	if !ok {
...
type RouteTableEventHandler interface {
	CreateRouteTable(obj *networking_solo_io_v2.RouteTable) error
	UpdateRouteTable(old, new *networking_solo_io_v2.RouteTable) error
	DeleteRouteTable(obj *networking_solo_io_v2.RouteTable) error
	GenericRouteTable(obj *networking_solo_io_v2.RouteTable) error
}

type RouteTableEventHandlerFuncs struct {
	OnCreate  func(obj *networking_solo_io_v2.RouteTable) error
	OnUpdate  func(old, new *networking_solo_io_v2.RouteTable) error
	OnDelete  func(obj *networking_solo_io_v2.RouteTable) error
	OnGeneric func(obj *networking_solo_io_v2.RouteTable) error
}

func (f *RouteTableEventHandlerFuncs) CreateRouteTable(obj *networking_solo_io_v2.RouteTable) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *RouteTableEventHandlerFuncs) DeleteRouteTable(obj *networking_solo_io_v2.RouteTable) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *RouteTableEventHandlerFuncs) UpdateRouteTable(objOld, objNew *networking_solo_io_v2.RouteTable) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *RouteTableEventHandlerFuncs) GenericRouteTable(obj *networking_solo_io_v2.RouteTable) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewRouteTableEventWatcher(name string, mgr manager.Manager) RouteTableEventWatcher {
	return &routeTableEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_solo_io_v2.RouteTable{}),
	}
}
...
func (h genericRouteTableHandler) Create(object client.Object) error {
	obj, ok := object.(*networking_solo_io_v2.RouteTable)
	if !ok {
...
func (h genericRouteTableHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*networking_solo_io_v2.RouteTable)
	if !ok {
		return errors.Errorf("internal error: RouteTable handler received event for %T", old)
	}
	objNew, ok := new.(*networking_solo_io_v2.RouteTable)
	if !ok {
...
type VirtualDestinationEventHandler interface {
	CreateVirtualDestination(obj *networking_solo_io_v2.VirtualDestination) error
	UpdateVirtualDestination(old, new *networking_solo_io_v2.VirtualDestination) error
	DeleteVirtualDestination(obj *networking_solo_io_v2.VirtualDestination) error
	GenericVirtualDestination(obj *networking_solo_io_v2.VirtualDestination) error
}

type VirtualDestinationEventHandlerFuncs struct {
	OnCreate  func(obj *networking_solo_io_v2.VirtualDestination) error
	OnUpdate  func(old, new *networking_solo_io_v2.VirtualDestination) error
	OnDelete  func(obj *networking_solo_io_v2.VirtualDestination) error
	OnGeneric func(obj *networking_solo_io_v2.VirtualDestination) error
}

func (f *VirtualDestinationEventHandlerFuncs) CreateVirtualDestination(obj *networking_solo_io_v2.VirtualDestination) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *VirtualDestinationEventHandlerFuncs) DeleteVirtualDestination(obj *networking_solo_io_v2.VirtualDestination) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *VirtualDestinationEventHandlerFuncs) UpdateVirtualDestination(objOld, objNew *networking_solo_io_v2.VirtualDestination) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *VirtualDestinationEventHandlerFuncs) GenericVirtualDestination(obj *networking_solo_io_v2.VirtualDestination) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewVirtualDestinationEventWatcher(name string, mgr manager.Manager) VirtualDestinationEventWatcher {
	return &virtualDestinationEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_solo_io_v2.VirtualDestination{}),
	}
}
...
func (h genericVirtualDestinationHandler) Create(object client.Object) error {
	obj, ok := object.(*networking_solo_io_v2.VirtualDestination)
	if !ok {
...
func (h genericVirtualDestinationHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*networking_solo_io_v2.VirtualDestination)
	if !ok {
		return errors.Errorf("internal error: VirtualDestination handler received event for %T", old)
	}
	objNew, ok := new.(*networking_solo_io_v2.VirtualDestination)
	if !ok {
...
type VirtualGatewayEventHandler interface {
	CreateVirtualGateway(obj *networking_solo_io_v2.VirtualGateway) error
	UpdateVirtualGateway(old, new *networking_solo_io_v2.VirtualGateway) error
	DeleteVirtualGateway(obj *networking_solo_io_v2.VirtualGateway) error
	GenericVirtualGateway(obj *networking_solo_io_v2.VirtualGateway) error
}

type VirtualGatewayEventHandlerFuncs struct {
	OnCreate  func(obj *networking_solo_io_v2.VirtualGateway) error
	OnUpdate  func(old, new *networking_solo_io_v2.VirtualGateway) error
	OnDelete  func(obj *networking_solo_io_v2.VirtualGateway) error
	OnGeneric func(obj *networking_solo_io_v2.VirtualGateway) error
}

func (f *VirtualGatewayEventHandlerFuncs) CreateVirtualGateway(obj *networking_solo_io_v2.VirtualGateway) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *VirtualGatewayEventHandlerFuncs) DeleteVirtualGateway(obj *networking_solo_io_v2.VirtualGateway) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *VirtualGatewayEventHandlerFuncs) UpdateVirtualGateway(objOld, objNew *networking_solo_io_v2.VirtualGateway) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *VirtualGatewayEventHandlerFuncs) GenericVirtualGateway(obj *networking_solo_io_v2.VirtualGateway) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewVirtualGatewayEventWatcher(name string, mgr manager.Manager) VirtualGatewayEventWatcher {
	return &virtualGatewayEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_solo_io_v2.VirtualGateway{}),
	}
}
...
func (h genericVirtualGatewayHandler) Create(object client.Object) error {
	obj, ok := object.(*networking_solo_io_v2.VirtualGateway)
	if !ok {
...
func (h genericVirtualGatewayHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*networking_solo_io_v2.VirtualGateway)
	if !ok {
		return errors.Errorf("internal error: VirtualGateway handler received event for %T", old)
	}
	objNew, ok := new.(*networking_solo_io_v2.VirtualGateway)
	if !ok {
