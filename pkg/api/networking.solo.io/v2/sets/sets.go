...
import (
	networking_solo_io_v2 "github.com/solo-io/solo-apis/pkg/api/networking.solo.io/v2"
...
type ExternalServiceSet interface {
	...
	List(filterResource ...func(*networking_solo_io_v2.ExternalService) bool) []*networking_solo_io_v2.ExternalService
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*networking_solo_io_v2.ExternalService) bool) []*networking_solo_io_v2.ExternalService
	// Return the Set as a map of key to resource.
	Map() map[string]*networking_solo_io_v2.ExternalService
	// Insert a resource into the set.
	Insert(externalService ...*networking_solo_io_v2.ExternalService)
	...
	Find(id ezkube.ResourceId) (*networking_solo_io_v2.ExternalService, error)
...
func makeGenericExternalServiceSet(externalServiceList []*networking_solo_io_v2.ExternalService) sksets.ResourceSet {
...
func NewExternalServiceSet(externalServiceList ...*networking_solo_io_v2.ExternalService) ExternalServiceSet {
	return &externalServiceSet{set: makeGenericExternalServiceSet(externalServiceList)}
}

func NewExternalServiceSetFromList(externalServiceList *networking_solo_io_v2.ExternalServiceList) ExternalServiceSet {
	list := make([]*networking_solo_io_v2.ExternalService, 0, len(externalServiceList.Items))
...
func (s *externalServiceSet) List(filterResource ...func(*networking_solo_io_v2.ExternalService) bool) []*networking_solo_io_v2.ExternalService {
	if s == nil {
		return nil
	}
	...
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*networking_solo_io_v2.ExternalService))
		})
	}

	objs := s.Generic().List(genericFilters...)
	externalServiceList := make([]*networking_solo_io_v2.ExternalService, 0, len(objs))
	for _, obj := range objs {
		externalServiceList = append(externalServiceList, obj.(*networking_solo_io_v2.ExternalService))
	}
	return externalServiceList
}

func (s *externalServiceSet) UnsortedList(filterResource ...func(*networking_solo_io_v2.ExternalService) bool) []*networking_solo_io_v2.ExternalService {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var externalServiceList []*networking_solo_io_v2.ExternalService
...
func (s *externalServiceSet) Map() map[string]*networking_solo_io_v2.ExternalService {
	if s == nil {
		return nil
	}

	newMap := map[string]*networking_solo_io_v2.ExternalService{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*networking_solo_io_v2.ExternalService)
	}
	return newMap
}

func (s *externalServiceSet) Insert(
	externalServiceList ...*networking_solo_io_v2.ExternalService,
) {
	if s == nil {
...
func (s *externalServiceSet) Find(id ezkube.ResourceId) (*networking_solo_io_v2.ExternalService, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find ExternalService %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&networking_solo_io_v2.ExternalService{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*networking_solo_io_v2.ExternalService), nil
}
...
type ExternalEndpointSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*networking_solo_io_v2.ExternalEndpoint) bool) []*networking_solo_io_v2.ExternalEndpoint
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*networking_solo_io_v2.ExternalEndpoint) bool) []*networking_solo_io_v2.ExternalEndpoint
	// Return the Set as a map of key to resource.
	Map() map[string]*networking_solo_io_v2.ExternalEndpoint
	// Insert a resource into the set.
	Insert(externalEndpoint ...*networking_solo_io_v2.ExternalEndpoint)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*networking_solo_io_v2.ExternalEndpoint, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericExternalEndpointSet(externalEndpointList []*networking_solo_io_v2.ExternalEndpoint) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewExternalEndpointSet(externalEndpointList ...*networking_solo_io_v2.ExternalEndpoint) ExternalEndpointSet {
	return &externalEndpointSet{set: makeGenericExternalEndpointSet(externalEndpointList)}
}

func NewExternalEndpointSetFromList(externalEndpointList *networking_solo_io_v2.ExternalEndpointList) ExternalEndpointSet {
	list := make([]*networking_solo_io_v2.ExternalEndpoint, 0, len(externalEndpointList.Items))
...
func (s *externalEndpointSet) List(filterResource ...func(*networking_solo_io_v2.ExternalEndpoint) bool) []*networking_solo_io_v2.ExternalEndpoint {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*networking_solo_io_v2.ExternalEndpoint))
		})
	}

	objs := s.Generic().List(genericFilters...)
	externalEndpointList := make([]*networking_solo_io_v2.ExternalEndpoint, 0, len(objs))
	for _, obj := range objs {
		externalEndpointList = append(externalEndpointList, obj.(*networking_solo_io_v2.ExternalEndpoint))
	}
	return externalEndpointList
}

func (s *externalEndpointSet) UnsortedList(filterResource ...func(*networking_solo_io_v2.ExternalEndpoint) bool) []*networking_solo_io_v2.ExternalEndpoint {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var externalEndpointList []*networking_solo_io_v2.ExternalEndpoint
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		externalEndpointList = append(externalEndpointList, obj.(*networking_solo_io_v2.ExternalEndpoint))
	}
	return externalEndpointList
...
func (s *externalEndpointSet) Map() map[string]*networking_solo_io_v2.ExternalEndpoint {
	if s == nil {
		return nil
	}

	newMap := map[string]*networking_solo_io_v2.ExternalEndpoint{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*networking_solo_io_v2.ExternalEndpoint)
	}
	return newMap
}

func (s *externalEndpointSet) Insert(
	externalEndpointList ...*networking_solo_io_v2.ExternalEndpoint,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *externalEndpointSet) Find(id ezkube.ResourceId) (*networking_solo_io_v2.ExternalEndpoint, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find ExternalEndpoint %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&networking_solo_io_v2.ExternalEndpoint{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*networking_solo_io_v2.ExternalEndpoint), nil
}
...
type RouteTableSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*networking_solo_io_v2.RouteTable) bool) []*networking_solo_io_v2.RouteTable
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*networking_solo_io_v2.RouteTable) bool) []*networking_solo_io_v2.RouteTable
	// Return the Set as a map of key to resource.
	Map() map[string]*networking_solo_io_v2.RouteTable
	// Insert a resource into the set.
	Insert(routeTable ...*networking_solo_io_v2.RouteTable)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*networking_solo_io_v2.RouteTable, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericRouteTableSet(routeTableList []*networking_solo_io_v2.RouteTable) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewRouteTableSet(routeTableList ...*networking_solo_io_v2.RouteTable) RouteTableSet {
	return &routeTableSet{set: makeGenericRouteTableSet(routeTableList)}
}

func NewRouteTableSetFromList(routeTableList *networking_solo_io_v2.RouteTableList) RouteTableSet {
	list := make([]*networking_solo_io_v2.RouteTable, 0, len(routeTableList.Items))
...
func (s *routeTableSet) List(filterResource ...func(*networking_solo_io_v2.RouteTable) bool) []*networking_solo_io_v2.RouteTable {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*networking_solo_io_v2.RouteTable))
		})
	}

	objs := s.Generic().List(genericFilters...)
	routeTableList := make([]*networking_solo_io_v2.RouteTable, 0, len(objs))
	for _, obj := range objs {
		routeTableList = append(routeTableList, obj.(*networking_solo_io_v2.RouteTable))
	}
	return routeTableList
}

func (s *routeTableSet) UnsortedList(filterResource ...func(*networking_solo_io_v2.RouteTable) bool) []*networking_solo_io_v2.RouteTable {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var routeTableList []*networking_solo_io_v2.RouteTable
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		routeTableList = append(routeTableList, obj.(*networking_solo_io_v2.RouteTable))
	}
	return routeTableList
...
func (s *routeTableSet) Map() map[string]*networking_solo_io_v2.RouteTable {
	if s == nil {
		return nil
	}

	newMap := map[string]*networking_solo_io_v2.RouteTable{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*networking_solo_io_v2.RouteTable)
	}
	return newMap
}

func (s *routeTableSet) Insert(
	routeTableList ...*networking_solo_io_v2.RouteTable,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *routeTableSet) Find(id ezkube.ResourceId) (*networking_solo_io_v2.RouteTable, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find RouteTable %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&networking_solo_io_v2.RouteTable{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*networking_solo_io_v2.RouteTable), nil
}
...
type VirtualDestinationSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*networking_solo_io_v2.VirtualDestination) bool) []*networking_solo_io_v2.VirtualDestination
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*networking_solo_io_v2.VirtualDestination) bool) []*networking_solo_io_v2.VirtualDestination
	// Return the Set as a map of key to resource.
	Map() map[string]*networking_solo_io_v2.VirtualDestination
	// Insert a resource into the set.
	Insert(virtualDestination ...*networking_solo_io_v2.VirtualDestination)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*networking_solo_io_v2.VirtualDestination, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericVirtualDestinationSet(virtualDestinationList []*networking_solo_io_v2.VirtualDestination) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewVirtualDestinationSet(virtualDestinationList ...*networking_solo_io_v2.VirtualDestination) VirtualDestinationSet {
	return &virtualDestinationSet{set: makeGenericVirtualDestinationSet(virtualDestinationList)}
}

func NewVirtualDestinationSetFromList(virtualDestinationList *networking_solo_io_v2.VirtualDestinationList) VirtualDestinationSet {
	list := make([]*networking_solo_io_v2.VirtualDestination, 0, len(virtualDestinationList.Items))
...
func (s *virtualDestinationSet) List(filterResource ...func(*networking_solo_io_v2.VirtualDestination) bool) []*networking_solo_io_v2.VirtualDestination {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*networking_solo_io_v2.VirtualDestination))
		})
	}

	objs := s.Generic().List(genericFilters...)
	virtualDestinationList := make([]*networking_solo_io_v2.VirtualDestination, 0, len(objs))
	for _, obj := range objs {
		virtualDestinationList = append(virtualDestinationList, obj.(*networking_solo_io_v2.VirtualDestination))
	}
	return virtualDestinationList
}

func (s *virtualDestinationSet) UnsortedList(filterResource ...func(*networking_solo_io_v2.VirtualDestination) bool) []*networking_solo_io_v2.VirtualDestination {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var virtualDestinationList []*networking_solo_io_v2.VirtualDestination
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		virtualDestinationList = append(virtualDestinationList, obj.(*networking_solo_io_v2.VirtualDestination))
	}
	return virtualDestinationList
...
func (s *virtualDestinationSet) Map() map[string]*networking_solo_io_v2.VirtualDestination {
	if s == nil {
		return nil
	}

	newMap := map[string]*networking_solo_io_v2.VirtualDestination{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*networking_solo_io_v2.VirtualDestination)
	}
	return newMap
}

func (s *virtualDestinationSet) Insert(
	virtualDestinationList ...*networking_solo_io_v2.VirtualDestination,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *virtualDestinationSet) Find(id ezkube.ResourceId) (*networking_solo_io_v2.VirtualDestination, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find VirtualDestination %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&networking_solo_io_v2.VirtualDestination{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*networking_solo_io_v2.VirtualDestination), nil
}
...
type VirtualGatewaySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*networking_solo_io_v2.VirtualGateway) bool) []*networking_solo_io_v2.VirtualGateway
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*networking_solo_io_v2.VirtualGateway) bool) []*networking_solo_io_v2.VirtualGateway
	// Return the Set as a map of key to resource.
	Map() map[string]*networking_solo_io_v2.VirtualGateway
	// Insert a resource into the set.
	Insert(virtualGateway ...*networking_solo_io_v2.VirtualGateway)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*networking_solo_io_v2.VirtualGateway, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericVirtualGatewaySet(virtualGatewayList []*networking_solo_io_v2.VirtualGateway) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewVirtualGatewaySet(virtualGatewayList ...*networking_solo_io_v2.VirtualGateway) VirtualGatewaySet {
	return &virtualGatewaySet{set: makeGenericVirtualGatewaySet(virtualGatewayList)}
}

func NewVirtualGatewaySetFromList(virtualGatewayList *networking_solo_io_v2.VirtualGatewayList) VirtualGatewaySet {
	list := make([]*networking_solo_io_v2.VirtualGateway, 0, len(virtualGatewayList.Items))
...
func (s *virtualGatewaySet) List(filterResource ...func(*networking_solo_io_v2.VirtualGateway) bool) []*networking_solo_io_v2.VirtualGateway {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*networking_solo_io_v2.VirtualGateway))
		})
	}

	objs := s.Generic().List(genericFilters...)
	virtualGatewayList := make([]*networking_solo_io_v2.VirtualGateway, 0, len(objs))
	for _, obj := range objs {
		virtualGatewayList = append(virtualGatewayList, obj.(*networking_solo_io_v2.VirtualGateway))
	}
	return virtualGatewayList
}

func (s *virtualGatewaySet) UnsortedList(filterResource ...func(*networking_solo_io_v2.VirtualGateway) bool) []*networking_solo_io_v2.VirtualGateway {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var virtualGatewayList []*networking_solo_io_v2.VirtualGateway
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		virtualGatewayList = append(virtualGatewayList, obj.(*networking_solo_io_v2.VirtualGateway))
	}
	return virtualGatewayList
...
func (s *virtualGatewaySet) Map() map[string]*networking_solo_io_v2.VirtualGateway {
	if s == nil {
		return nil
	}

	newMap := map[string]*networking_solo_io_v2.VirtualGateway{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*networking_solo_io_v2.VirtualGateway)
	}
	return newMap
}

func (s *virtualGatewaySet) Insert(
	virtualGatewayList ...*networking_solo_io_v2.VirtualGateway,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *virtualGatewaySet) Find(id ezkube.ResourceId) (*networking_solo_io_v2.VirtualGateway, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find VirtualGateway %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&networking_solo_io_v2.VirtualGateway{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*networking_solo_io_v2.VirtualGateway), nil
}
