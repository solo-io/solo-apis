...
type FailoverPolicyReconciler interface {
	ReconcileFailoverPolicy(obj *resilience_solo_io_v2.FailoverPolicy) (reconcile.Result, error)
}
...
type FailoverPolicyReconcilerFuncs struct {
	OnReconcileFailoverPolicy         func(obj *resilience_solo_io_v2.FailoverPolicy) (reconcile.Result, error)
	OnReconcileFailoverPolicyDeletion func(req reconcile.Request) error
}

func (f *FailoverPolicyReconcilerFuncs) ReconcileFailoverPolicy(obj *resilience_solo_io_v2.FailoverPolicy) (reconcile.Result, error) {
...
type FailoverPolicyFinalizer interface {
	...
	FinalizeFailoverPolicy(obj *resilience_solo_io_v2.FailoverPolicy) error
}
...
func NewFailoverPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) FailoverPolicyReconcileLoop {
	return &failoverPolicyReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &resilience_solo_io_v2.FailoverPolicy{}, options),
	}
}
...
type OutlierDetectionPolicyReconciler interface {
	ReconcileOutlierDetectionPolicy(obj *resilience_solo_io_v2.OutlierDetectionPolicy) (reconcile.Result, error)
}
...
type OutlierDetectionPolicyReconcilerFuncs struct {
	OnReconcileOutlierDetectionPolicy         func(obj *resilience_solo_io_v2.OutlierDetectionPolicy) (reconcile.Result, error)
	OnReconcileOutlierDetectionPolicyDeletion func(req reconcile.Request) error
}

func (f *OutlierDetectionPolicyReconcilerFuncs) ReconcileOutlierDetectionPolicy(obj *resilience_solo_io_v2.OutlierDetectionPolicy) (reconcile.Result, error) {
...
type OutlierDetectionPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeOutlierDetectionPolicy(obj *resilience_solo_io_v2.OutlierDetectionPolicy) error
}
...
func NewOutlierDetectionPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) OutlierDetectionPolicyReconcileLoop {
	return &outlierDetectionPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &resilience_solo_io_v2.OutlierDetectionPolicy{}, options),
	}
}
...
type FaultInjectionPolicyReconciler interface {
	ReconcileFaultInjectionPolicy(obj *resilience_solo_io_v2.FaultInjectionPolicy) (reconcile.Result, error)
}
...
type FaultInjectionPolicyReconcilerFuncs struct {
	OnReconcileFaultInjectionPolicy         func(obj *resilience_solo_io_v2.FaultInjectionPolicy) (reconcile.Result, error)
	OnReconcileFaultInjectionPolicyDeletion func(req reconcile.Request) error
}

func (f *FaultInjectionPolicyReconcilerFuncs) ReconcileFaultInjectionPolicy(obj *resilience_solo_io_v2.FaultInjectionPolicy) (reconcile.Result, error) {
...
type FaultInjectionPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeFaultInjectionPolicy(obj *resilience_solo_io_v2.FaultInjectionPolicy) error
}
...
func NewFaultInjectionPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) FaultInjectionPolicyReconcileLoop {
	return &faultInjectionPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &resilience_solo_io_v2.FaultInjectionPolicy{}, options),
	}
}
...
type RetryTimeoutPolicyReconciler interface {
	ReconcileRetryTimeoutPolicy(obj *resilience_solo_io_v2.RetryTimeoutPolicy) (reconcile.Result, error)
}
...
type RetryTimeoutPolicyReconcilerFuncs struct {
	OnReconcileRetryTimeoutPolicy         func(obj *resilience_solo_io_v2.RetryTimeoutPolicy) (reconcile.Result, error)
	OnReconcileRetryTimeoutPolicyDeletion func(req reconcile.Request) error
}

func (f *RetryTimeoutPolicyReconcilerFuncs) ReconcileRetryTimeoutPolicy(obj *resilience_solo_io_v2.RetryTimeoutPolicy) (reconcile.Result, error) {
...
type RetryTimeoutPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeRetryTimeoutPolicy(obj *resilience_solo_io_v2.RetryTimeoutPolicy) error
}
...
func NewRetryTimeoutPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) RetryTimeoutPolicyReconcileLoop {
	return &retryTimeoutPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &resilience_solo_io_v2.RetryTimeoutPolicy{}, options),
	}
}
