...
type MulticlusterFailoverPolicyReconciler interface {
	ReconcileFailoverPolicy(clusterName string, obj *resilience_solo_io_v2.FailoverPolicy) (reconcile.Result, error)
}
...
type MulticlusterFailoverPolicyReconcilerFuncs struct {
	OnReconcileFailoverPolicy         func(clusterName string, obj *resilience_solo_io_v2.FailoverPolicy) (reconcile.Result, error)
	OnReconcileFailoverPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterFailoverPolicyReconcilerFuncs) ReconcileFailoverPolicy(clusterName string, obj *resilience_solo_io_v2.FailoverPolicy) (reconcile.Result, error) {
...
func NewMulticlusterFailoverPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterFailoverPolicyReconcileLoop {
	return &multiclusterFailoverPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &resilience_solo_io_v2.FailoverPolicy{}, options)}
}
...
type MulticlusterOutlierDetectionPolicyReconciler interface {
	ReconcileOutlierDetectionPolicy(clusterName string, obj *resilience_solo_io_v2.OutlierDetectionPolicy) (reconcile.Result, error)
}
...
type MulticlusterOutlierDetectionPolicyReconcilerFuncs struct {
	OnReconcileOutlierDetectionPolicy         func(clusterName string, obj *resilience_solo_io_v2.OutlierDetectionPolicy) (reconcile.Result, error)
	OnReconcileOutlierDetectionPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterOutlierDetectionPolicyReconcilerFuncs) ReconcileOutlierDetectionPolicy(clusterName string, obj *resilience_solo_io_v2.OutlierDetectionPolicy) (reconcile.Result, error) {
...
func NewMulticlusterOutlierDetectionPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterOutlierDetectionPolicyReconcileLoop {
	return &multiclusterOutlierDetectionPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &resilience_solo_io_v2.OutlierDetectionPolicy{}, options)}
}
...
type MulticlusterFaultInjectionPolicyReconciler interface {
	ReconcileFaultInjectionPolicy(clusterName string, obj *resilience_solo_io_v2.FaultInjectionPolicy) (reconcile.Result, error)
}
...
type MulticlusterFaultInjectionPolicyReconcilerFuncs struct {
	OnReconcileFaultInjectionPolicy         func(clusterName string, obj *resilience_solo_io_v2.FaultInjectionPolicy) (reconcile.Result, error)
	OnReconcileFaultInjectionPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterFaultInjectionPolicyReconcilerFuncs) ReconcileFaultInjectionPolicy(clusterName string, obj *resilience_solo_io_v2.FaultInjectionPolicy) (reconcile.Result, error) {
...
func NewMulticlusterFaultInjectionPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterFaultInjectionPolicyReconcileLoop {
	return &multiclusterFaultInjectionPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &resilience_solo_io_v2.FaultInjectionPolicy{}, options)}
}
...
type MulticlusterRetryTimeoutPolicyReconciler interface {
	ReconcileRetryTimeoutPolicy(clusterName string, obj *resilience_solo_io_v2.RetryTimeoutPolicy) (reconcile.Result, error)
}
...
type MulticlusterRetryTimeoutPolicyReconcilerFuncs struct {
	OnReconcileRetryTimeoutPolicy         func(clusterName string, obj *resilience_solo_io_v2.RetryTimeoutPolicy) (reconcile.Result, error)
	OnReconcileRetryTimeoutPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterRetryTimeoutPolicyReconcilerFuncs) ReconcileRetryTimeoutPolicy(clusterName string, obj *resilience_solo_io_v2.RetryTimeoutPolicy) (reconcile.Result, error) {
...
func NewMulticlusterRetryTimeoutPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRetryTimeoutPolicyReconcileLoop {
	return &multiclusterRetryTimeoutPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &resilience_solo_io_v2.RetryTimeoutPolicy{}, options)}
}
