...
// Equal function
func (m *SettingsSpec_SecretOptions) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*SettingsSpec_SecretOptions)
	if !ok {
		that2, ok := that.(SettingsSpec_SecretOptions)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *SettingsSpec_VaultAwsAuth) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*SettingsSpec_VaultAwsAuth)
	if !ok {
		that2, ok := that.(SettingsSpec_VaultAwsAuth)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *SettingsSpec_VaultTlsConfig) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*SettingsSpec_VaultTlsConfig)
	if !ok {
		that2, ok := that.(SettingsSpec_VaultTlsConfig)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *SettingsSpec_SecretOptions_Source) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*SettingsSpec_SecretOptions_Source)
	if !ok {
		that2, ok := that.(SettingsSpec_SecretOptions_Source)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *SettingsSpec_DiscoveryOptions_FdsOptions) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*SettingsSpec_DiscoveryOptions_FdsOptions)
	if !ok {
		that2, ok := that.(SettingsSpec_DiscoveryOptions_FdsOptions)
		if ok {
			target = &that2
		} else {
			return false
