...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_rawDesc = "" +
	"\n" +
	"<github.com/solo-io/solo-apis/api/gloo/gloo/v1/upstream.proto\x12\fgloo.solo.io\x1a\x1cgoogle/protobuf/struct.proto\x1a\x12extproto/ext.proto\x1a;github.com/solo-io/solo-apis/api/gloo/gloo/v1/ssl/ssl.proto\x1aSgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/circuit_breaker/circuit_breaker.proto\x1aAgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/load_balancer.proto\x1a>github.com/solo-io/solo-apis/api/gloo/gloo/v1/connection.proto\x1aXgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/api/v2/core/health_check.proto\x1a`github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/api/v2/cluster/outlier_detection.proto\x1a1github.com/solo-io/solo-kit/api/v1/solo-kit.proto\x1aIgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/static/static.proto\x1aEgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/pipe/pipe.proto\x1aQgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/kubernetes/kubernetes.proto\x1aCgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/aws/aws.proto\x1aGgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/azure/azure.proto\x1aIgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/consul/consul.proto\x1aKgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/aws/ec2/aws_ec2.proto\x1a<github.com/solo-io/solo-apis/api/gloo/gloo/v1/failover.proto\x1aNgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/enterprise/options/gcp/gcp.proto\x1aLgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/enterprise/options/ai/ai.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x17validate/validate.proto\"\x9a\x14\n" +
	"\fUpstreamSpec\x12N\n" +
	...
	"\x11connection_config\x18\a \x01(\v2\x1e.gloo.solo.io.ConnectionConfigR\x10connectionConfig\x12b\n" +
	"\x12protocol_selection\x18\x19 \x01(\x0e23.gloo.solo.io.UpstreamSpec.ClusterProtocolSelectionR\x11protocolSelection\x127\n" +
	"\tuse_http2\x18\n" +
	...
	"\x17USE_DOWNSTREAM_PROTOCOL\x10\x01B\x0f\n" +
	...
	"\x1bpredictive_preconnect_ratio\x18\x02 \x01(\v2\x1c.google.protobuf.DoubleValueB\x17\xfaB\x14\x12\x12\x19\x00\x00\x00\x00\x00\x00\b@)\x00\x00\x00\x00\x00\x00\xf0?R\x19predictivePreconnectRatio\"\xc5\x03\n" +
	"\x0eUpstreamStatus\x128\n" +
	"\x05state\x18\x01 \x01(\x0e2\".gloo.solo.io.UpstreamStatus.StateR\x05state\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x1f\n" +
	"\vreported_by\x18\x03 \x01(\tR\n" +
	"reportedBy\x12h\n" +
	"\x14subresource_statuses\x18\x04 \x03(\v25.gloo.solo.io.UpstreamStatus.SubresourceStatusesEntryR\x13subresourceStatuses\x121\n" +
	"\adetails\x18\x05 \x01(\v2\x17.google.protobuf.StructR\adetails\x1ad\n" +
	"\x18SubresourceStatusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.gloo.solo.io.UpstreamStatusR\x05value:\x028\x01\"=\n" +
	"\x05State\x12\v\n" +
	"\aPending\x10\x00\x12\f\n" +
	"\bAccepted\x10\x01\x12\f\n" +
	"\bRejected\x10\x02\x12\v\n" +
	"\aWarning\x10\x03\"\xcb\x01\n" +
	"\x1aUpstreamNamespacedStatuses\x12R\n" +
	"\bstatuses\x18\x01 \x03(\v26.gloo.solo.io.UpstreamNamespacedStatuses.StatusesEntryR\bstatuses\x1aY\n" +
	"\rStatusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.gloo.solo.io.UpstreamStatusR\x05value:\x028\x01BB\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01Z4github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1b\x06proto3"
