...
func (x *UpstreamSpec) GetGcp() *gcp.UpstreamSpec {
	if x, ok := x.GetUpstreamType().(*UpstreamSpec_Gcp); ok {
		return x.Gcp
	}
	return nil
}
...
func (x *UpstreamSpec) GetAi() *ai.UpstreamSpec {
	if x, ok := x.GetUpstreamType().(*UpstreamSpec_Ai); ok {
		return x.Ai
	}
	return nil
}
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_msgTypes[5].Exporter = func(v any, i int) any {
