...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_rawDesc = []byte{
	...
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf9, 0x0b, 0x0a, 0x0c, 0x55, 0x70, 0x73, 0x74,
	...
	0x6e, 0x48, 0x6f, 0x73, 0x74, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x61, 0x6c, 0x42, 0x0f, 0x0a, 0x0d,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xc5, 0x03, 0x0a, 0x0e, 0x55, 0x70,
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x38, 0x0a, 0x05,
	...
	0x65, 0x61, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52,
	...
	0x03, 0x22, 0xcb, 0x01, 0x0a, 0x1a, 0x55, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4e, 0x61,
	...
	0x6f, 0x2e, 0x55, 0x70, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70,
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_goTypes = []interface{}{
	...
	(*UpstreamNamespacedStatuses)(nil), // 4: gloo.solo.io.UpstreamNamespacedStatuses
	nil,                                // 5: gloo.solo.io.DiscoveryMetadata.LabelsEntry
	nil,                                // 6: gloo.solo.io.UpstreamStatus.SubresourceStatusesEntry
	nil,                                // 7: gloo.solo.io.UpstreamNamespacedStatuses.StatusesEntry
	...
	(*ConnectionConfig)(nil),           // 11: gloo.solo.io.ConnectionConfig
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_upstream_proto_depIdxs = []int32{
	...
	8,  // 1: gloo.solo.io.UpstreamSpec.ssl_config:type_name -> gloo.solo.io.UpstreamSslConfig
	9,  // 2: gloo.solo.io.UpstreamSpec.circuit_breakers:type_name -> gloo.solo.io.CircuitBreakerConfig
	10, // 3: gloo.solo.io.UpstreamSpec.load_balancer_config:type_name -> gloo.solo.io.LoadBalancerConfig
	11, // 4: gloo.solo.io.UpstreamSpec.connection_config:type_name -> gloo.solo.io.ConnectionConfig
	12, // 5: gloo.solo.io.UpstreamSpec.health_checks:type_name -> solo.io.envoy.api.v2.core.HealthCheck
	13, // 6: gloo.solo.io.UpstreamSpec.outlier_detection:type_name -> solo.io.envoy.api.v2.cluster.OutlierDetection
	14, // 7: gloo.solo.io.UpstreamSpec.use_http2:type_name -> google.protobuf.BoolValue
	15, // 8: gloo.solo.io.UpstreamSpec.kube:type_name -> kubernetes.options.gloo.solo.io.UpstreamSpec
	16, // 9: gloo.solo.io.UpstreamSpec.static:type_name -> static.options.gloo.solo.io.UpstreamSpec
	17, // 10: gloo.solo.io.UpstreamSpec.pipe:type_name -> pipe.options.gloo.solo.io.UpstreamSpec
	18, // 11: gloo.solo.io.UpstreamSpec.aws:type_name -> aws.options.gloo.solo.io.UpstreamSpec
	19, // 12: gloo.solo.io.UpstreamSpec.azure:type_name -> azure.options.gloo.solo.io.UpstreamSpec
	20, // 13: gloo.solo.io.UpstreamSpec.consul:type_name -> consul.options.gloo.solo.io.UpstreamSpec
	21, // 14: gloo.solo.io.UpstreamSpec.aws_ec2:type_name -> aws_ec2.options.gloo.solo.io.UpstreamSpec
	22, // 15: gloo.solo.io.UpstreamSpec.failover:type_name -> gloo.solo.io.Failover
	23, // 16: gloo.solo.io.UpstreamSpec.initial_stream_window_size:type_name -> google.protobuf.UInt32Value
	23, // 17: gloo.solo.io.UpstreamSpec.initial_connection_window_size:type_name -> google.protobuf.UInt32Value
	24, // 18: gloo.solo.io.UpstreamSpec.http_proxy_hostname:type_name -> google.protobuf.StringValue
	14, // 19: gloo.solo.io.UpstreamSpec.ignore_health_on_host_removal:type_name -> google.protobuf.BoolValue
	5,  // 20: gloo.solo.io.DiscoveryMetadata.labels:type_name -> gloo.solo.io.DiscoveryMetadata.LabelsEntry
	0,  // 21: gloo.solo.io.UpstreamStatus.state:type_name -> gloo.solo.io.UpstreamStatus.State
	6,  // 22: gloo.solo.io.UpstreamStatus.subresource_statuses:type_name -> gloo.solo.io.UpstreamStatus.SubresourceStatusesEntry
	25, // 23: gloo.solo.io.UpstreamStatus.details:type_name -> google.protobuf.Struct
	7,  // 24: gloo.solo.io.UpstreamNamespacedStatuses.statuses:type_name -> gloo.solo.io.UpstreamNamespacedStatuses.StatusesEntry
	3,  // 25: gloo.solo.io.UpstreamStatus.SubresourceStatusesEntry.value:type_name -> gloo.solo.io.UpstreamStatus
	3,  // 26: gloo.solo.io.UpstreamNamespacedStatuses.StatusesEntry.value:type_name -> gloo.solo.io.UpstreamStatus
