...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_rawDesc = "" +
	"\n" +
	"Ngithub.com/solo-io/solo-apis/api/gloo/gloo/v1/enterprise/options/jwt/jwt.proto\x12\x18jwt.options.gloo.solo.io\x1a,github.com/solo-io/solo-kit/api/v1/ref.proto\x1akgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/extensions/filters/http/jwt_authn/v3/config.proto\x1a\x12extproto/ext.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1egoogle/protobuf/duration.proto\"\xbb\x01\n" +
	...
	"\x06append\x18\x04 \x01(\bR\x06appendBY\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01ZKgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/enterprise/options/jwtb\x06proto3"

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_rawDescData []byte
)
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_rawDesc)))
	})
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_jwt_jwt_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
