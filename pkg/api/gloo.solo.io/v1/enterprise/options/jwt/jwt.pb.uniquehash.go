...
func (m *JwtStagedRouteProvidersExtension) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("jwt.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/enterprise/options/jwt.JwtStagedRouteProvidersExtension")); err != nil {
		return 0, err
	}
