...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_dlp_dlp_proto_rawDesc = string([]byte{
...
var (
	...
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_dlp_dlp_proto_rawDescData []byte
)
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_dlp_dlp_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_dlp_dlp_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_dlp_dlp_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_dlp_dlp_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_dlp_dlp_proto_rawDesc)))
	})
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_dlp_dlp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_dlp_dlp_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_options_dlp_dlp_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
