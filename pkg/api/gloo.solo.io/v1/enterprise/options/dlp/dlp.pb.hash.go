...
func (m *Action) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetHeaderAction()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("HeaderAction")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetHeaderAction(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("HeaderAction")); err != nil {
				return 0, err
...
// Hash function
func (m *HeaderAction) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("dlp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/enterprise/options/dlp.HeaderAction")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte(m.GetHeaderToMask())); err != nil {
		return 0, err
	}
