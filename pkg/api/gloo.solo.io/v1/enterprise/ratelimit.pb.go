...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_ratelimit_proto_rawDesc = "" +
	...
	"\x14FetchRateLimitConfig\x12\x1e.envoy.api.v2.DiscoveryRequest\x1a\x1f.envoy.api.v2.DiscoveryResponse\"(\x82\xd3\xe4\x93\x02\":\x01*\"\x1d/v2/discovery:ratelimitconfigBM\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01Z?github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/enterpriseb\x06proto3"

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_ratelimit_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_ratelimit_proto_rawDescData []byte
)
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_ratelimit_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_ratelimit_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_ratelimit_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_enterprise_ratelimit_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
