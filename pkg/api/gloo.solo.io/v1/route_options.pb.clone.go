...
func (m *RouteOptions) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetExtProcEarly()).(clone.Cloner); ok {
		target.ExtProcEarly = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_extproc.RouteSettings)
	} else {
		target.ExtProcEarly = proto.Clone(m.GetExtProcEarly()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_extproc.RouteSettings)
	}
	...
	case *RouteOptions_JwtProvidersStaged:
		...
		if h, ok := interface{}(m.GetJwtProvidersStaged()).(clone.Cloner); ok {
			target.JwtConfig = &RouteOptions_JwtProvidersStaged{
				JwtProvidersStaged: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_jwt.JwtStagedRouteProvidersExtension),
			}
		} else {
			target.JwtConfig = &RouteOptions_JwtProvidersStaged{
				JwtProvidersStaged: proto.Clone(m.GetJwtProvidersStaged()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_jwt.JwtStagedRouteProvidersExtension),
			}
		}
