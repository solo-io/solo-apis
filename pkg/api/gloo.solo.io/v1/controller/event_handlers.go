...
type AuthConfigEventHandler interface {
	CreateAuthConfig(obj *gloo_solo_io_v1.AuthConfig) error
	UpdateAuthConfig(old, new *gloo_solo_io_v1.AuthConfig) error
	DeleteAuthConfig(obj *gloo_solo_io_v1.AuthConfig) error
	GenericAuthConfig(obj *gloo_solo_io_v1.AuthConfig) error
}

type AuthConfigEventHandlerFuncs struct {
	OnCreate  func(obj *gloo_solo_io_v1.AuthConfig) error
	OnUpdate  func(old, new *gloo_solo_io_v1.AuthConfig) error
	OnDelete  func(obj *gloo_solo_io_v1.AuthConfig) error
	OnGeneric func(obj *gloo_solo_io_v1.AuthConfig) error
}

func (f *AuthConfigEventHandlerFuncs) CreateAuthConfig(obj *gloo_solo_io_v1.AuthConfig) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *AuthConfigEventHandlerFuncs) DeleteAuthConfig(obj *gloo_solo_io_v1.AuthConfig) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *AuthConfigEventHandlerFuncs) UpdateAuthConfig(objOld, objNew *gloo_solo_io_v1.AuthConfig) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *AuthConfigEventHandlerFuncs) GenericAuthConfig(obj *gloo_solo_io_v1.AuthConfig) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewAuthConfigEventWatcher(name string, mgr manager.Manager) AuthConfigEventWatcher {
	return &authConfigEventWatcher{
		watcher: events.NewWatcher(name, mgr, &gloo_solo_io_v1.AuthConfig{}),
	}
}
...
func (h genericAuthConfigHandler) Create(object runtime.Object) error {
	obj, ok := object.(*gloo_solo_io_v1.AuthConfig)
	if !ok {
...
func (h genericAuthConfigHandler) Update(old, new runtime.Object) error {
	objOld, ok := old.(*gloo_solo_io_v1.AuthConfig)
	if !ok {
		return errors.Errorf("internal error: AuthConfig handler received event for %T", old)
	}
	objNew, ok := new.(*gloo_solo_io_v1.AuthConfig)
	if !ok {
