...
type MulticlusterAuthConfigReconciler interface {
	ReconcileAuthConfig(clusterName string, obj *gloo_solo_io_v1.AuthConfig) (reconcile.Result, error)
}
...
type MulticlusterAuthConfigReconcilerFuncs struct {
	OnReconcileAuthConfig         func(clusterName string, obj *gloo_solo_io_v1.AuthConfig) (reconcile.Result, error)
	OnReconcileAuthConfigDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterAuthConfigReconcilerFuncs) ReconcileAuthConfig(clusterName string, obj *gloo_solo_io_v1.AuthConfig) (reconcile.Result, error) {
...
func NewMulticlusterAuthConfigReconcileLoop(name string, cw multicluster.ClusterWatcher) MulticlusterAuthConfigReconcileLoop {
	return &multiclusterAuthConfigReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gloo_solo_io_v1.AuthConfig{})}
}
