...
type AuthConfigReconciler interface {
	ReconcileAuthConfig(obj *gloo_solo_io_v1.AuthConfig) (reconcile.Result, error)
}
...
type AuthConfigReconcilerFuncs struct {
	OnReconcileAuthConfig         func(obj *gloo_solo_io_v1.AuthConfig) (reconcile.Result, error)
	OnReconcileAuthConfigDeletion func(req reconcile.Request) error
}

func (f *AuthConfigReconcilerFuncs) ReconcileAuthConfig(obj *gloo_solo_io_v1.AuthConfig) (reconcile.Result, error) {
...
type AuthConfigFinalizer interface {
	...
	FinalizeAuthConfig(obj *gloo_solo_io_v1.AuthConfig) error
}
...
func NewAuthConfigReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) AuthConfigReconcileLoop {
	return &authConfigReconcileLoop{
		loop: reconcile.NewLoop(name, mgr, &gloo_solo_io_v1.AuthConfig{}, options),
	}
}
