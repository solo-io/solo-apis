...
func (m *SslConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/ssl.SslConfig")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetDisableTlsSessionResumption()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetDisableTlsSessionResumption(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
	...
	if h, ok := interface{}(m.GetTransportSocketConnectTimeout()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetTransportSocketConnectTimeout(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
...
func (m *SSLFiles) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/ssl.SSLFiles")); err != nil {
		return 0, err
	}
...
func (m *UpstreamSslConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/ssl.UpstreamSslConfig")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetAllowRenegotiation()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetAllowRenegotiation(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
...
func (m *SDSConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/ssl.SDSConfig")); err != nil {
		return 0, err
	}
...
func (m *CallCredentials) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/ssl.CallCredentials")); err != nil {
		return 0, err
	}
...
func (m *SslParameters) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/ssl.SslParameters")); err != nil {
		return 0, err
	}
...
func (m *CallCredentials_FileCredentialSource) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/ssl.CallCredentials_FileCredentialSource")); err != nil {
		return 0, err
	}
