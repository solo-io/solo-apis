...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_settings_proto_rawDesc = "" +
	...
	"\x18kubernetes_config_source\x18\x04 \x01(\v2).gloo.solo.io.SettingsSpec.KubernetesCrdsH\x00R\x16kubernetesConfigSource\x12^\n" +
	"\x17directory_config_source\x18\x05 \x01(\v2$.gloo.solo.io.SettingsSpec.DirectoryH\x00R\x15directoryConfigSource\x12O\n" +
	"\x10consul_kv_source\x18\x15 \x01(\v2#.gloo.solo.io.SettingsSpec.ConsulKvH\x00R\x0econsulKvSource\x12h\n" +
	"\x18kubernetes_secret_source\x18\x06 \x01(\v2,.gloo.solo.io.SettingsSpec.KubernetesSecretsH\x01R\x16kubernetesSecretSource\x12Y\n" +
	"\x13vault_secret_source\x18\a \x01(\v2'.gloo.solo.io.SettingsSpec.VaultSecretsH\x01R\x11vaultSecretSource\x12^\n" +
	"\x17directory_secret_source\x18\b \x01(\v2$.gloo.solo.io.SettingsSpec.DirectoryH\x01R\x15directorySecretSource\x12O\n" +
	"\x0esecret_options\x18& \x01(\v2(.gloo.solo.io.SettingsSpec.SecretOptionsR\rsecretOptions\x12o\n" +
	"\x1akubernetes_artifact_source\x18\t \x01(\v2/.gloo.solo.io.SettingsSpec.KubernetesConfigmapsH\x02R\x18kubernetesArtifactSource\x12b\n" +
	"\x19directory_artifact_source\x18\n" +
	" \x01(\v2$.gloo.solo.io.SettingsSpec.DirectoryH\x02R\x17directoryArtifactSource\x12`\n" +
	"\x19consul_kv_artifact_source\x18\x17 \x01(\v2#.gloo.solo.io.SettingsSpec.ConsulKvH\x02R\x16consulKvArtifactSource\x12<\n" +
	...
	"\alinkerd\x18\x11 \x01(\bR\alinkerd\x12G\n" +
	"\aknative\x18\x12 \x01(\v2).gloo.solo.io.SettingsSpec.KnativeOptionsB\x02\x18\x01R\aknative\x12I\n" +
	"\tdiscovery\x18\x13 \x01(\v2+.gloo.solo.io.SettingsSpec.DiscoveryOptionsR\tdiscovery\x12-\n" +
	"\x04gloo\x18\x18 \x01(\v2\x19.gloo.solo.io.GlooOptionsR\x04gloo\x126\n" +
	"\agateway\x18\x19 \x01(\v2\x1c.gloo.solo.io.GatewayOptionsR\agateway\x12F\n" +
	"\x06consul\x18\x14 \x01(\v2..gloo.solo.io.SettingsSpec.ConsulConfigurationR\x06consul\x12i\n" +
	"\x0fconsulDiscovery\x18\x1e \x01(\v2?.gloo.solo.io.SettingsSpec.ConsulUpstreamDiscoveryConfigurationR\x0fconsulDiscovery\x12R\n" +
	"\n" +
	"kubernetes\x18\x16 \x01(\v22.gloo.solo.io.SettingsSpec.KubernetesConfigurationR\n" +
	"kubernetes\x128\n" +
	"\n" +
	...
	"\aextauth\x18\x1d \x01(\v2!.enterprise.gloo.solo.io.SettingsR\aextauth\x12Q\n" +
	"\rnamed_extauth\x18! \x03(\v2,.gloo.solo.io.SettingsSpec.NamedExtauthEntryR\fnamedExtauth\x12M\n" +
	"\x0ecaching_server\x18$ \x01(\v2&.caching.options.gloo.solo.io.SettingsR\rcachingServer\x12c\n" +
	"\x14observabilityOptions\x18\x1f \x01(\v2/.gloo.solo.io.SettingsSpec.ObservabilityOptionsR\x14observabilityOptions\x12G\n" +
	...
	"\x06Source\x12N\n" +
	"\n" +
	"kubernetes\x18\x01 \x01(\v2,.gloo.solo.io.SettingsSpec.KubernetesSecretsH\x00R\n" +
	"kubernetes\x12?\n" +
	"\x05vault\x18\x02 \x01(\v2'.gloo.solo.io.SettingsSpec.VaultSecretsH\x00R\x05vault\x12D\n" +
	"\tdirectory\x18\x03 \x01(\v2$.gloo.solo.io.SettingsSpec.DirectoryH\x00R\tdirectoryB\b\n" +
	"\x06source\x1a\x10\n" +
	"\x0eKubernetesCrds\x1a\x13\n" +
	"\x11KubernetesSecrets\x1a\x87\x04\n" +
	...
	"pathPrefix\x12H\n" +
	"\n" +
	"tls_config\x18\v \x01(\v2).gloo.solo.io.SettingsSpec.VaultTlsConfigR\ttlsConfig\x12#\n" +
	"\faccess_token\x18\f \x01(\tH\x00R\vaccessToken\x12;\n" +
	"\x03aws\x18\r \x01(\v2'.gloo.solo.io.SettingsSpec.VaultAwsAuthH\x00R\x03awsB\r\n" +
	...
	"\x1eknative_internal_proxy_address\x18\x03 \x01(\tR\x1bknativeInternalProxyAddress\x1a\xe1\x04\n" +
	"\x10DiscoveryOptions\x12N\n" +
	"\bfds_mode\x18\x01 \x01(\x0e23.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsModeR\afdsMode\x12W\n" +
	"\vuds_options\x18\x02 \x01(\v26.gloo.solo.io.SettingsSpec.DiscoveryOptions.UdsOptionsR\n" +
	"udsOptions\x12W\n" +
	"\vfds_options\x18\x03 \x01(\v26.gloo.solo.io.SettingsSpec.DiscoveryOptions.FdsOptionsR\n" +
	"fdsOptions\x1a\xee\x01\n" +
	"\n" +
	"UdsOptions\x124\n" +
	"\aenabled\x18\x01 \x01(\v2\x1a.google.protobuf.BoolValueR\aenabled\x12j\n" +
	"\fwatch_labels\x18\x02 \x03(\v2G.gloo.solo.io.SettingsSpec.DiscoveryOptions.UdsOptions.WatchLabelsEntryR\vwatchLabels\x1a>\n" +
	...
	"\twait_time\x18\v \x01(\v2\x19.google.protobuf.DurationR\bwaitTime\x12s\n" +
	"\x11service_discovery\x18\f \x01(\v2F.gloo.solo.io.SettingsSpec.ConsulConfiguration.ServiceDiscoveryOptionsR\x10serviceDiscovery\x12!\n" +
	...
	"\x14eds_blocking_queries\x18\x17 \x01(\v2\x1a.google.protobuf.BoolValueR\x12edsBlockingQueries\x1a\xaf\x01\n" +
	"\x17KubernetesConfiguration\x12^\n" +
	"\vrate_limits\x18\x01 \x01(\v2=.gloo.solo.io.SettingsSpec.KubernetesConfiguration.RateLimitsR\n" +
	"rateLimits\x1a4\n" +
	"\n" +
	"RateLimits\x12\x10\n" +
	...
	"\x05value\x18\x02 \x01(\v2!.enterprise.gloo.solo.io.SettingsR\x05value:\x028\x01\x1a\xc6\x06\n" +
	"\x14ObservabilityOptions\x12r\n" +
	"\x12grafanaIntegration\x18\x01 \x01(\v2B.gloo.solo.io.SettingsSpec.ObservabilityOptions.GrafanaIntegrationR\x12grafanaIntegration\x12\x89\x01\n" +
	"\x18configStatusMetricLabels\x18\x02 \x03(\v2M.gloo.solo.io.SettingsSpec.ObservabilityOptions.ConfigStatusMetricLabelsEntryR\x18configStatusMetricLabels\x1a\xdf\x01\n" +
	...
	"\x1dextra_metric_query_parameters\x18\x03 \x01(\tR\x1aextraMetricQueryParameters\x1a\xbf\x01\n" +
	"\fMetricLabels\x12o\n" +
	"\vlabelToPath\x18\x01 \x03(\v2M.gloo.solo.io.SettingsSpec.ObservabilityOptions.MetricLabels.LabelToPathEntryR\vlabelToPath\x1a>\n" +
	...
	"\x05value\x18\x02 \x01(\v2<.gloo.solo.io.SettingsSpec.ObservabilityOptions.MetricLabelsR\x05value:\x028\x01B\x0f\n" +
	"\rconfig_sourceB\x0f\n" +
	"\rsecret_sourceB\x11\n" +
	...
	"\x1dSchemaChangeValidationOptionsJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03R\x17reject_breaking_changesR\x10processing_rulesJ\x04\b\x01\x10\x02R schema_change_validation_options\"\xc5\x03\n" +
	"\x0eSettingsStatus\x128\n" +
	"\x05state\x18\x01 \x01(\x0e2\".gloo.solo.io.SettingsStatus.StateR\x05state\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x1f\n" +
	"\vreported_by\x18\x03 \x01(\tR\n" +
	"reportedBy\x12h\n" +
	"\x14subresource_statuses\x18\x04 \x03(\v25.gloo.solo.io.SettingsStatus.SubresourceStatusesEntryR\x13subresourceStatuses\x121\n" +
	"\adetails\x18\x05 \x01(\v2\x17.google.protobuf.StructR\adetails\x1ad\n" +
	"\x18SubresourceStatusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.gloo.solo.io.SettingsStatusR\x05value:\x028\x01\"=\n" +
	"\x05State\x12\v\n" +
	"\aPending\x10\x00\x12\f\n" +
	"\bAccepted\x10\x01\x12\f\n" +
	"\bRejected\x10\x02\x12\v\n" +
	"\aWarning\x10\x03\"\xcb\x01\n" +
	"\x1aSettingsNamespacedStatuses\x12R\n" +
	"\bstatuses\x18\x01 \x03(\v26.gloo.solo.io.SettingsNamespacedStatuses.StatusesEntryR\bstatuses\x1aY\n" +
	"\rStatusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x122\n" +
	"\x05value\x18\x02 \x01(\v2\x1c.gloo.solo.io.SettingsStatusR\x05value:\x028\x01BB\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01Z4github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1b\x06proto3"
