...
func (m *Matcher_ConnectMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("matchers.core.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/core/matchers.Matcher_ConnectMatcher")); err != nil {
		return 0, err
	}
