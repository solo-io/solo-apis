...
func (m *Selector) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("selectors.core.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/core/selectors.Selector")); err != nil {
		return 0, err
	}
...
func (m *Selector_Expression) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("selectors.core.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/core/selectors.Selector_Expression")); err != nil {
		return 0, err
	}
