...
import (
	...
	github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_api_v2_cluster "github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/api/v2/cluster"
	...
	github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_aws_ec2 "github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/aws/ec2"
	...
	github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_kubernetes "github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/kubernetes"

	github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_pipe "github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/pipe"

	github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_static "github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/static"
...
func (m *UpstreamSpec) Clone() proto.Message {
	...
	if m.GetHealthChecks() != nil {
		target.HealthChecks = make([]*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_api_v2_core.HealthCheck, len(m.GetHealthChecks()))
		for idx, v := range m.GetHealthChecks() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.HealthChecks[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_api_v2_core.HealthCheck)
			} else {
				target.HealthChecks[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_api_v2_core.HealthCheck)
			}
	...
	if h, ok := interface{}(m.GetOutlierDetection()).(clone.Cloner); ok {
		target.OutlierDetection = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_api_v2_cluster.OutlierDetection)
	} else {
		target.OutlierDetection = proto.Clone(m.GetOutlierDetection()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_api_v2_cluster.OutlierDetection)
	}
	...
	if h, ok := interface{}(m.GetHttpConnectSslConfig()).(clone.Cloner); ok {
		target.HttpConnectSslConfig = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_ssl.UpstreamSslConfig)
	} else {
		target.HttpConnectSslConfig = proto.Clone(m.GetHttpConnectSslConfig()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_ssl.UpstreamSslConfig)
	}
	...
	case *UpstreamSpec_Kube:
		...
		if h, ok := interface{}(m.GetKube()).(clone.Cloner); ok {
			target.UpstreamType = &UpstreamSpec_Kube{
				Kube: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_kubernetes.UpstreamSpec),
			}
		} else {
			target.UpstreamType = &UpstreamSpec_Kube{
				Kube: proto.Clone(m.GetKube()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_kubernetes.UpstreamSpec),
			}
		}
	...
	case *UpstreamSpec_Static:
		...
		if h, ok := interface{}(m.GetStatic()).(clone.Cloner); ok {
			target.UpstreamType = &UpstreamSpec_Static{
				Static: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_static.UpstreamSpec),
			}
		} else {
			target.UpstreamType = &UpstreamSpec_Static{
				Static: proto.Clone(m.GetStatic()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_static.UpstreamSpec),
			}
		}
	...
	case *UpstreamSpec_Pipe:
		...
		if h, ok := interface{}(m.GetPipe()).(clone.Cloner); ok {
			target.UpstreamType = &UpstreamSpec_Pipe{
				Pipe: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_pipe.UpstreamSpec),
			}
		} else {
			target.UpstreamType = &UpstreamSpec_Pipe{
				Pipe: proto.Clone(m.GetPipe()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_pipe.UpstreamSpec),
			}
		}
	...
	case *UpstreamSpec_Aws:
		...
		if h, ok := interface{}(m.GetAws()).(clone.Cloner); ok {
			target.UpstreamType = &UpstreamSpec_Aws{
				Aws: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_aws.UpstreamSpec),
			}
		} else {
			target.UpstreamType = &UpstreamSpec_Aws{
				Aws: proto.Clone(m.GetAws()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_aws.UpstreamSpec),
			}
		}
	...
	case *UpstreamSpec_Azure:
		...
		if h, ok := interface{}(m.GetAzure()).(clone.Cloner); ok {
			target.UpstreamType = &UpstreamSpec_Azure{
				Azure: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_azure.UpstreamSpec),
			}
		} else {
			target.UpstreamType = &UpstreamSpec_Azure{
				Azure: proto.Clone(m.GetAzure()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_azure.UpstreamSpec),
			}
		}
	...
	case *UpstreamSpec_Consul:
		...
		if h, ok := interface{}(m.GetConsul()).(clone.Cloner); ok {
			target.UpstreamType = &UpstreamSpec_Consul{
				Consul: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_consul.UpstreamSpec),
			}
		} else {
			target.UpstreamType = &UpstreamSpec_Consul{
				Consul: proto.Clone(m.GetConsul()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_consul.UpstreamSpec),
			}
		}
	...
	case *UpstreamSpec_AwsEc2:
		...
		if h, ok := interface{}(m.GetAwsEc2()).(clone.Cloner); ok {
			target.UpstreamType = &UpstreamSpec_AwsEc2{
				AwsEc2: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_aws_ec2.UpstreamSpec),
			}
		} else {
			target.UpstreamType = &UpstreamSpec_AwsEc2{
				AwsEc2: proto.Clone(m.GetAwsEc2()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_aws_ec2.UpstreamSpec),
			}
		}
	...
	case *UpstreamSpec_Gcp:
		...
		if h, ok := interface{}(m.GetGcp()).(clone.Cloner); ok {
			target.UpstreamType = &UpstreamSpec_Gcp{
				Gcp: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_gcp.UpstreamSpec),
			}
		} else {
			target.UpstreamType = &UpstreamSpec_Gcp{
...
// Clone function
func (m *UpstreamStatus) Clone() proto.Message {
	var target *UpstreamStatus
	if m == nil {
		return target
	}
	target = &UpstreamStatus{}
	...
	if m.GetSubresourceStatuses() != nil {
		target.SubresourceStatuses = make(map[string]*UpstreamStatus, len(m.GetSubresourceStatuses()))
		for k, v := range m.GetSubresourceStatuses() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.SubresourceStatuses[k] = h.Clone().(*UpstreamStatus)
			} else {
				target.SubresourceStatuses[k] = proto.Clone(v).(*UpstreamStatus)
			}
...
// Clone function
func (m *UpstreamNamespacedStatuses) Clone() proto.Message {
	var target *UpstreamNamespacedStatuses
	if m == nil {
		return target
	}
	target = &UpstreamNamespacedStatuses{}

	if m.GetStatuses() != nil {
		target.Statuses = make(map[string]*UpstreamStatus, len(m.GetStatuses()))
		for k, v := range m.GetStatuses() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.Statuses[k] = h.Clone().(*UpstreamStatus)
			} else {
				target.Statuses[k] = proto.Clone(v).(*UpstreamStatus)
			}
