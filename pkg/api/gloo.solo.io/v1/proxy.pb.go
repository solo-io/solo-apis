...
func (m *HttpListener) GetOpaqueMetadata() isHttpListener_OpaqueMetadata {
	if m != nil {
		return m.OpaqueMetadata
	}
	return nil
...
func (x *HttpListener) GetMetadata() *structpb.Struct {
	if x, ok := x.GetOpaqueMetadata().(*HttpListener_Metadata); ok {
		return x.Metadata
	}
	return nil
}
...
func (x *HttpListener) GetMetadataStatic() *SourceMetadata {
	if x, ok := x.GetOpaqueMetadata().(*HttpListener_MetadataStatic); ok {
		return x.MetadataStatic
	}
	return nil
}
