...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_proxy_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xeb, 0x04, 0x0a, 0x05, 0x52, 0x6f, 0x75,
	...
	0x73, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x49, 0x0a, 0x12, 0x67, 0x72, 0x61, 0x70,
	0x68, 0x71, 0x6c, 0x5f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x5f, 0x72, 0x65, 0x66, 0x18, 0x08,
	...
	0x00, 0x52, 0x10, 0x67, 0x72, 0x61, 0x70, 0x68, 0x71, 0x6c, 0x53, 0x63, 0x68, 0x65, 0x6d, 0x61,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0xf6, 0x01, 0x0a, 0x0b, 0x52, 0x6f, 0x75, 0x74, 0x65,
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_proxy_proto_depIdxs = []int32{
	...
	43, // 38: gloo.solo.io.Destination.upstream:type_name -> core.solo.io.ResourceRef
	15, // 39: gloo.solo.io.Destination.kube:type_name -> gloo.solo.io.KubernetesServiceDestination
	16, // 40: gloo.solo.io.Destination.consul:type_name -> gloo.solo.io.ConsulServiceDestination
	45, // 41: gloo.solo.io.Destination.destination_spec:type_name -> gloo.solo.io.DestinationSpec
	46, // 42: gloo.solo.io.Destination.subset:type_name -> gloo.solo.io.Subset
	43, // 43: gloo.solo.io.KubernetesServiceDestination.ref:type_name -> core.solo.io.ResourceRef
	19, // 44: gloo.solo.io.UpstreamGroupSpec.destinations:type_name -> gloo.solo.io.WeightedDestination
	19, // 45: gloo.solo.io.MultiDestination.destinations:type_name -> gloo.solo.io.WeightedDestination
	14, // 46: gloo.solo.io.WeightedDestination.destination:type_name -> gloo.solo.io.Destination
	47, // 47: gloo.solo.io.WeightedDestination.options:type_name -> gloo.solo.io.WeightedDestinationOptions
	0,  // 48: gloo.solo.io.RedirectAction.response_code:type_name -> gloo.solo.io.RedirectAction.RedirectResponseCode
	28, // 49: gloo.solo.io.SourceMetadata.sources:type_name -> gloo.solo.io.SourceMetadata.SourceRef
	1,  // 50: gloo.solo.io.UpstreamGroupStatus.state:type_name -> gloo.solo.io.UpstreamGroupStatus.State
	29, // 51: gloo.solo.io.UpstreamGroupStatus.subresource_statuses:type_name -> gloo.solo.io.UpstreamGroupStatus.SubresourceStatusesEntry
	36, // 52: gloo.solo.io.UpstreamGroupStatus.details:type_name -> google.protobuf.Struct
	30, // 53: gloo.solo.io.UpstreamGroupNamespacedStatuses.statuses:type_name -> gloo.solo.io.UpstreamGroupNamespacedStatuses.StatusesEntry
	2,  // 54: gloo.solo.io.ProxyStatus.state:type_name -> gloo.solo.io.ProxyStatus.State
	31, // 55: gloo.solo.io.ProxyStatus.subresource_statuses:type_name -> gloo.solo.io.ProxyStatus.SubresourceStatusesEntry
	36, // 56: gloo.solo.io.ProxyStatus.details:type_name -> google.protobuf.Struct
	32, // 57: gloo.solo.io.ProxyNamespacedStatuses.statuses:type_name -> gloo.solo.io.ProxyNamespacedStatuses.StatusesEntry
	14, // 58: gloo.solo.io.TcpHost.TcpAction.single:type_name -> gloo.solo.io.Destination
	18, // 59: gloo.solo.io.TcpHost.TcpAction.multi:type_name -> gloo.solo.io.MultiDestination
	43, // 60: gloo.solo.io.TcpHost.TcpAction.upstream_group:type_name -> core.solo.io.ResourceRef
	48, // 61: gloo.solo.io.TcpHost.TcpAction.forward_sni_cluster_name:type_name -> google.protobuf.Empty
	43, // 62: gloo.solo.io.SourceMetadata.SourceRef.resource_ref:type_name -> core.solo.io.ResourceRef
	23, // 63: gloo.solo.io.UpstreamGroupStatus.SubresourceStatusesEntry.value:type_name -> gloo.solo.io.UpstreamGroupStatus
	23, // 64: gloo.solo.io.UpstreamGroupNamespacedStatuses.StatusesEntry.value:type_name -> gloo.solo.io.UpstreamGroupStatus
	25, // 65: gloo.solo.io.ProxyStatus.SubresourceStatusesEntry.value:type_name -> gloo.solo.io.ProxyStatus
	25, // 66: gloo.solo.io.ProxyNamespacedStatuses.StatusesEntry.value:type_name -> gloo.solo.io.ProxyStatus
