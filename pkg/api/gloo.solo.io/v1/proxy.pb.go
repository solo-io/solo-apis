...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_proxy_proto_rawDesc = "" +
	"\n" +
	"9github.com/solo-io/solo-apis/api/gloo/gloo/v1/proxy.proto\x12\fgloo.solo.io\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x19google/protobuf/any.proto\x1a\x12extproto/ext.proto\x1a,github.com/solo-io/solo-kit/api/v1/ref.proto\x1a1github.com/solo-io/solo-kit/api/v1/solo-kit.proto\x1aDgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/listener_options.proto\x1aIgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/http_listener_options.proto\x1aHgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/tcp_listener_options.proto\x1aHgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/virtual_host_options.proto\x1aAgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/route_options.proto\x1aOgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/route_configuration_options.proto\x1aPgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/weighted_destination_options.proto\x1a;github.com/solo-io/solo-apis/api/gloo/gloo/v1/ssl/ssl.proto\x1a:github.com/solo-io/solo-apis/api/gloo/gloo/v1/subset.proto\x1aDgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/destination_spec.proto\x1aBgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/filters/stages.proto\x1aJgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/core/matchers/matchers.proto\x1aVgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/config/core/v3/address.proto\x1aggithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/dynamic_forward_proxy/dynamic_forward_proxy.proto\x1aUgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/type/matcher/v3/regex.proto\"o\n" +
	"\tProxySpec\x12&\n" +
	"\x0ecompressedSpec\x18\x03 \x01(\tR\x0ecompressedSpec\x124\n" +
	"\tlisteners\x18\x02 \x03(\v2\x16.gloo.solo.io.ListenerR\tlistenersJ\x04\b\x06\x10\a\"\xc2\x06\n" +
	"\bListener\x12\x12\n" +
	...
	"\fdata_centers\x18\x03 \x03(\tR\vdataCenters\"`\n" +
	"\x11UpstreamGroupSpec\x12E\n" +
	"\fdestinations\x18\x01 \x03(\v2!.gloo.solo.io.WeightedDestinationR\fdestinationsJ\x04\b\x06\x10\a\"Y\n" +
	...
	"\x06config\x18\x03 \x01(\v2\x14.google.protobuf.AnyR\x06config\"\xd9\x03\n" +
	"\x13UpstreamGroupStatus\x12=\n" +
	"\x05state\x18\x01 \x01(\x0e2'.gloo.solo.io.UpstreamGroupStatus.StateR\x05state\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x1f\n" +
	"\vreported_by\x18\x03 \x01(\tR\n" +
	"reportedBy\x12m\n" +
	"\x14subresource_statuses\x18\x04 \x03(\v2:.gloo.solo.io.UpstreamGroupStatus.SubresourceStatusesEntryR\x13subresourceStatuses\x121\n" +
	"\adetails\x18\x05 \x01(\v2\x17.google.protobuf.StructR\adetails\x1ai\n" +
	"\x18SubresourceStatusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x127\n" +
	"\x05value\x18\x02 \x01(\v2!.gloo.solo.io.UpstreamGroupStatusR\x05value:\x028\x01\"=\n" +
	"\x05State\x12\v\n" +
	"\aPending\x10\x00\x12\f\n" +
	"\bAccepted\x10\x01\x12\f\n" +
	"\bRejected\x10\x02\x12\v\n" +
	"\aWarning\x10\x03\"\xda\x01\n" +
	"\x1fUpstreamGroupNamespacedStatuses\x12W\n" +
	"\bstatuses\x18\x01 \x03(\v2;.gloo.solo.io.UpstreamGroupNamespacedStatuses.StatusesEntryR\bstatuses\x1a^\n" +
	"\rStatusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x127\n" +
	"\x05value\x18\x02 \x01(\v2!.gloo.solo.io.UpstreamGroupStatusR\x05value:\x028\x01\"\xb9\x03\n" +
	"\vProxyStatus\x125\n" +
	"\x05state\x18\x01 \x01(\x0e2\x1f.gloo.solo.io.ProxyStatus.StateR\x05state\x12\x16\n" +
	"\x06reason\x18\x02 \x01(\tR\x06reason\x12\x1f\n" +
	"\vreported_by\x18\x03 \x01(\tR\n" +
	"reportedBy\x12e\n" +
	"\x14subresource_statuses\x18\x04 \x03(\v22.gloo.solo.io.ProxyStatus.SubresourceStatusesEntryR\x13subresourceStatuses\x121\n" +
	"\adetails\x18\x05 \x01(\v2\x17.google.protobuf.StructR\adetails\x1aa\n" +
	"\x18SubresourceStatusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12/\n" +
	"\x05value\x18\x02 \x01(\v2\x19.gloo.solo.io.ProxyStatusR\x05value:\x028\x01\"=\n" +
	"\x05State\x12\v\n" +
	"\aPending\x10\x00\x12\f\n" +
	"\bAccepted\x10\x01\x12\f\n" +
	"\bRejected\x10\x02\x12\v\n" +
	"\aWarning\x10\x03\"\xc2\x01\n" +
	"\x17ProxyNamespacedStatuses\x12O\n" +
	"\bstatuses\x18\x01 \x03(\v23.gloo.solo.io.ProxyNamespacedStatuses.StatusesEntryR\bstatuses\x1aV\n" +
	"\rStatusesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12/\n" +
	"\x05value\x18\x02 \x01(\v2\x19.gloo.solo.io.ProxyStatusR\x05value:\x028\x01BB\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01Z4github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1b\x06proto3"
