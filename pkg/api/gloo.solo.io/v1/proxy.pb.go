...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_proxy_proto_rawDesc = []byte{
	...
	0x72, 0x76, 0x65, 0x64, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xd9,
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_proxy_proto_goTypes = []interface{}{
	...
	(*WeightedDestinationOptions)(nil),           // 53: gloo.solo.io.WeightedDestinationOptions
	(*v31.RegexMatchAndSubstitute)(nil),          // 54: solo.io.envoy.type.matcher.v3.RegexMatchAndSubstitute
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_proxy_proto_depIdxs = []int32{
	...
	53, // 51: gloo.solo.io.WeightedDestination.options:type_name -> gloo.solo.io.WeightedDestinationOptions
	54, // 52: gloo.solo.io.RedirectAction.regex_rewrite:type_name -> solo.io.envoy.type.matcher.v3.RegexMatchAndSubstitute
	0,  // 53: gloo.solo.io.RedirectAction.response_code:type_name -> gloo.solo.io.RedirectAction.RedirectResponseCode
	33, // 54: gloo.solo.io.SourceMetadata.sources:type_name -> gloo.solo.io.SourceMetadata.SourceRef
	1,  // 55: gloo.solo.io.UpstreamGroupStatus.state:type_name -> gloo.solo.io.UpstreamGroupStatus.State
	34, // 56: gloo.solo.io.UpstreamGroupStatus.subresource_statuses:type_name -> gloo.solo.io.UpstreamGroupStatus.SubresourceStatusesEntry
	41, // 57: gloo.solo.io.UpstreamGroupStatus.details:type_name -> google.protobuf.Struct
	35, // 58: gloo.solo.io.UpstreamGroupNamespacedStatuses.statuses:type_name -> gloo.solo.io.UpstreamGroupNamespacedStatuses.StatusesEntry
	2,  // 59: gloo.solo.io.ProxyStatus.state:type_name -> gloo.solo.io.ProxyStatus.State
	36, // 60: gloo.solo.io.ProxyStatus.subresource_statuses:type_name -> gloo.solo.io.ProxyStatus.SubresourceStatusesEntry
	41, // 61: gloo.solo.io.ProxyStatus.details:type_name -> google.protobuf.Struct
	37, // 62: gloo.solo.io.ProxyNamespacedStatuses.statuses:type_name -> gloo.solo.io.ProxyNamespacedStatuses.StatusesEntry
	15, // 63: gloo.solo.io.TcpHost.TcpAction.single:type_name -> gloo.solo.io.Destination
	19, // 64: gloo.solo.io.TcpHost.TcpAction.multi:type_name -> gloo.solo.io.MultiDestination
	48, // 65: gloo.solo.io.TcpHost.TcpAction.upstream_group:type_name -> core.solo.io.ResourceRef
	55, // 66: gloo.solo.io.TcpHost.TcpAction.forward_sni_cluster_name:type_name -> google.protobuf.Empty
	31, // 67: gloo.solo.io.AggregateListener.HttpResources.virtual_hosts:type_name -> gloo.solo.io.AggregateListener.HttpResources.VirtualHostsEntry
	32, // 68: gloo.solo.io.AggregateListener.HttpResources.http_options:type_name -> gloo.solo.io.AggregateListener.HttpResources.HttpOptionsEntry
	10, // 69: gloo.solo.io.AggregateListener.HttpFilterChain.matcher:type_name -> gloo.solo.io.Matcher
	12, // 70: gloo.solo.io.AggregateListener.HttpResources.VirtualHostsEntry.value:type_name -> gloo.solo.io.VirtualHost
	44, // 71: gloo.solo.io.AggregateListener.HttpResources.HttpOptionsEntry.value:type_name -> gloo.solo.io.HttpListenerOptions
	48, // 72: gloo.solo.io.SourceMetadata.SourceRef.resource_ref:type_name -> core.solo.io.ResourceRef
	24, // 73: gloo.solo.io.UpstreamGroupStatus.SubresourceStatusesEntry.value:type_name -> gloo.solo.io.UpstreamGroupStatus
	24, // 74: gloo.solo.io.UpstreamGroupNamespacedStatuses.StatusesEntry.value:type_name -> gloo.solo.io.UpstreamGroupStatus
	26, // 75: gloo.solo.io.ProxyStatus.SubresourceStatusesEntry.value:type_name -> gloo.solo.io.ProxyStatus
	26, // 76: gloo.solo.io.ProxyNamespacedStatuses.StatusesEntry.value:type_name -> gloo.solo.io.ProxyStatus
