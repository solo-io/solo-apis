...
// Clone function
func (m *ProxySpec) Clone() proto.Message {
	var target *ProxySpec
	if m == nil {
		return target
	}
	target = &ProxySpec{}
...
func (m *Listener) Clone() proto.Message {
	...
	if m.GetSslConfigurations() != nil {
		target.SslConfigurations = make([]*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_ssl.SslConfig, len(m.GetSslConfigurations()))
		for idx, v := range m.GetSslConfigurations() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.SslConfigurations[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_ssl.SslConfig)
			} else {
				target.SslConfigurations[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_ssl.SslConfig)
			}
...
func (m *Matcher) Clone() proto.Message {
	...
	if m.GetPrefixRanges() != nil {
		target.PrefixRanges = make([]*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.CidrRange, len(m.GetPrefixRanges()))
		for idx, v := range m.GetPrefixRanges() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.PrefixRanges[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.CidrRange)
			} else {
				target.PrefixRanges[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.CidrRange)
			}
	...
	case *RouteAction_DynamicForwardProxy:
		...
		if h, ok := interface{}(m.GetDynamicForwardProxy()).(clone.Cloner); ok {
			target.Destination = &RouteAction_DynamicForwardProxy{
				DynamicForwardProxy: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_dynamic_forward_proxy.PerRouteConfig),
			}
		} else {
			target.Destination = &RouteAction_DynamicForwardProxy{
				DynamicForwardProxy: proto.Clone(m.GetDynamicForwardProxy()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_options_dynamic_forward_proxy.PerRouteConfig),
			}
		}
...
// Clone function
func (m *UpstreamGroupSpec) Clone() proto.Message {
	var target *UpstreamGroupSpec
	if m == nil {
		return target
	}
	target = &UpstreamGroupSpec{}
...
func (m *UpstreamGroupStatus) Clone() proto.Message {
	...
	if m.GetSubresourceStatuses() != nil {
		target.SubresourceStatuses = make(map[string]*UpstreamGroupStatus, len(m.GetSubresourceStatuses()))
		for k, v := range m.GetSubresourceStatuses() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.SubresourceStatuses[k] = h.Clone().(*UpstreamGroupStatus)
			} else {
				target.SubresourceStatuses[k] = proto.Clone(v).(*UpstreamGroupStatus)
			}
...
// Clone function
func (m *UpstreamGroupNamespacedStatuses) Clone() proto.Message {
	var target *UpstreamGroupNamespacedStatuses
	if m == nil {
		return target
	}
	target = &UpstreamGroupNamespacedStatuses{}

	if m.GetStatuses() != nil {
		target.Statuses = make(map[string]*UpstreamGroupStatus, len(m.GetStatuses()))
		for k, v := range m.GetStatuses() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.Statuses[k] = h.Clone().(*UpstreamGroupStatus)
			} else {
				target.Statuses[k] = proto.Clone(v).(*UpstreamGroupStatus)
			}
...
// Clone function
func (m *ProxyStatus) Clone() proto.Message {
	var target *ProxyStatus
	if m == nil {
		return target
	}
	target = &ProxyStatus{}
	...
	if m.GetSubresourceStatuses() != nil {
		target.SubresourceStatuses = make(map[string]*ProxyStatus, len(m.GetSubresourceStatuses()))
		for k, v := range m.GetSubresourceStatuses() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.SubresourceStatuses[k] = h.Clone().(*ProxyStatus)
			} else {
				target.SubresourceStatuses[k] = proto.Clone(v).(*ProxyStatus)
			}
...
// Clone function
func (m *ProxyNamespacedStatuses) Clone() proto.Message {
	var target *ProxyNamespacedStatuses
	if m == nil {
		return target
	}
	target = &ProxyNamespacedStatuses{}

	if m.GetStatuses() != nil {
		target.Statuses = make(map[string]*ProxyStatus, len(m.GetStatuses()))
		for k, v := range m.GetStatuses() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.Statuses[k] = h.Clone().(*ProxyStatus)
			} else {
				target.Statuses[k] = proto.Clone(v).(*ProxyStatus)
			}
