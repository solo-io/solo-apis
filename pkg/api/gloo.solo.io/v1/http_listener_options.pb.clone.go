	...
	case *HttpListenerOptions_DisableExtProcEarly:
		...
		if h, ok := interface{}(m.GetDisableExtProcEarly()).(clone.Cloner); ok {
			target.ExtProcEarlyConfig = &HttpListenerOptions_DisableExtProcEarly{
				DisableExtProcEarly: h.Clone().(*github_com_golang_protobuf_ptypes_wrappers.BoolValue),
			}
		} else {
			target.ExtProcEarlyConfig = &HttpListenerOptions_DisableExtProcEarly{
				DisableExtProcEarly: proto.Clone(m.GetDisableExtProcEarly()).(*github_com_golang_protobuf_ptypes_wrappers.BoolValue),
			}
		}
	...
	case *HttpListenerOptions_ExtProcEarly:
		...
		if h, ok := interface{}(m.GetExtProcEarly()).(clone.Cloner); ok {
			target.ExtProcEarlyConfig = &HttpListenerOptions_ExtProcEarly{
				ExtProcEarly: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_extproc.Settings),
			}
		} else {
			target.ExtProcEarlyConfig = &HttpListenerOptions_ExtProcEarly{
				ExtProcEarly: proto.Clone(m.GetExtProcEarly()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_extproc.Settings),
			}
		}
	...
	case *HttpListenerOptions_DisableExtProcLate:
		...
		if h, ok := interface{}(m.GetDisableExtProcLate()).(clone.Cloner); ok {
			target.ExtProcLateConfig = &HttpListenerOptions_DisableExtProcLate{
				DisableExtProcLate: h.Clone().(*github_com_golang_protobuf_ptypes_wrappers.BoolValue),
			}
		} else {
			target.ExtProcLateConfig = &HttpListenerOptions_DisableExtProcLate{
				DisableExtProcLate: proto.Clone(m.GetDisableExtProcLate()).(*github_com_golang_protobuf_ptypes_wrappers.BoolValue),
			}
		}
	...
	case *HttpListenerOptions_ExtProcLate:
		...
		if h, ok := interface{}(m.GetExtProcLate()).(clone.Cloner); ok {
			target.ExtProcLateConfig = &HttpListenerOptions_ExtProcLate{
				ExtProcLate: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_extproc.Settings),
			}
		} else {
			target.ExtProcLateConfig = &HttpListenerOptions_ExtProcLate{
				ExtProcLate: proto.Clone(m.GetExtProcLate()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_extproc.Settings),
			}
		}
