...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_filters_stages_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_filters_stages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_filters_stages_proto_msgTypes[0].Exporter = func(v any, i int) any {
