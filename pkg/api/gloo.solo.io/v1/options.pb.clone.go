...
import (
	...
	github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_statefulsession "github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/enterprise/options/statefulsession"
...
func (m *HttpListenerOptions) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetStatefulSession()).(clone.Cloner); ok {
		target.StatefulSession = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_statefulsession.StatefulSession)
	} else {
		target.StatefulSession = proto.Clone(m.GetStatefulSession()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_v1_enterprise_options_statefulsession.StatefulSession)
	}
