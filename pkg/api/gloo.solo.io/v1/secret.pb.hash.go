...
func (m *Secret) Hash(hasher hash.Hash64) (uint64, error) {
	...
	case *Secret_Credentials:
		...
		if h, ok := interface{}(m.GetCredentials()).(safe_hasher.SafeHasher); ok {
			...
			if val, err := hashstructure.Hash(m.GetCredentials(), nil); err != nil {
				return 0, err
			} else {
				if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
					return 0, err
...
func (m *AccountCredentialsSecret) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1.AccountCredentialsSecret")); err != nil {
		return 0, err
	}
...
func (m *EncryptionKeySecret) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1.EncryptionKeySecret")); err != nil {
		return 0, err
	}
