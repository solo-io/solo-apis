...
func (m *Listener) Hash(hasher hash.Hash64) (uint64, error) {
	...
	case *Listener_HybridListener:
		...
		if h, ok := interface{}(m.GetHybridListener()).(safe_hasher.SafeHasher); ok {
			...
			if val, err := hashstructure.Hash(m.GetHybridListener(), nil); err != nil {
				return 0, err
			} else {
				if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
					return 0, err
	...
	case *Listener_AggregateListener:
		...
		if h, ok := interface{}(m.GetAggregateListener()).(safe_hasher.SafeHasher); ok {
			...
			if val, err := hashstructure.Hash(m.GetAggregateListener(), nil); err != nil {
				return 0, err
			} else {
				if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
					return 0, err
...
func (m *AggregateListener) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetHttpResources()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetHttpResources(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
...
func (m *Route) Hash(hasher hash.Hash64) (uint64, error) {
	...
	case *Route_GraphqlApiRef:
		...
		if h, ok := interface{}(m.GetGraphqlApiRef()).(safe_hasher.SafeHasher); ok {
			...
			if val, err := hashstructure.Hash(m.GetGraphqlApiRef(), nil); err != nil {
				return 0, err
			} else {
				if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
					return 0, err
...
func (m *RedirectAction) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetPortRedirect()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetPortRedirect(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
...
func (m *SourceMetadata_SourceRef) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetResourceRef()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetResourceRef(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
