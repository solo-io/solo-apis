...
func (m *OpenTelemetryGrpcCollector) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("als.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/als.OpenTelemetryGrpcCollector")); err != nil {
		return 0, err
	}
...
func (m *OpenTelemetryService) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("als.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/als.OpenTelemetryService")); err != nil {
		return 0, err
	}
