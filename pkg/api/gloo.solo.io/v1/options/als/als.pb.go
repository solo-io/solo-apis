...
func (x *AccessLog) GetOpenTelemetryService() *OpenTelemetryService {
	if x, ok := x.GetOutputDestination().(*AccessLog_OpenTelemetryService); ok {
...
func (m *OpenTelemetryService) GetDestination() isOpenTelemetryService_Destination {
	if m != nil {
...
func (x *OpenTelemetryService) GetCollector() *OpenTelemetryGrpcCollector {
	if x, ok := x.GetDestination().(*OpenTelemetryService_Collector); ok {
		return x.Collector
	}
	return nil
}
