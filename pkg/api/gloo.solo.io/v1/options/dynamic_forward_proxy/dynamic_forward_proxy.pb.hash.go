...
func (m *FilterConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dfp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/dynamic_forward_proxy.FilterConfig")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetDnsCacheConfig()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetDnsCacheConfig(), nil); err != nil {
			return 0, err
		} else {
...
func (m *DnsCacheCircuitBreakers) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dfp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/dynamic_forward_proxy.DnsCacheCircuitBreakers")); err != nil {
		return 0, err
	}
...
func (m *DnsCacheConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dfp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/dynamic_forward_proxy.DnsCacheConfig")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetHostTtl()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetHostTtl(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
	...
	if h, ok := interface{}(m.GetMaxHosts()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetMaxHosts(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
	...
	if h, ok := interface{}(m.GetDnsCacheCircuitBreaker()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetDnsCacheCircuitBreaker(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
	...
	if h, ok := interface{}(m.GetDnsQueryTimeout()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetDnsQueryTimeout(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
	...
	case *DnsCacheConfig_CaresDns:
		...
		if h, ok := interface{}(m.GetCaresDns()).(safe_hasher.SafeHasher); ok {
			...
			if val, err := hashstructure.Hash(m.GetCaresDns(), nil); err != nil {
				return 0, err
			} else {
				if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
					return 0, err
	...
	case *DnsCacheConfig_AppleDns:
		...
		if h, ok := interface{}(m.GetAppleDns()).(safe_hasher.SafeHasher); ok {
			...
			if val, err := hashstructure.Hash(m.GetAppleDns(), nil); err != nil {
				return 0, err
			} else {
				if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
					return 0, err
...
func (m *RefreshRate) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dfp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/dynamic_forward_proxy.RefreshRate")); err != nil {
		return 0, err
	}
...
func (m *PerRouteConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dfp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/dynamic_forward_proxy.PerRouteConfig")); err != nil {
		return 0, err
	}
...
func (m *DnsResolverOptions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dfp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/dynamic_forward_proxy.DnsResolverOptions")); err != nil {
		return 0, err
	}
...
func (m *CaresDnsResolverConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dfp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/dynamic_forward_proxy.CaresDnsResolverConfig")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetDnsResolverOptions()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetDnsResolverOptions(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
...
func (m *AppleDnsResolverConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("dfp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/dynamic_forward_proxy.AppleDnsResolverConfig")); err != nil {
		return 0, err
	}
