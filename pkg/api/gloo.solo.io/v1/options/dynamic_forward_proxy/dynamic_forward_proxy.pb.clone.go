...
func (m *DnsCacheConfig) Clone() proto.Message {
	...
	if m.GetPreresolveHostnames() != nil {
		target.PreresolveHostnames = make([]*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.SocketAddress, len(m.GetPreresolveHostnames()))
		for idx, v := range m.GetPreresolveHostnames() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.PreresolveHostnames[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.SocketAddress)
			} else {
				target.PreresolveHostnames[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.SocketAddress)
			}
...
func (m *CaresDnsResolverConfig) Clone() proto.Message {
	...
	if m.GetResolvers() != nil {
		target.Resolvers = make([]*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.Address, len(m.GetResolvers()))
		for idx, v := range m.GetResolvers() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.Resolvers[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.Address)
			} else {
				target.Resolvers[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.Address)
			}
