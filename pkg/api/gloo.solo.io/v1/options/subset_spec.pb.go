...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_subset_spec_proto_rawDesc = []byte{
	...
	0x41, 0x4c, 0x4c, 0x42, 0x41, 0x43, 0x4b, 0x10, 0x02, 0x42, 0x46, 0xb8, 0xf5, 0x04, 0x01, 0xc0,
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_subset_spec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_subset_spec_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Subset); i {
			case 0:
				return &v.state
			case 1:
