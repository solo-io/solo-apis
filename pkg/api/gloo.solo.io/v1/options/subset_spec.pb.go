...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_subset_spec_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_subset_spec_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_subset_spec_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_subset_spec_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Subset); i {
			case 0:
				return &v.state
			case 1:
