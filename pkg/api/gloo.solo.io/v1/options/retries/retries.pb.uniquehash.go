...
func (m *RetryBackOff) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("retries.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/retries.RetryBackOff")); err != nil {
		return 0, err
	}
...
func (m *ResetHeader) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("retries.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/retries.ResetHeader")); err != nil {
		return 0, err
	}
...
func (m *RateLimitedRetryBackOff) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("retries.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/retries.RateLimitedRetryBackOff")); err != nil {
		return 0, err
	}
...
func (m *RetryPolicy_PreviousPriorities) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("retries.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/retries.RetryPolicy_PreviousPriorities")); err != nil {
		return 0, err
	}
