...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_retries_retries_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_retries_retries_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_retries_retries_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_retries_retries_proto_msgTypes[1].OneofWrappers = []interface{}{
