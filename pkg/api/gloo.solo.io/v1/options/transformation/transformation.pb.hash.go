...
func (m *MergeJsonKeys) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("transformation.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/transformation.MergeJsonKeys")); err != nil {
		return 0, err
	}
...
func (m *TransformationTemplate_SpanTransformer) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("transformation.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/transformation.TransformationTemplate_SpanTransformer")); err != nil {
		return 0, err
	}
...
func (m *MergeJsonKeys_OverridableTemplate) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("transformation.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/transformation.MergeJsonKeys_OverridableTemplate")); err != nil {
		return 0, err
	}
