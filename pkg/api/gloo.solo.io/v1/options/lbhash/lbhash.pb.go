...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_rawDesc = "" +
	"\n" +
	"Igithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/lbhash/lbhash.proto\x12\x1blbhash.options.gloo.solo.io\x1a\x1egoogle/protobuf/duration.proto\x1a\x12extproto/ext.proto\"e\n" +
	...
	"\aKeyTypeBQ\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01ZCgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/lbhashb\x06proto3"

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_rawDescData []byte
)
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_rawDesc)))
	})
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_init() {
	...
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_msgTypes[2].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_lbhash_lbhash_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
