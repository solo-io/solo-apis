...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_kubernetes_kubernetes_proto_rawDesc = "" +
	"\n" +
	"Qgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/kubernetes/kubernetes.proto\x12\x1fkubernetes.options.gloo.solo.io\x1a\x12extproto/ext.proto\x1aHgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/service_spec.proto\x1aGgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/subset_spec.proto\"\xa0\x03\n" +
	"\fUpstreamSpec\x12!\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01BU\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01ZGgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/kubernetesb\x06proto3"

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_kubernetes_kubernetes_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_kubernetes_kubernetes_proto_rawDescData []byte
)
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_kubernetes_kubernetes_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_kubernetes_kubernetes_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_kubernetes_kubernetes_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_kubernetes_kubernetes_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
