...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_tcp_tcp_proto_rawDesc = string([]byte{
...
var (
	...
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_tcp_tcp_proto_rawDescData []byte
)
