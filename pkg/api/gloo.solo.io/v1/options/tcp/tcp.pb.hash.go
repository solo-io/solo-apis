...
func (m *TcpProxySettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetAccessLogFlushInterval()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetAccessLogFlushInterval(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
...
func (m *HeaderValueOption) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tcp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/tcp.HeaderValueOption")); err != nil {
		return 0, err
	}
...
func (m *HeaderValue) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tcp.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/tcp.HeaderValue")); err != nil {
		return 0, err
	}
