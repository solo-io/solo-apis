...
func (m *FilterConfig) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("adaptive_concurrency.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/adaptive_concurrency.FilterConfig")); err != nil {
		return 0, err
	}
...
func (m *FilterConfig_MinRoundtripTimeCalculationParams) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("adaptive_concurrency.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/adaptive_concurrency.FilterConfig_MinRoundtripTimeCalculationParams")); err != nil {
		return 0, err
	}
...
func (m *FilterConfig_ConcurrencyLimitCalculationParams) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("adaptive_concurrency.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/adaptive_concurrency.FilterConfig_ConcurrencyLimitCalculationParams")); err != nil {
		return 0, err
	}
