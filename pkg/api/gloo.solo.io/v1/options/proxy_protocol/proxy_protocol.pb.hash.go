...
func (m *ProxyProtocol) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("proxy_protocol.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/proxy_protocol.ProxyProtocol")); err != nil {
		return 0, err
	}
...
func (m *ProxyProtocol_KeyValuePair) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("proxy_protocol.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/proxy_protocol.ProxyProtocol_KeyValuePair")); err != nil {
		return 0, err
	}
...
func (m *ProxyProtocol_Rule) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("proxy_protocol.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/proxy_protocol.ProxyProtocol_Rule")); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetOnTlvPresent()).(safe_hasher.SafeHasher); ok {
		...
		if val, err := hashstructure.Hash(m.GetOnTlvPresent(), nil); err != nil {
			return 0, err
		} else {
			if err := binary.Write(hasher, binary.LittleEndian, val); err != nil {
				return 0, err
