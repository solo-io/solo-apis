...
func (this *UpstreamSpec) MarshalJSON() ([]byte, error) {
	str, err := ConsulMarshaler.MarshalToString(this)
	return []byte(str), err
}

// UnmarshalJSON is a custom unmarshaler for UpstreamSpec
func (this *UpstreamSpec) UnmarshalJSON(b []byte) error {
	return ConsulUnmarshaler.Unmarshal(bytes.NewReader(b), this)
}

var (
	ConsulMarshaler   = &github_com_gogo_protobuf_jsonpb.Marshaler{EnumsAsInts: true}
	ConsulUnmarshaler = &github_com_gogo_protobuf_jsonpb.Unmarshaler{}
)
