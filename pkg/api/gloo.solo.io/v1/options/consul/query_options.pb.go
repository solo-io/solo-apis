...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_consul_query_options_proto_rawDesc = "" +
	"\n" +
	"Pgithub.com/solo-io/solo-apis/api/gloo/gloo/v1/options/consul/query_options.proto\x12\x1bconsul.options.gloo.solo.io\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x12extproto/ext.proto\"G\n" +
	"\fQueryOptions\x127\n" +
	...
	"\x0eConsistentMode\x10\x02BQ\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01ZCgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/consulb\x06proto3"

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_consul_query_options_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_consul_query_options_proto_rawDescData []byte
)
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_consul_query_options_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_consul_query_options_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_consul_query_options_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_v1_options_consul_query_options_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
