...
func (m *GrpcJsonTranscoder_DescriptorConfigMap) HashUnique(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("grpc_json.options.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/v1/options/grpc_json.GrpcJsonTranscoder_DescriptorConfigMap")); err != nil {
		return 0, err
	}
