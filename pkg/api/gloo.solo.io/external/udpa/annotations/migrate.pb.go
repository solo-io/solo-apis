...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_udpa_annotations_migrate_proto_rawDesc = "" +
	"\n" +
	"Rgithub.com/solo-io/solo-apis/api/gloo/gloo/external/udpa/annotations/migrate.proto\x12\x18solo.io.udpa.annotations\x1a google/protobuf/descriptor.proto\"+\n" +
	...
	"\x0fmove_to_package\x18\x02 \x01(\tR\rmoveToPackage:x\n" +
	"\x0fmessage_migrate\x12\x1f.google.protobuf.MessageOptions\x18\xa0\xf1\xdaE \x01(\v2+.solo.io.udpa.annotations.MigrateAnnotationR\x0emessageMigrate:w\n" +
	"\rfield_migrate\x12\x1d.google.protobuf.FieldOptions\x18\xa0\xf1\xdaE \x01(\v20.solo.io.udpa.annotations.FieldMigrateAnnotationR\ffieldMigrate:o\n" +
	"\fenum_migrate\x12\x1c.google.protobuf.EnumOptions\x18\xa0\xf1\xdaE \x01(\v2+.solo.io.udpa.annotations.MigrateAnnotationR\venumMigrate:\x7f\n" +
	"\x12enum_value_migrate\x12!.google.protobuf.EnumValueOptions\x18\xa0\xf1\xdaE \x01(\v2+.solo.io.udpa.annotations.MigrateAnnotationR\x10enumValueMigrate:s\n" +
	"\ffile_migrate\x12\x1c.google.protobuf.FileOptions\x18\xa0\xf1\xdaE \x01(\v2/.solo.io.udpa.annotations.FileMigrateAnnotationR\vfileMigrateBMZKgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/udpa/annotationsb\x06proto3"

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_udpa_annotations_migrate_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_udpa_annotations_migrate_proto_rawDescData []byte
)
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_external_udpa_annotations_migrate_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_external_udpa_annotations_migrate_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_udpa_annotations_migrate_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_udpa_annotations_migrate_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 5,
			NumServices:   0,
