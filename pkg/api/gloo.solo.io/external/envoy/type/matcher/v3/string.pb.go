...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_matcher_v3_string_proto_rawDesc = "" +
	"\n" +
	"Vgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/type/matcher/v3/string.proto\x12\x1dsolo.io.envoy.type.matcher.v3\x1aUgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/type/matcher/v3/regex.proto\x1a#envoy/annotations/deprecation.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\x1a\x12extproto/ext.proto\"\xb3\x02\n" +
	...
	"$envoy.type.matcher.ListStringMatcherB\xa2\x01\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01\xe2\xb5\xdf\xcb\a\x02\x10\x02\n" +
	"+io.envoyproxy.solo.io.envoy.type.matcher.v3B\vStringProtoP\x01ZPgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/type/matcher/v3b\x06proto3"

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_matcher_v3_string_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_matcher_v3_string_proto_rawDescData []byte
)
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_matcher_v3_string_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_matcher_v3_string_proto_init() {
	...
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_matcher_v3_string_proto_msgTypes[0].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_matcher_v3_string_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_matcher_v3_string_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
