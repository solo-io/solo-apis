...
func (m *Int64Range) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.type.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/type.Int64Range")); err != nil {
		return 0, err
	}
...
func (m *DoubleRange) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.type.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/type.DoubleRange")); err != nil {
		return 0, err
	}
