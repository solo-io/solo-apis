...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_rawDesc = "" +
	"\n" +
	"Ogithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/type/v3/percent.proto\x12\x15solo.io.envoy.type.v3\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\x1a\x12extproto/ext.proto\"]\n" +
	"\aPercent\x12-\n" +
	...
	"\x1cenvoy.type.FractionalPercentB\x93\x01\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01\xe2\xb5\xdf\xcb\a\x02\x10\x02\n" +
	"#io.envoyproxy.solo.io.envoy.type.v3B\fPercentProtoP\x01ZHgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/type/v3b\x06proto3"

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_rawDescData []byte
)
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_rawDesc)))
	})
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_type_v3_percent_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
