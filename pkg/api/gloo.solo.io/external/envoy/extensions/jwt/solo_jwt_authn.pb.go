...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_jwt_solo_jwt_authn_proto_rawDesc = "" +
	"\n" +
	"]github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/extensions/jwt/solo_jwt_authn.proto\x12*envoy.config.filter.http.solo_jwt_authn.v2\x1a\x17validate/validate.proto\x1akgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/extensions/filters/http/jwt_authn/v3/config.proto\"\x91\x01\n" +
	"\fJwtWithStage\x12b\n" +
	...
	"\x05value\x18\x02 \x01(\v2@.envoy.config.filter.http.solo_jwt_authn.v2.SoloJwtAuthnPerRouteR\x05value:\x028\x01B\xa0\x01\n" +
	"8io.envoyproxy.envoy.config.filter.http.solo_jwt_authn.v2B\x11SoloJwtAuthnProtoP\x01ZOgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/extensions/jwtb\x06proto3"

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_jwt_solo_jwt_authn_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_jwt_solo_jwt_authn_proto_rawDescData []byte
)
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_jwt_solo_jwt_authn_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_jwt_solo_jwt_authn_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_jwt_solo_jwt_authn_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_jwt_solo_jwt_authn_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
