...
func (m *AWSLambdaPerRoute) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetTransformerConfig()).(clone.Cloner); ok {
		target.TransformerConfig = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.TypedExtensionConfig)
	} else {
		target.TransformerConfig = proto.Clone(m.GetTransformerConfig()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.TypedExtensionConfig)
	}

	if h, ok := interface{}(m.GetRequestTransformerConfig()).(clone.Cloner); ok {
		target.RequestTransformerConfig = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.TypedExtensionConfig)
	} else {
		target.RequestTransformerConfig = proto.Clone(m.GetRequestTransformerConfig()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_config_core_v3.TypedExtensionConfig)
	}
