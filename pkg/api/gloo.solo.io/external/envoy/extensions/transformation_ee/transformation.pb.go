...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_transformation_ee_transformation_proto_rawDesc = "" +
	"\n" +
	"kgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/extensions/transformation_ee/transformation.proto\x12-envoy.config.filter.http.transformation_ee.v2\x1a\x17validate/validate.proto\x1a\x1eenvoy/api/v2/route/route.proto\x1aAgithub.com/solo-io/solo-kit/api/external/envoy/type/percent.proto\x1a`github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/config/route/v3/route_components.proto\"\x84\x01\n" +
	...
	"\bsubgroup\x18\x02 \x01(\rR\bsubgroupB\xbb\x01\n" +
	";io.envoyproxy.envoy.config.filter.http.transformation_ee.v2B\x1bTransformationEEFilterProtoP\x01Z]github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/extensions/transformation_eeb\x06proto3"
