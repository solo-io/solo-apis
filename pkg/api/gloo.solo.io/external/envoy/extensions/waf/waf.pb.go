...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_waf_waf_proto_rawDesc = "" +
	"\n" +
	"Rgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/extensions/waf/waf.proto\x12'envoy.config.filter.http.modsecurity.v2\x1a\x12extproto/ext.proto\x1akgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/extensions/transformation_ee/transformation.proto\"\xc8\x02\n" +
	"\fAuditLogging\x12\\\n" +
	...
	"\x12dlp_transformation\x18\b \x01(\v2@.envoy.config.filter.http.transformation_ee.v2.DlpTransformationR\x11dlpTransformationB]\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01ZOgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/extensions/wafb\x06proto3"
