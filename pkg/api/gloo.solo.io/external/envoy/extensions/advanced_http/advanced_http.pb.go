...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_advanced_http_advanced_http_proto_rawDesc = "" +
	"\n" +
	"fgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/extensions/advanced_http/advanced_http.proto\x12,envoy.config.health_checker.advanced_http.v2\x1a\x1dudpa/annotations/status.proto\x1a[github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/config/core/v3/health_check.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x17validate/validate.proto\"\xe8\x01\n" +
	"\fAdvancedHttp\x12e\n" +
	...
	"\tunhealthy\x10\x02B\xa7\x01\n" +
	":io.envoyproxy.envoy.config.health_checker.advanced_http.v2B\fAdvancedHttpP\x01ZYgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/extensions/advanced_httpb\x06proto3"
...
var (
	...
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_advanced_http_advanced_http_proto_rawDescData []byte
)
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_advanced_http_advanced_http_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_advanced_http_advanced_http_proto_init() {
	...
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_advanced_http_advanced_http_proto_msgTypes[3].OneofWrappers = []any{
		(*ResponseMatch_Header)(nil),
		(*ResponseMatch_Body)(nil),
	}
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_advanced_http_advanced_http_proto_msgTypes[5].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_advanced_http_advanced_http_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_advanced_http_advanced_http_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
