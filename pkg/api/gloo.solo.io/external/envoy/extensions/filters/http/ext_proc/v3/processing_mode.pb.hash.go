...
func (m *ProcessingMode) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.extensions.filters.http.ext_proc.v3.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/extensions/filters/http/ext_proc/v3.ProcessingMode")); err != nil {
		return 0, err
	}
