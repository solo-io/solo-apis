...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_extensions_graphql_graphql_proto_rawDesc = "" +
	"\n" +
	"Zgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/extensions/graphql/graphql.proto\x12#envoy.config.filter.http.graphql.v2\"0\n" +
	...
	"server_uriR\arequestR\tspan_nameJ\x04\b\x01\x10\x02J\x04\b\x02\x10\x03R\x05localR\x06remoteB\xae\x01\n" +
