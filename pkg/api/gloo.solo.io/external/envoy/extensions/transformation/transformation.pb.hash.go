...
func (m *MergeJsonKeys) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.filter.http.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/extensions/transformation.MergeJsonKeys")); err != nil {
		return 0, err
	}
...
func (m *TransformationTemplate_SpanTransformer) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.filter.http.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/extensions/transformation.TransformationTemplate_SpanTransformer")); err != nil {
		return 0, err
	}
...
func (m *MergeJsonKeys_OverridableTemplate) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.api.v2.filter.http.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/extensions/transformation.MergeJsonKeys_OverridableTemplate")); err != nil {
		return 0, err
	}
