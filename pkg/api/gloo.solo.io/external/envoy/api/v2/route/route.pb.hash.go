...
func (m *RouteMatch_ConnectMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.api.v2.route.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/api/v2/route.RouteMatch_ConnectMatcher")); err != nil {
		return 0, err
	}
