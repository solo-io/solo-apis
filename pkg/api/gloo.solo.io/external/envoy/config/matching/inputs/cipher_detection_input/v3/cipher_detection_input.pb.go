...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_matching_inputs_cipher_detection_input_v3_cipher_detection_input_proto_rawDesc = "" +
	"\n" +
	"\x87\x01github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/config/matching/inputs/cipher_detection_input/v3/cipher_detection_input.proto\x12/envoy.config.matching.cipher_detection_input.v3\x1a\x1dudpa/annotations/status.proto\x1a\x17validate/validate.proto\x1a\x12extproto/ext.proto\"x\n" +
	"\x14CipherDetectionInput\x12/\n" +
	"\x13passthrough_ciphers\x18\x01 \x03(\rR\x12passthroughCiphers\x12/\n" +
	"\x13terminating_ciphers\x18\x02 \x03(\rR\x12terminatingCiphersB\xdc\x01\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01\xe2\xb5\xdf\xcb\a\x02\x10\x02\n" +
	"=io.envoyproxy.envoy.config.matching.cipher_detection_input.v3B\x12NetworkInputsProtoP\x01Zqgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/config/matching/inputs/cipher_detection_input/v3b\x06proto3"
...
var (
	...
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_matching_inputs_cipher_detection_input_v3_cipher_detection_input_proto_rawDescData []byte
)
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_matching_inputs_cipher_detection_input_v3_cipher_detection_input_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_matching_inputs_cipher_detection_input_v3_cipher_detection_input_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_matching_inputs_cipher_detection_input_v3_cipher_detection_input_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_matching_inputs_cipher_detection_input_v3_cipher_detection_input_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
