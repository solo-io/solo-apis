...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_matching_custom_matchers_server_name_v3_server_name_matcher_proto_rawDesc = "" +
	"\n" +
	"\x82\x01github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/config/matching/custom_matchers/server_name/v3/server_name_matcher.proto\x124envoy.config.matching.custom_matchers.server_name.v3\x1a\x17validate/validate.proto\x1a!xds/type/matcher/v3/matcher.proto\x1a\x12extproto/ext.proto\"\xab\x02\n" +
	...
	"\bon_match\x18\x02 \x01(\v2$.xds.type.matcher.v3.Matcher.OnMatchR\aonMatchB\xd4\x01\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01\n" +
	";com.github.xds.type.matching.custom_matchers.server_name.v3B\x16ServerNameMatcherProtoP\x01Zogithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/config/matching/custom_matchers/server_name/v3b\x06proto3"
