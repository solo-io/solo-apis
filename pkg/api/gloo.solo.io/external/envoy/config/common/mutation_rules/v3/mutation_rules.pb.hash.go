...
func (m *HeaderMutationRules) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.common.mutation_rules.v3.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/config/common/mutation_rules/v3.HeaderMutationRules")); err != nil {
		return 0, err
	}
...
func (m *HeaderMutation) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.common.mutation_rules.v3.github.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/config/common/mutation_rules/v3.HeaderMutation")); err != nil {
		return 0, err
	}
