...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_filter_listener_tls_cipher_inspector_v3_tls_cipher_inspector_proto_rawDesc = "" +
	"\n" +
	"\x83\x01github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/config/filter/listener/tls_cipher_inspector/v3/tls_cipher_inspector.proto\x124envoy.config.filter.listener.tls_cipher_inspector.v3\x1a\x1dudpa/annotations/status.proto\x1a\x12extproto/ext.proto\"\x14\n" +
	"\x12TlsCipherInspectorB\xe4\x01\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01\xe2\xb5\xdf\xcb\a\x02\x10\x02\n" +
	"Bio.envoyproxy.envoy.config.filter.listener.tls_cipher_inspector.v3B\x17TlsCipherInspectorProtoP\x01Zogithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/config/filter/listener/tls_cipher_inspector/v3b\x06proto3"
...
var (
	...
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_filter_listener_tls_cipher_inspector_v3_tls_cipher_inspector_proto_rawDescData []byte
)
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_filter_listener_tls_cipher_inspector_v3_tls_cipher_inspector_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_filter_listener_tls_cipher_inspector_v3_tls_cipher_inspector_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_filter_listener_tls_cipher_inspector_v3_tls_cipher_inspector_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_filter_listener_tls_cipher_inspector_v3_tls_cipher_inspector_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
