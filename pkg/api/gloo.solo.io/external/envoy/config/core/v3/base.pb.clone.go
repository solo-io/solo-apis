...
func (m *BuildVersion) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetVersion()).(clone.Cloner); ok {
		target.Version = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_type_v3.SemanticVersion)
	} else {
		target.Version = proto.Clone(m.GetVersion()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_type_v3.SemanticVersion)
	}
...
func (m *RuntimeFractionalPercent) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetDefaultValue()).(clone.Cloner); ok {
		target.DefaultValue = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_type_v3.FractionalPercent)
	} else {
		target.DefaultValue = proto.Clone(m.GetDefaultValue()).(*github_com_solo_io_solo_apis_pkg_api_gloo_solo_io_external_envoy_type_v3.FractionalPercent)
	}
