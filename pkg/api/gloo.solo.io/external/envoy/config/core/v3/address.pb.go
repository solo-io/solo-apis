...
const file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_address_proto_rawDesc = "" +
	"\n" +
	"Vgithub.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/config/core/v3/address.proto\x12\x1csolo.io.envoy.config.core.v3\x1a\\github.com/solo-io/solo-apis/api/gloo/gloo/external/envoy/config/core/v3/socket_option.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1dudpa/annotations/status.proto\x1a!udpa/annotations/versioning.proto\x1a\x17validate/validate.proto\x1a\x12extproto/ext.proto\"i\n" +
	"\x04Pipe\x12\x1b\n" +
	...
	"#solo.io.envoy.api.v2.core.CidrRangeB\xa1\x01\xb8\xf5\x04\x01\xc0\xf5\x04\x01\xd0\xf5\x04\x01\xe2\xb5\xdf\xcb\a\x02\x10\x02\n" +
	"*io.envoyproxy.solo.io.envoy.config.core.v3B\fAddressProtoP\x01ZOgithub.com/solo-io/solo-apis/pkg/api/gloo.solo.io/external/envoy/config/core/v3b\x06proto3"

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_address_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_address_proto_rawDescData []byte
)
...
func file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_address_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_address_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_gloo_external_envoy_config_core_v3_address_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
