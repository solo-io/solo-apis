...
func (m *AccessLogPolicyStatus) Clone() proto.Message {
	...
	if m.GetSelectedWorkloadRefs() != nil {
		target.SelectedWorkloadRefs = make([]*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.WorkloadReference, len(m.GetSelectedWorkloadRefs()))
		for idx, v := range m.GetSelectedWorkloadRefs() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.SelectedWorkloadRefs[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.WorkloadReference)
			} else {
				target.SelectedWorkloadRefs[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.WorkloadReference)
			}
	...
	case *AccessLogPolicySpec_Config_Filter_StatusCodeMatcher:
		...
		if h, ok := interface{}(m.GetStatusCodeMatcher()).(clone.Cloner); ok {
			target.Type = &AccessLogPolicySpec_Config_Filter_StatusCodeMatcher{
				StatusCodeMatcher: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.StatusCodeMatcher),
			}
		} else {
			target.Type = &AccessLogPolicySpec_Config_Filter_StatusCodeMatcher{
				StatusCodeMatcher: proto.Clone(m.GetStatusCodeMatcher()).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.StatusCodeMatcher),
			}
		}
	...
	case *AccessLogPolicySpec_Config_Filter_HeaderMatcher:
		...
		if h, ok := interface{}(m.GetHeaderMatcher()).(clone.Cloner); ok {
			target.Type = &AccessLogPolicySpec_Config_Filter_HeaderMatcher{
				HeaderMatcher: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.HeaderMatcher),
			}
		} else {
			target.Type = &AccessLogPolicySpec_Config_Filter_HeaderMatcher{
				HeaderMatcher: proto.Clone(m.GetHeaderMatcher()).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.HeaderMatcher),
			}
		}
