...
type FailoverPolicySet interface {
	...
	List(filterResource ...func(*resilience_gloo_solo_io_v2.FailoverPolicy) bool) []*resilience_gloo_solo_io_v2.FailoverPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*resilience_gloo_solo_io_v2.FailoverPolicy) bool) []*resilience_gloo_solo_io_v2.FailoverPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*resilience_gloo_solo_io_v2.FailoverPolicy
	// Insert a resource into the set.
	Insert(failoverPolicy ...*resilience_gloo_solo_io_v2.FailoverPolicy)
	...
	Find(id ezkube.ResourceId) (*resilience_gloo_solo_io_v2.FailoverPolicy, error)
...
func makeGenericFailoverPolicySet(failoverPolicyList []*resilience_gloo_solo_io_v2.FailoverPolicy) sksets.ResourceSet {
...
func NewFailoverPolicySet(failoverPolicyList ...*resilience_gloo_solo_io_v2.FailoverPolicy) FailoverPolicySet {
	return &failoverPolicySet{set: makeGenericFailoverPolicySet(failoverPolicyList)}
}

func NewFailoverPolicySetFromList(failoverPolicyList *resilience_gloo_solo_io_v2.FailoverPolicyList) FailoverPolicySet {
	list := make([]*resilience_gloo_solo_io_v2.FailoverPolicy, 0, len(failoverPolicyList.Items))
...
func (s *failoverPolicySet) List(filterResource ...func(*resilience_gloo_solo_io_v2.FailoverPolicy) bool) []*resilience_gloo_solo_io_v2.FailoverPolicy {
	if s == nil {
		return nil
	}
	...
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*resilience_gloo_solo_io_v2.FailoverPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	failoverPolicyList := make([]*resilience_gloo_solo_io_v2.FailoverPolicy, 0, len(objs))
	for _, obj := range objs {
		failoverPolicyList = append(failoverPolicyList, obj.(*resilience_gloo_solo_io_v2.FailoverPolicy))
	}
	return failoverPolicyList
}

func (s *failoverPolicySet) UnsortedList(filterResource ...func(*resilience_gloo_solo_io_v2.FailoverPolicy) bool) []*resilience_gloo_solo_io_v2.FailoverPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var failoverPolicyList []*resilience_gloo_solo_io_v2.FailoverPolicy
...
func (s *failoverPolicySet) Map() map[string]*resilience_gloo_solo_io_v2.FailoverPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*resilience_gloo_solo_io_v2.FailoverPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*resilience_gloo_solo_io_v2.FailoverPolicy)
	}
	return newMap
}

func (s *failoverPolicySet) Insert(
	failoverPolicyList ...*resilience_gloo_solo_io_v2.FailoverPolicy,
) {
	if s == nil {
...
func (s *failoverPolicySet) Find(id ezkube.ResourceId) (*resilience_gloo_solo_io_v2.FailoverPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find FailoverPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&resilience_gloo_solo_io_v2.FailoverPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*resilience_gloo_solo_io_v2.FailoverPolicy), nil
}
...
type OutlierDetectionPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*resilience_gloo_solo_io_v2.OutlierDetectionPolicy) bool) []*resilience_gloo_solo_io_v2.OutlierDetectionPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*resilience_gloo_solo_io_v2.OutlierDetectionPolicy) bool) []*resilience_gloo_solo_io_v2.OutlierDetectionPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*resilience_gloo_solo_io_v2.OutlierDetectionPolicy
	// Insert a resource into the set.
	Insert(outlierDetectionPolicy ...*resilience_gloo_solo_io_v2.OutlierDetectionPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*resilience_gloo_solo_io_v2.OutlierDetectionPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericOutlierDetectionPolicySet(outlierDetectionPolicyList []*resilience_gloo_solo_io_v2.OutlierDetectionPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewOutlierDetectionPolicySet(outlierDetectionPolicyList ...*resilience_gloo_solo_io_v2.OutlierDetectionPolicy) OutlierDetectionPolicySet {
	return &outlierDetectionPolicySet{set: makeGenericOutlierDetectionPolicySet(outlierDetectionPolicyList)}
}

func NewOutlierDetectionPolicySetFromList(outlierDetectionPolicyList *resilience_gloo_solo_io_v2.OutlierDetectionPolicyList) OutlierDetectionPolicySet {
	list := make([]*resilience_gloo_solo_io_v2.OutlierDetectionPolicy, 0, len(outlierDetectionPolicyList.Items))
...
func (s *outlierDetectionPolicySet) List(filterResource ...func(*resilience_gloo_solo_io_v2.OutlierDetectionPolicy) bool) []*resilience_gloo_solo_io_v2.OutlierDetectionPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*resilience_gloo_solo_io_v2.OutlierDetectionPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	outlierDetectionPolicyList := make([]*resilience_gloo_solo_io_v2.OutlierDetectionPolicy, 0, len(objs))
	for _, obj := range objs {
		outlierDetectionPolicyList = append(outlierDetectionPolicyList, obj.(*resilience_gloo_solo_io_v2.OutlierDetectionPolicy))
	}
	return outlierDetectionPolicyList
}

func (s *outlierDetectionPolicySet) UnsortedList(filterResource ...func(*resilience_gloo_solo_io_v2.OutlierDetectionPolicy) bool) []*resilience_gloo_solo_io_v2.OutlierDetectionPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var outlierDetectionPolicyList []*resilience_gloo_solo_io_v2.OutlierDetectionPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		outlierDetectionPolicyList = append(outlierDetectionPolicyList, obj.(*resilience_gloo_solo_io_v2.OutlierDetectionPolicy))
	}
	return outlierDetectionPolicyList
...
func (s *outlierDetectionPolicySet) Map() map[string]*resilience_gloo_solo_io_v2.OutlierDetectionPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*resilience_gloo_solo_io_v2.OutlierDetectionPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*resilience_gloo_solo_io_v2.OutlierDetectionPolicy)
	}
	return newMap
}

func (s *outlierDetectionPolicySet) Insert(
	outlierDetectionPolicyList ...*resilience_gloo_solo_io_v2.OutlierDetectionPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *outlierDetectionPolicySet) Find(id ezkube.ResourceId) (*resilience_gloo_solo_io_v2.OutlierDetectionPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find OutlierDetectionPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&resilience_gloo_solo_io_v2.OutlierDetectionPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*resilience_gloo_solo_io_v2.OutlierDetectionPolicy), nil
}
...
type FaultInjectionPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*resilience_gloo_solo_io_v2.FaultInjectionPolicy) bool) []*resilience_gloo_solo_io_v2.FaultInjectionPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*resilience_gloo_solo_io_v2.FaultInjectionPolicy) bool) []*resilience_gloo_solo_io_v2.FaultInjectionPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*resilience_gloo_solo_io_v2.FaultInjectionPolicy
	// Insert a resource into the set.
	Insert(faultInjectionPolicy ...*resilience_gloo_solo_io_v2.FaultInjectionPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*resilience_gloo_solo_io_v2.FaultInjectionPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericFaultInjectionPolicySet(faultInjectionPolicyList []*resilience_gloo_solo_io_v2.FaultInjectionPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewFaultInjectionPolicySet(faultInjectionPolicyList ...*resilience_gloo_solo_io_v2.FaultInjectionPolicy) FaultInjectionPolicySet {
	return &faultInjectionPolicySet{set: makeGenericFaultInjectionPolicySet(faultInjectionPolicyList)}
}

func NewFaultInjectionPolicySetFromList(faultInjectionPolicyList *resilience_gloo_solo_io_v2.FaultInjectionPolicyList) FaultInjectionPolicySet {
	list := make([]*resilience_gloo_solo_io_v2.FaultInjectionPolicy, 0, len(faultInjectionPolicyList.Items))
...
func (s *faultInjectionPolicySet) List(filterResource ...func(*resilience_gloo_solo_io_v2.FaultInjectionPolicy) bool) []*resilience_gloo_solo_io_v2.FaultInjectionPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*resilience_gloo_solo_io_v2.FaultInjectionPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	faultInjectionPolicyList := make([]*resilience_gloo_solo_io_v2.FaultInjectionPolicy, 0, len(objs))
	for _, obj := range objs {
		faultInjectionPolicyList = append(faultInjectionPolicyList, obj.(*resilience_gloo_solo_io_v2.FaultInjectionPolicy))
	}
	return faultInjectionPolicyList
}

func (s *faultInjectionPolicySet) UnsortedList(filterResource ...func(*resilience_gloo_solo_io_v2.FaultInjectionPolicy) bool) []*resilience_gloo_solo_io_v2.FaultInjectionPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var faultInjectionPolicyList []*resilience_gloo_solo_io_v2.FaultInjectionPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		faultInjectionPolicyList = append(faultInjectionPolicyList, obj.(*resilience_gloo_solo_io_v2.FaultInjectionPolicy))
	}
	return faultInjectionPolicyList
...
func (s *faultInjectionPolicySet) Map() map[string]*resilience_gloo_solo_io_v2.FaultInjectionPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*resilience_gloo_solo_io_v2.FaultInjectionPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*resilience_gloo_solo_io_v2.FaultInjectionPolicy)
	}
	return newMap
}

func (s *faultInjectionPolicySet) Insert(
	faultInjectionPolicyList ...*resilience_gloo_solo_io_v2.FaultInjectionPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *faultInjectionPolicySet) Find(id ezkube.ResourceId) (*resilience_gloo_solo_io_v2.FaultInjectionPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find FaultInjectionPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&resilience_gloo_solo_io_v2.FaultInjectionPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*resilience_gloo_solo_io_v2.FaultInjectionPolicy), nil
}
...
type RetryTimeoutPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*resilience_gloo_solo_io_v2.RetryTimeoutPolicy) bool) []*resilience_gloo_solo_io_v2.RetryTimeoutPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*resilience_gloo_solo_io_v2.RetryTimeoutPolicy) bool) []*resilience_gloo_solo_io_v2.RetryTimeoutPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*resilience_gloo_solo_io_v2.RetryTimeoutPolicy
	// Insert a resource into the set.
	Insert(retryTimeoutPolicy ...*resilience_gloo_solo_io_v2.RetryTimeoutPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*resilience_gloo_solo_io_v2.RetryTimeoutPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericRetryTimeoutPolicySet(retryTimeoutPolicyList []*resilience_gloo_solo_io_v2.RetryTimeoutPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewRetryTimeoutPolicySet(retryTimeoutPolicyList ...*resilience_gloo_solo_io_v2.RetryTimeoutPolicy) RetryTimeoutPolicySet {
	return &retryTimeoutPolicySet{set: makeGenericRetryTimeoutPolicySet(retryTimeoutPolicyList)}
}

func NewRetryTimeoutPolicySetFromList(retryTimeoutPolicyList *resilience_gloo_solo_io_v2.RetryTimeoutPolicyList) RetryTimeoutPolicySet {
	list := make([]*resilience_gloo_solo_io_v2.RetryTimeoutPolicy, 0, len(retryTimeoutPolicyList.Items))
...
func (s *retryTimeoutPolicySet) List(filterResource ...func(*resilience_gloo_solo_io_v2.RetryTimeoutPolicy) bool) []*resilience_gloo_solo_io_v2.RetryTimeoutPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*resilience_gloo_solo_io_v2.RetryTimeoutPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	retryTimeoutPolicyList := make([]*resilience_gloo_solo_io_v2.RetryTimeoutPolicy, 0, len(objs))
	for _, obj := range objs {
		retryTimeoutPolicyList = append(retryTimeoutPolicyList, obj.(*resilience_gloo_solo_io_v2.RetryTimeoutPolicy))
	}
	return retryTimeoutPolicyList
}

func (s *retryTimeoutPolicySet) UnsortedList(filterResource ...func(*resilience_gloo_solo_io_v2.RetryTimeoutPolicy) bool) []*resilience_gloo_solo_io_v2.RetryTimeoutPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var retryTimeoutPolicyList []*resilience_gloo_solo_io_v2.RetryTimeoutPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		retryTimeoutPolicyList = append(retryTimeoutPolicyList, obj.(*resilience_gloo_solo_io_v2.RetryTimeoutPolicy))
	}
	return retryTimeoutPolicyList
...
func (s *retryTimeoutPolicySet) Map() map[string]*resilience_gloo_solo_io_v2.RetryTimeoutPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*resilience_gloo_solo_io_v2.RetryTimeoutPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*resilience_gloo_solo_io_v2.RetryTimeoutPolicy)
	}
	return newMap
}

func (s *retryTimeoutPolicySet) Insert(
	retryTimeoutPolicyList ...*resilience_gloo_solo_io_v2.RetryTimeoutPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *retryTimeoutPolicySet) Find(id ezkube.ResourceId) (*resilience_gloo_solo_io_v2.RetryTimeoutPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find RetryTimeoutPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&resilience_gloo_solo_io_v2.RetryTimeoutPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*resilience_gloo_solo_io_v2.RetryTimeoutPolicy), nil
}
