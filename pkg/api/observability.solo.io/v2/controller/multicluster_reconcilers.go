...
type MulticlusterAccessLogPolicyReconciler interface {
	ReconcileAccessLogPolicy(clusterName string, obj *observability_solo_io_v2.AccessLogPolicy) (reconcile.Result, error)
}
...
type MulticlusterAccessLogPolicyReconcilerFuncs struct {
	OnReconcileAccessLogPolicy         func(clusterName string, obj *observability_solo_io_v2.AccessLogPolicy) (reconcile.Result, error)
	OnReconcileAccessLogPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterAccessLogPolicyReconcilerFuncs) ReconcileAccessLogPolicy(clusterName string, obj *observability_solo_io_v2.AccessLogPolicy) (reconcile.Result, error) {
...
func NewMulticlusterAccessLogPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterAccessLogPolicyReconcileLoop {
	return &multiclusterAccessLogPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &observability_solo_io_v2.AccessLogPolicy{}, options)}
}
