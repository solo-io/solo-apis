...
// Hash function
func (m *GraphQLStitchedSchemaNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("apimanagement.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/apimanagement.gloo.solo.io/v2.GraphQLStitchedSchemaNewStatus")); err != nil {
		return 0, err
	}
...
func (m *GraphQLStitchedSchemaReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("apimanagement.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/apimanagement.gloo.solo.io/v2.GraphQLStitchedSchemaReport")); err != nil {
		return 0, err
	}
...
func (m *GraphQLStitchedSchemaSpec_Options) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("apimanagement.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/apimanagement.gloo.solo.io/v2.GraphQLStitchedSchemaSpec_Options")); err != nil {
		return 0, err
	}
