...
func (m *PortalSpec) Clone() proto.Message {
	...
	if m.GetPortalBackendSelectors() != nil {
		target.PortalBackendSelectors = make([]*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.WorkloadSelector, len(m.GetPortalBackendSelectors()))
		for idx, v := range m.GetPortalBackendSelectors() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.PortalBackendSelectors[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.WorkloadSelector)
			} else {
				target.PortalBackendSelectors[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.WorkloadSelector)
			}
...
func (m *PortalReport) Clone() proto.Message {
	...
	if m.GetSelectedRouteTables() != nil {
		target.SelectedRouteTables = make([]*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference, len(m.GetSelectedRouteTables()))
		for idx, v := range m.GetSelectedRouteTables() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.SelectedRouteTables[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
			} else {
				target.SelectedRouteTables[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
			}
	...
	if m.GetSelectedExtAuthPolicies() != nil {
		target.SelectedExtAuthPolicies = make([]*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference, len(m.GetSelectedExtAuthPolicies()))
		for idx, v := range m.GetSelectedExtAuthPolicies() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.SelectedExtAuthPolicies[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
			} else {
				target.SelectedExtAuthPolicies[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
			}
	...
	if m.GetSelectedRateLimitPolicies() != nil {
		target.SelectedRateLimitPolicies = make([]*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference, len(m.GetSelectedRateLimitPolicies()))
		for idx, v := range m.GetSelectedRateLimitPolicies() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.SelectedRateLimitPolicies[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
			} else {
				target.SelectedRateLimitPolicies[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
			}
	...
	if m.GetSelectedPortalBackend() != nil {
		target.SelectedPortalBackend = make([]*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference, len(m.GetSelectedPortalBackend()))
		for idx, v := range m.GetSelectedPortalBackend() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.SelectedPortalBackend[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
			} else {
				target.SelectedPortalBackend[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
			}
