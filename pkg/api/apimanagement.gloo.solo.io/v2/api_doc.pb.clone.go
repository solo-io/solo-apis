...
func (m *ApiDocStatus) Clone() proto.Message {
	...
	if m.GetServingDestinations() != nil {
		target.ServingDestinations = make([]*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.DestinationReference, len(m.GetServingDestinations()))
		for idx, v := range m.GetServingDestinations() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.ServingDestinations[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.DestinationReference)
			} else {
				target.ServingDestinations[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.DestinationReference)
			}
...
// Clone function
func (m *ApiDocNewStatus) Clone() proto.Message {
	var target *ApiDocNewStatus
	if m == nil {
		return target
	}
	target = &ApiDocNewStatus{}
	...
	case *ApiDocSpec_ServedBy_DestinationSelector:
		...
		if h, ok := interface{}(m.GetDestinationSelector()).(clone.Cloner); ok {
			target.ServedByType = &ApiDocSpec_ServedBy_DestinationSelector{
				DestinationSelector: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.DestinationSelector),
			}
		} else {
			target.ServedByType = &ApiDocSpec_ServedBy_DestinationSelector{
				DestinationSelector: proto.Clone(m.GetDestinationSelector()).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.DestinationSelector),
			}
		}
	...
	case *ApiDocSpec_ServedBy_RouteTable:
		...
		if h, ok := interface{}(m.GetRouteTable()).(clone.Cloner); ok {
			target.ServedByType = &ApiDocSpec_ServedBy_RouteTable{
				RouteTable: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference),
			}
		} else {
			target.ServedByType = &ApiDocSpec_ServedBy_RouteTable{
				RouteTable: proto.Clone(m.GetRouteTable()).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference),
			}
		}
