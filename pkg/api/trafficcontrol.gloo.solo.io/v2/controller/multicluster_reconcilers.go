...
type MulticlusterMirrorPolicyReconciler interface {
	ReconcileMirrorPolicy(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.MirrorPolicy) (reconcile.Result, error)
}
...
type MulticlusterMirrorPolicyReconcilerFuncs struct {
	OnReconcileMirrorPolicy         func(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.MirrorPolicy) (reconcile.Result, error)
	OnReconcileMirrorPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterMirrorPolicyReconcilerFuncs) ReconcileMirrorPolicy(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.MirrorPolicy) (reconcile.Result, error) {
...
func NewMulticlusterMirrorPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterMirrorPolicyReconcileLoop {
	return &multiclusterMirrorPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &trafficcontrol_gloo_solo_io_v2.MirrorPolicy{}, options)}
}
...
type MulticlusterRateLimitPolicyReconciler interface {
	ReconcileRateLimitPolicy(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.RateLimitPolicy) (reconcile.Result, error)
}
...
type MulticlusterRateLimitPolicyReconcilerFuncs struct {
	OnReconcileRateLimitPolicy         func(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.RateLimitPolicy) (reconcile.Result, error)
	OnReconcileRateLimitPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterRateLimitPolicyReconcilerFuncs) ReconcileRateLimitPolicy(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.RateLimitPolicy) (reconcile.Result, error) {
...
func NewMulticlusterRateLimitPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRateLimitPolicyReconcileLoop {
	return &multiclusterRateLimitPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &trafficcontrol_gloo_solo_io_v2.RateLimitPolicy{}, options)}
}
...
type MulticlusterRateLimitClientConfigReconciler interface {
	ReconcileRateLimitClientConfig(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.RateLimitClientConfig) (reconcile.Result, error)
}
...
type MulticlusterRateLimitClientConfigReconcilerFuncs struct {
	OnReconcileRateLimitClientConfig         func(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.RateLimitClientConfig) (reconcile.Result, error)
	OnReconcileRateLimitClientConfigDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterRateLimitClientConfigReconcilerFuncs) ReconcileRateLimitClientConfig(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.RateLimitClientConfig) (reconcile.Result, error) {
...
func NewMulticlusterRateLimitClientConfigReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRateLimitClientConfigReconcileLoop {
	return &multiclusterRateLimitClientConfigReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &trafficcontrol_gloo_solo_io_v2.RateLimitClientConfig{}, options)}
}
...
type MulticlusterHeaderManipulationPolicyReconciler interface {
	ReconcileHeaderManipulationPolicy(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.HeaderManipulationPolicy) (reconcile.Result, error)
}
...
type MulticlusterHeaderManipulationPolicyReconcilerFuncs struct {
	OnReconcileHeaderManipulationPolicy         func(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.HeaderManipulationPolicy) (reconcile.Result, error)
	OnReconcileHeaderManipulationPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterHeaderManipulationPolicyReconcilerFuncs) ReconcileHeaderManipulationPolicy(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.HeaderManipulationPolicy) (reconcile.Result, error) {
...
func NewMulticlusterHeaderManipulationPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterHeaderManipulationPolicyReconcileLoop {
	return &multiclusterHeaderManipulationPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &trafficcontrol_gloo_solo_io_v2.HeaderManipulationPolicy{}, options)}
}
...
type MulticlusterTransformationPolicyReconciler interface {
	ReconcileTransformationPolicy(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.TransformationPolicy) (reconcile.Result, error)
}
...
type MulticlusterTransformationPolicyReconcilerFuncs struct {
	OnReconcileTransformationPolicy         func(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.TransformationPolicy) (reconcile.Result, error)
	OnReconcileTransformationPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterTransformationPolicyReconcilerFuncs) ReconcileTransformationPolicy(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.TransformationPolicy) (reconcile.Result, error) {
...
func NewMulticlusterTransformationPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterTransformationPolicyReconcileLoop {
	return &multiclusterTransformationPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &trafficcontrol_gloo_solo_io_v2.TransformationPolicy{}, options)}
}
...
type MulticlusterProxyProtocolPolicyReconciler interface {
	ReconcileProxyProtocolPolicy(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.ProxyProtocolPolicy) (reconcile.Result, error)
}
...
type MulticlusterProxyProtocolPolicyReconcilerFuncs struct {
	OnReconcileProxyProtocolPolicy         func(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.ProxyProtocolPolicy) (reconcile.Result, error)
	OnReconcileProxyProtocolPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterProxyProtocolPolicyReconcilerFuncs) ReconcileProxyProtocolPolicy(clusterName string, obj *trafficcontrol_gloo_solo_io_v2.ProxyProtocolPolicy) (reconcile.Result, error) {
...
func NewMulticlusterProxyProtocolPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterProxyProtocolPolicyReconcileLoop {
	return &multiclusterProxyProtocolPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &trafficcontrol_gloo_solo_io_v2.ProxyProtocolPolicy{}, options)}
}
