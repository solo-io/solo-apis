...
type MirrorPolicyReconciler interface {
	ReconcileMirrorPolicy(obj *trafficcontrol_gloo_solo_io_v2.MirrorPolicy) (reconcile.Result, error)
}
...
type MirrorPolicyReconcilerFuncs struct {
	OnReconcileMirrorPolicy         func(obj *trafficcontrol_gloo_solo_io_v2.MirrorPolicy) (reconcile.Result, error)
	OnReconcileMirrorPolicyDeletion func(req reconcile.Request) error
}

func (f *MirrorPolicyReconcilerFuncs) ReconcileMirrorPolicy(obj *trafficcontrol_gloo_solo_io_v2.MirrorPolicy) (reconcile.Result, error) {
...
type MirrorPolicyFinalizer interface {
	...
	FinalizeMirrorPolicy(obj *trafficcontrol_gloo_solo_io_v2.MirrorPolicy) error
}
...
func NewMirrorPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) MirrorPolicyReconcileLoop {
	return &mirrorPolicyReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &trafficcontrol_gloo_solo_io_v2.MirrorPolicy{}, options),
	}
}
...
type RateLimitPolicyReconciler interface {
	ReconcileRateLimitPolicy(obj *trafficcontrol_gloo_solo_io_v2.RateLimitPolicy) (reconcile.Result, error)
}
...
type RateLimitPolicyReconcilerFuncs struct {
	OnReconcileRateLimitPolicy         func(obj *trafficcontrol_gloo_solo_io_v2.RateLimitPolicy) (reconcile.Result, error)
	OnReconcileRateLimitPolicyDeletion func(req reconcile.Request) error
}

func (f *RateLimitPolicyReconcilerFuncs) ReconcileRateLimitPolicy(obj *trafficcontrol_gloo_solo_io_v2.RateLimitPolicy) (reconcile.Result, error) {
...
type RateLimitPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeRateLimitPolicy(obj *trafficcontrol_gloo_solo_io_v2.RateLimitPolicy) error
}
...
func NewRateLimitPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) RateLimitPolicyReconcileLoop {
	return &rateLimitPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &trafficcontrol_gloo_solo_io_v2.RateLimitPolicy{}, options),
	}
}
...
type RateLimitClientConfigReconciler interface {
	ReconcileRateLimitClientConfig(obj *trafficcontrol_gloo_solo_io_v2.RateLimitClientConfig) (reconcile.Result, error)
}
...
type RateLimitClientConfigReconcilerFuncs struct {
	OnReconcileRateLimitClientConfig         func(obj *trafficcontrol_gloo_solo_io_v2.RateLimitClientConfig) (reconcile.Result, error)
	OnReconcileRateLimitClientConfigDeletion func(req reconcile.Request) error
}

func (f *RateLimitClientConfigReconcilerFuncs) ReconcileRateLimitClientConfig(obj *trafficcontrol_gloo_solo_io_v2.RateLimitClientConfig) (reconcile.Result, error) {
...
type RateLimitClientConfigFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeRateLimitClientConfig(obj *trafficcontrol_gloo_solo_io_v2.RateLimitClientConfig) error
}
...
func NewRateLimitClientConfigReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) RateLimitClientConfigReconcileLoop {
	return &rateLimitClientConfigReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &trafficcontrol_gloo_solo_io_v2.RateLimitClientConfig{}, options),
	}
}
...
type HeaderManipulationPolicyReconciler interface {
	ReconcileHeaderManipulationPolicy(obj *trafficcontrol_gloo_solo_io_v2.HeaderManipulationPolicy) (reconcile.Result, error)
}
...
type HeaderManipulationPolicyReconcilerFuncs struct {
	OnReconcileHeaderManipulationPolicy         func(obj *trafficcontrol_gloo_solo_io_v2.HeaderManipulationPolicy) (reconcile.Result, error)
	OnReconcileHeaderManipulationPolicyDeletion func(req reconcile.Request) error
}

func (f *HeaderManipulationPolicyReconcilerFuncs) ReconcileHeaderManipulationPolicy(obj *trafficcontrol_gloo_solo_io_v2.HeaderManipulationPolicy) (reconcile.Result, error) {
...
type HeaderManipulationPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeHeaderManipulationPolicy(obj *trafficcontrol_gloo_solo_io_v2.HeaderManipulationPolicy) error
}
...
func NewHeaderManipulationPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) HeaderManipulationPolicyReconcileLoop {
	return &headerManipulationPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &trafficcontrol_gloo_solo_io_v2.HeaderManipulationPolicy{}, options),
	}
}
...
type TransformationPolicyReconciler interface {
	ReconcileTransformationPolicy(obj *trafficcontrol_gloo_solo_io_v2.TransformationPolicy) (reconcile.Result, error)
}
...
type TransformationPolicyReconcilerFuncs struct {
	OnReconcileTransformationPolicy         func(obj *trafficcontrol_gloo_solo_io_v2.TransformationPolicy) (reconcile.Result, error)
	OnReconcileTransformationPolicyDeletion func(req reconcile.Request) error
}

func (f *TransformationPolicyReconcilerFuncs) ReconcileTransformationPolicy(obj *trafficcontrol_gloo_solo_io_v2.TransformationPolicy) (reconcile.Result, error) {
...
type TransformationPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeTransformationPolicy(obj *trafficcontrol_gloo_solo_io_v2.TransformationPolicy) error
}
...
func NewTransformationPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) TransformationPolicyReconcileLoop {
	return &transformationPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &trafficcontrol_gloo_solo_io_v2.TransformationPolicy{}, options),
	}
}
...
type ProxyProtocolPolicyReconciler interface {
	ReconcileProxyProtocolPolicy(obj *trafficcontrol_gloo_solo_io_v2.ProxyProtocolPolicy) (reconcile.Result, error)
}
...
type ProxyProtocolPolicyReconcilerFuncs struct {
	OnReconcileProxyProtocolPolicy         func(obj *trafficcontrol_gloo_solo_io_v2.ProxyProtocolPolicy) (reconcile.Result, error)
	OnReconcileProxyProtocolPolicyDeletion func(req reconcile.Request) error
}

func (f *ProxyProtocolPolicyReconcilerFuncs) ReconcileProxyProtocolPolicy(obj *trafficcontrol_gloo_solo_io_v2.ProxyProtocolPolicy) (reconcile.Result, error) {
...
type ProxyProtocolPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeProxyProtocolPolicy(obj *trafficcontrol_gloo_solo_io_v2.ProxyProtocolPolicy) error
}
...
func NewProxyProtocolPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) ProxyProtocolPolicyReconcileLoop {
	return &proxyProtocolPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &trafficcontrol_gloo_solo_io_v2.ProxyProtocolPolicy{}, options),
	}
}
