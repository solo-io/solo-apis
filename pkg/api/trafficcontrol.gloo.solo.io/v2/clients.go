...
// MulticlusterClientset for the trafficcontrol.gloo.solo.io/v2 APIs
...
// clienset for the trafficcontrol.gloo.solo.io/v2 APIs
type Clientset interface {
	// clienset for the trafficcontrol.gloo.solo.io/v2/v2 APIs
