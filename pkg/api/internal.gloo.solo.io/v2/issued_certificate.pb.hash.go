...
func (m *IssuedCertificateSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.IssuedCertificateSpec")); err != nil {
		return 0, err
	}
...
func (m *MgmtServerCertificateAuthority) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.MgmtServerCertificateAuthority")); err != nil {
		return 0, err
	}
...
func (m *IssuedCertificateStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.IssuedCertificateStatus")); err != nil {
		return 0, err
	}
