...
func (m *CertificateRequestSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.CertificateRequestSpec")); err != nil {
		return 0, err
	}
...
func (m *CertificateRequestStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.CertificateRequestStatus")); err != nil {
		return 0, err
	}
