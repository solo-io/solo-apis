...
func (m *MeshSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.MeshSpec")); err != nil {
		return 0, err
	}
...
func (m *MeshStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.MeshStatus")); err != nil {
		return 0, err
	}
...
func (m *MeshSpec_Installation) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.MeshSpec_Installation")); err != nil {
		return 0, err
	}
...
func (m *MeshSpec_AgentInfo) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.MeshSpec_AgentInfo")); err != nil {
		return 0, err
	}
