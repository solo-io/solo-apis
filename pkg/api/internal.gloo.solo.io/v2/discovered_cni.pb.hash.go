...
func (m *DiscoveredCNISpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.DiscoveredCNISpec")); err != nil {
		return 0, err
	}
...
func (m *DiscoveredCNIStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.DiscoveredCNIStatus")); err != nil {
		return 0, err
	}
