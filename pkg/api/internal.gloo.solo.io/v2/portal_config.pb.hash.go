...
func (m *PortalConfigSpec_Group) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.PortalConfigSpec_Group")); err != nil {
		return 0, err
	}
...
func (m *PortalConfigSpec_ExtAuthPolicy) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.PortalConfigSpec_ExtAuthPolicy")); err != nil {
		return 0, err
	}
...
func (m *PortalConfigSpec_ExtAuthLabelSelector) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("internal.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/internal.gloo.solo.io/v2.PortalConfigSpec_ExtAuthLabelSelector")); err != nil {
		return 0, err
	}
