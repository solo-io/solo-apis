...
// MulticlusterClientset for the enterprise.gloo.solo.io/v1alpha1 APIs
...
// clienset for the enterprise.gloo.solo.io/v1alpha1 APIs
type Clientset interface {
	// clienset for the enterprise.gloo.solo.io/v1alpha1/v1alpha1 APIs
