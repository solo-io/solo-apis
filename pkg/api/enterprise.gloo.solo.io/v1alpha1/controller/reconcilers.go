...
type GraphQLSchemaReconciler interface {
	ReconcileGraphQLSchema(obj *enterprise_gloo_solo_io_v1alpha1.GraphQLSchema) (reconcile.Result, error)
}
...
type GraphQLSchemaReconcilerFuncs struct {
	OnReconcileGraphQLSchema         func(obj *enterprise_gloo_solo_io_v1alpha1.GraphQLSchema) (reconcile.Result, error)
	OnReconcileGraphQLSchemaDeletion func(req reconcile.Request) error
}

func (f *GraphQLSchemaReconcilerFuncs) ReconcileGraphQLSchema(obj *enterprise_gloo_solo_io_v1alpha1.GraphQLSchema) (reconcile.Result, error) {
...
type GraphQLSchemaFinalizer interface {
	...
	FinalizeGraphQLSchema(obj *enterprise_gloo_solo_io_v1alpha1.GraphQLSchema) error
}
...
func NewGraphQLSchemaReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) GraphQLSchemaReconcileLoop {
	return &graphQLSchemaReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &enterprise_gloo_solo_io_v1alpha1.GraphQLSchema{}, options),
	}
}
