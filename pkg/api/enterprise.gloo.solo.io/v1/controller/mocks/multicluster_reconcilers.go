...
func (mr *MockMulticlusterAuthConfigReconcilerMockRecorder) ReconcileAuthConfig(clusterName, obj any) *gomock.Call {
...
func (mr *MockMulticlusterAuthConfigDeletionReconcilerMockRecorder) ReconcileAuthConfigDeletion(clusterName, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMulticlusterAuthConfigReconcileLoopMockRecorder) AddMulticlusterAuthConfigReconciler(ctx, rec any, predicates ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
