...
type OpaAuth struct {
	...
	// If you are using sidecar-based OPA auth (recommended), this will be the package used to query the OPA API.
	Package string `protobuf:"bytes,4,opt,name=package,proto3" json:"package,omitempty"`
	// If you are using sidecar-based OPA auth (recommended), this will be the rule name used to query the OPA API.
...
func (x *OpaAuth) GetPackage() string {
	if x != nil {
		return x.Package
	}
	return ""
...
func (x *OpaAuth) GetRuleName() string {
	if x != nil {
		return x.RuleName
	}
	return ""
...
var file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a,
	0x02, 0x38, 0x01, 0x22, 0xce, 0x01, 0x0a, 0x07, 0x4f, 0x70, 0x61, 0x41, 0x75, 0x74, 0x68, 0x12,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61,
