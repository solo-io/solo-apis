...
type AuthConfigSpec struct {
	...
	FailureOnUpdatePolicy *AuthConfigSpec_FailureOnUpdatePolicy `protobuf:"bytes,14,opt,name=failure_on_update_policy,json=failureOnUpdatePolicy,proto3" json:"failure_on_update_policy,omitempty"`
}
...
func (x *AuthConfigSpec) GetFailureOnUpdatePolicy() *AuthConfigSpec_FailureOnUpdatePolicy {
	if x != nil {
		return x.FailureOnUpdatePolicy
	}
	return nil
}
...
type ExtAuthConfig struct {
	...
	FailOnRedirect bool `protobuf:"varint,11,opt,name=fail_on_redirect,json=failOnRedirect,proto3" json:"fail_on_redirect,omitempty"`
	// Defines the approach to take when a modified authconfig fails to start and an existing authconfig is running
	FailureOnUpdatePolicy *ExtAuthConfig_FailureOnUpdatePolicy `protobuf:"bytes,12,opt,name=failure_on_update_policy,json=failureOnUpdatePolicy,proto3" json:"failure_on_update_policy,omitempty"`
}
...
func (x *ExtAuthConfig) GetFailureOnUpdatePolicy() *ExtAuthConfig_FailureOnUpdatePolicy {
	if x != nil {
		return x.FailureOnUpdatePolicy
	}
	return nil
...
type AuthConfigSpec_FailureOnUpdatePolicy struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Policy:
	//
	//	*AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting_
	//	*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable_
	//	*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting_
	Policy isAuthConfigSpec_FailureOnUpdatePolicy_Policy `protobuf_oneof:"policy"`
}

func (x *AuthConfigSpec_FailureOnUpdatePolicy) Reset() {
	*x = AuthConfigSpec_FailureOnUpdatePolicy{}
	if protoimpl.UnsafeEnabled {
...
func (x *AuthConfigSpec_FailureOnUpdatePolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthConfigSpec_FailureOnUpdatePolicy) ProtoMessage() {}

func (x *AuthConfigSpec_FailureOnUpdatePolicy) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[56]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthConfigSpec_FailureOnUpdatePolicy.ProtoReflect.Descriptor instead.
func (*AuthConfigSpec_FailureOnUpdatePolicy) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_rawDescGZIP(), []int{0, 1}
}

func (m *AuthConfigSpec_FailureOnUpdatePolicy) GetPolicy() isAuthConfigSpec_FailureOnUpdatePolicy_Policy {
	if m != nil {
		return m.Policy
	}
	return nil
...
func (x *AuthConfigSpec_FailureOnUpdatePolicy) GetContinueExisting() *AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting {
	if x, ok := x.GetPolicy().(*AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting_); ok {
		return x.ContinueExisting
	}
	return nil
}

func (x *AuthConfigSpec_FailureOnUpdatePolicy) GetReplaceIfRecoverable() *AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable {
	if x, ok := x.GetPolicy().(*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable_); ok {
		return x.ReplaceIfRecoverable
	}
	return nil
}

func (x *AuthConfigSpec_FailureOnUpdatePolicy) GetReplaceExisting() *AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting {
	if x, ok := x.GetPolicy().(*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting_); ok {
		return x.ReplaceExisting
	}
	return nil
}

type isAuthConfigSpec_FailureOnUpdatePolicy_Policy interface {
	isAuthConfigSpec_FailureOnUpdatePolicy_Policy()
}

type AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting_ struct {
	ContinueExisting *AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting `protobuf:"bytes,1,opt,name=continue_existing,json=continueExisting,proto3,oneof"`
}

type AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable_ struct {
	ReplaceIfRecoverable *AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable `protobuf:"bytes,2,opt,name=replace_if_recoverable,json=replaceIfRecoverable,proto3,oneof"`
}

type AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting_ struct {
	ReplaceExisting *AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting `protobuf:"bytes,3,opt,name=replace_existing,json=replaceExisting,proto3,oneof"`
}

func (*AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting_) isAuthConfigSpec_FailureOnUpdatePolicy_Policy() {
}

func (*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable_) isAuthConfigSpec_FailureOnUpdatePolicy_Policy() {
}

func (*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting_) isAuthConfigSpec_FailureOnUpdatePolicy_Policy() {
}

type AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting) Reset() {
	*x = AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting{}
	if protoimpl.UnsafeEnabled {
...
func (x *AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting) ProtoMessage() {}

func (x *AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[57]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting.ProtoReflect.Descriptor instead.
func (*AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_rawDescGZIP(), []int{0, 1, 0}
}

type AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable) Reset() {
	*x = AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable{}
	if protoimpl.UnsafeEnabled {
...
func (x *AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable) ProtoMessage() {}

func (x *AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[58]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable.ProtoReflect.Descriptor instead.
func (*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_rawDescGZIP(), []int{0, 1, 1}
}

type AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting) Reset() {
	*x = AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting{}
	if protoimpl.UnsafeEnabled {
...
func (x *AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting) ProtoMessage() {}

func (x *AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[59]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting.ProtoReflect.Descriptor instead.
func (*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_rawDescGZIP(), []int{0, 1, 2}
}
...
// Approach to take when a modified authconfig fails translation from internal configuration to authservice and an existing authservice
// for this resource is already running
type ExtAuthConfig_FailureOnUpdatePolicy struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Types that are assignable to Policy:
	//
	//	*ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting_
	//	*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable_
	//	*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting_
	Policy isExtAuthConfig_FailureOnUpdatePolicy_Policy `protobuf_oneof:"policy"`
}

func (x *ExtAuthConfig_FailureOnUpdatePolicy) Reset() {
	*x = ExtAuthConfig_FailureOnUpdatePolicy{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExtAuthConfig_FailureOnUpdatePolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExtAuthConfig_FailureOnUpdatePolicy) ProtoMessage() {}

func (x *ExtAuthConfig_FailureOnUpdatePolicy) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[125]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExtAuthConfig_FailureOnUpdatePolicy.ProtoReflect.Descriptor instead.
func (*ExtAuthConfig_FailureOnUpdatePolicy) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_rawDescGZIP(), []int{44, 15}
}

func (m *ExtAuthConfig_FailureOnUpdatePolicy) GetPolicy() isExtAuthConfig_FailureOnUpdatePolicy_Policy {
	if m != nil {
		return m.Policy
	}
	return nil
...
func (x *ExtAuthConfig_FailureOnUpdatePolicy) GetContinueExisting() *ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting {
	if x, ok := x.GetPolicy().(*ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting_); ok {
		return x.ContinueExisting
	}
	return nil
}

func (x *ExtAuthConfig_FailureOnUpdatePolicy) GetReplaceIfRecoverable() *ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable {
	if x, ok := x.GetPolicy().(*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable_); ok {
		return x.ReplaceIfRecoverable
	}
	return nil
}

func (x *ExtAuthConfig_FailureOnUpdatePolicy) GetReplaceExisting() *ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting {
	if x, ok := x.GetPolicy().(*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting_); ok {
		return x.ReplaceExisting
	}
	return nil
}

type isExtAuthConfig_FailureOnUpdatePolicy_Policy interface {
	isExtAuthConfig_FailureOnUpdatePolicy_Policy()
}

type ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting_ struct {
	ContinueExisting *ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting `protobuf:"bytes,1,opt,name=continue_existing,json=continueExisting,proto3,oneof"`
}

type ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable_ struct {
	ReplaceIfRecoverable *ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable `protobuf:"bytes,2,opt,name=replace_if_recoverable,json=replaceIfRecoverable,proto3,oneof"`
}

type ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting_ struct {
	ReplaceExisting *ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting `protobuf:"bytes,3,opt,name=replace_existing,json=replaceExisting,proto3,oneof"`
}

func (*ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting_) isExtAuthConfig_FailureOnUpdatePolicy_Policy() {
}

func (*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable_) isExtAuthConfig_FailureOnUpdatePolicy_Policy() {
}

func (*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting_) isExtAuthConfig_FailureOnUpdatePolicy_Policy() {
}
...
func (x *ExtAuthConfig_BasicAuthInternal_EncryptionType_Apr) Reset() {
	*x = ExtAuthConfig_BasicAuthInternal_EncryptionType_Apr{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[130]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *ExtAuthConfig_UserSessionConfig_CipherConfig) Reset() {
	*x = ExtAuthConfig_UserSessionConfig_CipherConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[133]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *ExtAuthConfig_AccessTokenValidationConfig_JwtValidation_LocalJwks) Reset() {
	*x = ExtAuthConfig_AccessTokenValidationConfig_JwtValidation_LocalJwks{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[146]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *ExtAuthConfig_ApiKeyAuthConfig_KeyMetadata) Reset() {
	*x = ExtAuthConfig_ApiKeyAuthConfig_KeyMetadata{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[149]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting) Reset() {
	*x = ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting) ProtoMessage() {}

func (x *ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[155]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting.ProtoReflect.Descriptor instead.
func (*ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_rawDescGZIP(), []int{44, 15, 0}
}

type ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable) Reset() {
	*x = ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[156]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable) ProtoMessage() {}

func (x *ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[156]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable.ProtoReflect.Descriptor instead.
func (*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_rawDescGZIP(), []int{44, 15, 1}
}

type ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting) Reset() {
	*x = ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[157]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting) ProtoMessage() {}

func (x *ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[157]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting.ProtoReflect.Descriptor instead.
func (*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_rawDescGZIP(), []int{44, 15, 2}
}
...
var file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd3, 0x0c, 0x0a, 0x0e, 0x41,
	...
	,
	...
	0x41, 0x75, 0x74, 0x68, 0x12, 0x3d, 0x0a, 0x08, 0x6f, 0x70, 0x61, 0x5f, 0x61, 0x75, 0x74, 0x68,
	0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72,
	0x69, 0x73, 0x65, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f,
	0x2e, 0x4f, 0x70, 0x61, 0x41, 0x75, 0x74, 0x68, 0x48, 0x00, 0x52, 0x07, 0x6f, 0x70, 0x61, 0x41,
	0x75, 0x74, 0x68, 0x12, 0x33, 0x0a, 0x04, 0x6c, 0x64, 0x61, 0x70, 0x18, 0x07, 0x20, 0x01, 0x28,
	...
	0x6f, 0x75, 0x67, 0x68, 0x5f, 0x61, 0x75, 0x74, 0x68, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	,
	...
	,
	...
	0x93, 0x1a, 0x0a, 0x15, 0x4f, 0x69, 0x64, 0x63, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a,
	...
	0x6c, 0x69, 0x63, 0x79, 0x12, 0x37, 0x0a, 0x16, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f,
	0x69, 0x64, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x10,
	0x20, 0x01, 0x28, 0x09, 0x42, 0x02, 0x18, 0x01, 0x52, 0x13, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f,
	...
	0x72, 0x74, 0x69, 0x65, 0x73, 0x12, 0x8e, 0x01, 0x0a, 0x1c, 0x64, 0x79, 0x6e, 0x61, 0x6d, 0x69,
	0x63, 0x5f, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x66, 0x72, 0x6f, 0x6d, 0x5f,
	0x63, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x18, 0x14, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x4d, 0x2e, 0x65,
	0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73,
	0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x4f, 0x69, 0x64, 0x63, 0x41, 0x75, 0x74, 0x68, 0x6f,
	0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x64, 0x65, 0x2e, 0x44, 0x79, 0x6e,
	...
	0x61, 0x6d, 0x69, 0x63, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x46, 0x72, 0x6f, 0x6d,
	0x43, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x12, 0x52, 0x0a, 0x15, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c,
	...
	0x65, 0x42, 0x02, 0x18, 0x01, 0x52, 0x13, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x43, 0x6c,
	0x69, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x5d, 0x0a, 0x0c, 0x61, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x17, 0x20, 0x01, 0x28, 0x0b,
	...
	,
	...
	,
	...
	0x07, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x1a, 0xde, 0x01, 0x0a, 0x05, 0x41, 0x7a, 0x75,
	...
	0x76, 0x69, 0x64, 0x65, 0x72, 0x22, 0xbc, 0x07, 0x0a, 0x0b, 0x50, 0x6c, 0x61, 0x69, 0x6e, 0x4f,
	...
	0x77, 0x72, 0x69, 0x74, 0x65, 0x22, 0xd6, 0x5c, 0x0a, 0x0d, 0x45, 0x78, 0x74, 0x41, 0x75, 0x74,
	...
	,
	...
	0x79, 0x42, 0x09, 0x0a, 0x07, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x1a, 0x8b, 0x17, 0x0a,
	...
	0x61, 0x75, 0x6c, 0x74, 0x12, 0x60, 0x0a, 0x05, 0x61, 0x7a, 0x75, 0x72, 0x65, 0x18, 0x1b, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x48, 0x2e, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65,
	0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x45, 0x78,
	0x74, 0x41, 0x75, 0x74, 0x68, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x4f, 0x69, 0x64, 0x63,
	0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x64,
	0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x48, 0x00, 0x52,
	...
	,
	...
	0x08, 0x52, 0x06, 0x61, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x1a, 0x8b, 0x01, 0x0a, 0x0b, 0x41, 0x63,
	0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x7c, 0x0a, 0x11, 0x63, 0x6c, 0x61,
	0x69, 0x6d, 0x73, 0x5f, 0x74, 0x6f, 0x5f, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x50, 0x2e, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73,
	0x65, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x45,
	...
	,
	...
	0x64, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x43, 0x6c, 0x61, 0x69, 0x6d, 0x54, 0x6f,
	0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x52, 0x0f, 0x63, 0x6c, 0x61, 0x69, 0x6d, 0x73, 0x54, 0x6f,
	0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x1a, 0x09, 0x0a, 0x07, 0x44, 0x65, 0x66, 0x61, 0x75,
	0x6c, 0x74, 0x1a, 0xc9, 0x01, 0x0a, 0x05, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x12, 0x1b, 0x0a, 0x09,
	0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x43, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x67, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x42, 0x0a,
	0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x1a, 0xff, 0x09, 0x0a, 0x1b, 0x41,
	0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61,
	...
	0x65, 0x5f, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0xe0, 0x07, 0x0a,
	...
	0x6e, 0x45, 0x6e, 0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x12, 0x5b, 0x0a, 0x0c, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0b, 0x75, 0x73, 0x65, 0x72, 0x53,
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x1a, 0x4a, 0x0a, 0x1c, 0x41, 0x75, 0x74, 0x68, 0x45, 0x6e,
	0x64, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x51, 0x75, 0x65, 0x72, 0x79, 0x50, 0x61, 0x72, 0x61, 0x6d,
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x22, 0xee, 0x03, 0x0a, 0x10, 0x41, 0x75, 0x74, 0x68, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x6e, 0x67, 0x10, 0x03, 0x22, 0xe7, 0x01, 0x0a, 0x1c, 0x41, 0x75, 0x74, 0x68, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x64, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x65, 0x73, 0x12, 0x5f, 0x0a, 0x08, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x65,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x43, 0x2e, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70,
	0x72, 0x69, 0x73, 0x65, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69,
	0x6f, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4e, 0x61, 0x6d, 0x65,
	...
	0x61, 0x74, 0x75, 0x73, 0x65, 0x73, 0x1a, 0x66, 0x0a, 0x0d, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x3f, 0x0a, 0x05, 0x76, 0x61, 0x6c,
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x65, 0x6e, 0x74, 0x65, 0x72,
	0x70, 0x72, 0x69, 0x73, 0x65, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e,
	0x69, 0x6f, 0x2e, 0x41, 0x75, 0x74, 0x68, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xdd,
	...
	0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x4d,
	0xb8, 0xf5, 0x04, 0x01, 0xc0, 0xf5, 0x04, 0x01, 0xd0, 0xf5, 0x04, 0x01, 0x5a, 0x3f, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6f, 0x6c, 0x6f, 0x2d, 0x69, 0x6f,
	0x2f, 0x73, 0x6f, 0x6c, 0x6f, 0x2d, 0x61, 0x70, 0x69, 0x73, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61,
	0x70, 0x69, 0x2f, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x2e, 0x67, 0x6c,
...
var file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes = make([]protoimpl.MessageInfo, 160)
var file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_goTypes = []interface{}{
	...
	(*AuthConfigSpec_FailureOnUpdatePolicy)(nil), // 61: enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy
	(*AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting)(nil),     // 62: enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy.ContinueExisting
	(*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable)(nil), // 63: enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy.ReplaceIfRecoverable
	(*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting)(nil),      // 64: enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy.ReplaceExisting
	(*HttpService_Request)(nil),                                       // 65: enterprise.gloo.solo.io.HttpService.Request
	(*HttpService_Response)(nil),                                      // 66: enterprise.gloo.solo.io.HttpService.Response
	nil,                                                               // 67: enterprise.gloo.solo.io.HttpService.Request.HeadersToAddEntry
	nil,                                                               // 68: enterprise.gloo.solo.io.CustomAuth.ContextExtensionsEntry
	(*BasicAuth_Apr)(nil),                                             // 69: enterprise.gloo.solo.io.BasicAuth.Apr
	(*BasicAuth_EncryptionType)(nil),                                  // 70: enterprise.gloo.solo.io.BasicAuth.EncryptionType
	(*BasicAuth_User)(nil),                                            // 71: enterprise.gloo.solo.io.BasicAuth.User
	(*BasicAuth_UserList)(nil),                                        // 72: enterprise.gloo.solo.io.BasicAuth.UserList
	(*BasicAuth_Apr_SaltedHashedPassword)(nil),                        // 73: enterprise.gloo.solo.io.BasicAuth.Apr.SaltedHashedPassword
	nil,                                   // 74: enterprise.gloo.solo.io.BasicAuth.Apr.UsersEntry
	(*BasicAuth_EncryptionType_Sha1)(nil), // 75: enterprise.gloo.solo.io.BasicAuth.EncryptionType.Sha1
	(*BasicAuth_EncryptionType_Apr)(nil),  // 76: enterprise.gloo.solo.io.BasicAuth.EncryptionType.Apr
	nil,                                   // 77: enterprise.gloo.solo.io.BasicAuth.UserList.UsersEntry
	nil,                                   // 78: enterprise.gloo.solo.io.OAuth.AuthEndpointQueryParamsEntry
	(*UserSession_InternalSession)(nil),   // 79: enterprise.gloo.solo.io.UserSession.InternalSession
	(*UserSession_RedisSession)(nil),      // 80: enterprise.gloo.solo.io.UserSession.RedisSession
	(*UserSession_CookieOptions)(nil),     // 81: enterprise.gloo.solo.io.UserSession.CookieOptions
	(*UserSession_CipherConfig)(nil),      // 82: enterprise.gloo.solo.io.UserSession.CipherConfig
	nil,                                   // 83: enterprise.gloo.solo.io.OidcAuthorizationCode.AuthEndpointQueryParamsEntry
	nil,                                   // 84: enterprise.gloo.solo.io.OidcAuthorizationCode.TokenEndpointQueryParamsEntry
	nil,                                   // 85: enterprise.gloo.solo.io.OidcAuthorizationCode.DynamicMetadataFromClaimsEntry
	(*OidcAuthorizationCode_AccessToken)(nil),                        // 86: enterprise.gloo.solo.io.OidcAuthorizationCode.AccessToken
	(*OidcAuthorizationCode_IdentityToken)(nil),                      // 87: enterprise.gloo.solo.io.OidcAuthorizationCode.IdentityToken
	(*OidcAuthorizationCode_ClientAuthentication)(nil),               // 88: enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication
	(*OidcAuthorizationCode_Default)(nil),                            // 89: enterprise.gloo.solo.io.OidcAuthorizationCode.Default
	(*OidcAuthorizationCode_Azure)(nil),                              // 90: enterprise.gloo.solo.io.OidcAuthorizationCode.Azure
	(*OidcAuthorizationCode_ClientAuthentication_ClientSecret)(nil),  // 91: enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication.ClientSecret
	(*OidcAuthorizationCode_ClientAuthentication_PrivateKeyJwt)(nil), // 92: enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication.PrivateKeyJwt
	nil,                                      // 93: enterprise.gloo.solo.io.PlainOAuth2.AuthEndpointQueryParamsEntry
	nil,                                      // 94: enterprise.gloo.solo.io.PlainOAuth2.TokenEndpointQueryParamsEntry
	(*JwtValidation_RemoteJwks)(nil),         // 95: enterprise.gloo.solo.io.JwtValidation.RemoteJwks
	(*JwtValidation_LocalJwks)(nil),          // 96: enterprise.gloo.solo.io.JwtValidation.LocalJwks
	nil,                                      // 97: enterprise.gloo.solo.io.AccessTokenValidation.DynamicMetadataFromClaimsEntry
	...
	(*ExtAuthConfig_BasicAuthInternal)(nil),  // 115: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal
	(*ExtAuthConfig_OAuthConfig)(nil),        // 116: enterprise.gloo.solo.io.ExtAuthConfig.OAuthConfig
	(*ExtAuthConfig_UserSessionConfig)(nil),  // 117: enterprise.gloo.solo.io.ExtAuthConfig.UserSessionConfig
	(*ExtAuthConfig_OidcAuthorizationCodeConfig)(nil),           // 118: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig
	(*ExtAuthConfig_AccessTokenValidationConfig)(nil),           // 119: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig
	(*ExtAuthConfig_PlainOAuth2Config)(nil),                     // 120: enterprise.gloo.solo.io.ExtAuthConfig.PlainOAuth2Config
	(*ExtAuthConfig_OAuth2Config)(nil),                          // 121: enterprise.gloo.solo.io.ExtAuthConfig.OAuth2Config
	(*ExtAuthConfig_ApiKeyAuthConfig)(nil),                      // 122: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig
	(*ExtAuthConfig_OpaAuthConfig)(nil),                         // 123: enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig
	(*ExtAuthConfig_OpaServerAuthConfig)(nil),                   // 124: enterprise.gloo.solo.io.ExtAuthConfig.OpaServerAuthConfig
	(*ExtAuthConfig_LdapConfig)(nil),                            // 125: enterprise.gloo.solo.io.ExtAuthConfig.LdapConfig
	(*ExtAuthConfig_LdapServiceAccountConfig)(nil),              // 126: enterprise.gloo.solo.io.ExtAuthConfig.LdapServiceAccountConfig
	(*ExtAuthConfig_HmacAuthConfig)(nil),                        // 127: enterprise.gloo.solo.io.ExtAuthConfig.HmacAuthConfig
	(*ExtAuthConfig_InMemorySecretList)(nil),                    // 128: enterprise.gloo.solo.io.ExtAuthConfig.InMemorySecretList
	(*ExtAuthConfig_Config)(nil),                                // 129: enterprise.gloo.solo.io.ExtAuthConfig.Config
	(*ExtAuthConfig_FailureOnUpdatePolicy)(nil),                 // 130: enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy
	(*ExtAuthConfig_BasicAuthInternal_EncryptionType)(nil),      // 131: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.EncryptionType
	(*ExtAuthConfig_BasicAuthInternal_User)(nil),                // 132: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.User
	(*ExtAuthConfig_BasicAuthInternal_UserList)(nil),            // 133: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.UserList
	(*ExtAuthConfig_BasicAuthInternal_EncryptionType_Sha1)(nil), // 134: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.EncryptionType.Sha1
	(*ExtAuthConfig_BasicAuthInternal_EncryptionType_Apr)(nil),  // 135: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.EncryptionType.Apr
	nil, // 136: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.UserList.UsersEntry
	nil, // 137: enterprise.gloo.solo.io.ExtAuthConfig.OAuthConfig.AuthEndpointQueryParamsEntry
	(*ExtAuthConfig_UserSessionConfig_CipherConfig)(nil), // 138: enterprise.gloo.solo.io.ExtAuthConfig.UserSessionConfig.CipherConfig
	nil, // 139: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.AuthEndpointQueryParamsEntry
	nil, // 140: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.TokenEndpointQueryParamsEntry
	(*ExtAuthConfig_OidcAuthorizationCodeConfig_PkJwtClientAuthenticationConfig)(nil), // 141: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.PkJwtClientAuthenticationConfig
	(*ExtAuthConfig_OidcAuthorizationCodeConfig_ClaimToHeader)(nil),                   // 142: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.ClaimToHeader
	(*ExtAuthConfig_OidcAuthorizationCodeConfig_AccessToken)(nil),                     // 143: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.AccessToken
	(*ExtAuthConfig_OidcAuthorizationCodeConfig_IdentityToken)(nil),                   // 144: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.IdentityToken
	(*ExtAuthConfig_OidcAuthorizationCodeConfig_Default)(nil),                         // 145: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.Default
	(*ExtAuthConfig_OidcAuthorizationCodeConfig_Azure)(nil),                           // 146: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.Azure
	(*ExtAuthConfig_AccessTokenValidationConfig_JwtValidation)(nil),                   // 147: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation
	(*ExtAuthConfig_AccessTokenValidationConfig_IntrospectionValidation)(nil),         // 148: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.IntrospectionValidation
	(*ExtAuthConfig_AccessTokenValidationConfig_ScopeList)(nil),                       // 149: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.ScopeList
	(*ExtAuthConfig_AccessTokenValidationConfig_JwtValidation_RemoteJwks)(nil),        // 150: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.RemoteJwks
	(*ExtAuthConfig_AccessTokenValidationConfig_JwtValidation_LocalJwks)(nil),         // 151: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.LocalJwks
	nil, // 152: enterprise.gloo.solo.io.ExtAuthConfig.PlainOAuth2Config.AuthEndpointQueryParamsEntry
	nil, // 153: enterprise.gloo.solo.io.ExtAuthConfig.PlainOAuth2Config.TokenEndpointQueryParamsEntry
	(*ExtAuthConfig_ApiKeyAuthConfig_KeyMetadata)(nil), // 154: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.KeyMetadata
	nil, // 155: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.ValidApiKeysEntry
	nil, // 156: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.HeadersFromKeyMetadataEntry
	nil, // 157: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.KeyMetadata.MetadataEntry
	nil, // 158: enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig.ModulesEntry
	nil, // 159: enterprise.gloo.solo.io.ExtAuthConfig.InMemorySecretList.SecretListEntry
	(*ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting)(nil),     // 160: enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy.ContinueExisting
	(*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable)(nil), // 161: enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy.ReplaceIfRecoverable
	(*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting)(nil),      // 162: enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy.ReplaceExisting
	nil,                               // 163: enterprise.gloo.solo.io.AuthConfigStatus.SubresourceStatusesEntry
	nil,                               // 164: enterprise.gloo.solo.io.AuthConfigNamespacedStatuses.StatusesEntry
	(*wrappers.StringValue)(nil),      // 165: google.protobuf.StringValue
	(*core.ResourceRef)(nil),          // 166: core.solo.io.ResourceRef
	(*duration.Duration)(nil),         // 167: google.protobuf.Duration
	(*_struct.Struct)(nil),            // 168: google.protobuf.Struct
	(*wrappers.BoolValue)(nil),        // 169: google.protobuf.BoolValue
	(*empty.Empty)(nil),               // 170: google.protobuf.Empty
	(*wrappers.UInt32Value)(nil),      // 171: google.protobuf.UInt32Value
	(*v2.DiscoveryRequest)(nil),       // 172: envoy.api.v2.DiscoveryRequest
	(*v2.DeltaDiscoveryRequest)(nil),  // 173: envoy.api.v2.DeltaDiscoveryRequest
	(*v2.DiscoveryResponse)(nil),      // 174: envoy.api.v2.DiscoveryResponse
	(*v2.DeltaDiscoveryResponse)(nil), // 175: envoy.api.v2.DeltaDiscoveryResponse
}
var file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_depIdxs = []int32{
	...
	165, // 1: enterprise.gloo.solo.io.AuthConfigSpec.boolean_expr:type_name -> google.protobuf.StringValue
	61,  // 2: enterprise.gloo.solo.io.AuthConfigSpec.failure_on_update_policy:type_name -> enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy
	166, // 3: enterprise.gloo.solo.io.ExtAuthExtension.config_ref:type_name -> core.solo.io.ResourceRef
	11,  // 4: enterprise.gloo.solo.io.ExtAuthExtension.custom_auth:type_name -> enterprise.gloo.solo.io.CustomAuth
	166, // 5: enterprise.gloo.solo.io.Settings.extauthz_server_ref:type_name -> core.solo.io.ResourceRef
	...
	167, // 8: enterprise.gloo.solo.io.Settings.request_timeout:type_name -> google.protobuf.Duration
	...
	65,  // 11: enterprise.gloo.solo.io.HttpService.request:type_name -> enterprise.gloo.solo.io.HttpService.Request
	66,  // 12: enterprise.gloo.solo.io.HttpService.response:type_name -> enterprise.gloo.solo.io.HttpService.Response
	68,  // 13: enterprise.gloo.solo.io.CustomAuth.context_extensions:type_name -> enterprise.gloo.solo.io.CustomAuth.ContextExtensionsEntry
	168, // 14: enterprise.gloo.solo.io.AuthPlugin.config:type_name -> google.protobuf.Struct
	69,  // 15: enterprise.gloo.solo.io.BasicAuth.apr:type_name -> enterprise.gloo.solo.io.BasicAuth.Apr
	70,  // 16: enterprise.gloo.solo.io.BasicAuth.encryption:type_name -> enterprise.gloo.solo.io.BasicAuth.EncryptionType
	72,  // 17: enterprise.gloo.solo.io.BasicAuth.user_list:type_name -> enterprise.gloo.solo.io.BasicAuth.UserList
	...
	166, // 20: enterprise.gloo.solo.io.SecretRefList.secret_refs:type_name -> core.solo.io.ResourceRef
	166, // 21: enterprise.gloo.solo.io.OAuth.client_secret_ref:type_name -> core.solo.io.ResourceRef
	78,  // 22: enterprise.gloo.solo.io.OAuth.auth_endpoint_query_params:type_name -> enterprise.gloo.solo.io.OAuth.AuthEndpointQueryParamsEntry
	...
	81,  // 27: enterprise.gloo.solo.io.UserSession.cookie_options:type_name -> enterprise.gloo.solo.io.UserSession.CookieOptions
	79,  // 28: enterprise.gloo.solo.io.UserSession.cookie:type_name -> enterprise.gloo.solo.io.UserSession.InternalSession
	80,  // 29: enterprise.gloo.solo.io.UserSession.redis:type_name -> enterprise.gloo.solo.io.UserSession.RedisSession
	82,  // 30: enterprise.gloo.solo.io.UserSession.cipher_config:type_name -> enterprise.gloo.solo.io.UserSession.CipherConfig
	169, // 31: enterprise.gloo.solo.io.HeaderConfiguration.use_bearer_schema_for_authorization:type_name -> google.protobuf.BoolValue
	170, // 32: enterprise.gloo.solo.io.JwksOnDemandCacheRefreshPolicy.never:type_name -> google.protobuf.Empty
	170, // 33: enterprise.gloo.solo.io.JwksOnDemandCacheRefreshPolicy.always:type_name -> google.protobuf.Empty
	...
	166, // 35: enterprise.gloo.solo.io.OidcAuthorizationCode.client_secret_ref:type_name -> core.solo.io.ResourceRef
	83,  // 36: enterprise.gloo.solo.io.OidcAuthorizationCode.auth_endpoint_query_params:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.AuthEndpointQueryParamsEntry
	84,  // 37: enterprise.gloo.solo.io.OidcAuthorizationCode.token_endpoint_query_params:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.TokenEndpointQueryParamsEntry
	...
	167, // 41: enterprise.gloo.solo.io.OidcAuthorizationCode.discovery_poll_interval:type_name -> google.protobuf.Duration
	...
	85,  // 45: enterprise.gloo.solo.io.OidcAuthorizationCode.dynamic_metadata_from_claims:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.DynamicMetadataFromClaimsEntry
	169, // 46: enterprise.gloo.solo.io.OidcAuthorizationCode.disable_client_secret:type_name -> google.protobuf.BoolValue
	86,  // 47: enterprise.gloo.solo.io.OidcAuthorizationCode.access_token:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.AccessToken
	87,  // 48: enterprise.gloo.solo.io.OidcAuthorizationCode.identity_token:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.IdentityToken
	88,  // 49: enterprise.gloo.solo.io.OidcAuthorizationCode.client_authentication:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication
	89,  // 50: enterprise.gloo.solo.io.OidcAuthorizationCode.default:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.Default
	90,  // 51: enterprise.gloo.solo.io.OidcAuthorizationCode.azure:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.Azure
	166, // 52: enterprise.gloo.solo.io.PlainOAuth2.client_secret_ref:type_name -> core.solo.io.ResourceRef
	93,  // 53: enterprise.gloo.solo.io.PlainOAuth2.auth_endpoint_query_params:type_name -> enterprise.gloo.solo.io.PlainOAuth2.AuthEndpointQueryParamsEntry
	20,  // 54: enterprise.gloo.solo.io.PlainOAuth2.session:type_name -> enterprise.gloo.solo.io.UserSession
	94,  // 55: enterprise.gloo.solo.io.PlainOAuth2.token_endpoint_query_params:type_name -> enterprise.gloo.solo.io.PlainOAuth2.TokenEndpointQueryParamsEntry
	169, // 56: enterprise.gloo.solo.io.PlainOAuth2.disable_client_secret:type_name -> google.protobuf.BoolValue
	95,  // 57: enterprise.gloo.solo.io.JwtValidation.remote_jwks:type_name -> enterprise.gloo.solo.io.JwtValidation.RemoteJwks
	96,  // 58: enterprise.gloo.solo.io.JwtValidation.local_jwks:type_name -> enterprise.gloo.solo.io.JwtValidation.LocalJwks
	166, // 59: enterprise.gloo.solo.io.IntrospectionValidation.client_secret_ref:type_name -> core.solo.io.ResourceRef
	169, // 60: enterprise.gloo.solo.io.IntrospectionValidation.disable_client_secret:type_name -> google.protobuf.BoolValue
	...
	167, // 63: enterprise.gloo.solo.io.AccessTokenValidation.cache_timeout:type_name -> google.protobuf.Duration
	98,  // 64: enterprise.gloo.solo.io.AccessTokenValidation.required_scopes:type_name -> enterprise.gloo.solo.io.AccessTokenValidation.ScopeList
	97,  // 65: enterprise.gloo.solo.io.AccessTokenValidation.dynamic_metadata_from_claims:type_name -> enterprise.gloo.solo.io.AccessTokenValidation.DynamicMetadataFromClaimsEntry
	99,  // 66: enterprise.gloo.solo.io.ApiKeyAuth.label_selector:type_name -> enterprise.gloo.solo.io.ApiKeyAuth.LabelSelectorEntry
	166, // 67: enterprise.gloo.solo.io.ApiKeyAuth.api_key_secret_refs:type_name -> core.solo.io.ResourceRef
	100, // 68: enterprise.gloo.solo.io.ApiKeyAuth.headers_from_metadata:type_name -> enterprise.gloo.solo.io.ApiKeyAuth.HeadersFromMetadataEntry
	101, // 69: enterprise.gloo.solo.io.ApiKeyAuth.headers_from_metadata_entry:type_name -> enterprise.gloo.solo.io.ApiKeyAuth.HeadersFromMetadataEntryEntry
	...
	104, // 72: enterprise.gloo.solo.io.K8sSecretApiKeyStorage.label_selector:type_name -> enterprise.gloo.solo.io.K8sSecretApiKeyStorage.LabelSelectorEntry
	166, // 73: enterprise.gloo.solo.io.K8sSecretApiKeyStorage.api_key_secret_refs:type_name -> core.solo.io.ResourceRef
	105, // 74: enterprise.gloo.solo.io.AerospikeApiKeyStorage.read_mode_sc:type_name -> enterprise.gloo.solo.io.AerospikeApiKeyStorage.readModeSc
	106, // 75: enterprise.gloo.solo.io.AerospikeApiKeyStorage.read_mode_ap:type_name -> enterprise.gloo.solo.io.AerospikeApiKeyStorage.readModeAp
	107, // 76: enterprise.gloo.solo.io.AerospikeApiKeyStorage.tls_curve_groups:type_name -> enterprise.gloo.solo.io.AerospikeApiKeyStorage.tlsCurveID
	108, // 77: enterprise.gloo.solo.io.AerospikeApiKeyStorage.label_selector:type_name -> enterprise.gloo.solo.io.AerospikeApiKeyStorage.LabelSelectorEntry
	109, // 78: enterprise.gloo.solo.io.ApiKey.metadata:type_name -> enterprise.gloo.solo.io.ApiKey.MetadataEntry
	110, // 79: enterprise.gloo.solo.io.ApiKeySecret.metadata:type_name -> enterprise.gloo.solo.io.ApiKeySecret.MetadataEntry
	166, // 80: enterprise.gloo.solo.io.OpaAuth.modules:type_name -> core.solo.io.ResourceRef
	...
	111, // 83: enterprise.gloo.solo.io.Ldap.pool:type_name -> enterprise.gloo.solo.io.Ldap.ConnectionPool
	42,  // 84: enterprise.gloo.solo.io.Ldap.group_lookup_settings:type_name -> enterprise.gloo.solo.io.LdapServiceAccount
	166, // 85: enterprise.gloo.solo.io.LdapServiceAccount.credentials_secret_ref:type_name -> core.solo.io.ResourceRef
	...
	168, // 88: enterprise.gloo.solo.io.PassThroughAuth.config:type_name -> google.protobuf.Struct
	167, // 89: enterprise.gloo.solo.io.BackoffStrategy.base_interval:type_name -> google.protobuf.Duration
	167, // 90: enterprise.gloo.solo.io.BackoffStrategy.max_interval:type_name -> google.protobuf.Duration
	171, // 91: enterprise.gloo.solo.io.RetryPolicy.num_retries:type_name -> google.protobuf.UInt32Value
	44,  // 92: enterprise.gloo.solo.io.RetryPolicy.retry_back_off:type_name -> enterprise.gloo.solo.io.BackoffStrategy
	167, // 93: enterprise.gloo.solo.io.PassThroughGrpc.connection_timeout:type_name -> google.protobuf.Duration
	...
	112, // 96: enterprise.gloo.solo.io.PassThroughHttp.request:type_name -> enterprise.gloo.solo.io.PassThroughHttp.Request
	113, // 97: enterprise.gloo.solo.io.PassThroughHttp.response:type_name -> enterprise.gloo.solo.io.PassThroughHttp.Response
	167, // 98: enterprise.gloo.solo.io.PassThroughHttp.connection_timeout:type_name -> google.protobuf.Duration
	129, // 99: enterprise.gloo.solo.io.ExtAuthConfig.configs:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.Config
	165, // 100: enterprise.gloo.solo.io.ExtAuthConfig.boolean_expr:type_name -> google.protobuf.StringValue
	130, // 101: enterprise.gloo.solo.io.ExtAuthConfig.failure_on_update_policy:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy
	...
	163, // 108: enterprise.gloo.solo.io.AuthConfigStatus.subresource_statuses:type_name -> enterprise.gloo.solo.io.AuthConfigStatus.SubresourceStatusesEntry
	168, // 109: enterprise.gloo.solo.io.AuthConfigStatus.details:type_name -> google.protobuf.Struct
	164, // 110: enterprise.gloo.solo.io.AuthConfigNamespacedStatuses.statuses:type_name -> enterprise.gloo.solo.io.AuthConfigNamespacedStatuses.StatusesEntry
	165, // 111: enterprise.gloo.solo.io.AuthConfigSpec.Config.name:type_name -> google.protobuf.StringValue
	...
	170, // 119: enterprise.gloo.solo.io.AuthConfigSpec.Config.jwt:type_name -> google.protobuf.Empty
	...
	62,  // 123: enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy.continue_existing:type_name -> enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy.ContinueExisting
	63,  // 124: enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy.replace_if_recoverable:type_name -> enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy.ReplaceIfRecoverable
	64,  // 125: enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy.replace_existing:type_name -> enterprise.gloo.solo.io.AuthConfigSpec.FailureOnUpdatePolicy.ReplaceExisting
	67,  // 126: enterprise.gloo.solo.io.HttpService.Request.headers_to_add:type_name -> enterprise.gloo.solo.io.HttpService.Request.HeadersToAddEntry
	74,  // 127: enterprise.gloo.solo.io.BasicAuth.Apr.users:type_name -> enterprise.gloo.solo.io.BasicAuth.Apr.UsersEntry
	76,  // 128: enterprise.gloo.solo.io.BasicAuth.EncryptionType.apr:type_name -> enterprise.gloo.solo.io.BasicAuth.EncryptionType.Apr
	75,  // 129: enterprise.gloo.solo.io.BasicAuth.EncryptionType.sha1:type_name -> enterprise.gloo.solo.io.BasicAuth.EncryptionType.Sha1
	77,  // 130: enterprise.gloo.solo.io.BasicAuth.UserList.users:type_name -> enterprise.gloo.solo.io.BasicAuth.UserList.UsersEntry
	73,  // 131: enterprise.gloo.solo.io.BasicAuth.Apr.UsersEntry.value:type_name -> enterprise.gloo.solo.io.BasicAuth.Apr.SaltedHashedPassword
	71,  // 132: enterprise.gloo.solo.io.BasicAuth.UserList.UsersEntry.value:type_name -> enterprise.gloo.solo.io.BasicAuth.User
	169, // 133: enterprise.gloo.solo.io.UserSession.InternalSession.allow_refreshing:type_name -> google.protobuf.BoolValue
	19,  // 134: enterprise.gloo.solo.io.UserSession.RedisSession.options:type_name -> enterprise.gloo.solo.io.RedisOptions
	169, // 135: enterprise.gloo.solo.io.UserSession.RedisSession.allow_refreshing:type_name -> google.protobuf.BoolValue
	167, // 136: enterprise.gloo.solo.io.UserSession.RedisSession.pre_expiry_buffer:type_name -> google.protobuf.Duration
	171, // 137: enterprise.gloo.solo.io.UserSession.CookieOptions.max_age:type_name -> google.protobuf.UInt32Value
	169, // 138: enterprise.gloo.solo.io.UserSession.CookieOptions.http_only:type_name -> google.protobuf.BoolValue
	165, // 139: enterprise.gloo.solo.io.UserSession.CookieOptions.path:type_name -> google.protobuf.StringValue
	2,   // 140: enterprise.gloo.solo.io.UserSession.CookieOptions.same_site:type_name -> enterprise.gloo.solo.io.UserSession.CookieOptions.SameSite
	166, // 141: enterprise.gloo.solo.io.UserSession.CipherConfig.key_ref:type_name -> core.solo.io.ResourceRef
	26,  // 142: enterprise.gloo.solo.io.OidcAuthorizationCode.AccessToken.claims_to_headers:type_name -> enterprise.gloo.solo.io.ClaimToHeader
	26,  // 143: enterprise.gloo.solo.io.OidcAuthorizationCode.IdentityToken.claims_to_headers:type_name -> enterprise.gloo.solo.io.ClaimToHeader
	91,  // 144: enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication.client_secret:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication.ClientSecret
	92,  // 145: enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication.private_key_jwt:type_name -> enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication.PrivateKeyJwt
	166, // 146: enterprise.gloo.solo.io.OidcAuthorizationCode.Azure.client_secret:type_name -> core.solo.io.ResourceRef
	19,  // 147: enterprise.gloo.solo.io.OidcAuthorizationCode.Azure.claims_caching_options:type_name -> enterprise.gloo.solo.io.RedisOptions
	166, // 148: enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication.ClientSecret.client_secret_ref:type_name -> core.solo.io.ResourceRef
	169, // 149: enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication.ClientSecret.disable_client_secret:type_name -> google.protobuf.BoolValue
	166, // 150: enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication.PrivateKeyJwt.signing_key_ref:type_name -> core.solo.io.ResourceRef
	167, // 151: enterprise.gloo.solo.io.OidcAuthorizationCode.ClientAuthentication.PrivateKeyJwt.valid_for:type_name -> google.protobuf.Duration
	167, // 152: enterprise.gloo.solo.io.JwtValidation.RemoteJwks.refresh_interval:type_name -> google.protobuf.Duration
	102, // 153: enterprise.gloo.solo.io.ApiKeyAuth.HeadersFromMetadataEntry.value:type_name -> enterprise.gloo.solo.io.ApiKeyAuth.SecretKey
	103, // 154: enterprise.gloo.solo.io.ApiKeyAuth.HeadersFromMetadataEntryEntry.value:type_name -> enterprise.gloo.solo.io.ApiKeyAuth.MetadataEntry
	171, // 155: enterprise.gloo.solo.io.Ldap.ConnectionPool.maxSize:type_name -> google.protobuf.UInt32Value
	171, // 156: enterprise.gloo.solo.io.Ldap.ConnectionPool.initialSize:type_name -> google.protobuf.UInt32Value
	114, // 157: enterprise.gloo.solo.io.PassThroughHttp.Request.headers_to_add:type_name -> enterprise.gloo.solo.io.PassThroughHttp.Request.HeadersToAddEntry
	131, // 158: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.encryption:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.EncryptionType
	133, // 159: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.user_list:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.UserList
	137, // 160: enterprise.gloo.solo.io.ExtAuthConfig.OAuthConfig.auth_endpoint_query_params:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OAuthConfig.AuthEndpointQueryParamsEntry
	81,  // 161: enterprise.gloo.solo.io.ExtAuthConfig.UserSessionConfig.cookie_options:type_name -> enterprise.gloo.solo.io.UserSession.CookieOptions
	79,  // 162: enterprise.gloo.solo.io.ExtAuthConfig.UserSessionConfig.cookie:type_name -> enterprise.gloo.solo.io.UserSession.InternalSession
	80,  // 163: enterprise.gloo.solo.io.ExtAuthConfig.UserSessionConfig.redis:type_name -> enterprise.gloo.solo.io.UserSession.RedisSession
	138, // 164: enterprise.gloo.solo.io.ExtAuthConfig.UserSessionConfig.cipher_config:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.UserSessionConfig.CipherConfig
	139, // 165: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.auth_endpoint_query_params:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.AuthEndpointQueryParamsEntry
	140, // 166: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.token_endpoint_query_params:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.TokenEndpointQueryParamsEntry
	20,  // 167: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.session:type_name -> enterprise.gloo.solo.io.UserSession
	21,  // 168: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.headers:type_name -> enterprise.gloo.solo.io.HeaderConfiguration
	22,  // 169: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.discovery_override:type_name -> enterprise.gloo.solo.io.DiscoveryOverride
	167, // 170: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.discovery_poll_interval:type_name -> google.protobuf.Duration
	23,  // 171: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.jwks_cache_refresh_policy:type_name -> enterprise.gloo.solo.io.JwksOnDemandCacheRefreshPolicy
	24,  // 172: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.auto_map_from_metadata:type_name -> enterprise.gloo.solo.io.AutoMapFromMetadata
	25,  // 173: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.end_session_properties:type_name -> enterprise.gloo.solo.io.EndSessionProperties
	117, // 174: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.user_session:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.UserSessionConfig
	141, // 175: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.pk_jwt_client_authentication_config:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.PkJwtClientAuthenticationConfig
	143, // 176: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.access_token:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.AccessToken
	144, // 177: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.identity_token:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.IdentityToken
	145, // 178: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.default:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.Default
	146, // 179: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.azure:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.Azure
	147, // 180: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.jwt:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation
	148, // 181: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.introspection:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.IntrospectionValidation
	167, // 182: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.cache_timeout:type_name -> google.protobuf.Duration
	149, // 183: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.required_scopes:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.ScopeList
	152, // 184: enterprise.gloo.solo.io.ExtAuthConfig.PlainOAuth2Config.auth_endpoint_query_params:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.PlainOAuth2Config.AuthEndpointQueryParamsEntry
	20,  // 185: enterprise.gloo.solo.io.ExtAuthConfig.PlainOAuth2Config.session:type_name -> enterprise.gloo.solo.io.UserSession
	153, // 186: enterprise.gloo.solo.io.ExtAuthConfig.PlainOAuth2Config.token_endpoint_query_params:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.PlainOAuth2Config.TokenEndpointQueryParamsEntry
	117, // 187: enterprise.gloo.solo.io.ExtAuthConfig.PlainOAuth2Config.user_session:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.UserSessionConfig
	118, // 188: enterprise.gloo.solo.io.ExtAuthConfig.OAuth2Config.oidc_authorization_code:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig
	119, // 189: enterprise.gloo.solo.io.ExtAuthConfig.OAuth2Config.access_token_validation_config:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig
	120, // 190: enterprise.gloo.solo.io.ExtAuthConfig.OAuth2Config.oauth2_config:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.PlainOAuth2Config
	155, // 191: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.valid_api_keys:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.ValidApiKeysEntry
	156, // 192: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.headers_from_key_metadata:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.HeadersFromKeyMetadataEntry
	34,  // 193: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.k8s_secret_apikey_storage:type_name -> enterprise.gloo.solo.io.K8sSecretApiKeyStorage
	35,  // 194: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.aerospike_apikey_storage:type_name -> enterprise.gloo.solo.io.AerospikeApiKeyStorage
	158, // 195: enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig.modules:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig.ModulesEntry
	39,  // 196: enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig.options:type_name -> enterprise.gloo.solo.io.OpaAuthOptions
	39,  // 197: enterprise.gloo.solo.io.ExtAuthConfig.OpaServerAuthConfig.options:type_name -> enterprise.gloo.solo.io.OpaAuthOptions
	111, // 198: enterprise.gloo.solo.io.ExtAuthConfig.LdapConfig.pool:type_name -> enterprise.gloo.solo.io.Ldap.ConnectionPool
	126, // 199: enterprise.gloo.solo.io.ExtAuthConfig.LdapConfig.group_lookup_settings:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.LdapServiceAccountConfig
	128, // 200: enterprise.gloo.solo.io.ExtAuthConfig.HmacAuthConfig.secret_list:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.InMemorySecretList
	16,  // 201: enterprise.gloo.solo.io.ExtAuthConfig.HmacAuthConfig.parameters_in_headers:type_name -> enterprise.gloo.solo.io.HmacParametersInHeaders
	159, // 202: enterprise.gloo.solo.io.ExtAuthConfig.InMemorySecretList.secret_list:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.InMemorySecretList.SecretListEntry
	165, // 203: enterprise.gloo.solo.io.ExtAuthConfig.Config.name:type_name -> google.protobuf.StringValue
	116, // 204: enterprise.gloo.solo.io.ExtAuthConfig.Config.oauth:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OAuthConfig
	121, // 205: enterprise.gloo.solo.io.ExtAuthConfig.Config.oauth2:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OAuth2Config
	13,  // 206: enterprise.gloo.solo.io.ExtAuthConfig.Config.basic_auth:type_name -> enterprise.gloo.solo.io.BasicAuth
	115, // 207: enterprise.gloo.solo.io.ExtAuthConfig.Config.basic_auth_internal:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal
	122, // 208: enterprise.gloo.solo.io.ExtAuthConfig.Config.api_key_auth:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig
	12,  // 209: enterprise.gloo.solo.io.ExtAuthConfig.Config.plugin_auth:type_name -> enterprise.gloo.solo.io.AuthPlugin
	123, // 210: enterprise.gloo.solo.io.ExtAuthConfig.Config.opa_auth:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OpaAuthConfig
	41,  // 211: enterprise.gloo.solo.io.ExtAuthConfig.Config.ldap:type_name -> enterprise.gloo.solo.io.Ldap
	125, // 212: enterprise.gloo.solo.io.ExtAuthConfig.Config.ldap_internal:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.LdapConfig
	170, // 213: enterprise.gloo.solo.io.ExtAuthConfig.Config.jwt:type_name -> google.protobuf.Empty
	43,  // 214: enterprise.gloo.solo.io.ExtAuthConfig.Config.pass_through_auth:type_name -> enterprise.gloo.solo.io.PassThroughAuth
	127, // 215: enterprise.gloo.solo.io.ExtAuthConfig.Config.hmac_auth:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.HmacAuthConfig
	124, // 216: enterprise.gloo.solo.io.ExtAuthConfig.Config.opa_server_auth:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OpaServerAuthConfig
	160, // 217: enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy.continue_existing:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy.ContinueExisting
	161, // 218: enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy.replace_if_recoverable:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy.ReplaceIfRecoverable
	162, // 219: enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy.replace_existing:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.FailureOnUpdatePolicy.ReplaceExisting
	135, // 220: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.EncryptionType.apr:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.EncryptionType.Apr
	134, // 221: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.EncryptionType.sha1:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.EncryptionType.Sha1
	136, // 222: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.UserList.users:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.UserList.UsersEntry
	132, // 223: enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.UserList.UsersEntry.value:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.BasicAuthInternal.User
	167, // 224: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.PkJwtClientAuthenticationConfig.valid_for:type_name -> google.protobuf.Duration
	142, // 225: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.AccessToken.claims_to_headers:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.ClaimToHeader
	142, // 226: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.IdentityToken.claims_to_headers:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.ClaimToHeader
	19,  // 227: enterprise.gloo.solo.io.ExtAuthConfig.OidcAuthorizationCodeConfig.Azure.claims_caching_options:type_name -> enterprise.gloo.solo.io.RedisOptions
	150, // 228: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.remote_jwks:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.RemoteJwks
	151, // 229: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.local_jwks:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.LocalJwks
	167, // 230: enterprise.gloo.solo.io.ExtAuthConfig.AccessTokenValidationConfig.JwtValidation.RemoteJwks.refresh_interval:type_name -> google.protobuf.Duration
	157, // 231: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.KeyMetadata.metadata:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.KeyMetadata.MetadataEntry
	154, // 232: enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.ValidApiKeysEntry.value:type_name -> enterprise.gloo.solo.io.ExtAuthConfig.ApiKeyAuthConfig.KeyMetadata
	58,  // 233: enterprise.gloo.solo.io.AuthConfigStatus.SubresourceStatusesEntry.value:type_name -> enterprise.gloo.solo.io.AuthConfigStatus
	58,  // 234: enterprise.gloo.solo.io.AuthConfigNamespacedStatuses.StatusesEntry.value:type_name -> enterprise.gloo.solo.io.AuthConfigStatus
	172, // 235: enterprise.gloo.solo.io.ExtAuthDiscoveryService.StreamExtAuthConfig:input_type -> envoy.api.v2.DiscoveryRequest
	173, // 236: enterprise.gloo.solo.io.ExtAuthDiscoveryService.DeltaExtAuthConfig:input_type -> envoy.api.v2.DeltaDiscoveryRequest
	172, // 237: enterprise.gloo.solo.io.ExtAuthDiscoveryService.FetchExtAuthConfig:input_type -> envoy.api.v2.DiscoveryRequest
	50,  // 238: enterprise.gloo.solo.io.ApiKeyService.Create:input_type -> enterprise.gloo.solo.io.ApiKeyCreateRequest
	52,  // 239: enterprise.gloo.solo.io.ApiKeyService.Read:input_type -> enterprise.gloo.solo.io.ApiKeyReadRequest
	54,  // 240: enterprise.gloo.solo.io.ApiKeyService.Update:input_type -> enterprise.gloo.solo.io.ApiKeyUpdateRequest
	56,  // 241: enterprise.gloo.solo.io.ApiKeyService.Delete:input_type -> enterprise.gloo.solo.io.ApiKeyDeleteRequest
	174, // 242: enterprise.gloo.solo.io.ExtAuthDiscoveryService.StreamExtAuthConfig:output_type -> envoy.api.v2.DiscoveryResponse
	175, // 243: enterprise.gloo.solo.io.ExtAuthDiscoveryService.DeltaExtAuthConfig:output_type -> envoy.api.v2.DeltaDiscoveryResponse
	174, // 244: enterprise.gloo.solo.io.ExtAuthDiscoveryService.FetchExtAuthConfig:output_type -> envoy.api.v2.DiscoveryResponse
	51,  // 245: enterprise.gloo.solo.io.ApiKeyService.Create:output_type -> enterprise.gloo.solo.io.ApiKeyCreateResponse
	53,  // 246: enterprise.gloo.solo.io.ApiKeyService.Read:output_type -> enterprise.gloo.solo.io.ApiKeyReadResponse
	55,  // 247: enterprise.gloo.solo.io.ApiKeyService.Update:output_type -> enterprise.gloo.solo.io.ApiKeyUpdateResponse
	57,  // 248: enterprise.gloo.solo.io.ApiKeyService.Delete:output_type -> enterprise.gloo.solo.io.ApiKeyDeleteResponse
	242, // [242:249] is the sub-list for method output_type
	235, // [235:242] is the sub-list for method input_type
...
func file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[56].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthConfigSpec_FailureOnUpdatePolicy); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[57].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[58].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[59].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[68].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[71].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[77].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[87].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[91].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[93].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[98].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[102].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[108].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[125].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExtAuthConfig_FailureOnUpdatePolicy); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[130].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[133].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[146].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[149].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[155].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[156].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[157].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[56].OneofWrappers = []interface{}{
		(*AuthConfigSpec_FailureOnUpdatePolicy_ContinueExisting_)(nil),
		(*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceIfRecoverable_)(nil),
		(*AuthConfigSpec_FailureOnUpdatePolicy_ReplaceExisting_)(nil),
	}
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[65].OneofWrappers = []interface{}{
		(*BasicAuth_EncryptionType_Apr_)(nil),
		(*BasicAuth_EncryptionType_Sha1_)(nil),
	}
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[77].OneofWrappers = []interface{}{
		(*UserSession_CipherConfig_KeyRef)(nil),
	}
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[83].OneofWrappers = []interface{}{
	...
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[102].OneofWrappers = []interface{}{
	...
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[110].OneofWrappers = []interface{}{
	...
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[114].OneofWrappers = []interface{}{
	...
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[117].OneofWrappers = []interface{}{
		(*ExtAuthConfig_ApiKeyAuthConfig_K8SSecretApikeyStorage)(nil),
		(*ExtAuthConfig_ApiKeyAuthConfig_AerospikeApikeyStorage)(nil),
	}
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[122].OneofWrappers = []interface{}{
	...
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[125].OneofWrappers = []interface{}{
		(*ExtAuthConfig_FailureOnUpdatePolicy_ContinueExisting_)(nil),
		(*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceIfRecoverable_)(nil),
		(*ExtAuthConfig_FailureOnUpdatePolicy_ReplaceExisting_)(nil),
	}
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[126].OneofWrappers = []interface{}{
		(*ExtAuthConfig_BasicAuthInternal_EncryptionType_Apr_)(nil),
		(*ExtAuthConfig_BasicAuthInternal_EncryptionType_Sha1_)(nil),
	}
	file_github_com_solo_io_solo_apis_api_gloo_enterprise_gloo_v1_auth_config_proto_msgTypes[142].OneofWrappers = []interface{}{
