...
func (m *OidcAuthorizationCode) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetClaimsToMetadata()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("ClaimsToMetadata")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetClaimsToMetadata(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("ClaimsToMetadata")); err != nil {
				return 0, err
...
// Hash function
func (m *ClaimsToMetadata) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ClaimsToMetadata")); err != nil {
		return 0, err
	}

	if h, ok := interface{}(m.GetIdToken()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("IdToken")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetIdToken(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("IdToken")); err != nil {
				return 0, err
...
// Hash function
func (m *ClaimsToMetadata_IdToken) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ClaimsToMetadata_IdToken")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *ClaimsToMetadata_AccessToken) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ClaimsToMetadata_AccessToken")); err != nil {
		return 0, err
	}
