...
func (m *AuthConfigSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetUpdatePolicy()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("UpdatePolicy")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetUpdatePolicy(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("UpdatePolicy")); err != nil {
				return 0, err
...
// Hash function
func (m *AuthConfigSpec_UpdatePolicy) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.AuthConfigSpec_UpdatePolicy")); err != nil {
		return 0, err
	}

	err = binary.Write(hasher, binary.LittleEndian, m.GetAllowRecoverableErrors())
	if err != nil {
		return 0, err
	}
...
// Hash function
func (m *ExtAuthConfig_UpdatePolicy) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ExtAuthConfig_UpdatePolicy")); err != nil {
		return 0, err
	}
