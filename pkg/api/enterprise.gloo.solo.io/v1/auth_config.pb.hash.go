...
// Hash function
func (m *AzureOidc) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.AzureOidc")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte(m.GetApplicationClientId())); err != nil {
		return 0, err
	}
	...
	if h, ok := interface{}(m.GetCachingRedisOptions()).(safe_hasher.SafeHasher); ok {
		if _, err = hasher.Write([]byte("CachingRedisOptions")); err != nil {
			return 0, err
		}
		if _, err = h.Hash(hasher); err != nil {
			return 0, err
		...
		if fieldValue, err := hashstructure.Hash(m.GetCachingRedisOptions(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("CachingRedisOptions")); err != nil {
				return 0, err
...
func (m *OidcAuthorizationCode) Hash(hasher hash.Hash64) (uint64, error) {
	...
	case *OidcAuthorizationCode_Default:
...
// Hash function
func (m *OidcAuthorizationCode_DefaultOIDCProvider) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.OidcAuthorizationCode_DefaultOIDCProvider")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *ExtAuthConfig_MSEnteraOauth2ConfigSettings) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ExtAuthConfig_MSEnteraOauth2ConfigSettings")); err != nil {
		return 0, err
	}
