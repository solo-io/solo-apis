...
func (m *OidcAuthorizationCode_ClientSecretExchangeConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.OidcAuthorizationCode_ClientSecretExchangeConfig")); err != nil {
		return 0, err
	}
...
func (m *OidcAuthorizationCode_PkJwtExchangeConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.OidcAuthorizationCode_PkJwtExchangeConfig")); err != nil {
		return 0, err
	}
