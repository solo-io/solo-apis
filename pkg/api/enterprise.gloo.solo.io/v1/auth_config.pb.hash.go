...
func (m *OidcAuthorizationCode_CodeExchangeType) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.OidcAuthorizationCode_CodeExchangeType")); err != nil {
		return 0, err
	}
...
func (m *OidcAuthorizationCode_CodeExchangeType_ClientSecret) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.OidcAuthorizationCode_CodeExchangeType_ClientSecret")); err != nil {
		return 0, err
	}
...
func (m *OidcAuthorizationCode_CodeExchangeType_PrivateKeyJwt) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.OidcAuthorizationCode_CodeExchangeType_PrivateKeyJwt")); err != nil {
		return 0, err
	}
...
func (m *ExtAuthConfig_OidcAuthorizationCodeConfig_ClientSecretExchangeConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ExtAuthConfig_OidcAuthorizationCodeConfig_ClientSecretExchangeConfig")); err != nil {
		return 0, err
	}
...
func (m *ExtAuthConfig_OidcAuthorizationCodeConfig_PkJwtExchangeConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ExtAuthConfig_OidcAuthorizationCodeConfig_PkJwtExchangeConfig")); err != nil {
		return 0, err
	}
