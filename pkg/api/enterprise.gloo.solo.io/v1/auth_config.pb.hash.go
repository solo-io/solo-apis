...
func (m *HeaderValue) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.HeaderValue")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write(m.GetRawValue()); err != nil {
		return 0, err
	}
...
func (m *HeaderValueOption) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.HeaderValueOption")); err != nil {
		return 0, err
	}
	...
	err = binary.Write(hasher, binary.LittleEndian, m.GetKeepEmptyValue())
	if err != nil {
		return 0, err
	}
...
func (m *PassThroughHttp_Response) Hash(hasher hash.Hash64) (uint64, error) {
	...
	for _, v := range m.GetPassthroughUpstreamHeaders() {
	...
	for _, v := range m.GetPassthroughUpstreamHeadersOnDenied() {
