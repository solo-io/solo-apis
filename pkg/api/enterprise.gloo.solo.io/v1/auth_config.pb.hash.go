...
// Hash function
func (m *ExtAuthConfig_BasicAuthExtended) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ExtAuthConfig_BasicAuthExtended")); err != nil {
		return 0, err
	}
...
func (m *ExtAuthConfig_Config) Hash(hasher hash.Hash64) (uint64, error) {
	...
	case *ExtAuthConfig_Config_BasicAuthExtended:
		...
		if h, ok := interface{}(m.GetBasicAuthExtended()).(safe_hasher.SafeHasher); ok {
			if _, err = hasher.Write([]byte("BasicAuthExtended")); err != nil {
				return 0, err
			}
			if _, err = h.Hash(hasher); err != nil {
				return 0, err
			...
			if fieldValue, err := hashstructure.Hash(m.GetBasicAuthExtended(), nil); err != nil {
				return 0, err
			} else {
				if _, err = hasher.Write([]byte("BasicAuthExtended")); err != nil {
					return 0, err
...
// Hash function
func (m *ExtAuthConfig_BasicAuthExtended_EncryptionType) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ExtAuthConfig_BasicAuthExtended_EncryptionType")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *ExtAuthConfig_BasicAuthExtended_User) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ExtAuthConfig_BasicAuthExtended_User")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *ExtAuthConfig_BasicAuthExtended_UserList) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ExtAuthConfig_BasicAuthExtended_UserList")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *ExtAuthConfig_BasicAuthExtended_EncryptionType_Sha1) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ExtAuthConfig_BasicAuthExtended_EncryptionType_Sha1")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *ExtAuthConfig_BasicAuthExtended_EncryptionType_Apr) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.ExtAuthConfig_BasicAuthExtended_EncryptionType_Apr")); err != nil {
		return 0, err
	}
