...
func (m *OidcAuthorizationCode) Hash(hasher hash.Hash64) (uint64, error) {
	...
	if h, ok := interface{}(m.GetClaimsToHeaders()).(safe_hasher.SafeHasher); ok {
		...
		if fieldValue, err := hashstructure.Hash(m.GetClaimsToHeaders(), nil); err != nil {
			return 0, err
		} else {
			if _, err = hasher.Write([]byte("ClaimsToHeaders")); err != nil {
				return 0, err
...
// Hash function
func (m *OidcAuthorizationCode_OidcClaimsToHeaders) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("enterprise.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/enterprise.gloo.solo.io/v1.OidcAuthorizationCode_OidcClaimsToHeaders")); err != nil {
		return 0, err
	}
