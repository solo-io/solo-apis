...
type MulticlusterAccessPolicyReconciler interface {
	ReconcileAccessPolicy(clusterName string, obj *security_gloo_solo_io_v2.AccessPolicy) (reconcile.Result, error)
}
...
type MulticlusterAccessPolicyReconcilerFuncs struct {
	OnReconcileAccessPolicy         func(clusterName string, obj *security_gloo_solo_io_v2.AccessPolicy) (reconcile.Result, error)
	OnReconcileAccessPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterAccessPolicyReconcilerFuncs) ReconcileAccessPolicy(clusterName string, obj *security_gloo_solo_io_v2.AccessPolicy) (reconcile.Result, error) {
...
func NewMulticlusterAccessPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterAccessPolicyReconcileLoop {
	return &multiclusterAccessPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &security_gloo_solo_io_v2.AccessPolicy{}, options)}
}
...
type MulticlusterCORSPolicyReconciler interface {
	ReconcileCORSPolicy(clusterName string, obj *security_gloo_solo_io_v2.CORSPolicy) (reconcile.Result, error)
}
...
type MulticlusterCORSPolicyReconcilerFuncs struct {
	OnReconcileCORSPolicy         func(clusterName string, obj *security_gloo_solo_io_v2.CORSPolicy) (reconcile.Result, error)
	OnReconcileCORSPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterCORSPolicyReconcilerFuncs) ReconcileCORSPolicy(clusterName string, obj *security_gloo_solo_io_v2.CORSPolicy) (reconcile.Result, error) {
...
func NewMulticlusterCORSPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterCORSPolicyReconcileLoop {
	return &multiclusterCORSPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &security_gloo_solo_io_v2.CORSPolicy{}, options)}
}
...
type MulticlusterCSRFPolicyReconciler interface {
	ReconcileCSRFPolicy(clusterName string, obj *security_gloo_solo_io_v2.CSRFPolicy) (reconcile.Result, error)
}
...
type MulticlusterCSRFPolicyReconcilerFuncs struct {
	OnReconcileCSRFPolicy         func(clusterName string, obj *security_gloo_solo_io_v2.CSRFPolicy) (reconcile.Result, error)
	OnReconcileCSRFPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterCSRFPolicyReconcilerFuncs) ReconcileCSRFPolicy(clusterName string, obj *security_gloo_solo_io_v2.CSRFPolicy) (reconcile.Result, error) {
...
func NewMulticlusterCSRFPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterCSRFPolicyReconcileLoop {
	return &multiclusterCSRFPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &security_gloo_solo_io_v2.CSRFPolicy{}, options)}
}
...
type MulticlusterExtAuthPolicyReconciler interface {
	ReconcileExtAuthPolicy(clusterName string, obj *security_gloo_solo_io_v2.ExtAuthPolicy) (reconcile.Result, error)
}
...
type MulticlusterExtAuthPolicyReconcilerFuncs struct {
	OnReconcileExtAuthPolicy         func(clusterName string, obj *security_gloo_solo_io_v2.ExtAuthPolicy) (reconcile.Result, error)
	OnReconcileExtAuthPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterExtAuthPolicyReconcilerFuncs) ReconcileExtAuthPolicy(clusterName string, obj *security_gloo_solo_io_v2.ExtAuthPolicy) (reconcile.Result, error) {
...
func NewMulticlusterExtAuthPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterExtAuthPolicyReconcileLoop {
	return &multiclusterExtAuthPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &security_gloo_solo_io_v2.ExtAuthPolicy{}, options)}
}
...
type MulticlusterWAFPolicyReconciler interface {
	ReconcileWAFPolicy(clusterName string, obj *security_gloo_solo_io_v2.WAFPolicy) (reconcile.Result, error)
}
...
type MulticlusterWAFPolicyReconcilerFuncs struct {
	OnReconcileWAFPolicy         func(clusterName string, obj *security_gloo_solo_io_v2.WAFPolicy) (reconcile.Result, error)
	OnReconcileWAFPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterWAFPolicyReconcilerFuncs) ReconcileWAFPolicy(clusterName string, obj *security_gloo_solo_io_v2.WAFPolicy) (reconcile.Result, error) {
...
func NewMulticlusterWAFPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterWAFPolicyReconcileLoop {
	return &multiclusterWAFPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &security_gloo_solo_io_v2.WAFPolicy{}, options)}
}
...
type MulticlusterJWTPolicyReconciler interface {
	ReconcileJWTPolicy(clusterName string, obj *security_gloo_solo_io_v2.JWTPolicy) (reconcile.Result, error)
}
...
type MulticlusterJWTPolicyReconcilerFuncs struct {
	OnReconcileJWTPolicy         func(clusterName string, obj *security_gloo_solo_io_v2.JWTPolicy) (reconcile.Result, error)
	OnReconcileJWTPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterJWTPolicyReconcilerFuncs) ReconcileJWTPolicy(clusterName string, obj *security_gloo_solo_io_v2.JWTPolicy) (reconcile.Result, error) {
...
func NewMulticlusterJWTPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterJWTPolicyReconcileLoop {
	return &multiclusterJWTPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &security_gloo_solo_io_v2.JWTPolicy{}, options)}
}
