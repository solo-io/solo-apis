...
type AccessPolicySet interface {
	...
	List(filterResource ...func(*security_gloo_solo_io_v2.AccessPolicy) bool) []*security_gloo_solo_io_v2.AccessPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.AccessPolicy) bool) []*security_gloo_solo_io_v2.AccessPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*security_gloo_solo_io_v2.AccessPolicy
	// Insert a resource into the set.
	Insert(accessPolicy ...*security_gloo_solo_io_v2.AccessPolicy)
	...
	Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.AccessPolicy, error)
...
func makeGenericAccessPolicySet(accessPolicyList []*security_gloo_solo_io_v2.AccessPolicy) sksets.ResourceSet {
...
func NewAccessPolicySet(accessPolicyList ...*security_gloo_solo_io_v2.AccessPolicy) AccessPolicySet {
	return &accessPolicySet{set: makeGenericAccessPolicySet(accessPolicyList)}
}

func NewAccessPolicySetFromList(accessPolicyList *security_gloo_solo_io_v2.AccessPolicyList) AccessPolicySet {
	list := make([]*security_gloo_solo_io_v2.AccessPolicy, 0, len(accessPolicyList.Items))
...
func (s *accessPolicySet) List(filterResource ...func(*security_gloo_solo_io_v2.AccessPolicy) bool) []*security_gloo_solo_io_v2.AccessPolicy {
	if s == nil {
		return nil
	}
	...
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*security_gloo_solo_io_v2.AccessPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	accessPolicyList := make([]*security_gloo_solo_io_v2.AccessPolicy, 0, len(objs))
	for _, obj := range objs {
		accessPolicyList = append(accessPolicyList, obj.(*security_gloo_solo_io_v2.AccessPolicy))
	}
	return accessPolicyList
}

func (s *accessPolicySet) UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.AccessPolicy) bool) []*security_gloo_solo_io_v2.AccessPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var accessPolicyList []*security_gloo_solo_io_v2.AccessPolicy
...
func (s *accessPolicySet) Map() map[string]*security_gloo_solo_io_v2.AccessPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*security_gloo_solo_io_v2.AccessPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*security_gloo_solo_io_v2.AccessPolicy)
	}
	return newMap
}

func (s *accessPolicySet) Insert(
	accessPolicyList ...*security_gloo_solo_io_v2.AccessPolicy,
) {
	if s == nil {
...
func (s *accessPolicySet) Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.AccessPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find AccessPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&security_gloo_solo_io_v2.AccessPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*security_gloo_solo_io_v2.AccessPolicy), nil
}
...
type CORSPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*security_gloo_solo_io_v2.CORSPolicy) bool) []*security_gloo_solo_io_v2.CORSPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.CORSPolicy) bool) []*security_gloo_solo_io_v2.CORSPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*security_gloo_solo_io_v2.CORSPolicy
	// Insert a resource into the set.
	Insert(cORSPolicy ...*security_gloo_solo_io_v2.CORSPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.CORSPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericCORSPolicySet(cORSPolicyList []*security_gloo_solo_io_v2.CORSPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewCORSPolicySet(cORSPolicyList ...*security_gloo_solo_io_v2.CORSPolicy) CORSPolicySet {
	return &cORSPolicySet{set: makeGenericCORSPolicySet(cORSPolicyList)}
}

func NewCORSPolicySetFromList(cORSPolicyList *security_gloo_solo_io_v2.CORSPolicyList) CORSPolicySet {
	list := make([]*security_gloo_solo_io_v2.CORSPolicy, 0, len(cORSPolicyList.Items))
...
func (s *cORSPolicySet) List(filterResource ...func(*security_gloo_solo_io_v2.CORSPolicy) bool) []*security_gloo_solo_io_v2.CORSPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*security_gloo_solo_io_v2.CORSPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	cORSPolicyList := make([]*security_gloo_solo_io_v2.CORSPolicy, 0, len(objs))
	for _, obj := range objs {
		cORSPolicyList = append(cORSPolicyList, obj.(*security_gloo_solo_io_v2.CORSPolicy))
	}
	return cORSPolicyList
}

func (s *cORSPolicySet) UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.CORSPolicy) bool) []*security_gloo_solo_io_v2.CORSPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var cORSPolicyList []*security_gloo_solo_io_v2.CORSPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		cORSPolicyList = append(cORSPolicyList, obj.(*security_gloo_solo_io_v2.CORSPolicy))
	}
	return cORSPolicyList
...
func (s *cORSPolicySet) Map() map[string]*security_gloo_solo_io_v2.CORSPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*security_gloo_solo_io_v2.CORSPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*security_gloo_solo_io_v2.CORSPolicy)
	}
	return newMap
}

func (s *cORSPolicySet) Insert(
	cORSPolicyList ...*security_gloo_solo_io_v2.CORSPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *cORSPolicySet) Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.CORSPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find CORSPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&security_gloo_solo_io_v2.CORSPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*security_gloo_solo_io_v2.CORSPolicy), nil
}
...
type CSRFPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*security_gloo_solo_io_v2.CSRFPolicy) bool) []*security_gloo_solo_io_v2.CSRFPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.CSRFPolicy) bool) []*security_gloo_solo_io_v2.CSRFPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*security_gloo_solo_io_v2.CSRFPolicy
	// Insert a resource into the set.
	Insert(cSRFPolicy ...*security_gloo_solo_io_v2.CSRFPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.CSRFPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericCSRFPolicySet(cSRFPolicyList []*security_gloo_solo_io_v2.CSRFPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewCSRFPolicySet(cSRFPolicyList ...*security_gloo_solo_io_v2.CSRFPolicy) CSRFPolicySet {
	return &cSRFPolicySet{set: makeGenericCSRFPolicySet(cSRFPolicyList)}
}

func NewCSRFPolicySetFromList(cSRFPolicyList *security_gloo_solo_io_v2.CSRFPolicyList) CSRFPolicySet {
	list := make([]*security_gloo_solo_io_v2.CSRFPolicy, 0, len(cSRFPolicyList.Items))
...
func (s *cSRFPolicySet) List(filterResource ...func(*security_gloo_solo_io_v2.CSRFPolicy) bool) []*security_gloo_solo_io_v2.CSRFPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*security_gloo_solo_io_v2.CSRFPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	cSRFPolicyList := make([]*security_gloo_solo_io_v2.CSRFPolicy, 0, len(objs))
	for _, obj := range objs {
		cSRFPolicyList = append(cSRFPolicyList, obj.(*security_gloo_solo_io_v2.CSRFPolicy))
	}
	return cSRFPolicyList
}

func (s *cSRFPolicySet) UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.CSRFPolicy) bool) []*security_gloo_solo_io_v2.CSRFPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var cSRFPolicyList []*security_gloo_solo_io_v2.CSRFPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		cSRFPolicyList = append(cSRFPolicyList, obj.(*security_gloo_solo_io_v2.CSRFPolicy))
	}
	return cSRFPolicyList
...
func (s *cSRFPolicySet) Map() map[string]*security_gloo_solo_io_v2.CSRFPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*security_gloo_solo_io_v2.CSRFPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*security_gloo_solo_io_v2.CSRFPolicy)
	}
	return newMap
}

func (s *cSRFPolicySet) Insert(
	cSRFPolicyList ...*security_gloo_solo_io_v2.CSRFPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *cSRFPolicySet) Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.CSRFPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find CSRFPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&security_gloo_solo_io_v2.CSRFPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*security_gloo_solo_io_v2.CSRFPolicy), nil
}
...
type ExtAuthPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*security_gloo_solo_io_v2.ExtAuthPolicy) bool) []*security_gloo_solo_io_v2.ExtAuthPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.ExtAuthPolicy) bool) []*security_gloo_solo_io_v2.ExtAuthPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*security_gloo_solo_io_v2.ExtAuthPolicy
	// Insert a resource into the set.
	Insert(extAuthPolicy ...*security_gloo_solo_io_v2.ExtAuthPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.ExtAuthPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericExtAuthPolicySet(extAuthPolicyList []*security_gloo_solo_io_v2.ExtAuthPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewExtAuthPolicySet(extAuthPolicyList ...*security_gloo_solo_io_v2.ExtAuthPolicy) ExtAuthPolicySet {
	return &extAuthPolicySet{set: makeGenericExtAuthPolicySet(extAuthPolicyList)}
}

func NewExtAuthPolicySetFromList(extAuthPolicyList *security_gloo_solo_io_v2.ExtAuthPolicyList) ExtAuthPolicySet {
	list := make([]*security_gloo_solo_io_v2.ExtAuthPolicy, 0, len(extAuthPolicyList.Items))
...
func (s *extAuthPolicySet) List(filterResource ...func(*security_gloo_solo_io_v2.ExtAuthPolicy) bool) []*security_gloo_solo_io_v2.ExtAuthPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*security_gloo_solo_io_v2.ExtAuthPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	extAuthPolicyList := make([]*security_gloo_solo_io_v2.ExtAuthPolicy, 0, len(objs))
	for _, obj := range objs {
		extAuthPolicyList = append(extAuthPolicyList, obj.(*security_gloo_solo_io_v2.ExtAuthPolicy))
	}
	return extAuthPolicyList
}

func (s *extAuthPolicySet) UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.ExtAuthPolicy) bool) []*security_gloo_solo_io_v2.ExtAuthPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var extAuthPolicyList []*security_gloo_solo_io_v2.ExtAuthPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		extAuthPolicyList = append(extAuthPolicyList, obj.(*security_gloo_solo_io_v2.ExtAuthPolicy))
	}
	return extAuthPolicyList
...
func (s *extAuthPolicySet) Map() map[string]*security_gloo_solo_io_v2.ExtAuthPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*security_gloo_solo_io_v2.ExtAuthPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*security_gloo_solo_io_v2.ExtAuthPolicy)
	}
	return newMap
}

func (s *extAuthPolicySet) Insert(
	extAuthPolicyList ...*security_gloo_solo_io_v2.ExtAuthPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *extAuthPolicySet) Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.ExtAuthPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find ExtAuthPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&security_gloo_solo_io_v2.ExtAuthPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*security_gloo_solo_io_v2.ExtAuthPolicy), nil
}
...
type WAFPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*security_gloo_solo_io_v2.WAFPolicy) bool) []*security_gloo_solo_io_v2.WAFPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.WAFPolicy) bool) []*security_gloo_solo_io_v2.WAFPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*security_gloo_solo_io_v2.WAFPolicy
	// Insert a resource into the set.
	Insert(wAFPolicy ...*security_gloo_solo_io_v2.WAFPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.WAFPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericWAFPolicySet(wAFPolicyList []*security_gloo_solo_io_v2.WAFPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewWAFPolicySet(wAFPolicyList ...*security_gloo_solo_io_v2.WAFPolicy) WAFPolicySet {
	return &wAFPolicySet{set: makeGenericWAFPolicySet(wAFPolicyList)}
}

func NewWAFPolicySetFromList(wAFPolicyList *security_gloo_solo_io_v2.WAFPolicyList) WAFPolicySet {
	list := make([]*security_gloo_solo_io_v2.WAFPolicy, 0, len(wAFPolicyList.Items))
...
func (s *wAFPolicySet) List(filterResource ...func(*security_gloo_solo_io_v2.WAFPolicy) bool) []*security_gloo_solo_io_v2.WAFPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*security_gloo_solo_io_v2.WAFPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	wAFPolicyList := make([]*security_gloo_solo_io_v2.WAFPolicy, 0, len(objs))
	for _, obj := range objs {
		wAFPolicyList = append(wAFPolicyList, obj.(*security_gloo_solo_io_v2.WAFPolicy))
	}
	return wAFPolicyList
}

func (s *wAFPolicySet) UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.WAFPolicy) bool) []*security_gloo_solo_io_v2.WAFPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var wAFPolicyList []*security_gloo_solo_io_v2.WAFPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		wAFPolicyList = append(wAFPolicyList, obj.(*security_gloo_solo_io_v2.WAFPolicy))
	}
	return wAFPolicyList
...
func (s *wAFPolicySet) Map() map[string]*security_gloo_solo_io_v2.WAFPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*security_gloo_solo_io_v2.WAFPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*security_gloo_solo_io_v2.WAFPolicy)
	}
	return newMap
}

func (s *wAFPolicySet) Insert(
	wAFPolicyList ...*security_gloo_solo_io_v2.WAFPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *wAFPolicySet) Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.WAFPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find WAFPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&security_gloo_solo_io_v2.WAFPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*security_gloo_solo_io_v2.WAFPolicy), nil
}
...
type JWTPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*security_gloo_solo_io_v2.JWTPolicy) bool) []*security_gloo_solo_io_v2.JWTPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.JWTPolicy) bool) []*security_gloo_solo_io_v2.JWTPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*security_gloo_solo_io_v2.JWTPolicy
	// Insert a resource into the set.
	Insert(jWTPolicy ...*security_gloo_solo_io_v2.JWTPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.JWTPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericJWTPolicySet(jWTPolicyList []*security_gloo_solo_io_v2.JWTPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewJWTPolicySet(jWTPolicyList ...*security_gloo_solo_io_v2.JWTPolicy) JWTPolicySet {
	return &jWTPolicySet{set: makeGenericJWTPolicySet(jWTPolicyList)}
}

func NewJWTPolicySetFromList(jWTPolicyList *security_gloo_solo_io_v2.JWTPolicyList) JWTPolicySet {
	list := make([]*security_gloo_solo_io_v2.JWTPolicy, 0, len(jWTPolicyList.Items))
...
func (s *jWTPolicySet) List(filterResource ...func(*security_gloo_solo_io_v2.JWTPolicy) bool) []*security_gloo_solo_io_v2.JWTPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*security_gloo_solo_io_v2.JWTPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	jWTPolicyList := make([]*security_gloo_solo_io_v2.JWTPolicy, 0, len(objs))
	for _, obj := range objs {
		jWTPolicyList = append(jWTPolicyList, obj.(*security_gloo_solo_io_v2.JWTPolicy))
	}
	return jWTPolicyList
}

func (s *jWTPolicySet) UnsortedList(filterResource ...func(*security_gloo_solo_io_v2.JWTPolicy) bool) []*security_gloo_solo_io_v2.JWTPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var jWTPolicyList []*security_gloo_solo_io_v2.JWTPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		jWTPolicyList = append(jWTPolicyList, obj.(*security_gloo_solo_io_v2.JWTPolicy))
	}
	return jWTPolicyList
...
func (s *jWTPolicySet) Map() map[string]*security_gloo_solo_io_v2.JWTPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*security_gloo_solo_io_v2.JWTPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*security_gloo_solo_io_v2.JWTPolicy)
	}
	return newMap
}

func (s *jWTPolicySet) Insert(
	jWTPolicyList ...*security_gloo_solo_io_v2.JWTPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *jWTPolicySet) Find(id ezkube.ResourceId) (*security_gloo_solo_io_v2.JWTPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find JWTPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&security_gloo_solo_io_v2.JWTPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*security_gloo_solo_io_v2.JWTPolicy), nil
}
