...
type FederatedMatchableTcpGateway struct {
	...
	Spec   ia0552ed88a14a7609c8a695ce249939f.FederatedMatchableTcpGatewaySpec   `json:"spec,omitempty"`
	Status ia0552ed88a14a7609c8a695ce249939f.FederatedMatchableTcpGatewayStatus `json:"status,omitempty"`
}
