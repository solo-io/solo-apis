...
func (m *FederatedMatchableTcpGatewaySpec) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.gateway.solo.io.github.com/solo-io/solo-apis/pkg/api/fed.gateway.solo.io/v1/types.FederatedMatchableTcpGatewaySpec")); err != nil {
		return 0, err
	}
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *FederatedMatchableTcpGatewayStatus) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.gateway.solo.io.github.com/solo-io/solo-apis/pkg/api/fed.gateway.solo.io/v1/types.FederatedMatchableTcpGatewayStatus")); err != nil {
		return 0, err
	}
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *FederatedMatchableTcpGatewaySpec_Template) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.gateway.solo.io.github.com/solo-io/solo-apis/pkg/api/fed.gateway.solo.io/v1/types.FederatedMatchableTcpGatewaySpec_Template")); err != nil {
		return 0, err
	}
