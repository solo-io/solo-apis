...
// Equal function
func (m *FederatedHttpGatewaySpec) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*FederatedHttpGatewaySpec)
	if !ok {
		that2, ok := that.(FederatedHttpGatewaySpec)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *FederatedHttpGatewayStatus) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*FederatedHttpGatewayStatus)
	if !ok {
		that2, ok := that.(FederatedHttpGatewayStatus)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *FederatedHttpGatewaySpec_Template) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*FederatedHttpGatewaySpec_Template)
	if !ok {
		that2, ok := that.(FederatedHttpGatewaySpec_Template)
		if ok {
			target = &that2
		} else {
			return false
