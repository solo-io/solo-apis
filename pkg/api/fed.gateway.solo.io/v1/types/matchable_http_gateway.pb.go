...
const file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_rawDesc = "" +
	"\n" +
	"Ugithub.com/solo-io/solo-apis/api/gloo-fed/fed.gateway/v1/matchable_http_gateway.proto\x12\x13fed.gateway.solo.io\x1a\x12extproto/ext.proto\x1aRgithub.com/solo-io/solo-apis/api/gloo-fed/multicluster/v1alpha1/multicluster.proto\x1aEgithub.com/solo-io/solo-apis/api/gloo-fed/fed/core/v1/placement.proto\x1aMgithub.com/solo-io/solo-apis/api/gloo/gateway/v1/matchable_http_gateway.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xcb\x02\n" +
	"!FederatedMatchableHttpGatewaySpec\x12[\n" +
	"\btemplate\x18\x01 \x01(\v2?.fed.gateway.solo.io.FederatedMatchableHttpGatewaySpec.TemplateR\btemplate\x12=\n" +
	"\tplacement\x18\x02 \x01(\v2\x1f.multicluster.solo.io.PlacementR\tplacement\x1a\x89\x01\n" +
	"\bTemplate\x12=\n" +
	"\x04spec\x18\x01 \x01(\v2).gateway.solo.io.MatchableHttpGatewaySpecR\x04spec\x12>\n" +
	"\bmetadata\x18\x02 \x01(\v2\".core.fed.solo.io.TemplateMetadataR\bmetadata\"\x86\x03\n" +
	"#FederatedMatchableHttpGatewayStatus\x12L\n" +
	"\x10placement_status\x18\x01 \x01(\v2!.core.fed.solo.io.PlacementStatusR\x0fplacementStatus\x12\x9d\x01\n" +
	"\x1dnamespaced_placement_statuses\x18\x02 \x03(\v2Y.fed.gateway.solo.io.FederatedMatchableHttpGatewayStatus.NamespacedPlacementStatusesEntryR\x1bnamespacedPlacementStatuses\x1aq\n" +
...
var (
	...
	file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_rawDescData []byte
)
...
func file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_rawDesc)))
	})
...
var file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_goTypes = []any{
...
func file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_rawDesc), len(file_github_com_solo_io_solo_apis_api_gloo_fed_fed_gateway_v1_matchable_http_gateway_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
