...
// Hash function
func (m *FederatedHttpGatewaySpec) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.gateway.solo.io.github.com/solo-io/solo-apis/pkg/api/fed.gateway.solo.io/v1/types.FederatedHttpGatewaySpec")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *FederatedHttpGatewayStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.gateway.solo.io.github.com/solo-io/solo-apis/pkg/api/fed.gateway.solo.io/v1/types.FederatedHttpGatewayStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *FederatedHttpGatewaySpec_Template) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("fed.gateway.solo.io.github.com/solo-io/solo-apis/pkg/api/fed.gateway.solo.io/v1/types.FederatedHttpGatewaySpec_Template")); err != nil {
		return 0, err
	}
