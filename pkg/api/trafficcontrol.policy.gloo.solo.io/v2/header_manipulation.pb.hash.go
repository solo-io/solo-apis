...
func (m *HeaderManipulationPolicySpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("trafficcontrol.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/trafficcontrol.policy.gloo.solo.io/v2.HeaderManipulationPolicySpec")); err != nil {
		return 0, err
	}
...
func (m *HeaderManipulationPolicyStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("trafficcontrol.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/trafficcontrol.policy.gloo.solo.io/v2.HeaderManipulationPolicyStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *HeaderManipulationPolicyNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("trafficcontrol.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/trafficcontrol.policy.gloo.solo.io/v2.HeaderManipulationPolicyNewStatus")); err != nil {
		return 0, err
	}
...
func (m *HeaderManipulationPolicySpec_Config) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("trafficcontrol.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/trafficcontrol.policy.gloo.solo.io/v2.HeaderManipulationPolicySpec_Config")); err != nil {
		return 0, err
	}
