...
// Clone function
func (m *RateLimitPolicyNewStatus) Clone() proto.Message {
	var target *RateLimitPolicyNewStatus
	if m == nil {
		return target
	}
	target = &RateLimitPolicyNewStatus{}
...
func (m *RateLimitPolicySpec_Config) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetRatelimitServerConfig()).(clone.Cloner); ok {
		target.RatelimitServerConfig = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
	} else {
		target.RatelimitServerConfig = proto.Clone(m.GetRatelimitServerConfig()).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
	}

	if h, ok := interface{}(m.GetServerSettings()).(clone.Cloner); ok {
		target.ServerSettings = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
	} else {
		target.ServerSettings = proto.Clone(m.GetServerSettings()).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference)
	}
	...
	case *RateLimitPolicySpec_Config_RatelimitClientConfig:
		...
		if h, ok := interface{}(m.GetRatelimitClientConfig()).(clone.Cloner); ok {
			target.ConfigType = &RateLimitPolicySpec_Config_RatelimitClientConfig{
				RatelimitClientConfig: h.Clone().(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference),
			}
		} else {
			target.ConfigType = &RateLimitPolicySpec_Config_RatelimitClientConfig{
				RatelimitClientConfig: proto.Clone(m.GetRatelimitClientConfig()).(*github_com_solo_io_solo_apis_pkg_api_common_gloo_solo_io_v2.ObjectReference),
			}
		}
