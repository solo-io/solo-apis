...
// $hide_from_docs
type RateLimitClientConfigNewStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RateLimitClientConfigNewStatus) Reset() {
	*x = RateLimitClientConfigNewStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RateLimitClientConfigNewStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RateLimitClientConfigNewStatus) ProtoMessage() {}

func (x *RateLimitClientConfigNewStatus) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RateLimitClientConfigNewStatus.ProtoReflect.Descriptor instead.
func (*RateLimitClientConfigNewStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_rawDescGZIP(), []int{3}
}

func (x *RateLimitClientConfigNewStatus) GetCommon() *v2.Status {
	if x != nil {
		return x.Common
	}
	return nil
...
func (x *RateLimitClientConfigReport) Reset() {
	*x = RateLimitClientConfigReport{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RateLimitClientConfigReport) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_rawDescGZIP(), []int{4}
}
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x73, 0x22, 0xb5, 0x02, 0x0a, 0x1b, 0x52, 0x61, 0x74, 0x65,
	0x4c, 0x69, 0x6d, 0x69, 0x74, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	0x67, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x40, 0x0a, 0x06, 0x67, 0x6c, 0x6f, 0x62, 0x61,
	...
	0x73, 0x52, 0x06, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x12, 0x6f, 0x0a, 0x0a, 0x77, 0x6f, 0x72,
	0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x4f, 0x2e,
	...
	0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x57,
	0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0a,
	0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x1a, 0x63, 0x0a, 0x0f, 0x57, 0x6f,
	...
	0x55, 0x0a, 0x1e, 0x52, 0x61, 0x74, 0x65, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x43, 0x6c, 0x69, 0x65,
	0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4e, 0x65, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75,
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_goTypes = []interface{}{
	...
	(*RateLimitClientConfigNewStatus)(nil), // 3: trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigNewStatus
	(*RateLimitClientConfigReport)(nil),    // 4: trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigReport
	nil,                                    // 5: trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigStatus.WorkspacesEntry
	nil,                                    // 6: trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigReport.WorkspacesEntry
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_depIdxs = []int32{
	...
	7,  // 1: trafficcontrol.policy.gloo.solo.io.Raw.rate_limits:type_name -> ratelimit.api.solo.io.RateLimitActions
	8,  // 2: trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigStatus.global:type_name -> common.gloo.solo.io.GenericGlobalStatus
	5,  // 3: trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigStatus.workspaces:type_name -> trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigStatus.WorkspacesEntry
	9,  // 4: trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigNewStatus.common:type_name -> common.gloo.solo.io.Status
	6,  // 5: trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigReport.workspaces:type_name -> trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigReport.WorkspacesEntry
	10, // 6: trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigStatus.WorkspacesEntry.value:type_name -> common.gloo.solo.io.WorkspaceStatus
	11, // 7: trafficcontrol.policy.gloo.solo.io.RateLimitClientConfigReport.WorkspacesEntry.value:type_name -> common.gloo.solo.io.Report
...
func file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RateLimitClientConfigNewStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_trafficcontrol_ratelimit_client_config_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
