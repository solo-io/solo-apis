...
// Hash function
func (m *MirrorPolicyNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("trafficcontrol.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/trafficcontrol.policy.gloo.solo.io/v2.MirrorPolicyNewStatus")); err != nil {
		return 0, err
	}
...
func (m *MirrorPolicyReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("trafficcontrol.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/trafficcontrol.policy.gloo.solo.io/v2.MirrorPolicyReport")); err != nil {
		return 0, err
	}
