...
func (m *GlooInstanceSpec) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	if _, err = hasher.Write([]byte("IsEnterprise")); err != nil {
		return 0, err
	}
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *GlooInstanceStatus) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *GlooInstanceSpec_ControlPlane) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	if _, err = hasher.Write([]byte("WatchedNamespaces")); err != nil {
		return 0, err
	}
	for i, v := range m.GetWatchedNamespaces() {
		if _, err = hasher.Write([]byte(strconv.Itoa(i))); err != nil {
			return 0, err
		}
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *GlooInstanceSpec_Proxy) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	if _, err = hasher.Write([]byte("AvailableReplicas")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("ReadyReplicas")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("WasmEnabled")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("ReadConfigMulticlusterEnabled")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("WorkloadControllerType")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("Zones")); err != nil {
		return 0, err
	}
	...
	if _, err = hasher.Write([]byte("IngressEndpoints")); err != nil {
		return 0, err
	}
	for i, v := range m.GetIngressEndpoints() {
		if _, err = hasher.Write([]byte(strconv.Itoa(i))); err != nil {
			return 0, err
		}
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *GlooInstanceSpec_Admin) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	if _, err = hasher.Write([]byte("WriteNamespace")); err != nil {
		return 0, err
	}
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *GlooInstanceSpec_Check) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *GlooInstanceSpec_Proxy_IngressEndpoint) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *GlooInstanceSpec_Proxy_IngressEndpoint_Port) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *GlooInstanceSpec_Check_Summary) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	if _, err = hasher.Write([]byte("Total")); err != nil {
		return 0, err
	}
...
// Replaces Hash due to original hashing implemention only using field values. The omission
// of the field name in the hash calculation can lead to hash collisions.
func (m *GlooInstanceSpec_Check_Summary_ResourceReport) HashUnique(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
