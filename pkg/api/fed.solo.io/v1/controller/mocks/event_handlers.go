...
func (mr *MockGlooInstanceEventHandlerMockRecorder) CreateGlooInstance(obj any) *gomock.Call {
...
func (mr *MockGlooInstanceEventHandlerMockRecorder) DeleteGlooInstance(obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGlooInstanceEventHandlerMockRecorder) GenericGlooInstance(obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGlooInstanceEventHandlerMockRecorder) UpdateGlooInstance(old, new any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGlooInstanceEventWatcherMockRecorder) AddEventHandler(ctx, h any, predicates ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFailoverSchemeEventHandlerMockRecorder) CreateFailoverScheme(obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFailoverSchemeEventHandlerMockRecorder) DeleteFailoverScheme(obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFailoverSchemeEventHandlerMockRecorder) GenericFailoverScheme(obj any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockFailoverSchemeEventHandlerMockRecorder) UpdateFailoverScheme(old, new any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// AddEventHandler indicates an expected call of AddEventHandler.
func (mr *MockFailoverSchemeEventWatcherMockRecorder) AddEventHandler(ctx, h any, predicates ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, h}, predicates...)
