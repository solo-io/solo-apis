...
func file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_gateway_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_gateway_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_gateway_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_gateway_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*DelegatedHttpGateway_Ref)(nil),
		(*DelegatedHttpGateway_Selector)(nil),
	}
	file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_gateway_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*DelegatedTcpGateway_Ref)(nil),
		(*DelegatedTcpGateway_Selector)(nil),
	}
	file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_gateway_proto_msgTypes[5].OneofWrappers = []interface{}{
