...
var file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_gateway_proto_rawDesc = []byte{
	...
	0x0b, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x54, 0x79, 0x70, 0x65, 0x22, 0x8d, 0x03, 0x0a,
	...
	0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x12, 0x3c, 0x0a, 0x1a, 0x76, 0x69, 0x72, 0x74, 0x75, 0x61,
	...
	0x73, 0x52, 0x07, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xca, 0x03, 0x0a, 0x0d, 0x47,
...
var file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_gateway_proto_goTypes = []interface{}{
	...
	(*v1.RouteConfigurationOptions)(nil), // 9: gloo.solo.io.RouteConfigurationOptions
...
var file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_gateway_proto_depIdxs = []int32{
	...
	9,  // 4: gateway.solo.io.GatewaySpec.route_options:type_name -> gloo.solo.io.RouteConfigurationOptions
	10, // 5: gateway.solo.io.HttpGateway.virtual_services:type_name -> core.solo.io.ResourceRef
	5,  // 6: gateway.solo.io.HttpGateway.virtual_service_selector:type_name -> gateway.solo.io.HttpGateway.VirtualServiceSelectorEntry
	11, // 7: gateway.solo.io.HttpGateway.options:type_name -> gloo.solo.io.HttpListenerOptions
	...
	0,  // 10: gateway.solo.io.GatewayStatus.state:type_name -> gateway.solo.io.GatewayStatus.State
	6,  // 11: gateway.solo.io.GatewayStatus.subresource_statuses:type_name -> gateway.solo.io.GatewayStatus.SubresourceStatusesEntry
	14, // 12: gateway.solo.io.GatewayStatus.details:type_name -> google.protobuf.Struct
	4,  // 13: gateway.solo.io.GatewayStatus.SubresourceStatusesEntry.value:type_name -> gateway.solo.io.GatewayStatus
