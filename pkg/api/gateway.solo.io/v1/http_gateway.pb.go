...
type HttpGatewayStatus_State int32

const (
	// Pending status indicates the resource has not yet been validated
	HttpGatewayStatus_Pending HttpGatewayStatus_State = 0
	// Accepted indicates the resource has been validated
	HttpGatewayStatus_Accepted HttpGatewayStatus_State = 1
	...
	HttpGatewayStatus_Rejected HttpGatewayStatus_State = 2
	...
	HttpGatewayStatus_Warning HttpGatewayStatus_State = 3
)

// Enum value maps for HttpGatewayStatus_State.
var (
	HttpGatewayStatus_State_name = map[int32]string{
		0: "Pending",
		1: "Accepted",
		2: "Rejected",
		3: "Warning",
	}
	HttpGatewayStatus_State_value = map[string]int32{
		"Pending":  0,
		"Accepted": 1,
		"Rejected": 2,
		"Warning":  3,
...
func (x HttpGatewayStatus_State) Enum() *HttpGatewayStatus_State {
	p := new(HttpGatewayStatus_State)
	*p = x
	return p
}

func (x HttpGatewayStatus_State) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (HttpGatewayStatus_State) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_enumTypes[1].Descriptor()
}

func (HttpGatewayStatus_State) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_enumTypes[1]
}

func (x HttpGatewayStatus_State) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use HttpGatewayStatus_State.Descriptor instead.
func (HttpGatewayStatus_State) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_rawDescGZIP(), []int{3, 0}
}
...
type HttpGatewaySpec struct {
	...
	Matcher *HttpGatewaySpec_Matcher `protobuf:"bytes,3,opt,name=matcher,proto3" json:"matcher,omitempty"`
...
func (x *HttpGatewaySpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HttpGatewaySpec) ProtoMessage() {}

func (x *HttpGatewaySpec) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[0]
...
// Deprecated: Use HttpGatewaySpec.ProtoReflect.Descriptor instead.
func (*HttpGatewaySpec) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_rawDescGZIP(), []int{0}
}

func (x *HttpGatewaySpec) GetMatcher() *HttpGatewaySpec_Matcher {
	if x != nil {
		return x.Matcher
	}
	return nil
...
func (x *HttpGatewaySpec) GetHttpGateway() *HttpGateway {
	if x != nil {
...
type HttpGatewayStatus struct {
	...
	State HttpGatewayStatus_State `protobuf:"varint,1,opt,name=state,proto3,enum=gateway.solo.io.HttpGatewayStatus_State" json:"state,omitempty"`
	...
	SubresourceStatuses map[string]*HttpGatewayStatus `protobuf:"bytes,4,rep,name=subresource_statuses,json=subresourceStatuses,proto3" json:"subresource_statuses,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *HttpGatewayStatus) Reset() {
	*x = HttpGatewayStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *HttpGatewayStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HttpGatewayStatus) ProtoMessage() {}

func (x *HttpGatewayStatus) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HttpGatewayStatus.ProtoReflect.Descriptor instead.
func (*HttpGatewayStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_rawDescGZIP(), []int{3}
}

func (x *HttpGatewayStatus) GetState() HttpGatewayStatus_State {
	if x != nil {
		return x.State
	}
	return HttpGatewayStatus_Pending
}

func (x *HttpGatewayStatus) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *HttpGatewayStatus) GetReportedBy() string {
	if x != nil {
		return x.ReportedBy
	}
	return ""
...
func (x *HttpGatewayStatus) GetSubresourceStatuses() map[string]*HttpGatewayStatus {
	if x != nil {
...
func (x *HttpGatewayStatus) GetDetails() *_struct.Struct {
	if x != nil {
		return x.Details
	}
	return nil
...
type HttpGatewayNamespacedStatuses struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Statuses map[string]*HttpGatewayStatus `protobuf:"bytes,1,rep,name=statuses,proto3" json:"statuses,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (x *HttpGatewayNamespacedStatuses) Reset() {
	*x = HttpGatewayNamespacedStatuses{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *HttpGatewayNamespacedStatuses) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HttpGatewayNamespacedStatuses) ProtoMessage() {}

func (x *HttpGatewayNamespacedStatuses) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HttpGatewayNamespacedStatuses.ProtoReflect.Descriptor instead.
func (*HttpGatewayNamespacedStatuses) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_rawDescGZIP(), []int{4}
}

func (x *HttpGatewayNamespacedStatuses) GetStatuses() map[string]*HttpGatewayStatus {
	if x != nil {
		return x.Statuses
	}
	return nil
...
type HttpGatewaySpec_Matcher struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *HttpGatewaySpec_Matcher) Reset() {
	*x = HttpGatewaySpec_Matcher{}
	if protoimpl.UnsafeEnabled {
...
func (x *HttpGatewaySpec_Matcher) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HttpGatewaySpec_Matcher) ProtoMessage() {}

func (x *HttpGatewaySpec_Matcher) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HttpGatewaySpec_Matcher.ProtoReflect.Descriptor instead.
func (*HttpGatewaySpec_Matcher) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_rawDescGZIP(), []int{0, 0}
}

func (x *HttpGatewaySpec_Matcher) GetSourcePrefixRanges() []*v3.CidrRange {
	if x != nil {
...
func (x *HttpGatewaySpec_Matcher) GetSslConfig() *v1.SslConfig {
	if x != nil {
		return x.SslConfig
	}
	return nil
...
func (x *VirtualServiceSelectorExpressions_Expression) Reset() {
	*x = VirtualServiceSelectorExpressions_Expression{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_rawDesc = []byte{
	...
	0x6b, 0x69, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x39, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x2f, 0x73, 0x73, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x56, 0x67, 0x69, 0x74, 0x68,
	...
	0x74, 0x6f, 0x22, 0xb5, 0x02, 0x0a, 0x0f, 0x48, 0x74, 0x74, 0x70, 0x47, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x53, 0x70, 0x65, 0x63, 0x12, 0x42, 0x0a, 0x07, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65,
	0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61,
	0x79, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x48, 0x74, 0x74, 0x70, 0x47, 0x61,
	0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65,
	...
	0x09, 0x73, 0x73, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x81, 0x04, 0x0a, 0x0b, 0x48,
	...
	0x0a, 0x08, 0x4c, 0x65, 0x73, 0x73, 0x54, 0x68, 0x61, 0x6e, 0x10, 0x08, 0x22, 0xda, 0x03, 0x0a,
	0x11, 0x48, 0x74, 0x74, 0x70, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x74, 0x61, 0x74,
	...
	0x2e, 0x69, 0x6f, 0x2e, 0x48, 0x74, 0x74, 0x70, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53,
	...
	0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x53, 0x75,
	...
	0x74, 0x70, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	0x57, 0x61, 0x72, 0x6e, 0x69, 0x6e, 0x67, 0x10, 0x03, 0x22, 0xda, 0x01, 0x0a, 0x1d, 0x48, 0x74,
	0x74, 0x70, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61,
	...
	0x48, 0x74, 0x74, 0x70, 0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x73,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x45, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6f, 0x6c, 0x6f, 0x2d, 0x69, 0x6f, 0x2f, 0x73, 0x6f, 0x6c,
...
var file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_goTypes = []interface{}{
	...
	(HttpGatewayStatus_State)(0),                               // 1: gateway.solo.io.HttpGatewayStatus.State
	(*HttpGatewaySpec)(nil),                                    // 2: gateway.solo.io.HttpGatewaySpec
	...
	(*HttpGatewayStatus)(nil),                                  // 5: gateway.solo.io.HttpGatewayStatus
	(*HttpGatewayNamespacedStatuses)(nil),                      // 6: gateway.solo.io.HttpGatewayNamespacedStatuses
	(*HttpGatewaySpec_Matcher)(nil),                            // 7: gateway.solo.io.HttpGatewaySpec.Matcher
	...
	nil,                            // 10: gateway.solo.io.HttpGatewayStatus.SubresourceStatusesEntry
	nil,                            // 11: gateway.solo.io.HttpGatewayNamespacedStatuses.StatusesEntry
	...
	(*v3.CidrRange)(nil),           // 15: solo.io.envoy.config.core.v3.CidrRange
...
var file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_depIdxs = []int32{
	7,  // 0: gateway.solo.io.HttpGatewaySpec.matcher:type_name -> gateway.solo.io.HttpGatewaySpec.Matcher
	3,  // 1: gateway.solo.io.HttpGatewaySpec.http_gateway:type_name -> gateway.solo.io.HttpGateway
	12, // 2: gateway.solo.io.HttpGateway.virtual_services:type_name -> core.solo.io.ResourceRef
	8,  // 3: gateway.solo.io.HttpGateway.virtual_service_selector:type_name -> gateway.solo.io.HttpGateway.VirtualServiceSelectorEntry
	4,  // 4: gateway.solo.io.HttpGateway.virtual_service_expressions:type_name -> gateway.solo.io.VirtualServiceSelectorExpressions
	13, // 5: gateway.solo.io.HttpGateway.options:type_name -> gloo.solo.io.HttpListenerOptions
	9,  // 6: gateway.solo.io.VirtualServiceSelectorExpressions.expressions:type_name -> gateway.solo.io.VirtualServiceSelectorExpressions.Expression
	1,  // 7: gateway.solo.io.HttpGatewayStatus.state:type_name -> gateway.solo.io.HttpGatewayStatus.State
	10, // 8: gateway.solo.io.HttpGatewayStatus.subresource_statuses:type_name -> gateway.solo.io.HttpGatewayStatus.SubresourceStatusesEntry
	14, // 9: gateway.solo.io.HttpGatewayStatus.details:type_name -> google.protobuf.Struct
	11, // 10: gateway.solo.io.HttpGatewayNamespacedStatuses.statuses:type_name -> gateway.solo.io.HttpGatewayNamespacedStatuses.StatusesEntry
	15, // 11: gateway.solo.io.HttpGatewaySpec.Matcher.source_prefix_ranges:type_name -> solo.io.envoy.config.core.v3.CidrRange
	16, // 12: gateway.solo.io.HttpGatewaySpec.Matcher.ssl_config:type_name -> gloo.solo.io.SslConfig
	0,  // 13: gateway.solo.io.VirtualServiceSelectorExpressions.Expression.operator:type_name -> gateway.solo.io.VirtualServiceSelectorExpressions.Expression.Operator
	5,  // 14: gateway.solo.io.HttpGatewayStatus.SubresourceStatusesEntry.value:type_name -> gateway.solo.io.HttpGatewayStatus
	5,  // 15: gateway.solo.io.HttpGatewayNamespacedStatuses.StatusesEntry.value:type_name -> gateway.solo.io.HttpGatewayStatus
...
func file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HttpGatewayStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HttpGatewayNamespacedStatuses); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HttpGatewaySpec_Matcher); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
