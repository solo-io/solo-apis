...
var file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_rawDesc = []byte{
	...
	0x10, 0x08, 0x42, 0x45, 0xb8, 0xf5, 0x04, 0x01, 0xc0, 0xf5, 0x04, 0x01, 0xd0, 0xf5, 0x04, 0x01,
...
func file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gateway_v1_http_gateway_proto_msgTypes[3].Exporter = func(v any, i int) any {
