...
func (m *MatchableHttpGateway) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.solo.io/v1.MatchableHttpGateway")); err != nil {
		return 0, err
	}
...
func (m *MatchableHttpGateway_Matcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.solo.io/v1.MatchableHttpGateway_Matcher")); err != nil {
		return 0, err
	}
