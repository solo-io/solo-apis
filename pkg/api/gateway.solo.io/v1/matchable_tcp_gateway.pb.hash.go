...
// Hash function
func (m *MatchableTcpGatewaySpec) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Hash function
func (m *MatchableTcpGatewayStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Hash function
func (m *MatchableTcpGatewayNamespacedStatuses) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
...
// Hash function
func (m *MatchableTcpGatewaySpec_Matcher) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
