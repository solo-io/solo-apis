...
func (m *MatchableTcpGateway) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.solo.io/v1.MatchableTcpGateway")); err != nil {
		return 0, err
	}
...
func (m *MatchableTcpGateway_Matcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gateway.solo.io.github.com/solo-io/solo-apis/pkg/api/gateway.solo.io/v1.MatchableTcpGateway_Matcher")); err != nil {
		return 0, err
	}
