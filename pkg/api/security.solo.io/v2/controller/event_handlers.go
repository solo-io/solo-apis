...
type AccessPolicyEventHandler interface {
	CreateAccessPolicy(obj *security_solo_io_v2.AccessPolicy) error
	UpdateAccessPolicy(old, new *security_solo_io_v2.AccessPolicy) error
	DeleteAccessPolicy(obj *security_solo_io_v2.AccessPolicy) error
	GenericAccessPolicy(obj *security_solo_io_v2.AccessPolicy) error
}

type AccessPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *security_solo_io_v2.AccessPolicy) error
	OnUpdate  func(old, new *security_solo_io_v2.AccessPolicy) error
	OnDelete  func(obj *security_solo_io_v2.AccessPolicy) error
	OnGeneric func(obj *security_solo_io_v2.AccessPolicy) error
}

func (f *AccessPolicyEventHandlerFuncs) CreateAccessPolicy(obj *security_solo_io_v2.AccessPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *AccessPolicyEventHandlerFuncs) DeleteAccessPolicy(obj *security_solo_io_v2.AccessPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *AccessPolicyEventHandlerFuncs) UpdateAccessPolicy(objOld, objNew *security_solo_io_v2.AccessPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *AccessPolicyEventHandlerFuncs) GenericAccessPolicy(obj *security_solo_io_v2.AccessPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewAccessPolicyEventWatcher(name string, mgr manager.Manager) AccessPolicyEventWatcher {
	return &accessPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &security_solo_io_v2.AccessPolicy{}),
	}
}
...
func (h genericAccessPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*security_solo_io_v2.AccessPolicy)
	if !ok {
		return errors.Errorf("internal error: AccessPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*security_solo_io_v2.AccessPolicy)
	if !ok {
...
type CORSPolicyEventHandler interface {
	CreateCORSPolicy(obj *security_solo_io_v2.CORSPolicy) error
	UpdateCORSPolicy(old, new *security_solo_io_v2.CORSPolicy) error
	DeleteCORSPolicy(obj *security_solo_io_v2.CORSPolicy) error
	GenericCORSPolicy(obj *security_solo_io_v2.CORSPolicy) error
}

type CORSPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *security_solo_io_v2.CORSPolicy) error
	OnUpdate  func(old, new *security_solo_io_v2.CORSPolicy) error
	OnDelete  func(obj *security_solo_io_v2.CORSPolicy) error
	OnGeneric func(obj *security_solo_io_v2.CORSPolicy) error
}

func (f *CORSPolicyEventHandlerFuncs) CreateCORSPolicy(obj *security_solo_io_v2.CORSPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *CORSPolicyEventHandlerFuncs) DeleteCORSPolicy(obj *security_solo_io_v2.CORSPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *CORSPolicyEventHandlerFuncs) UpdateCORSPolicy(objOld, objNew *security_solo_io_v2.CORSPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *CORSPolicyEventHandlerFuncs) GenericCORSPolicy(obj *security_solo_io_v2.CORSPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewCORSPolicyEventWatcher(name string, mgr manager.Manager) CORSPolicyEventWatcher {
	return &cORSPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &security_solo_io_v2.CORSPolicy{}),
	}
}
...
func (h genericCORSPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*security_solo_io_v2.CORSPolicy)
	if !ok {
		return errors.Errorf("internal error: CORSPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*security_solo_io_v2.CORSPolicy)
	if !ok {
...
type CSRFPolicyEventHandler interface {
	CreateCSRFPolicy(obj *security_solo_io_v2.CSRFPolicy) error
	UpdateCSRFPolicy(old, new *security_solo_io_v2.CSRFPolicy) error
	DeleteCSRFPolicy(obj *security_solo_io_v2.CSRFPolicy) error
	GenericCSRFPolicy(obj *security_solo_io_v2.CSRFPolicy) error
}

type CSRFPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *security_solo_io_v2.CSRFPolicy) error
	OnUpdate  func(old, new *security_solo_io_v2.CSRFPolicy) error
	OnDelete  func(obj *security_solo_io_v2.CSRFPolicy) error
	OnGeneric func(obj *security_solo_io_v2.CSRFPolicy) error
}

func (f *CSRFPolicyEventHandlerFuncs) CreateCSRFPolicy(obj *security_solo_io_v2.CSRFPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *CSRFPolicyEventHandlerFuncs) DeleteCSRFPolicy(obj *security_solo_io_v2.CSRFPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *CSRFPolicyEventHandlerFuncs) UpdateCSRFPolicy(objOld, objNew *security_solo_io_v2.CSRFPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *CSRFPolicyEventHandlerFuncs) GenericCSRFPolicy(obj *security_solo_io_v2.CSRFPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewCSRFPolicyEventWatcher(name string, mgr manager.Manager) CSRFPolicyEventWatcher {
	return &cSRFPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &security_solo_io_v2.CSRFPolicy{}),
	}
}
...
func (h genericCSRFPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*security_solo_io_v2.CSRFPolicy)
	if !ok {
		return errors.Errorf("internal error: CSRFPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*security_solo_io_v2.CSRFPolicy)
	if !ok {
...
type ExtAuthPolicyEventHandler interface {
	CreateExtAuthPolicy(obj *security_solo_io_v2.ExtAuthPolicy) error
	UpdateExtAuthPolicy(old, new *security_solo_io_v2.ExtAuthPolicy) error
	DeleteExtAuthPolicy(obj *security_solo_io_v2.ExtAuthPolicy) error
	GenericExtAuthPolicy(obj *security_solo_io_v2.ExtAuthPolicy) error
}

type ExtAuthPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *security_solo_io_v2.ExtAuthPolicy) error
	OnUpdate  func(old, new *security_solo_io_v2.ExtAuthPolicy) error
	OnDelete  func(obj *security_solo_io_v2.ExtAuthPolicy) error
	OnGeneric func(obj *security_solo_io_v2.ExtAuthPolicy) error
}

func (f *ExtAuthPolicyEventHandlerFuncs) CreateExtAuthPolicy(obj *security_solo_io_v2.ExtAuthPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *ExtAuthPolicyEventHandlerFuncs) DeleteExtAuthPolicy(obj *security_solo_io_v2.ExtAuthPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *ExtAuthPolicyEventHandlerFuncs) UpdateExtAuthPolicy(objOld, objNew *security_solo_io_v2.ExtAuthPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *ExtAuthPolicyEventHandlerFuncs) GenericExtAuthPolicy(obj *security_solo_io_v2.ExtAuthPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewExtAuthPolicyEventWatcher(name string, mgr manager.Manager) ExtAuthPolicyEventWatcher {
	return &extAuthPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &security_solo_io_v2.ExtAuthPolicy{}),
	}
}
...
func (h genericExtAuthPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*security_solo_io_v2.ExtAuthPolicy)
	if !ok {
		return errors.Errorf("internal error: ExtAuthPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*security_solo_io_v2.ExtAuthPolicy)
	if !ok {
...
type WAFPolicyEventHandler interface {
	CreateWAFPolicy(obj *security_solo_io_v2.WAFPolicy) error
	UpdateWAFPolicy(old, new *security_solo_io_v2.WAFPolicy) error
	DeleteWAFPolicy(obj *security_solo_io_v2.WAFPolicy) error
	GenericWAFPolicy(obj *security_solo_io_v2.WAFPolicy) error
}

type WAFPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *security_solo_io_v2.WAFPolicy) error
	OnUpdate  func(old, new *security_solo_io_v2.WAFPolicy) error
	OnDelete  func(obj *security_solo_io_v2.WAFPolicy) error
	OnGeneric func(obj *security_solo_io_v2.WAFPolicy) error
}

func (f *WAFPolicyEventHandlerFuncs) CreateWAFPolicy(obj *security_solo_io_v2.WAFPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *WAFPolicyEventHandlerFuncs) DeleteWAFPolicy(obj *security_solo_io_v2.WAFPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *WAFPolicyEventHandlerFuncs) UpdateWAFPolicy(objOld, objNew *security_solo_io_v2.WAFPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *WAFPolicyEventHandlerFuncs) GenericWAFPolicy(obj *security_solo_io_v2.WAFPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewWAFPolicyEventWatcher(name string, mgr manager.Manager) WAFPolicyEventWatcher {
	return &wAFPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &security_solo_io_v2.WAFPolicy{}),
	}
}
...
func (h genericWAFPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*security_solo_io_v2.WAFPolicy)
	if !ok {
		return errors.Errorf("internal error: WAFPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*security_solo_io_v2.WAFPolicy)
	if !ok {
...
type JWTPolicyEventHandler interface {
	CreateJWTPolicy(obj *security_solo_io_v2.JWTPolicy) error
	UpdateJWTPolicy(old, new *security_solo_io_v2.JWTPolicy) error
	DeleteJWTPolicy(obj *security_solo_io_v2.JWTPolicy) error
	GenericJWTPolicy(obj *security_solo_io_v2.JWTPolicy) error
}

type JWTPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *security_solo_io_v2.JWTPolicy) error
	OnUpdate  func(old, new *security_solo_io_v2.JWTPolicy) error
	OnDelete  func(obj *security_solo_io_v2.JWTPolicy) error
	OnGeneric func(obj *security_solo_io_v2.JWTPolicy) error
}

func (f *JWTPolicyEventHandlerFuncs) CreateJWTPolicy(obj *security_solo_io_v2.JWTPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *JWTPolicyEventHandlerFuncs) DeleteJWTPolicy(obj *security_solo_io_v2.JWTPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *JWTPolicyEventHandlerFuncs) UpdateJWTPolicy(objOld, objNew *security_solo_io_v2.JWTPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *JWTPolicyEventHandlerFuncs) GenericJWTPolicy(obj *security_solo_io_v2.JWTPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewJWTPolicyEventWatcher(name string, mgr manager.Manager) JWTPolicyEventWatcher {
	return &jWTPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &security_solo_io_v2.JWTPolicy{}),
	}
}
...
func (h genericJWTPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*security_solo_io_v2.JWTPolicy)
	if !ok {
		return errors.Errorf("internal error: JWTPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*security_solo_io_v2.JWTPolicy)
	if !ok {
