...
type AccessPolicyReconciler interface {
	ReconcileAccessPolicy(obj *security_solo_io_v2.AccessPolicy) (reconcile.Result, error)
}
...
type AccessPolicyReconcilerFuncs struct {
	OnReconcileAccessPolicy         func(obj *security_solo_io_v2.AccessPolicy) (reconcile.Result, error)
	OnReconcileAccessPolicyDeletion func(req reconcile.Request) error
}

func (f *AccessPolicyReconcilerFuncs) ReconcileAccessPolicy(obj *security_solo_io_v2.AccessPolicy) (reconcile.Result, error) {
...
type AccessPolicyFinalizer interface {
	...
	FinalizeAccessPolicy(obj *security_solo_io_v2.AccessPolicy) error
}
...
func NewAccessPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) AccessPolicyReconcileLoop {
	return &accessPolicyReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &security_solo_io_v2.AccessPolicy{}, options),
	}
}
...
type CORSPolicyReconciler interface {
	ReconcileCORSPolicy(obj *security_solo_io_v2.CORSPolicy) (reconcile.Result, error)
}
...
type CORSPolicyReconcilerFuncs struct {
	OnReconcileCORSPolicy         func(obj *security_solo_io_v2.CORSPolicy) (reconcile.Result, error)
	OnReconcileCORSPolicyDeletion func(req reconcile.Request) error
}

func (f *CORSPolicyReconcilerFuncs) ReconcileCORSPolicy(obj *security_solo_io_v2.CORSPolicy) (reconcile.Result, error) {
...
type CORSPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeCORSPolicy(obj *security_solo_io_v2.CORSPolicy) error
}
...
func NewCORSPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) CORSPolicyReconcileLoop {
	return &cORSPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &security_solo_io_v2.CORSPolicy{}, options),
	}
}
...
type CSRFPolicyReconciler interface {
	ReconcileCSRFPolicy(obj *security_solo_io_v2.CSRFPolicy) (reconcile.Result, error)
}
...
type CSRFPolicyReconcilerFuncs struct {
	OnReconcileCSRFPolicy         func(obj *security_solo_io_v2.CSRFPolicy) (reconcile.Result, error)
	OnReconcileCSRFPolicyDeletion func(req reconcile.Request) error
}

func (f *CSRFPolicyReconcilerFuncs) ReconcileCSRFPolicy(obj *security_solo_io_v2.CSRFPolicy) (reconcile.Result, error) {
...
type CSRFPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeCSRFPolicy(obj *security_solo_io_v2.CSRFPolicy) error
}
...
func NewCSRFPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) CSRFPolicyReconcileLoop {
	return &cSRFPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &security_solo_io_v2.CSRFPolicy{}, options),
	}
}
...
type ExtAuthPolicyReconciler interface {
	ReconcileExtAuthPolicy(obj *security_solo_io_v2.ExtAuthPolicy) (reconcile.Result, error)
}
...
type ExtAuthPolicyReconcilerFuncs struct {
	OnReconcileExtAuthPolicy         func(obj *security_solo_io_v2.ExtAuthPolicy) (reconcile.Result, error)
	OnReconcileExtAuthPolicyDeletion func(req reconcile.Request) error
}

func (f *ExtAuthPolicyReconcilerFuncs) ReconcileExtAuthPolicy(obj *security_solo_io_v2.ExtAuthPolicy) (reconcile.Result, error) {
...
type ExtAuthPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeExtAuthPolicy(obj *security_solo_io_v2.ExtAuthPolicy) error
}
...
func NewExtAuthPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) ExtAuthPolicyReconcileLoop {
	return &extAuthPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &security_solo_io_v2.ExtAuthPolicy{}, options),
	}
}
...
type WAFPolicyReconciler interface {
	ReconcileWAFPolicy(obj *security_solo_io_v2.WAFPolicy) (reconcile.Result, error)
}
...
type WAFPolicyReconcilerFuncs struct {
	OnReconcileWAFPolicy         func(obj *security_solo_io_v2.WAFPolicy) (reconcile.Result, error)
	OnReconcileWAFPolicyDeletion func(req reconcile.Request) error
}

func (f *WAFPolicyReconcilerFuncs) ReconcileWAFPolicy(obj *security_solo_io_v2.WAFPolicy) (reconcile.Result, error) {
...
type WAFPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeWAFPolicy(obj *security_solo_io_v2.WAFPolicy) error
}
...
func NewWAFPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) WAFPolicyReconcileLoop {
	return &wAFPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &security_solo_io_v2.WAFPolicy{}, options),
	}
}
...
type JWTPolicyReconciler interface {
	ReconcileJWTPolicy(obj *security_solo_io_v2.JWTPolicy) (reconcile.Result, error)
}
...
type JWTPolicyReconcilerFuncs struct {
	OnReconcileJWTPolicy         func(obj *security_solo_io_v2.JWTPolicy) (reconcile.Result, error)
	OnReconcileJWTPolicyDeletion func(req reconcile.Request) error
}

func (f *JWTPolicyReconcilerFuncs) ReconcileJWTPolicy(obj *security_solo_io_v2.JWTPolicy) (reconcile.Result, error) {
...
type JWTPolicyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeJWTPolicy(obj *security_solo_io_v2.JWTPolicy) error
}
...
func NewJWTPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) JWTPolicyReconcileLoop {
	return &jWTPolicyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &security_solo_io_v2.JWTPolicy{}, options),
	}
}
