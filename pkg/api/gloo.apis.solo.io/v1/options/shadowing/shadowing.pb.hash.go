...
func (m *RouteShadowing) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("shadowing.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/shadowing.RouteShadowing")); err != nil {
		return 0, err
	}
