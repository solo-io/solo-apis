...
func (m *UpstreamSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("kubernetes.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/kubernetes.UpstreamSpec")); err != nil {
		return 0, err
	}
