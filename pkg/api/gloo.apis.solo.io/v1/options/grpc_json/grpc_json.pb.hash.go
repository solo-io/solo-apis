...
func (m *GrpcJsonTranscoder) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("grpc_json.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/grpc_json.GrpcJsonTranscoder")); err != nil {
		return 0, err
	}
...
func (m *GrpcJsonTranscoder_PrintOptions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("grpc_json.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/grpc_json.GrpcJsonTranscoder_PrintOptions")); err != nil {
		return 0, err
	}
