...
func (m *HttpConnectionManagerSettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("hcm.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/hcm.HttpConnectionManagerSettings")); err != nil {
		return 0, err
	}
...
func (m *HttpConnectionManagerSettings_SetCurrentClientCertDetails) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("hcm.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/hcm.HttpConnectionManagerSettings_SetCurrentClientCertDetails")); err != nil {
		return 0, err
	}
