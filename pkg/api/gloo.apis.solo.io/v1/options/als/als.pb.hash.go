...
func (m *AccessLoggingService) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("als.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/als.AccessLoggingService")); err != nil {
		return 0, err
	}
...
func (m *AccessLog) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("als.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/als.AccessLog")); err != nil {
		return 0, err
	}
...
func (m *FileSink) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("als.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/als.FileSink")); err != nil {
		return 0, err
	}
...
func (m *GrpcService) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("als.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/als.GrpcService")); err != nil {
		return 0, err
	}
