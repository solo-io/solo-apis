...
func (m *TcpProxySettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tcp.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/tcp.TcpProxySettings")); err != nil {
		return 0, err
	}
...
func (m *TcpProxySettings_TunnelingConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tcp.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/tcp.TcpProxySettings_TunnelingConfig")); err != nil {
		return 0, err
	}
