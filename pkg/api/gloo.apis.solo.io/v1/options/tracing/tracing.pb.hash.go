...
func (m *ListenerTracingSettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tracing.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/tracing.ListenerTracingSettings")); err != nil {
		return 0, err
	}
...
func (m *RouteTracingSettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tracing.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/tracing.RouteTracingSettings")); err != nil {
		return 0, err
	}
...
func (m *TracePercentages) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tracing.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/tracing.TracePercentages")); err != nil {
		return 0, err
	}
...
func (m *TracingTagEnvironmentVariable) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tracing.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/tracing.TracingTagEnvironmentVariable")); err != nil {
		return 0, err
	}
...
func (m *TracingTagLiteral) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("tracing.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/options/tracing.TracingTagLiteral")); err != nil {
		return 0, err
	}
