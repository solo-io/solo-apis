...
func (m *ConnectionConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.ConnectionConfig")); err != nil {
		return 0, err
	}
...
func (m *ConnectionConfig_TcpKeepAlive) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.ConnectionConfig_TcpKeepAlive")); err != nil {
		return 0, err
	}
...
func (m *ConnectionConfig_HttpProtocolOptions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.ConnectionConfig_HttpProtocolOptions")); err != nil {
		return 0, err
	}
