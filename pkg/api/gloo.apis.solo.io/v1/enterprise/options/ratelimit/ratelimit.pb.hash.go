...
func (m *IngressRateLimit) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/ratelimit.IngressRateLimit")); err != nil {
		return 0, err
	}
...
func (m *Settings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/ratelimit.Settings")); err != nil {
		return 0, err
	}
...
func (m *ServiceSettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/ratelimit.ServiceSettings")); err != nil {
		return 0, err
	}
...
func (m *RateLimitConfigRefs) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/ratelimit.RateLimitConfigRefs")); err != nil {
		return 0, err
	}
...
func (m *RateLimitConfigRef) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/ratelimit.RateLimitConfigRef")); err != nil {
		return 0, err
	}
...
func (m *RateLimitVhostExtension) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/ratelimit.RateLimitVhostExtension")); err != nil {
		return 0, err
	}
...
func (m *RateLimitRouteExtension) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("ratelimit.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/ratelimit.RateLimitRouteExtension")); err != nil {
		return 0, err
	}
