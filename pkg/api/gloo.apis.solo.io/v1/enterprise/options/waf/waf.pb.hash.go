...
func (m *Settings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("waf.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/waf.Settings")); err != nil {
		return 0, err
	}
...
func (m *CoreRuleSet) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("waf.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/waf.CoreRuleSet")); err != nil {
		return 0, err
	}
