...
func (m *Settings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rbac.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/rbac.Settings")); err != nil {
		return 0, err
	}
...
func (m *ExtensionSettings) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rbac.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/rbac.ExtensionSettings")); err != nil {
		return 0, err
	}
...
func (m *Policy) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rbac.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/rbac.Policy")); err != nil {
		return 0, err
	}
...
func (m *Principal) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rbac.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/rbac.Principal")); err != nil {
		return 0, err
	}
...
func (m *JWTPrincipal) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rbac.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/rbac.JWTPrincipal")); err != nil {
		return 0, err
	}
...
func (m *Permissions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("rbac.options.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/enterprise/options/rbac.Permissions")); err != nil {
		return 0, err
	}
