...
type SettingsReconciler interface {
	ReconcileSettings(obj *gloo_apis_solo_io_v1.Settings) (reconcile.Result, error)
}
...
type SettingsReconcilerFuncs struct {
	OnReconcileSettings         func(obj *gloo_apis_solo_io_v1.Settings) (reconcile.Result, error)
	OnReconcileSettingsDeletion func(req reconcile.Request) error
}

func (f *SettingsReconcilerFuncs) ReconcileSettings(obj *gloo_apis_solo_io_v1.Settings) (reconcile.Result, error) {
...
type SettingsFinalizer interface {
	...
	FinalizeSettings(obj *gloo_apis_solo_io_v1.Settings) error
}
...
func NewSettingsReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) SettingsReconcileLoop {
	return &settingsReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &gloo_apis_solo_io_v1.Settings{}, options),
	}
}
...
type UpstreamReconciler interface {
	ReconcileUpstream(obj *gloo_apis_solo_io_v1.Upstream) (reconcile.Result, error)
}
...
type UpstreamReconcilerFuncs struct {
	OnReconcileUpstream         func(obj *gloo_apis_solo_io_v1.Upstream) (reconcile.Result, error)
	OnReconcileUpstreamDeletion func(req reconcile.Request) error
}

func (f *UpstreamReconcilerFuncs) ReconcileUpstream(obj *gloo_apis_solo_io_v1.Upstream) (reconcile.Result, error) {
...
type UpstreamFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeUpstream(obj *gloo_apis_solo_io_v1.Upstream) error
}
...
func NewUpstreamReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) UpstreamReconcileLoop {
	return &upstreamReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &gloo_apis_solo_io_v1.Upstream{}, options),
	}
}
...
type UpstreamGroupReconciler interface {
	ReconcileUpstreamGroup(obj *gloo_apis_solo_io_v1.UpstreamGroup) (reconcile.Result, error)
}
...
type UpstreamGroupReconcilerFuncs struct {
	OnReconcileUpstreamGroup         func(obj *gloo_apis_solo_io_v1.UpstreamGroup) (reconcile.Result, error)
	OnReconcileUpstreamGroupDeletion func(req reconcile.Request) error
}

func (f *UpstreamGroupReconcilerFuncs) ReconcileUpstreamGroup(obj *gloo_apis_solo_io_v1.UpstreamGroup) (reconcile.Result, error) {
...
type UpstreamGroupFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeUpstreamGroup(obj *gloo_apis_solo_io_v1.UpstreamGroup) error
}
...
func NewUpstreamGroupReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) UpstreamGroupReconcileLoop {
	return &upstreamGroupReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &gloo_apis_solo_io_v1.UpstreamGroup{}, options),
	}
}
...
type ProxyReconciler interface {
	ReconcileProxy(obj *gloo_apis_solo_io_v1.Proxy) (reconcile.Result, error)
}
...
type ProxyReconcilerFuncs struct {
	OnReconcileProxy         func(obj *gloo_apis_solo_io_v1.Proxy) (reconcile.Result, error)
	OnReconcileProxyDeletion func(req reconcile.Request) error
}

func (f *ProxyReconcilerFuncs) ReconcileProxy(obj *gloo_apis_solo_io_v1.Proxy) (reconcile.Result, error) {
...
type ProxyFinalizer interface {
	...
	// finalize the object before it is deleted.
	// Watchers created with a finalizing handler will a
	FinalizeProxy(obj *gloo_apis_solo_io_v1.Proxy) error
}
...
func NewProxyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) ProxyReconcileLoop {
	return &proxyReconcileLoop{
		// empty cluster indicates this reconciler is built for the local cluster
		loop: reconcile.NewLoop(name, "", mgr, &gloo_apis_solo_io_v1.Proxy{}, options),
	}
}
