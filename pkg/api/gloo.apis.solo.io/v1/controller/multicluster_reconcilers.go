...
type MulticlusterSettingsReconciler interface {
	ReconcileSettings(clusterName string, obj *gloo_apis_solo_io_v1.Settings) (reconcile.Result, error)
}
...
type MulticlusterSettingsReconcilerFuncs struct {
	OnReconcileSettings         func(clusterName string, obj *gloo_apis_solo_io_v1.Settings) (reconcile.Result, error)
	OnReconcileSettingsDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterSettingsReconcilerFuncs) ReconcileSettings(clusterName string, obj *gloo_apis_solo_io_v1.Settings) (reconcile.Result, error) {
...
func NewMulticlusterSettingsReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterSettingsReconcileLoop {
	return &multiclusterSettingsReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gloo_apis_solo_io_v1.Settings{}, options)}
}
...
type MulticlusterUpstreamReconciler interface {
	ReconcileUpstream(clusterName string, obj *gloo_apis_solo_io_v1.Upstream) (reconcile.Result, error)
}
...
type MulticlusterUpstreamReconcilerFuncs struct {
	OnReconcileUpstream         func(clusterName string, obj *gloo_apis_solo_io_v1.Upstream) (reconcile.Result, error)
	OnReconcileUpstreamDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterUpstreamReconcilerFuncs) ReconcileUpstream(clusterName string, obj *gloo_apis_solo_io_v1.Upstream) (reconcile.Result, error) {
...
func NewMulticlusterUpstreamReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterUpstreamReconcileLoop {
	return &multiclusterUpstreamReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gloo_apis_solo_io_v1.Upstream{}, options)}
}
...
type MulticlusterUpstreamGroupReconciler interface {
	ReconcileUpstreamGroup(clusterName string, obj *gloo_apis_solo_io_v1.UpstreamGroup) (reconcile.Result, error)
}
...
type MulticlusterUpstreamGroupReconcilerFuncs struct {
	OnReconcileUpstreamGroup         func(clusterName string, obj *gloo_apis_solo_io_v1.UpstreamGroup) (reconcile.Result, error)
	OnReconcileUpstreamGroupDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterUpstreamGroupReconcilerFuncs) ReconcileUpstreamGroup(clusterName string, obj *gloo_apis_solo_io_v1.UpstreamGroup) (reconcile.Result, error) {
...
func NewMulticlusterUpstreamGroupReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterUpstreamGroupReconcileLoop {
	return &multiclusterUpstreamGroupReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gloo_apis_solo_io_v1.UpstreamGroup{}, options)}
}
...
type MulticlusterProxyReconciler interface {
	ReconcileProxy(clusterName string, obj *gloo_apis_solo_io_v1.Proxy) (reconcile.Result, error)
}
...
type MulticlusterProxyReconcilerFuncs struct {
	OnReconcileProxy         func(clusterName string, obj *gloo_apis_solo_io_v1.Proxy) (reconcile.Result, error)
	OnReconcileProxyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterProxyReconcilerFuncs) ReconcileProxy(clusterName string, obj *gloo_apis_solo_io_v1.Proxy) (reconcile.Result, error) {
...
func NewMulticlusterProxyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterProxyReconcileLoop {
	return &multiclusterProxyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &gloo_apis_solo_io_v1.Proxy{}, options)}
}
