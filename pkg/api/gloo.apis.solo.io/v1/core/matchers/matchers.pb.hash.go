...
func (m *Matcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("matchers.core.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/core/matchers.Matcher")); err != nil {
		return 0, err
	}
...
func (m *HeaderMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("matchers.core.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/core/matchers.HeaderMatcher")); err != nil {
		return 0, err
	}
...
func (m *QueryParameterMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("matchers.core.gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1/core/matchers.QueryParameterMatcher")); err != nil {
		return 0, err
	}
