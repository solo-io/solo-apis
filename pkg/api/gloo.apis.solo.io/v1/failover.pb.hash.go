...
func (m *Failover) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.Failover")); err != nil {
		return 0, err
	}
...
func (m *LocalityLbEndpoints) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.LocalityLbEndpoints")); err != nil {
		return 0, err
	}
...
func (m *LbEndpoint) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.LbEndpoint")); err != nil {
		return 0, err
	}
...
func (m *Locality) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.Locality")); err != nil {
		return 0, err
	}
...
func (m *Failover_PrioritizedLocality) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.Failover_PrioritizedLocality")); err != nil {
		return 0, err
	}
...
func (m *LbEndpoint_HealthCheckConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.LbEndpoint_HealthCheckConfig")); err != nil {
		return 0, err
	}
