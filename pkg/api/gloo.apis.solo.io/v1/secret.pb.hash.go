...
func (m *Secret) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.Secret")); err != nil {
		return 0, err
	}
...
func (m *AwsSecret) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.AwsSecret")); err != nil {
		return 0, err
	}
...
func (m *AzureSecret) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.AzureSecret")); err != nil {
		return 0, err
	}
...
func (m *TlsSecret) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.TlsSecret")); err != nil {
		return 0, err
	}
...
func (m *HeaderSecret) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.HeaderSecret")); err != nil {
		return 0, err
	}
