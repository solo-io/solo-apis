...
func (m *LoadBalancerConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.LoadBalancerConfig")); err != nil {
		return 0, err
	}
...
func (m *LoadBalancerConfig_RoundRobin) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.LoadBalancerConfig_RoundRobin")); err != nil {
		return 0, err
	}
...
func (m *LoadBalancerConfig_LeastRequest) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.LoadBalancerConfig_LeastRequest")); err != nil {
		return 0, err
	}
...
func (m *LoadBalancerConfig_Random) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.LoadBalancerConfig_Random")); err != nil {
		return 0, err
	}
...
func (m *LoadBalancerConfig_RingHashConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.LoadBalancerConfig_RingHashConfig")); err != nil {
		return 0, err
	}
...
func (m *LoadBalancerConfig_RingHash) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.LoadBalancerConfig_RingHash")); err != nil {
		return 0, err
	}
...
func (m *LoadBalancerConfig_Maglev) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("gloo.apis.solo.io.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/v1.LoadBalancerConfig_Maglev")); err != nil {
		return 0, err
	}
