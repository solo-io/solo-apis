...
func (m *StringMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.matcher.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/type/matcher/v3.StringMatcher")); err != nil {
		return 0, err
	}
...
func (m *ListStringMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.matcher.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/type/matcher/v3.ListStringMatcher")); err != nil {
		return 0, err
	}
