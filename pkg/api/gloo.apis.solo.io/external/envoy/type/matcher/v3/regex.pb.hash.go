...
func (m *RegexMatcher) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.matcher.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/type/matcher/v3.RegexMatcher")); err != nil {
		return 0, err
	}
...
func (m *RegexMatchAndSubstitute) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.matcher.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/type/matcher/v3.RegexMatchAndSubstitute")); err != nil {
		return 0, err
	}
...
func (m *RegexMatcher_GoogleRE2) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.matcher.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/type/matcher/v3.RegexMatcher_GoogleRE2")); err != nil {
		return 0, err
	}
