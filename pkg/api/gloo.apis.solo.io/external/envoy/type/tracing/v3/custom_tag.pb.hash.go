...
func (m *CustomTag) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.tracing.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/type/tracing/v3.CustomTag")); err != nil {
		return 0, err
	}
...
func (m *CustomTag_Literal) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.tracing.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/type/tracing/v3.CustomTag_Literal")); err != nil {
		return 0, err
	}
...
func (m *CustomTag_Environment) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.tracing.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/type/tracing/v3.CustomTag_Environment")); err != nil {
		return 0, err
	}
...
func (m *CustomTag_Header) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.tracing.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/type/tracing/v3.CustomTag_Header")); err != nil {
		return 0, err
	}
...
func (m *CustomTag_Metadata) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.type.tracing.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/type/tracing/v3.CustomTag_Metadata")); err != nil {
		return 0, err
	}
