...
func (m *CsrfPolicy) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.extensions.filters.http.csrf.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/extensions/filters/http/csrf/v3.CsrfPolicy")); err != nil {
		return 0, err
	}
