...
func (m *ProxyLatency) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.filter.http.proxylatency.v2.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/extensions/proxylatency.ProxyLatency")); err != nil {
		return 0, err
	}
