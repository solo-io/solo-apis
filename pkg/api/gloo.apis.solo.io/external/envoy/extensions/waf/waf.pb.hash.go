...
func (m *AuditLogging) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.filter.http.modsecurity.v2.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/extensions/waf.AuditLogging")); err != nil {
		return 0, err
	}
...
func (m *ModSecurity) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.filter.http.modsecurity.v2.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/extensions/waf.ModSecurity")); err != nil {
		return 0, err
	}
...
func (m *RuleSet) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.filter.http.modsecurity.v2.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/extensions/waf.RuleSet")); err != nil {
		return 0, err
	}
...
func (m *ModSecurityPerRoute) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.filter.http.modsecurity.v2.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/extensions/waf.ModSecurityPerRoute")); err != nil {
		return 0, err
	}
