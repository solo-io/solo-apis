...
func (m *AWSLambdaPerRoute) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.filter.http.aws_lambda.v2.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/extensions/aws.AWSLambdaPerRoute")); err != nil {
		return 0, err
	}
...
func (m *AWSLambdaProtocolExtension) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.filter.http.aws_lambda.v2.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/extensions/aws.AWSLambdaProtocolExtension")); err != nil {
		return 0, err
	}
...
func (m *AWSLambdaConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.filter.http.aws_lambda.v2.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/extensions/aws.AWSLambdaConfig")); err != nil {
		return 0, err
	}
...
func (m *AWSLambdaConfig_ServiceAccountCredentials) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("envoy.config.filter.http.aws_lambda.v2.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/extensions/aws.AWSLambdaConfig_ServiceAccountCredentials")); err != nil {
		return 0, err
	}
