...
// 	protoc        v3.6.1
// source: github.com/solo-io/solo-apis/api/gloo/gloo.apis/external/envoy/extensions/aws/filter.proto
...
func (x *AWSLambdaPerRoute) Reset() {
	*x = AWSLambdaPerRoute{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes[0]
...
func (*AWSLambdaPerRoute) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescGZIP(), []int{0}
}
...
func (x *AWSLambdaProtocolExtension) Reset() {
	*x = AWSLambdaProtocolExtension{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AWSLambdaProtocolExtension) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescGZIP(), []int{1}
}
...
func (x *AWSLambdaConfig) Reset() {
	*x = AWSLambdaConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AWSLambdaConfig) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescGZIP(), []int{2}
}
...
func (x *AWSLambdaConfig_ServiceAccountCredentials) Reset() {
	*x = AWSLambdaConfig_ServiceAccountCredentials{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AWSLambdaConfig_ServiceAccountCredentials) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescGZIP(), []int{2, 0}
}
...
var File_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto protoreflect.FileDescriptor

var file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDesc = []byte{
	...
	,
	...
	0x6e, 0x22, 0xa5, 0x03, 0x0a, 0x0f, 0x41, 0x57, 0x53, 0x4c, 0x61, 0x6d, 0x62, 0x64, 0x61, 0x43,
	...
	0x73, 0x1a, 0x8e, 0x01, 0x0a, 0x19, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x41, 0x63, 0x63,
	...
	0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x20, 0x01, 0x52, 0x03, 0x75, 0x72, 0x69, 0x12, 0x33, 0x0a,
	...
	0x75, 0x74, 0x42, 0x15, 0x0a, 0x13, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c,
	0x73, 0x5f, 0x66, 0x65, 0x74, 0x63, 0x68, 0x65, 0x72, 0x42, 0xa6, 0x01, 0x0a, 0x34, 0x69, 0x6f,
	...
	0x61, 0x70, 0x69, 0x73, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2f, 0x65, 0x78, 0x74,
...
var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescData = file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDesc
)

func file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescData)
	})
	return file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDescData
}

var file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_goTypes = []interface{}{
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_depIdxs = []int32{
...
func init() {
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_init()
}
func file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_init() {
	if File_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes[2].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_goTypes,
		DependencyIndexes: file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_depIdxs,
		MessageInfos:      file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_msgTypes,
	}.Build()
	File_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto = out.File
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_rawDesc = nil
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_goTypes = nil
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_extensions_aws_filter_proto_depIdxs = nil
}
