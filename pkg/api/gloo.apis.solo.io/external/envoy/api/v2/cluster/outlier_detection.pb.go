...
// 	protoc        v3.6.1
// source: github.com/solo-io/solo-apis/api/gloo/gloo.apis/external/envoy/api/v2/cluster/outlier_detection.proto
...
func (x *OutlierDetection) Reset() {
	*x = OutlierDetection{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_msgTypes[0]
...
func (*OutlierDetection) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDescGZIP(), []int{0}
}
...
var File_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto protoreflect.FileDescriptor

var file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDesc = []byte{
	...
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x32, 0x2e, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0x42,
	...
	0x61, 0x70, 0x69, 0x2f, 0x76, 0x32, 0x2f, 0x63, 0x6c, 0x75, 0x73, 0x74, 0x65, 0x72, 0xc0, 0xf5,
	0x04, 0x01, 0xb8, 0xf5, 0x04, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDescData = file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDesc
)

func file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDescData)
	})
	return file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDescData
}

var file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_goTypes = []interface{}{
...
var file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_depIdxs = []int32{
...
func init() {
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_init()
}
func file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_init() {
	if File_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_goTypes,
		DependencyIndexes: file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_depIdxs,
		MessageInfos:      file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_msgTypes,
	}.Build()
	File_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto = out.File
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_rawDesc = nil
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_goTypes = nil
	file_github_com_solo_io_solo_apis_api_gloo_gloo_apis_external_envoy_api_v2_cluster_outlier_detection_proto_depIdxs = nil
}
