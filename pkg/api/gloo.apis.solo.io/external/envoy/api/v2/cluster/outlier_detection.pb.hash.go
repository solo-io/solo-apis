...
func (m *OutlierDetection) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.api.v2.cluster.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/api/v2/cluster.OutlierDetection")); err != nil {
		return 0, err
	}
