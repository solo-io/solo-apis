...
func (m *Locality) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.Locality")); err != nil {
		return 0, err
	}
...
func (m *BuildVersion) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.BuildVersion")); err != nil {
		return 0, err
	}
...
func (m *Extension) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.Extension")); err != nil {
		return 0, err
	}
...
func (m *Node) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.Node")); err != nil {
		return 0, err
	}
...
func (m *Metadata) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.Metadata")); err != nil {
		return 0, err
	}
...
func (m *RuntimeUInt32) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.RuntimeUInt32")); err != nil {
		return 0, err
	}
...
func (m *RuntimeDouble) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.RuntimeDouble")); err != nil {
		return 0, err
	}
...
func (m *RuntimeFeatureFlag) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.RuntimeFeatureFlag")); err != nil {
		return 0, err
	}
...
func (m *HeaderValue) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HeaderValue")); err != nil {
		return 0, err
	}
...
func (m *HeaderValueOption) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HeaderValueOption")); err != nil {
		return 0, err
	}
...
func (m *HeaderMap) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HeaderMap")); err != nil {
		return 0, err
	}
...
func (m *DataSource) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.DataSource")); err != nil {
		return 0, err
	}
...
func (m *RetryPolicy) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.RetryPolicy")); err != nil {
		return 0, err
	}
...
func (m *RemoteDataSource) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.RemoteDataSource")); err != nil {
		return 0, err
	}
...
func (m *AsyncDataSource) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.AsyncDataSource")); err != nil {
		return 0, err
	}
...
func (m *TransportSocket) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.TransportSocket")); err != nil {
		return 0, err
	}
...
func (m *RuntimeFractionalPercent) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.RuntimeFractionalPercent")); err != nil {
		return 0, err
	}
...
func (m *ControlPlane) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.ControlPlane")); err != nil {
		return 0, err
	}
