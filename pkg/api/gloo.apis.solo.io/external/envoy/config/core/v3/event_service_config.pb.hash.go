...
func (m *EventServiceConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.EventServiceConfig")); err != nil {
		return 0, err
	}
