...
func (m *HealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_Payload) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HealthCheck_Payload")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_HttpHealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HealthCheck_HttpHealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_TcpHealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HealthCheck_TcpHealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_RedisHealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HealthCheck_RedisHealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_GrpcHealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HealthCheck_GrpcHealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_CustomHealthCheck) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HealthCheck_CustomHealthCheck")); err != nil {
		return 0, err
	}
...
func (m *HealthCheck_TlsOptions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("solo.io.envoy.config.core.v3.github.com/solo-io/solo-apis/pkg/api/gloo.apis.solo.io/external/envoy/config/core/v3.HealthCheck_TlsOptions")); err != nil {
		return 0, err
	}
