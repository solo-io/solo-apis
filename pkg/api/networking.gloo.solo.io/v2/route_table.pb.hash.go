...
func (m *TCPRoute) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.TCPRoute")); err != nil {
		return 0, err
	}
...
func (m *GraphQLAction) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.GraphQLAction")); err != nil {
		return 0, err
	}
...
func (m *PortalMetadata) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.PortalMetadata")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *RouteTableNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.RouteTableNewStatus")); err != nil {
		return 0, err
	}
	...
	err = binary.Write(hasher, binary.LittleEndian, m.GetParentRouteTables())
	if err != nil {
		return 0, err
	}
	...
	err = binary.Write(hasher, binary.LittleEndian, m.GetAllowedVirtualGateways())
	if err != nil {
		return 0, err
	}
...
func (m *RouteTableReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.RouteTableReport")); err != nil {
		return 0, err
	}
...
func (m *GraphQLAction_Options) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.GraphQLAction_Options")); err != nil {
		return 0, err
	}
