...
// Clone function
func (m *ExternalServiceNewStatus) Clone() proto.Message {
	var target *ExternalServiceNewStatus
	if m == nil {
		return target
	}
	target = &ExternalServiceNewStatus{}
	...
	target.SelectedExternalEndpoints = m.GetSelectedExternalEndpoints()
