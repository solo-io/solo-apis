...
// Equal function
func (m *LambdaDiscovery) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*LambdaDiscovery)
	if !ok {
		that2, ok := that.(LambdaDiscovery)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *LambdaFilter) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*LambdaFilter)
	if !ok {
		that2, ok := that.(LambdaFilter)
		if ok {
			target = &that2
		} else {
			return false
...
// Equal function
func (m *CloudProviderNewStatus) Equal(that interface{}) bool {
	if that == nil {
		return m == nil
	}

	target, ok := that.(*CloudProviderNewStatus)
	if !ok {
		that2, ok := that.(CloudProviderNewStatus)
		if ok {
			target = &that2
		} else {
			return false
	...
	if m.GetChildCloudResources() != target.GetChildCloudResources() {
		return false
	}
