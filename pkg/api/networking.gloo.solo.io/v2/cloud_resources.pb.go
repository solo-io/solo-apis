...
// $hide_from_docs
type CloudResourcesNewStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CloudResourcesNewStatus) Reset() {
	*x = CloudResourcesNewStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CloudResourcesNewStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloudResourcesNewStatus) ProtoMessage() {}

func (x *CloudResourcesNewStatus) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloudResourcesNewStatus.ProtoReflect.Descriptor instead.
func (*CloudResourcesNewStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_rawDescGZIP(), []int{3}
}

func (x *CloudResourcesNewStatus) GetCommon() *v2.Status {
	if x != nil {
		return x.Common
	}
	return nil
...
// $hide_from_docs
type CloudResourcesReport struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CloudResourcesReport) Reset() {
	*x = CloudResourcesReport{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *CloudResourcesReport) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloudResourcesReport) ProtoMessage() {}

func (x *CloudResourcesReport) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloudResourcesReport.ProtoReflect.Descriptor instead.
func (*CloudResourcesReport) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_rawDescGZIP(), []int{4}
}

func (x *CloudResourcesReport) GetWorkspaces() map[string]*v2.Report {
	if x != nil {
		return x.Workspaces
	}
	return nil
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x72, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x51, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73, 0x6f, 0x6c, 0x6f, 0x2d, 0x69, 0x6f, 0x2f, 0x73,
	...
	,
	...
	0x72, 0x22, 0x9c, 0x02, 0x0a, 0x14, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x73, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x40, 0x0a, 0x06, 0x67, 0x6c,
	...
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e,
	...
	0x22, 0x4e, 0x0a, 0x17, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63,
	0x65, 0x73, 0x4e, 0x65, 0x77, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x33, 0x0a, 0x06, 0x63,
	...
	0x22, 0xd1, 0x01, 0x0a, 0x14, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x5d, 0x0a, 0x0a, 0x77, 0x6f, 0x72,
	...
	0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x43, 0x6c, 0x6f, 0x75, 0x64, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x2e, 0x57, 0x6f, 0x72,
	0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0a, 0x77, 0x6f,
	0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x1a, 0x5a, 0x0a, 0x0f, 0x57, 0x6f, 0x72, 0x6b,
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_goTypes = []interface{}{
	...
	(*CloudResourcesNewStatus)(nil), // 3: networking.gloo.solo.io.CloudResourcesNewStatus
	(*CloudResourcesReport)(nil),    // 4: networking.gloo.solo.io.CloudResourcesReport
	nil,                             // 5: networking.gloo.solo.io.CloudResourcesStatus.WorkspacesEntry
	nil,                             // 6: networking.gloo.solo.io.CloudResourcesReport.WorkspacesEntry
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_depIdxs = []int32{
	...
	7,  // 1: networking.gloo.solo.io.CloudResourcesStatus.global:type_name -> common.gloo.solo.io.GenericGlobalStatus
	5,  // 2: networking.gloo.solo.io.CloudResourcesStatus.workspaces:type_name -> networking.gloo.solo.io.CloudResourcesStatus.WorkspacesEntry
	8,  // 3: networking.gloo.solo.io.CloudResourcesNewStatus.common:type_name -> common.gloo.solo.io.Status
	6,  // 4: networking.gloo.solo.io.CloudResourcesReport.workspaces:type_name -> networking.gloo.solo.io.CloudResourcesReport.WorkspacesEntry
	9,  // 5: networking.gloo.solo.io.CloudResourcesStatus.WorkspacesEntry.value:type_name -> common.gloo.solo.io.WorkspaceStatus
	10, // 6: networking.gloo.solo.io.CloudResourcesReport.WorkspacesEntry.value:type_name -> common.gloo.solo.io.Report
...
func file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CloudResourcesNewStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_cloud_resources_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CloudResourcesReport); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
