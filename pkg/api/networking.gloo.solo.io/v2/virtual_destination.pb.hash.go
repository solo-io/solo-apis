...
func (m *VirtualDestinationSpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.VirtualDestinationSpec")); err != nil {
		return 0, err
	}
...
func (m *VirtualDestinationStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.VirtualDestinationStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *VirtualDestinationNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.VirtualDestinationNewStatus")); err != nil {
		return 0, err
	}
	...
	err = binary.Write(hasher, binary.LittleEndian, m.GetSelectedBackingServices())
	if err != nil {
		return 0, err
	}
...
func (m *VirtualDestinationReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.VirtualDestinationReport")); err != nil {
		return 0, err
	}
...
func (m *VirtualDestinationSpec_PortMapping) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("networking.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/networking.gloo.solo.io/v2.VirtualDestinationSpec_PortMapping")); err != nil {
		return 0, err
	}
