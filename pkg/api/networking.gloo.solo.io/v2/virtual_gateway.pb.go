...
func (TLSConfig_TLSMode) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_enumTypes[0].Descriptor()
}

func (TLSConfig_TLSMode) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_enumTypes[0]
}
...
func (TLSConfig_TLSMode) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescGZIP(), []int{1, 0}
}
...
func (TLSConfig_Parameters_ProtocolVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_enumTypes[1].Descriptor()
}

func (TLSConfig_Parameters_ProtocolVersion) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_enumTypes[1]
}
...
func (TLSConfig_Parameters_ProtocolVersion) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescGZIP(), []int{1, 1, 0}
}
...
func (x *VirtualGatewaySpec) Reset() {
	*x = VirtualGatewaySpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[0]
...
func (*VirtualGatewaySpec) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescGZIP(), []int{0}
}
...
func (x *TLSConfig) Reset() {
	*x = TLSConfig{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TLSConfig) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescGZIP(), []int{1}
}
...
type VirtualGatewayStatus struct {
	...
	// list of RouteTables allowed to bind to this VirtualGateway
	AllowedRouteTables []*v2.ObjectReference `protobuf:"bytes,3,rep,name=allowed_route_tables,json=allowedRouteTables,proto3" json:"allowed_route_tables,omitempty"`
	// workloads selected by this VirtualGateway
	Workloads []*v2.ObjectReference `protobuf:"bytes,4,rep,name=workloads,proto3" json:"workloads,omitempty"`
}

func (x *VirtualGatewayStatus) Reset() {
	*x = VirtualGatewayStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VirtualGatewayStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescGZIP(), []int{2}
}

func (x *VirtualGatewayStatus) GetGlobal() *v2.GenericGlobalStatus {
	if x != nil {
		return x.Global
	}
	return nil
...
func (x *VirtualGatewayStatus) GetWorkspaces() map[string]*v2.WorkspaceStatus {
	if x != nil {
		return x.Workspaces
	}
	return nil
...
func (x *VirtualGatewayStatus) GetAllowedRouteTables() []*v2.ObjectReference {
	if x != nil {
...
func (x *VirtualGatewayStatus) GetWorkloads() []*v2.ObjectReference {
	if x != nil {
		return x.Workloads
	}
	return nil
...
type VirtualGatewaySpec_Listener struct {
	...
	// Optional: restrict the routes that can be applied to this VirtualGateway.
	// If not specified, any route will be allowed to bind to this VirtualGateway.
	AllowedRoutes *v2.RouteFilter `protobuf:"bytes,8,opt,name=allowed_routes,json=allowedRoutes,proto3" json:"allowed_routes,omitempty"`
...
func (x *VirtualGatewaySpec_Listener) Reset() {
	*x = VirtualGatewaySpec_Listener{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VirtualGatewaySpec_Listener) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *VirtualGatewaySpec_Listener) GetAllowedRoutes() *v2.RouteFilter {
	if x != nil {
...
func (x *VirtualGatewaySpec_Listener_HTTPServer) Reset() {
	*x = VirtualGatewaySpec_Listener_HTTPServer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *VirtualGatewaySpec_Listener_TCPServer) Reset() {
	*x = VirtualGatewaySpec_Listener_TCPServer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VirtualGatewaySpec_Listener_TCPServer) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescGZIP(), []int{0, 0, 1}
}
...
func (x *VirtualGatewaySpec_Listener_RouteTableFilter) Reset() {
	*x = VirtualGatewaySpec_Listener_RouteTableFilter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VirtualGatewaySpec_Listener_RouteTableFilter) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescGZIP(), []int{0, 0, 2}
}
...
func (x *TLSConfig_Files) Reset() {
	*x = TLSConfig_Files{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *TLSConfig_Parameters) Reset() {
	*x = TLSConfig_Parameters{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TLSConfig_Parameters) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescGZIP(), []int{1, 1}
}
...
var File_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto protoreflect.FileDescriptor

var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDesc = []byte{
	...
	0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x17, 0x6e,
	...
	0x2f, 0x65, 0x78, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x4c, 0x67, 0x69, 0x74, 0x68,
	...
	0x87, 0x07, 0x0a, 0x12, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x47, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x53, 0x70, 0x65, 0x63, 0x12, 0x43, 0x0a, 0x09, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f,
	0x61, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	...
	0x52, 0x09, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x12, 0x52, 0x0a, 0x09, 0x6c,
	0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x34,
	...
	0x47, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x4c, 0x69, 0x73, 0x74,
	0x65, 0x6e, 0x65, 0x72, 0x52, 0x09, 0x6c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x73, 0x1a,
	0xd7, 0x05, 0x0a, 0x08, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x12, 0x35, 0x0a, 0x04,
	0x70, 0x6f, 0x72, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x63, 0x6f, 0x6d,
	...
	0x6f, 0x72, 0x74, 0x12, 0x36, 0x0a, 0x03, 0x74, 0x6c, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x22, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x67, 0x6c,
	0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x54, 0x4c, 0x53, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x48, 0x00, 0x52, 0x03, 0x74, 0x6c, 0x73, 0x12, 0x27, 0x0a, 0x0e, 0x68,
	0x74, 0x74, 0x70, 0x73, 0x5f, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x08, 0x48, 0x00, 0x52, 0x0d, 0x68, 0x74, 0x74, 0x70, 0x73, 0x52, 0x65, 0x64, 0x69,
	0x72, 0x65, 0x63, 0x74, 0x12, 0x55, 0x0a, 0x04, 0x68, 0x74, 0x74, 0x70, 0x18, 0x04, 0x20, 0x01,
	...
	0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x53, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x48, 0x01, 0x52, 0x04, 0x68, 0x74, 0x74, 0x70, 0x12, 0x52, 0x0a, 0x03, 0x74,
	0x63, 0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3e, 0x2e, 0x6e, 0x65, 0x74, 0x77, 0x6f,
	...
	0x79, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x65, 0x6e, 0x65, 0x72, 0x2e, 0x54,
	0x43, 0x50, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x48, 0x01, 0x52, 0x03, 0x74, 0x63, 0x70, 0x12,
	0x77, 0x0a, 0x14, 0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65,
	0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x45, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	0x52, 0x0c, 0x63, 0x69, 0x70, 0x68, 0x65, 0x72, 0x53, 0x75, 0x69, 0x74, 0x65, 0x73, 0x22, 0x53,
	...
	0x33, 0x10, 0x04, 0x22, 0x5a, 0x0a, 0x07, 0x54, 0x4c, 0x53, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x0f,
	...
	0x0c, 0x49, 0x53, 0x54, 0x49, 0x4f, 0x5f, 0x4d, 0x55, 0x54, 0x55, 0x41, 0x4c, 0x10, 0x04, 0x42,
	0x0e, 0x0a, 0x0c, 0x63, 0x65, 0x72, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x73, 0x22,
	0xb8, 0x03, 0x0a, 0x14, 0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x47, 0x61, 0x74, 0x65, 0x77,
	0x61, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x40, 0x0a, 0x06, 0x67, 0x6c, 0x6f, 0x62,
	...
	,
	...
	0x6a, 0x65, 0x63, 0x74, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x12, 0x61,
	0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x64, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65,
	0x73, 0x12, 0x42, 0x0a, 0x09, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x18, 0x04,
	...
	0x74, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x09, 0x77, 0x6f, 0x72, 0x6b,
	0x6c, 0x6f, 0x61, 0x64, 0x73, 0x1a, 0x63, 0x0a, 0x0f, 0x57, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61,
...
var (
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescData = file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDesc
)

func file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescData)
	})
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDescData
}

var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_goTypes = []interface{}{
	...
	(*VirtualGatewaySpec_Listener)(nil),                  // 5: networking.gloo.solo.io.VirtualGatewaySpec.Listener
	(*VirtualGatewaySpec_Listener_HTTPServer)(nil),       // 6: networking.gloo.solo.io.VirtualGatewaySpec.Listener.HTTPServer
	(*VirtualGatewaySpec_Listener_TCPServer)(nil),        // 7: networking.gloo.solo.io.VirtualGatewaySpec.Listener.TCPServer
	(*VirtualGatewaySpec_Listener_RouteTableFilter)(nil), // 8: networking.gloo.solo.io.VirtualGatewaySpec.Listener.RouteTableFilter
	(*TLSConfig_Files)(nil),                              // 9: networking.gloo.solo.io.TLSConfig.Files
	(*TLSConfig_Parameters)(nil),                         // 10: networking.gloo.solo.io.TLSConfig.Parameters
	nil,                                                  // 11: networking.gloo.solo.io.VirtualGatewayStatus.WorkspacesEntry
	(*v2.WorkloadSelector)(nil),                          // 12: common.gloo.solo.io.WorkloadSelector
	...
	(*v2.PortSelector)(nil),                              // 15: common.gloo.solo.io.PortSelector
	(*v2.RouteFilter)(nil),                               // 16: common.gloo.solo.io.RouteFilter
	(*v2.ObjectSelector)(nil),                            // 17: common.gloo.solo.io.ObjectSelector
	(*v2.WorkspaceStatus)(nil),                           // 18: common.gloo.solo.io.WorkspaceStatus
}
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_depIdxs = []int32{
	12, // 0: networking.gloo.solo.io.VirtualGatewaySpec.workloads:type_name -> common.gloo.solo.io.WorkloadSelector
	5,  // 1: networking.gloo.solo.io.VirtualGatewaySpec.listeners:type_name -> networking.gloo.solo.io.VirtualGatewaySpec.Listener
	9,  // 2: networking.gloo.solo.io.TLSConfig.files:type_name -> networking.gloo.solo.io.TLSConfig.Files
	10, // 3: networking.gloo.solo.io.TLSConfig.parameters:type_name -> networking.gloo.solo.io.TLSConfig.Parameters
	0,  // 4: networking.gloo.solo.io.TLSConfig.mode:type_name -> networking.gloo.solo.io.TLSConfig.TLSMode
	13, // 5: networking.gloo.solo.io.VirtualGatewayStatus.global:type_name -> common.gloo.solo.io.GenericGlobalStatus
	11, // 6: networking.gloo.solo.io.VirtualGatewayStatus.workspaces:type_name -> networking.gloo.solo.io.VirtualGatewayStatus.WorkspacesEntry
	14, // 7: networking.gloo.solo.io.VirtualGatewayStatus.allowed_route_tables:type_name -> common.gloo.solo.io.ObjectReference
	14, // 8: networking.gloo.solo.io.VirtualGatewayStatus.workloads:type_name -> common.gloo.solo.io.ObjectReference
	15, // 9: networking.gloo.solo.io.VirtualGatewaySpec.Listener.port:type_name -> common.gloo.solo.io.PortSelector
	3,  // 10: networking.gloo.solo.io.VirtualGatewaySpec.Listener.tls:type_name -> networking.gloo.solo.io.TLSConfig
	6,  // 11: networking.gloo.solo.io.VirtualGatewaySpec.Listener.http:type_name -> networking.gloo.solo.io.VirtualGatewaySpec.Listener.HTTPServer
	7,  // 12: networking.gloo.solo.io.VirtualGatewaySpec.Listener.tcp:type_name -> networking.gloo.solo.io.VirtualGatewaySpec.Listener.TCPServer
	8,  // 13: networking.gloo.solo.io.VirtualGatewaySpec.Listener.allowed_route_tables:type_name -> networking.gloo.solo.io.VirtualGatewaySpec.Listener.RouteTableFilter
	16, // 14: networking.gloo.solo.io.VirtualGatewaySpec.Listener.allowed_routes:type_name -> common.gloo.solo.io.RouteFilter
	17, // 15: networking.gloo.solo.io.VirtualGatewaySpec.Listener.RouteTableFilter.selector:type_name -> common.gloo.solo.io.ObjectSelector
	1,  // 16: networking.gloo.solo.io.TLSConfig.Parameters.minimum_protocol_version:type_name -> networking.gloo.solo.io.TLSConfig.Parameters.ProtocolVersion
	1,  // 17: networking.gloo.solo.io.TLSConfig.Parameters.maximum_protocol_version:type_name -> networking.gloo.solo.io.TLSConfig.Parameters.ProtocolVersion
	18, // 18: networking.gloo.solo.io.VirtualGatewayStatus.WorkspacesEntry.value:type_name -> common.gloo.solo.io.WorkspaceStatus
...
func init() {
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_init()
}
func file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_init() {
	if File_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*TLSConfig_SecretName)(nil),
		(*TLSConfig_Files_)(nil),
	}
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes[3].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_goTypes,
		DependencyIndexes: file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_depIdxs,
		EnumInfos:         file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_enumTypes,
		MessageInfos:      file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_msgTypes,
	}.Build()
	File_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto = out.File
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_rawDesc = nil
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_goTypes = nil
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_networking_v2_virtual_gateway_proto_depIdxs = nil
}
