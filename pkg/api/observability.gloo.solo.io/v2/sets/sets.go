...
type AccessLogPolicySet interface {
	...
	List(filterResource ...func(*observability_gloo_solo_io_v2.AccessLogPolicy) bool) []*observability_gloo_solo_io_v2.AccessLogPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*observability_gloo_solo_io_v2.AccessLogPolicy) bool) []*observability_gloo_solo_io_v2.AccessLogPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*observability_gloo_solo_io_v2.AccessLogPolicy
	// Insert a resource into the set.
	Insert(accessLogPolicy ...*observability_gloo_solo_io_v2.AccessLogPolicy)
	...
	Find(id ezkube.ResourceId) (*observability_gloo_solo_io_v2.AccessLogPolicy, error)
...
func makeGenericAccessLogPolicySet(accessLogPolicyList []*observability_gloo_solo_io_v2.AccessLogPolicy) sksets.ResourceSet {
...
func NewAccessLogPolicySet(accessLogPolicyList ...*observability_gloo_solo_io_v2.AccessLogPolicy) AccessLogPolicySet {
	return &accessLogPolicySet{set: makeGenericAccessLogPolicySet(accessLogPolicyList)}
}

func NewAccessLogPolicySetFromList(accessLogPolicyList *observability_gloo_solo_io_v2.AccessLogPolicyList) AccessLogPolicySet {
	list := make([]*observability_gloo_solo_io_v2.AccessLogPolicy, 0, len(accessLogPolicyList.Items))
...
func (s *accessLogPolicySet) List(filterResource ...func(*observability_gloo_solo_io_v2.AccessLogPolicy) bool) []*observability_gloo_solo_io_v2.AccessLogPolicy {
	if s == nil {
		return nil
	}
	...
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*observability_gloo_solo_io_v2.AccessLogPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	accessLogPolicyList := make([]*observability_gloo_solo_io_v2.AccessLogPolicy, 0, len(objs))
	for _, obj := range objs {
		accessLogPolicyList = append(accessLogPolicyList, obj.(*observability_gloo_solo_io_v2.AccessLogPolicy))
	}
	return accessLogPolicyList
}

func (s *accessLogPolicySet) UnsortedList(filterResource ...func(*observability_gloo_solo_io_v2.AccessLogPolicy) bool) []*observability_gloo_solo_io_v2.AccessLogPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var accessLogPolicyList []*observability_gloo_solo_io_v2.AccessLogPolicy
...
func (s *accessLogPolicySet) Map() map[string]*observability_gloo_solo_io_v2.AccessLogPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*observability_gloo_solo_io_v2.AccessLogPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*observability_gloo_solo_io_v2.AccessLogPolicy)
	}
	return newMap
}

func (s *accessLogPolicySet) Insert(
	accessLogPolicyList ...*observability_gloo_solo_io_v2.AccessLogPolicy,
) {
	if s == nil {
...
func (s *accessLogPolicySet) Find(id ezkube.ResourceId) (*observability_gloo_solo_io_v2.AccessLogPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find AccessLogPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&observability_gloo_solo_io_v2.AccessLogPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*observability_gloo_solo_io_v2.AccessLogPolicy), nil
}
