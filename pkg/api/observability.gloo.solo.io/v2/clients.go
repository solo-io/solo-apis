...
// MulticlusterClientset for the observability.gloo.solo.io/v2 APIs
...
// clienset for the observability.gloo.solo.io/v2 APIs
type Clientset interface {
	// clienset for the observability.gloo.solo.io/v2/v2 APIs
