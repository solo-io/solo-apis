...
type AccessLogPolicyReconciler interface {
	ReconcileAccessLogPolicy(obj *observability_gloo_solo_io_v2.AccessLogPolicy) (reconcile.Result, error)
}
...
type AccessLogPolicyReconcilerFuncs struct {
	OnReconcileAccessLogPolicy         func(obj *observability_gloo_solo_io_v2.AccessLogPolicy) (reconcile.Result, error)
	OnReconcileAccessLogPolicyDeletion func(req reconcile.Request) error
}

func (f *AccessLogPolicyReconcilerFuncs) ReconcileAccessLogPolicy(obj *observability_gloo_solo_io_v2.AccessLogPolicy) (reconcile.Result, error) {
...
type AccessLogPolicyFinalizer interface {
	...
	FinalizeAccessLogPolicy(obj *observability_gloo_solo_io_v2.AccessLogPolicy) error
}
...
func NewAccessLogPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) AccessLogPolicyReconcileLoop {
	return &accessLogPolicyReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &observability_gloo_solo_io_v2.AccessLogPolicy{}, options),
	}
}
