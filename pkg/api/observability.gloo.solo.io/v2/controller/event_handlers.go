...
type AccessLogPolicyEventHandler interface {
	CreateAccessLogPolicy(obj *observability_gloo_solo_io_v2.AccessLogPolicy) error
	UpdateAccessLogPolicy(old, new *observability_gloo_solo_io_v2.AccessLogPolicy) error
	DeleteAccessLogPolicy(obj *observability_gloo_solo_io_v2.AccessLogPolicy) error
	GenericAccessLogPolicy(obj *observability_gloo_solo_io_v2.AccessLogPolicy) error
}

type AccessLogPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *observability_gloo_solo_io_v2.AccessLogPolicy) error
	OnUpdate  func(old, new *observability_gloo_solo_io_v2.AccessLogPolicy) error
	OnDelete  func(obj *observability_gloo_solo_io_v2.AccessLogPolicy) error
	OnGeneric func(obj *observability_gloo_solo_io_v2.AccessLogPolicy) error
}

func (f *AccessLogPolicyEventHandlerFuncs) CreateAccessLogPolicy(obj *observability_gloo_solo_io_v2.AccessLogPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *AccessLogPolicyEventHandlerFuncs) DeleteAccessLogPolicy(obj *observability_gloo_solo_io_v2.AccessLogPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *AccessLogPolicyEventHandlerFuncs) UpdateAccessLogPolicy(objOld, objNew *observability_gloo_solo_io_v2.AccessLogPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *AccessLogPolicyEventHandlerFuncs) GenericAccessLogPolicy(obj *observability_gloo_solo_io_v2.AccessLogPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewAccessLogPolicyEventWatcher(name string, mgr manager.Manager) AccessLogPolicyEventWatcher {
	return &accessLogPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &observability_gloo_solo_io_v2.AccessLogPolicy{}),
	}
}
...
func (h genericAccessLogPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*observability_gloo_solo_io_v2.AccessLogPolicy)
	if !ok {
		return errors.Errorf("internal error: AccessLogPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*observability_gloo_solo_io_v2.AccessLogPolicy)
	if !ok {
