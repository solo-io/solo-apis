...
import (
	...
	github_com_solo_io_solo_apis_pkg_api_envoy_gloo_ee_api_envoy_config_filter_http_transformation_ee_v2 "github.com/solo-io/solo-apis/pkg/api/envoy-gloo-ee/api/envoy/config/filter/http/transformation_ee/v2"
)
...
func (m *DlpCustomAction) Clone() proto.Message {
	...
	if m.GetRegexActions() != nil {
		target.RegexActions = make([]*github_com_solo_io_solo_apis_pkg_api_envoy_gloo_ee_api_envoy_config_filter_http_transformation_ee_v2.RegexAction, len(m.GetRegexActions()))
		for idx, v := range m.GetRegexActions() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.RegexActions[idx] = h.Clone().(*github_com_solo_io_solo_apis_pkg_api_envoy_gloo_ee_api_envoy_config_filter_http_transformation_ee_v2.RegexAction)
			} else {
				target.RegexActions[idx] = proto.Clone(v).(*github_com_solo_io_solo_apis_pkg_api_envoy_gloo_ee_api_envoy_config_filter_http_transformation_ee_v2.RegexAction)
			}
