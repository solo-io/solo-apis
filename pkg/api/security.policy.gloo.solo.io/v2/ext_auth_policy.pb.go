...
// $hide_from_docs
type ExtAuthPolicyNewStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ExtAuthPolicyNewStatus) Reset() {
	*x = ExtAuthPolicyNewStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *ExtAuthPolicyNewStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExtAuthPolicyNewStatus) ProtoMessage() {}

func (x *ExtAuthPolicyNewStatus) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ExtAuthPolicyNewStatus.ProtoReflect.Descriptor instead.
func (*ExtAuthPolicyNewStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_rawDescGZIP(), []int{2}
}

func (x *ExtAuthPolicyNewStatus) GetCommon() *v2.Status {
	if x != nil {
		return x.Common
	}
	return nil
...
func (x *ExtAuthPolicyNewStatus) GetSelectedDestinationPorts() uint32 {
	if x != nil {
		return x.SelectedDestinationPorts
	}
	return 0
...
func (x *ExtAuthPolicyNewStatus) GetSelectedRoutes() uint32 {
	if x != nil {
		return x.SelectedRoutes
	}
	return 0
...
func (*ExtAuthPolicyReport) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_rawDescGZIP(), []int{3}
}
...
func (x *ExtAuthPolicySpec_Config) Reset() {
	*x = ExtAuthPolicySpec_Config{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *ExtAuthPolicySpec_Config_CustomAuth) Reset() {
	*x = ExtAuthPolicySpec_Config_CustomAuth{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_rawDesc = []byte{
	...
	0x75, 0x73, 0x5f, 0x6e, 0x65, 0x77, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x93, 0x06, 0x0a,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb4, 0x01, 0x0a, 0x16,
	0x45, 0x78, 0x74, 0x41, 0x75, 0x74, 0x68, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x4e, 0x65, 0x77,
	...
	0x74, 0x75, 0x73, 0x52, 0x06, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x12, 0x3c, 0x0a, 0x1a, 0x73,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x65, 0x6c,
	0x65, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0e, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x52, 0x6f, 0x75, 0x74,
	0x65, 0x73, 0x22, 0x8b, 0x03, 0x0a, 0x13, 0x45, 0x78, 0x74, 0x41, 0x75, 0x74, 0x68, 0x50, 0x6f,
	0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x61, 0x0a, 0x0a, 0x77, 0x6f,
	0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x41,
	...
	0x74, 0x41, 0x75, 0x74, 0x68, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x70, 0x6f, 0x72,
	...
	0x42, 0x52, 0x5a, 0x44, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x73,
	0x6f, 0x6c, 0x6f, 0x2d, 0x69, 0x6f, 0x2f, 0x73, 0x6f, 0x6c, 0x6f, 0x2d, 0x61, 0x70, 0x69, 0x73,
	0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x73, 0x65, 0x63, 0x75, 0x72, 0x69, 0x74,
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_goTypes = []interface{}{
	...
	(*ExtAuthPolicyNewStatus)(nil),              // 2: security.policy.gloo.solo.io.ExtAuthPolicyNewStatus
	(*ExtAuthPolicyReport)(nil),                 // 3: security.policy.gloo.solo.io.ExtAuthPolicyReport
	(*ExtAuthPolicySpec_Config)(nil),            // 4: security.policy.gloo.solo.io.ExtAuthPolicySpec.Config
	(*ExtAuthPolicySpec_Config_CustomAuth)(nil), // 5: security.policy.gloo.solo.io.ExtAuthPolicySpec.Config.CustomAuth
	nil,                             // 6: security.policy.gloo.solo.io.ExtAuthPolicySpec.Config.CustomAuth.ContextExtensionsEntry
	nil,                             // 7: security.policy.gloo.solo.io.ExtAuthPolicyStatus.WorkspacesEntry
	nil,                             // 8: security.policy.gloo.solo.io.ExtAuthPolicyReport.WorkspacesEntry
	...
	(*v2.RouteReference)(nil),       // 13: common.gloo.solo.io.RouteReference
	(*v2.Status)(nil),               // 14: common.gloo.solo.io.Status
	(*v1.AuthConfigSpec)(nil),       // 15: enterprise.gloo.solo.io.AuthConfigSpec
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_depIdxs = []int32{
	9,  // 0: security.policy.gloo.solo.io.ExtAuthPolicySpec.apply_to_routes:type_name -> common.gloo.solo.io.RouteSelector
	10, // 1: security.policy.gloo.solo.io.ExtAuthPolicySpec.apply_to_destinations:type_name -> common.gloo.solo.io.DestinationSelector
	4,  // 2: security.policy.gloo.solo.io.ExtAuthPolicySpec.config:type_name -> security.policy.gloo.solo.io.ExtAuthPolicySpec.Config
	11, // 3: security.policy.gloo.solo.io.ExtAuthPolicyStatus.global:type_name -> common.gloo.solo.io.GenericGlobalStatus
	7,  // 4: security.policy.gloo.solo.io.ExtAuthPolicyStatus.workspaces:type_name -> security.policy.gloo.solo.io.ExtAuthPolicyStatus.WorkspacesEntry
	12, // 5: security.policy.gloo.solo.io.ExtAuthPolicyStatus.selected_destination_ports:type_name -> common.gloo.solo.io.DestinationReference
	13, // 6: security.policy.gloo.solo.io.ExtAuthPolicyStatus.selected_routes:type_name -> common.gloo.solo.io.RouteReference
	14, // 7: security.policy.gloo.solo.io.ExtAuthPolicyNewStatus.common:type_name -> common.gloo.solo.io.Status
	8,  // 8: security.policy.gloo.solo.io.ExtAuthPolicyReport.workspaces:type_name -> security.policy.gloo.solo.io.ExtAuthPolicyReport.WorkspacesEntry
	12, // 9: security.policy.gloo.solo.io.ExtAuthPolicyReport.selected_destination_ports:type_name -> common.gloo.solo.io.DestinationReference
	13, // 10: security.policy.gloo.solo.io.ExtAuthPolicyReport.selected_routes:type_name -> common.gloo.solo.io.RouteReference
	15, // 11: security.policy.gloo.solo.io.ExtAuthPolicySpec.Config.gloo_auth:type_name -> enterprise.gloo.solo.io.AuthConfigSpec
	5,  // 12: security.policy.gloo.solo.io.ExtAuthPolicySpec.Config.custom_auth:type_name -> security.policy.gloo.solo.io.ExtAuthPolicySpec.Config.CustomAuth
	16, // 13: security.policy.gloo.solo.io.ExtAuthPolicySpec.Config.server:type_name -> common.gloo.solo.io.ObjectReference
	6,  // 14: security.policy.gloo.solo.io.ExtAuthPolicySpec.Config.CustomAuth.context_extensions:type_name -> security.policy.gloo.solo.io.ExtAuthPolicySpec.Config.CustomAuth.ContextExtensionsEntry
	17, // 15: security.policy.gloo.solo.io.ExtAuthPolicyStatus.WorkspacesEntry.value:type_name -> common.gloo.solo.io.WorkspaceStatus
	18, // 16: security.policy.gloo.solo.io.ExtAuthPolicyReport.WorkspacesEntry.value:type_name -> common.gloo.solo.io.Report
...
func file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExtAuthPolicyNewStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_security_ext_auth_policy_proto_msgTypes[4].OneofWrappers = []interface{}{
