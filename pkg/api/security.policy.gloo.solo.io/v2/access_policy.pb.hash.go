...
func (m *AccessPolicySpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.AccessPolicySpec")); err != nil {
		return 0, err
	}
...
func (m *AccessPolicyStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.AccessPolicyStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *AccessPolicyNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.AccessPolicyNewStatus")); err != nil {
		return 0, err
	}
...
func (m *AccessPolicyReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.AccessPolicyReport")); err != nil {
		return 0, err
	}
...
func (m *AccessPolicySpec_Config) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.AccessPolicySpec_Config")); err != nil {
		return 0, err
	}
...
func (m *AccessPolicySpec_Config_Authentication) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.AccessPolicySpec_Config_Authentication")); err != nil {
		return 0, err
	}
...
func (m *AccessPolicySpec_Config_Authorization) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.AccessPolicySpec_Config_Authorization")); err != nil {
		return 0, err
	}
