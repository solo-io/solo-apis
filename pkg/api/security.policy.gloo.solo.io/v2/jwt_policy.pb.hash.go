...
func (m *JWTPolicySpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec")); err != nil {
		return 0, err
	}
...
func (m *JWTPolicyStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicyStatus")); err != nil {
		return 0, err
	}
...
// Hash function
func (m *JWTPolicyNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicyNewStatus")); err != nil {
		return 0, err
	}
...
func (m *JWTPolicyReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicyReport")); err != nil {
		return 0, err
	}
...
func (m *JWTPolicySpec_Config) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec_Config")); err != nil {
		return 0, err
	}
...
func (m *JWTPolicySpec_Config_Provider) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec_Config_Provider")); err != nil {
		return 0, err
	}
...
func (m *JWTPolicySpec_Config_Provider_TokenSource) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec_Config_Provider_TokenSource")); err != nil {
		return 0, err
	}
...
func (m *JWTPolicySpec_Config_Provider_LocalJWKS) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec_Config_Provider_LocalJWKS")); err != nil {
		return 0, err
	}
...
func (m *JWTPolicySpec_Config_Provider_RemoteJWKS) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec_Config_Provider_RemoteJWKS")); err != nil {
		return 0, err
	}
...
func (m *JWTPolicySpec_Config_Provider_ClaimsToHeader) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec_Config_Provider_ClaimsToHeader")); err != nil {
		return 0, err
	}
...
func (m *JWTPolicySpec_Config_Provider_TokenSourceFromHeader) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec_Config_Provider_TokenSourceFromHeader")); err != nil {
		return 0, err
	}
...
func (m *JWTPolicySpec_Config_Provider_LocalJWKS_SecretRef) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.JWTPolicySpec_Config_Provider_LocalJWKS_SecretRef")); err != nil {
		return 0, err
	}
