...
// Hash function
func (m *CORSPolicyNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.CORSPolicyNewStatus")); err != nil {
		return 0, err
	}
...
func (m *CORSPolicyReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("security.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/security.policy.gloo.solo.io/v2.CORSPolicyReport")); err != nil {
		return 0, err
	}
