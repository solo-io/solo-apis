...
// $hide_from_docs
type OutlierDetectionPolicyNewStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *OutlierDetectionPolicyNewStatus) Reset() {
	*x = OutlierDetectionPolicyNewStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *OutlierDetectionPolicyNewStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OutlierDetectionPolicyNewStatus) ProtoMessage() {}

func (x *OutlierDetectionPolicyNewStatus) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OutlierDetectionPolicyNewStatus.ProtoReflect.Descriptor instead.
func (*OutlierDetectionPolicyNewStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_rawDescGZIP(), []int{2}
}

func (x *OutlierDetectionPolicyNewStatus) GetCommon() *v2.Status {
	if x != nil {
		return x.Common
	}
	return nil
...
func (x *OutlierDetectionPolicyNewStatus) GetSelectedDestinationPorts() uint32 {
	if x != nil {
		return x.SelectedDestinationPorts
	}
	return 0
...
func (x *OutlierDetectionPolicyReport) Reset() {
	*x = OutlierDetectionPolicyReport{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OutlierDetectionPolicyReport) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_rawDescGZIP(), []int{3}
}
...
func (x *OutlierDetectionPolicySpec_Config) Reset() {
	*x = OutlierDetectionPolicySpec_Config{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_rawDesc = []byte{
	...
	0x22, 0x9c, 0x03, 0x0a, 0x1c, 0x4f, 0x75, 0x74, 0x6c, 0x69, 0x65, 0x72, 0x44, 0x65, 0x74, 0x65,
	...
	0x62, 0x61, 0x6c, 0x12, 0x6c, 0x0a, 0x0a, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65,
	0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x4c, 0x2e, 0x72, 0x65, 0x73, 0x69, 0x6c, 0x69,
	0x65, 0x6e, 0x63, 0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x67, 0x6c, 0x6f, 0x6f,
	0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x4f, 0x75, 0x74, 0x6c, 0x69, 0x65, 0x72,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x1a, 0x63, 0x0a, 0x0f, 0x57, 0x6f,
	...
	0x94, 0x01, 0x0a, 0x1f, 0x4f, 0x75, 0x74, 0x6c, 0x69, 0x65, 0x72, 0x44, 0x65, 0x74, 0x65, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x4e, 0x65, 0x77, 0x53, 0x74, 0x61,
	...
	,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x54, 0x5a, 0x46, 0x67, 0x69,
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_goTypes = []interface{}{
	...
	(*OutlierDetectionPolicyNewStatus)(nil),   // 2: resilience.policy.gloo.solo.io.OutlierDetectionPolicyNewStatus
	(*OutlierDetectionPolicyReport)(nil),      // 3: resilience.policy.gloo.solo.io.OutlierDetectionPolicyReport
	(*OutlierDetectionPolicySpec_Config)(nil), // 4: resilience.policy.gloo.solo.io.OutlierDetectionPolicySpec.Config
	nil,                             // 5: resilience.policy.gloo.solo.io.OutlierDetectionPolicyStatus.WorkspacesEntry
	nil,                             // 6: resilience.policy.gloo.solo.io.OutlierDetectionPolicyReport.WorkspacesEntry
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_depIdxs = []int32{
	7,  // 0: resilience.policy.gloo.solo.io.OutlierDetectionPolicySpec.apply_to_destinations:type_name -> common.gloo.solo.io.DestinationSelector
	4,  // 1: resilience.policy.gloo.solo.io.OutlierDetectionPolicySpec.config:type_name -> resilience.policy.gloo.solo.io.OutlierDetectionPolicySpec.Config
	8,  // 2: resilience.policy.gloo.solo.io.OutlierDetectionPolicyStatus.global:type_name -> common.gloo.solo.io.GenericGlobalStatus
	5,  // 3: resilience.policy.gloo.solo.io.OutlierDetectionPolicyStatus.workspaces:type_name -> resilience.policy.gloo.solo.io.OutlierDetectionPolicyStatus.WorkspacesEntry
	9,  // 4: resilience.policy.gloo.solo.io.OutlierDetectionPolicyStatus.selected_destination_ports:type_name -> common.gloo.solo.io.DestinationReference
	10, // 5: resilience.policy.gloo.solo.io.OutlierDetectionPolicyNewStatus.common:type_name -> common.gloo.solo.io.Status
	6,  // 6: resilience.policy.gloo.solo.io.OutlierDetectionPolicyReport.workspaces:type_name -> resilience.policy.gloo.solo.io.OutlierDetectionPolicyReport.WorkspacesEntry
	9,  // 7: resilience.policy.gloo.solo.io.OutlierDetectionPolicyReport.selected_destination_ports:type_name -> common.gloo.solo.io.DestinationReference
	11, // 8: resilience.policy.gloo.solo.io.OutlierDetectionPolicySpec.Config.interval:type_name -> google.protobuf.Duration
	11, // 9: resilience.policy.gloo.solo.io.OutlierDetectionPolicySpec.Config.base_ejection_time:type_name -> google.protobuf.Duration
	12, // 10: resilience.policy.gloo.solo.io.OutlierDetectionPolicyStatus.WorkspacesEntry.value:type_name -> common.gloo.solo.io.WorkspaceStatus
	13, // 11: resilience.policy.gloo.solo.io.OutlierDetectionPolicyReport.WorkspacesEntry.value:type_name -> common.gloo.solo.io.Report
...
func file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OutlierDetectionPolicyNewStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_outlier_detection_policy_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
