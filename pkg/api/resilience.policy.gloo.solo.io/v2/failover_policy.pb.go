...
// $hide_from_docs
type FailoverPolicyNewStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *FailoverPolicyNewStatus) Reset() {
	*x = FailoverPolicyNewStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *FailoverPolicyNewStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FailoverPolicyNewStatus) ProtoMessage() {}

func (x *FailoverPolicyNewStatus) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FailoverPolicyNewStatus.ProtoReflect.Descriptor instead.
func (*FailoverPolicyNewStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_rawDescGZIP(), []int{2}
}

func (x *FailoverPolicyNewStatus) GetCommon() *v2.Status {
	if x != nil {
		return x.Common
	}
	return nil
...
func (x *FailoverPolicyNewStatus) GetSelectedDestinationPorts() uint32 {
	if x != nil {
		return x.SelectedDestinationPorts
	}
	return 0
...
func (*FailoverPolicyReport) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_rawDescGZIP(), []int{3}
}
...
func (x *FailoverPolicySpec_Config_LocalityMappings_OriginatingLocality) Reset() {
	*x = FailoverPolicySpec_Config_LocalityMappings_OriginatingLocality{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *FailoverPolicySpec_Config_LocalityMappings_DestinationLocality) Reset() {
	*x = FailoverPolicySpec_Config_LocalityMappings_DestinationLocality{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_rawDesc = []byte{
	...
	0x78, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x52, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x6c, 0x75, 0x65, 0x52, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x8c, 0x03, 0x0a, 0x14,
	...
	0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x12, 0x64, 0x0a, 0x0a, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70,
	0x61, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x44, 0x2e, 0x72, 0x65, 0x73,
	...
	0x6f, 0x76, 0x65, 0x72, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x8c, 0x01, 0x0a, 0x17, 0x46,
	0x61, 0x69, 0x6c, 0x6f, 0x76, 0x65, 0x72, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x4e, 0x65, 0x77,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x72, 0x74, 0x73, 0x22, 0xc1, 0x02, 0x0a, 0x14, 0x46, 0x61,
	0x69, 0x6c, 0x6f, 0x76, 0x65, 0x72, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x12, 0x64, 0x0a, 0x0a, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x44, 0x2e, 0x72, 0x65, 0x73, 0x69, 0x6c, 0x69, 0x65,
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_goTypes = []interface{}{
	...
	(*FailoverPolicyNewStatus)(nil),                                        // 2: resilience.policy.gloo.solo.io.FailoverPolicyNewStatus
	(*FailoverPolicyReport)(nil),                                           // 3: resilience.policy.gloo.solo.io.FailoverPolicyReport
	(*FailoverPolicySpec_Config)(nil),                                      // 4: resilience.policy.gloo.solo.io.FailoverPolicySpec.Config
	(*FailoverPolicySpec_Config_LocalityMappings)(nil),                     // 5: resilience.policy.gloo.solo.io.FailoverPolicySpec.Config.LocalityMappings
	(*FailoverPolicySpec_Config_LocalityMappings_OriginatingLocality)(nil), // 6: resilience.policy.gloo.solo.io.FailoverPolicySpec.Config.LocalityMappings.OriginatingLocality
	(*FailoverPolicySpec_Config_LocalityMappings_DestinationLocality)(nil), // 7: resilience.policy.gloo.solo.io.FailoverPolicySpec.Config.LocalityMappings.DestinationLocality
	nil,                             // 8: resilience.policy.gloo.solo.io.FailoverPolicyStatus.WorkspacesEntry
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_depIdxs = []int32{
	...
	11, // 2: resilience.policy.gloo.solo.io.FailoverPolicyStatus.global:type_name -> common.gloo.solo.io.GenericGlobalStatus
	8,  // 3: resilience.policy.gloo.solo.io.FailoverPolicyStatus.workspaces:type_name -> resilience.policy.gloo.solo.io.FailoverPolicyStatus.WorkspacesEntry
	12, // 4: resilience.policy.gloo.solo.io.FailoverPolicyStatus.selected_destination_ports:type_name -> common.gloo.solo.io.DestinationReference
	13, // 5: resilience.policy.gloo.solo.io.FailoverPolicyNewStatus.common:type_name -> common.gloo.solo.io.Status
	9,  // 6: resilience.policy.gloo.solo.io.FailoverPolicyReport.workspaces:type_name -> resilience.policy.gloo.solo.io.FailoverPolicyReport.WorkspacesEntry
	12, // 7: resilience.policy.gloo.solo.io.FailoverPolicyReport.selected_destination_ports:type_name -> common.gloo.solo.io.DestinationReference
	5,  // 8: resilience.policy.gloo.solo.io.FailoverPolicySpec.Config.locality_mappings:type_name -> resilience.policy.gloo.solo.io.FailoverPolicySpec.Config.LocalityMappings
	6,  // 9: resilience.policy.gloo.solo.io.FailoverPolicySpec.Config.LocalityMappings.from:type_name -> resilience.policy.gloo.solo.io.FailoverPolicySpec.Config.LocalityMappings.OriginatingLocality
	7,  // 10: resilience.policy.gloo.solo.io.FailoverPolicySpec.Config.LocalityMappings.to:type_name -> resilience.policy.gloo.solo.io.FailoverPolicySpec.Config.LocalityMappings.DestinationLocality
	14, // 11: resilience.policy.gloo.solo.io.FailoverPolicySpec.Config.LocalityMappings.DestinationLocality.weight:type_name -> google.protobuf.UInt32Value
	15, // 12: resilience.policy.gloo.solo.io.FailoverPolicyStatus.WorkspacesEntry.value:type_name -> common.gloo.solo.io.WorkspaceStatus
	16, // 13: resilience.policy.gloo.solo.io.FailoverPolicyReport.WorkspacesEntry.value:type_name -> common.gloo.solo.io.Report
...
func file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FailoverPolicyNewStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_failover_policy_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
