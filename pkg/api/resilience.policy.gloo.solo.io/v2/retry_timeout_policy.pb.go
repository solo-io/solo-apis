...
// $hide_from_docs
type RetryTimeoutPolicyNewStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *RetryTimeoutPolicyNewStatus) Reset() {
	*x = RetryTimeoutPolicyNewStatus{}
	if protoimpl.UnsafeEnabled {
...
func (x *RetryTimeoutPolicyNewStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RetryTimeoutPolicyNewStatus) ProtoMessage() {}

func (x *RetryTimeoutPolicyNewStatus) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RetryTimeoutPolicyNewStatus.ProtoReflect.Descriptor instead.
func (*RetryTimeoutPolicyNewStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_rawDescGZIP(), []int{2}
}

func (x *RetryTimeoutPolicyNewStatus) GetCommon() *v2.Status {
	if x != nil {
		return x.Common
	}
	return nil
...
func (x *RetryTimeoutPolicyNewStatus) GetSelectedRoutes() uint32 {
	if x != nil {
		return x.SelectedRoutes
	}
	return 0
...
func (*RetryTimeoutPolicyReport) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_rawDescGZIP(), []int{3}
}
...
func (x *RetryTimeoutPolicySpec_Config) Reset() {
	*x = RetryTimeoutPolicySpec_Config{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *RetryTimeoutPolicySpec_Config_RetryPolicy) Reset() {
	*x = RetryTimeoutPolicySpec_Config_RetryPolicy{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xea, 0x04, 0x0a, 0x16, 0x52, 0x65, 0x74, 0x72, 0x79, 0x54, 0x69,
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x53, 0x70, 0x65, 0x63, 0x12,
	...
	0x70, 0x6c, 0x79, 0x54, 0x6f, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x73, 0x12, 0x55, 0x0a, 0x06, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3d, 0x2e, 0x72, 0x65,
	...
	0x69, 0x67, 0x1a, 0xac, 0x03, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x63, 0x0a,
	0x07, 0x72, 0x65, 0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x49,
	...
	0x52, 0x65, 0x74, 0x72, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x50, 0x6f, 0x6c, 0x69,
	0x63, 0x79, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x52, 0x65,
	0x74, 0x72, 0x79, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x52, 0x07, 0x72, 0x65, 0x74, 0x72, 0x69,
	0x65, 0x73, 0x12, 0x42, 0x0a, 0x0f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x5f, 0x74, 0x69,
	...
	0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0xf8, 0x01, 0x0a, 0x0b, 0x52, 0x65, 0x74, 0x72, 0x79,
	0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x37, 0x0a, 0x08, 0x61, 0x74, 0x74, 0x65, 0x6d, 0x70,
	0x74, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x49, 0x6e, 0x74, 0x33, 0x32,
	0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x08, 0x61, 0x74, 0x74, 0x65, 0x6d, 0x70, 0x74, 0x73, 0x12,
	...
	0x73, 0x22, 0xf9, 0x02, 0x0a, 0x18, 0x52, 0x65, 0x74, 0x72, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x6f,
	0x75, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x40,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x48, 0x2e, 0x72, 0x65, 0x73, 0x69, 0x6c, 0x69, 0x65, 0x6e, 0x63,
	0x65, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f,
	0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x52, 0x65, 0x74, 0x72, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x6f,
	0x75, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x57,
	...
	0x75, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x7b, 0x0a,
	0x1b, 0x52, 0x65, 0x74, 0x72, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x50, 0x6f, 0x6c,
	...
	0x6e, 0x12, 0x27, 0x0a, 0x0f, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x72, 0x6f,
	0x75, 0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0e, 0x73, 0x65, 0x6c, 0x65,
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_goTypes = []interface{}{
	...
	(*RetryTimeoutPolicyNewStatus)(nil),               // 2: resilience.policy.gloo.solo.io.RetryTimeoutPolicyNewStatus
	(*RetryTimeoutPolicyReport)(nil),                  // 3: resilience.policy.gloo.solo.io.RetryTimeoutPolicyReport
	(*RetryTimeoutPolicySpec_Config)(nil),             // 4: resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.Config
	(*RetryTimeoutPolicySpec_Config_RetryPolicy)(nil), // 5: resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.Config.RetryPolicy
	nil,                            // 6: resilience.policy.gloo.solo.io.RetryTimeoutPolicyStatus.WorkspacesEntry
	nil,                            // 7: resilience.policy.gloo.solo.io.RetryTimeoutPolicyReport.WorkspacesEntry
	(*v2.RouteSelector)(nil),       // 8: common.gloo.solo.io.RouteSelector
...
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_depIdxs = []int32{
	8,  // 0: resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.apply_to_routes:type_name -> common.gloo.solo.io.RouteSelector
	4,  // 1: resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.config:type_name -> resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.Config
	9,  // 2: resilience.policy.gloo.solo.io.RetryTimeoutPolicyStatus.global:type_name -> common.gloo.solo.io.GenericGlobalStatus
	6,  // 3: resilience.policy.gloo.solo.io.RetryTimeoutPolicyStatus.workspaces:type_name -> resilience.policy.gloo.solo.io.RetryTimeoutPolicyStatus.WorkspacesEntry
	10, // 4: resilience.policy.gloo.solo.io.RetryTimeoutPolicyStatus.selected_routes:type_name -> common.gloo.solo.io.RouteReference
	11, // 5: resilience.policy.gloo.solo.io.RetryTimeoutPolicyNewStatus.common:type_name -> common.gloo.solo.io.Status
	7,  // 6: resilience.policy.gloo.solo.io.RetryTimeoutPolicyReport.workspaces:type_name -> resilience.policy.gloo.solo.io.RetryTimeoutPolicyReport.WorkspacesEntry
	10, // 7: resilience.policy.gloo.solo.io.RetryTimeoutPolicyReport.selected_routes:type_name -> common.gloo.solo.io.RouteReference
	5,  // 8: resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.Config.retries:type_name -> resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.Config.RetryPolicy
	12, // 9: resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.Config.request_timeout:type_name -> google.protobuf.Duration
	13, // 10: resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.Config.RetryPolicy.attempts:type_name -> google.protobuf.Int32Value
	12, // 11: resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.Config.RetryPolicy.per_try_timeout:type_name -> google.protobuf.Duration
	14, // 12: resilience.policy.gloo.solo.io.RetryTimeoutPolicySpec.Config.RetryPolicy.retry_remote_localities:type_name -> google.protobuf.BoolValue
	15, // 13: resilience.policy.gloo.solo.io.RetryTimeoutPolicyStatus.WorkspacesEntry.value:type_name -> common.gloo.solo.io.WorkspaceStatus
	16, // 14: resilience.policy.gloo.solo.io.RetryTimeoutPolicyReport.WorkspacesEntry.value:type_name -> common.gloo.solo.io.Report
...
func file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RetryTimeoutPolicyNewStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_resilience_retry_timeout_policy_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
