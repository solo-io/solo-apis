...
func (m *ConnectionPolicySpec_Config_HTTPConfig) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("resilience.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/resilience.policy.gloo.solo.io/v2.ConnectionPolicySpec_Config_HTTPConfig")); err != nil {
		return 0, err
	}
