...
// Hash function
func (m *GraphQLPersistedQueryCachePolicyNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("resilience.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/resilience.policy.gloo.solo.io/v2.GraphQLPersistedQueryCachePolicyNewStatus")); err != nil {
		return 0, err
	}
...
func (m *GraphQLPersistedQueryCachePolicyReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("resilience.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/resilience.policy.gloo.solo.io/v2.GraphQLPersistedQueryCachePolicyReport")); err != nil {
		return 0, err
	}
