...
func (m *GraphQLApiSpec_GraphQLApiOptions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("graphql.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/graphql.gloo.solo.io/v1alpha1.GraphQLApiSpec_GraphQLApiOptions")); err != nil {
		return 0, err
	}
...
func (m *Executor_Local_LocalExecutorOptions) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("graphql.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/graphql.gloo.solo.io/v1alpha1.Executor_Local_LocalExecutorOptions")); err != nil {
		return 0, err
	}
