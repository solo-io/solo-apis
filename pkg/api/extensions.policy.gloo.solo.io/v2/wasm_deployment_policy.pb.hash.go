...
func (m *WasmDeploymentPolicySpec) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("extensions.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/extensions.policy.gloo.solo.io/v2.WasmDeploymentPolicySpec")); err != nil {
		return 0, err
	}
...
func (m *WasmDeploymentPolicyStatus) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("extensions.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/extensions.policy.gloo.solo.io/v2.WasmDeploymentPolicyStatus")); err != nil {
		return 0, err
	}
	...
	for _, v := range m.GetSelectedWorkloadRefs() {
...
// Hash function
func (m *WasmDeploymentPolicyNewStatus) Hash(hasher hash.Hash64) (uint64, error) {
	if m == nil {
		return 0, nil
	}
	if hasher == nil {
	...
	var err error
	if _, err = hasher.Write([]byte("extensions.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/extensions.policy.gloo.solo.io/v2.WasmDeploymentPolicyNewStatus")); err != nil {
		return 0, err
	}
	...
	err = binary.Write(hasher, binary.LittleEndian, m.GetSelectedWorkloads())
	if err != nil {
		return 0, err
	}
...
func (m *WasmDeploymentPolicyReport) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("extensions.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/extensions.policy.gloo.solo.io/v2.WasmDeploymentPolicyReport")); err != nil {
		return 0, err
	}
...
func (m *WasmDeploymentPolicySpec_Config) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("extensions.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/extensions.policy.gloo.solo.io/v2.WasmDeploymentPolicySpec_Config")); err != nil {
		return 0, err
	}
...
func (m *WasmDeploymentPolicySpec_Config_WasmFilter) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("extensions.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/extensions.policy.gloo.solo.io/v2.WasmDeploymentPolicySpec_Config_WasmFilter")); err != nil {
		return 0, err
	}
...
func (m *WasmDeploymentPolicySpec_Config_WasmFilter_UriSource) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("extensions.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/extensions.policy.gloo.solo.io/v2.WasmDeploymentPolicySpec_Config_WasmFilter_UriSource")); err != nil {
		return 0, err
	}
...
func (m *WasmDeploymentPolicySpec_Config_WasmFilter_WasmImageSource) Hash(hasher hash.Hash64) (uint64, error) {
	...
	var err error
	if _, err = hasher.Write([]byte("extensions.policy.gloo.solo.io.github.com/solo-io/solo-apis/pkg/api/extensions.policy.gloo.solo.io/v2.WasmDeploymentPolicySpec_Config_WasmFilter_WasmImageSource")); err != nil {
		return 0, err
	}
