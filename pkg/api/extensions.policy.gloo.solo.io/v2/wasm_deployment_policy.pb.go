...
func (x *WasmDeploymentPolicySpec) Reset() {
	*x = WasmDeploymentPolicySpec{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[0]
...
func (*WasmDeploymentPolicySpec) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescGZIP(), []int{0}
}
...
func (x *WasmDeploymentPolicyStatus) Reset() {
	*x = WasmDeploymentPolicyStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WasmDeploymentPolicyStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescGZIP(), []int{1}
}

func (x *WasmDeploymentPolicyStatus) GetGlobal() *v2.GenericGlobalStatus {
	if x != nil {
		return x.Global
	}
	return nil
...
func (x *WasmDeploymentPolicyStatus) GetWorkspaces() map[string]*v2.WorkspaceStatus {
	if x != nil {
		return x.Workspaces
	}
	return nil
...
// Deprecated: Do not use.
func (x *WasmDeploymentPolicyStatus) GetSelectedWorkloads() []*v2.ObjectReference {
	if x != nil {
...
func (x *WasmDeploymentPolicyStatus) GetSelectedWorkloadRefs() []*v2.WorkloadReference {
	if x != nil {
		return x.SelectedWorkloadRefs
	}
	return nil
}

// $hide_from_docs
type WasmDeploymentPolicyNewStatus struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Status *v2.Status `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	// Count of workloads selected by the policy
	SelectedWorkloads uint32 `protobuf:"varint,2,opt,name=selected_workloads,json=selectedWorkloads,proto3" json:"selected_workloads,omitempty"`
}

func (x *WasmDeploymentPolicyNewStatus) Reset() {
	*x = WasmDeploymentPolicyNewStatus{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *WasmDeploymentPolicyNewStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WasmDeploymentPolicyNewStatus) ProtoMessage() {}

func (x *WasmDeploymentPolicyNewStatus) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WasmDeploymentPolicyNewStatus.ProtoReflect.Descriptor instead.
func (*WasmDeploymentPolicyNewStatus) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescGZIP(), []int{2}
}

func (x *WasmDeploymentPolicyNewStatus) GetStatus() *v2.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
func (x *WasmDeploymentPolicyNewStatus) GetSelectedWorkloads() uint32 {
	if x != nil {
		return x.SelectedWorkloads
	}
	return 0
...
func (x *WasmDeploymentPolicyReport) Reset() {
	*x = WasmDeploymentPolicyReport{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WasmDeploymentPolicyReport) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescGZIP(), []int{3}
}
...
func (x *WasmDeploymentPolicySpec_Config) Reset() {
	*x = WasmDeploymentPolicySpec_Config{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WasmDeploymentPolicySpec_Config) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *WasmDeploymentPolicySpec_Config_WasmFilter) Reset() {
	*x = WasmDeploymentPolicySpec_Config_WasmFilter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WasmDeploymentPolicySpec_Config_WasmFilter) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
func (x *WasmDeploymentPolicySpec_Config_WasmFilter_UriSource) Reset() {
	*x = WasmDeploymentPolicySpec_Config_WasmFilter_UriSource{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WasmDeploymentPolicySpec_Config_WasmFilter_UriSource) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescGZIP(), []int{0, 0, 0, 0}
}
...
func (x *WasmDeploymentPolicySpec_Config_WasmFilter_WasmImageSource) Reset() {
	*x = WasmDeploymentPolicySpec_Config_WasmFilter_WasmImageSource{}
	if protoimpl.UnsafeEnabled {
		mi := &file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WasmDeploymentPolicySpec_Config_WasmFilter_WasmImageSource) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescGZIP(), []int{0, 0, 0, 1}
}
...
var File_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto protoreflect.FileDescriptor

var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x32, 0x2f, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2f, 0x77,
	0x61, 0x73, 0x6d, 0x5f, 0x64, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x70,
	0x6f, 0x6c, 0x69, 0x63, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1e, 0x65, 0x78, 0x74,
	...
	0x73, 0x68, 0x2f, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2f,
	0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x76, 0x32, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x5f, 0x6e, 0x65, 0x77, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x19, 0x67, 0x6f, 0x6f, 0x67,
	...
	0x68, 0x2f, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x69, 0x73, 0x74, 0x69, 0x6f,
	...
	0x79, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe8,
	0x08, 0x0a, 0x18, 0x57, 0x61, 0x73, 0x6d, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e,
	0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x53, 0x70, 0x65, 0x63, 0x12, 0x53, 0x0a, 0x12, 0x61,
	...
	0x12, 0x57, 0x0a, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x3f, 0x2e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x6f,
	...
	0x67, 0x52, 0x06, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0x9d, 0x07, 0x0a, 0x06, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x12, 0x64, 0x0a, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18,
	0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x4a, 0x2e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f,
	...
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x53, 0x70, 0x65, 0x63, 0x2e,
	0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x57, 0x61, 0x73, 0x6d, 0x46, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x77, 0x65,
	0x69, 0x67, 0x68, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x77, 0x65, 0x69, 0x67,
	0x68, 0x74, 0x1a, 0x94, 0x06, 0x0a, 0x0a, 0x57, 0x61, 0x73, 0x6d, 0x46, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x12, 0x2c, 0x0a, 0x11, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x5f, 0x70, 0x61, 0x74, 0x68, 0x5f,
	...
	,
	...
	0x79, 0x53, 0x70, 0x65, 0x63, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x57, 0x61, 0x73,
	0x6d, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x2e, 0x57, 0x61, 0x73, 0x6d, 0x49, 0x6d, 0x61, 0x67,
	0x65, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x48, 0x00, 0x52, 0x0f, 0x77, 0x61, 0x73, 0x6d, 0x49,
	0x6d, 0x61, 0x67, 0x65, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x48, 0x0a, 0x14, 0x73, 0x74,
	0x61, 0x74, 0x69, 0x63, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x6e, 0x66,
	...
	,
	...
	,
	...
	0x69, 0x67, 0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xe6, 0x03, 0x0a, 0x1a, 0x57, 0x61,
	...
	0x75, 0x73, 0x52, 0x06, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c, 0x12, 0x6a, 0x0a, 0x0a, 0x77, 0x6f,
	0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x4a,
	0x2e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x6f, 0x6c, 0x69,
	0x63, 0x79, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f, 0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e,
	0x57, 0x61, 0x73, 0x6d, 0x44, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x50, 0x6f,
	...
	0x73, 0x70, 0x61, 0x63, 0x65, 0x73, 0x12, 0x57, 0x0a, 0x12, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74,
	0x65, 0x64, 0x5f, 0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x18, 0x03, 0x20, 0x03,
	...
	,
	...
	0x38, 0x01, 0x22, 0x83, 0x01, 0x0a, 0x1d, 0x57, 0x61, 0x73, 0x6d, 0x44, 0x65, 0x70, 0x6c, 0x6f,
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x4e, 0x65, 0x77, 0x53, 0x74,
	...
	,
	...
	0x63, 0x65, 0x73, 0x12, 0x55, 0x0a, 0x12, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65, 0x64, 0x5f,
	0x77, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x26, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x67, 0x6c, 0x6f, 0x6f, 0x2e, 0x73, 0x6f,
	0x6c, 0x6f, 0x2e, 0x69, 0x6f, 0x2e, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65,
	0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x52, 0x11, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x65,
	0x64, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x1a, 0x5a, 0x0a, 0x0f, 0x57, 0x6f,
	...
	0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79,
...
var (
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescOnce sync.Once
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescData = file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDesc
)

func file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescData)
	})
	return file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDescData
}

var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_goTypes = []interface{}{
	...
	(*WasmDeploymentPolicyNewStatus)(nil),                              // 2: extensions.policy.gloo.solo.io.WasmDeploymentPolicyNewStatus
	(*WasmDeploymentPolicyReport)(nil),                                 // 3: extensions.policy.gloo.solo.io.WasmDeploymentPolicyReport
	(*WasmDeploymentPolicySpec_Config)(nil),                            // 4: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config
	(*WasmDeploymentPolicySpec_Config_WasmFilter)(nil),                 // 5: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.WasmFilter
	(*WasmDeploymentPolicySpec_Config_WasmFilter_UriSource)(nil),       // 6: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.WasmFilter.UriSource
	(*WasmDeploymentPolicySpec_Config_WasmFilter_WasmImageSource)(nil), // 7: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.WasmFilter.WasmImageSource
	nil,                                    // 8: extensions.policy.gloo.solo.io.WasmDeploymentPolicyStatus.WorkspacesEntry
	nil,                                    // 9: extensions.policy.gloo.solo.io.WasmDeploymentPolicyReport.WorkspacesEntry
	(*v2.WorkloadSelector)(nil),            // 10: common.gloo.solo.io.WorkloadSelector
	(*v2.GenericGlobalStatus)(nil),         // 11: common.gloo.solo.io.GenericGlobalStatus
	(*v2.ObjectReference)(nil),             // 12: common.gloo.solo.io.ObjectReference
	(*v2.WorkloadReference)(nil),           // 13: common.gloo.solo.io.WorkloadReference
	(*v2.Status)(nil),                      // 14: common.gloo.solo.io.Status
	(*any1.Any)(nil),                       // 15: google.protobuf.Any
	(v1alpha3.EnvoyFilter_PatchContext)(0), // 16: istio.networking.v1alpha3.EnvoyFilter.PatchContext
	(*v2.WorkspaceStatus)(nil),             // 17: common.gloo.solo.io.WorkspaceStatus
	(*v2.Report)(nil),                      // 18: common.gloo.solo.io.Report
}
var file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_depIdxs = []int32{
	10, // 0: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.apply_to_workloads:type_name -> common.gloo.solo.io.WorkloadSelector
	4,  // 1: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.config:type_name -> extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config
	11, // 2: extensions.policy.gloo.solo.io.WasmDeploymentPolicyStatus.global:type_name -> common.gloo.solo.io.GenericGlobalStatus
	8,  // 3: extensions.policy.gloo.solo.io.WasmDeploymentPolicyStatus.workspaces:type_name -> extensions.policy.gloo.solo.io.WasmDeploymentPolicyStatus.WorkspacesEntry
	12, // 4: extensions.policy.gloo.solo.io.WasmDeploymentPolicyStatus.selected_workloads:type_name -> common.gloo.solo.io.ObjectReference
	13, // 5: extensions.policy.gloo.solo.io.WasmDeploymentPolicyStatus.selected_workload_refs:type_name -> common.gloo.solo.io.WorkloadReference
	14, // 6: extensions.policy.gloo.solo.io.WasmDeploymentPolicyNewStatus.status:type_name -> common.gloo.solo.io.Status
	9,  // 7: extensions.policy.gloo.solo.io.WasmDeploymentPolicyReport.workspaces:type_name -> extensions.policy.gloo.solo.io.WasmDeploymentPolicyReport.WorkspacesEntry
	13, // 8: extensions.policy.gloo.solo.io.WasmDeploymentPolicyReport.selected_workloads:type_name -> common.gloo.solo.io.WorkloadReference
	5,  // 9: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.filters:type_name -> extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.WasmFilter
	6,  // 10: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.WasmFilter.http_uri_source:type_name -> extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.WasmFilter.UriSource
	7,  // 11: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.WasmFilter.wasm_image_source:type_name -> extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.WasmFilter.WasmImageSource
	15, // 12: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.WasmFilter.static_filter_config:type_name -> google.protobuf.Any
	16, // 13: extensions.policy.gloo.solo.io.WasmDeploymentPolicySpec.Config.WasmFilter.filter_context:type_name -> istio.networking.v1alpha3.EnvoyFilter.PatchContext
	17, // 14: extensions.policy.gloo.solo.io.WasmDeploymentPolicyStatus.WorkspacesEntry.value:type_name -> common.gloo.solo.io.WorkspaceStatus
	18, // 15: extensions.policy.gloo.solo.io.WasmDeploymentPolicyReport.WorkspacesEntry.value:type_name -> common.gloo.solo.io.Report
...
func init() {
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_init()
}
func file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_init() {
	if File_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*WasmDeploymentPolicyNewStatus); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes[5].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_goTypes,
		DependencyIndexes: file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_depIdxs,
		MessageInfos:      file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_msgTypes,
	}.Build()
	File_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto = out.File
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_rawDesc = nil
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_goTypes = nil
	file_github_com_solo_io_solo_apis_api_gloo_mesh_gloo_solo_io_policy_v2_extensions_wasm_deployment_policy_proto_depIdxs = nil
}
