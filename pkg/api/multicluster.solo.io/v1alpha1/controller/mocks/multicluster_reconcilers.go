...
func (mr *MockMulticlusterMultiClusterRoleReconcilerMockRecorder) ReconcileMultiClusterRole(clusterName, obj any) *gomock.Call {
...
func (mr *MockMulticlusterMultiClusterRoleDeletionReconcilerMockRecorder) ReconcileMultiClusterRoleDeletion(clusterName, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockMulticlusterMultiClusterRoleReconcileLoopMockRecorder) AddMulticlusterMultiClusterRoleReconciler(ctx, rec any, predicates ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
