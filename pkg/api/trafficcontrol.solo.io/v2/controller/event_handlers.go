...
type MirrorPolicyEventHandler interface {
	CreateMirrorPolicy(obj *trafficcontrol_solo_io_v2.MirrorPolicy) error
	UpdateMirrorPolicy(old, new *trafficcontrol_solo_io_v2.MirrorPolicy) error
	DeleteMirrorPolicy(obj *trafficcontrol_solo_io_v2.MirrorPolicy) error
	GenericMirrorPolicy(obj *trafficcontrol_solo_io_v2.MirrorPolicy) error
}

type MirrorPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *trafficcontrol_solo_io_v2.MirrorPolicy) error
	OnUpdate  func(old, new *trafficcontrol_solo_io_v2.MirrorPolicy) error
	OnDelete  func(obj *trafficcontrol_solo_io_v2.MirrorPolicy) error
	OnGeneric func(obj *trafficcontrol_solo_io_v2.MirrorPolicy) error
}

func (f *MirrorPolicyEventHandlerFuncs) CreateMirrorPolicy(obj *trafficcontrol_solo_io_v2.MirrorPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *MirrorPolicyEventHandlerFuncs) DeleteMirrorPolicy(obj *trafficcontrol_solo_io_v2.MirrorPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *MirrorPolicyEventHandlerFuncs) UpdateMirrorPolicy(objOld, objNew *trafficcontrol_solo_io_v2.MirrorPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *MirrorPolicyEventHandlerFuncs) GenericMirrorPolicy(obj *trafficcontrol_solo_io_v2.MirrorPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewMirrorPolicyEventWatcher(name string, mgr manager.Manager) MirrorPolicyEventWatcher {
	return &mirrorPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &trafficcontrol_solo_io_v2.MirrorPolicy{}),
	}
}
...
func (h genericMirrorPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*trafficcontrol_solo_io_v2.MirrorPolicy)
	if !ok {
		return errors.Errorf("internal error: MirrorPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*trafficcontrol_solo_io_v2.MirrorPolicy)
	if !ok {
...
type RateLimitPolicyEventHandler interface {
	CreateRateLimitPolicy(obj *trafficcontrol_solo_io_v2.RateLimitPolicy) error
	UpdateRateLimitPolicy(old, new *trafficcontrol_solo_io_v2.RateLimitPolicy) error
	DeleteRateLimitPolicy(obj *trafficcontrol_solo_io_v2.RateLimitPolicy) error
	GenericRateLimitPolicy(obj *trafficcontrol_solo_io_v2.RateLimitPolicy) error
}

type RateLimitPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *trafficcontrol_solo_io_v2.RateLimitPolicy) error
	OnUpdate  func(old, new *trafficcontrol_solo_io_v2.RateLimitPolicy) error
	OnDelete  func(obj *trafficcontrol_solo_io_v2.RateLimitPolicy) error
	OnGeneric func(obj *trafficcontrol_solo_io_v2.RateLimitPolicy) error
}

func (f *RateLimitPolicyEventHandlerFuncs) CreateRateLimitPolicy(obj *trafficcontrol_solo_io_v2.RateLimitPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *RateLimitPolicyEventHandlerFuncs) DeleteRateLimitPolicy(obj *trafficcontrol_solo_io_v2.RateLimitPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *RateLimitPolicyEventHandlerFuncs) UpdateRateLimitPolicy(objOld, objNew *trafficcontrol_solo_io_v2.RateLimitPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *RateLimitPolicyEventHandlerFuncs) GenericRateLimitPolicy(obj *trafficcontrol_solo_io_v2.RateLimitPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewRateLimitPolicyEventWatcher(name string, mgr manager.Manager) RateLimitPolicyEventWatcher {
	return &rateLimitPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &trafficcontrol_solo_io_v2.RateLimitPolicy{}),
	}
}
...
func (h genericRateLimitPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*trafficcontrol_solo_io_v2.RateLimitPolicy)
	if !ok {
		return errors.Errorf("internal error: RateLimitPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*trafficcontrol_solo_io_v2.RateLimitPolicy)
	if !ok {
...
type RateLimitClientConfigEventHandler interface {
	CreateRateLimitClientConfig(obj *trafficcontrol_solo_io_v2.RateLimitClientConfig) error
	UpdateRateLimitClientConfig(old, new *trafficcontrol_solo_io_v2.RateLimitClientConfig) error
	DeleteRateLimitClientConfig(obj *trafficcontrol_solo_io_v2.RateLimitClientConfig) error
	GenericRateLimitClientConfig(obj *trafficcontrol_solo_io_v2.RateLimitClientConfig) error
}

type RateLimitClientConfigEventHandlerFuncs struct {
	OnCreate  func(obj *trafficcontrol_solo_io_v2.RateLimitClientConfig) error
	OnUpdate  func(old, new *trafficcontrol_solo_io_v2.RateLimitClientConfig) error
	OnDelete  func(obj *trafficcontrol_solo_io_v2.RateLimitClientConfig) error
	OnGeneric func(obj *trafficcontrol_solo_io_v2.RateLimitClientConfig) error
}

func (f *RateLimitClientConfigEventHandlerFuncs) CreateRateLimitClientConfig(obj *trafficcontrol_solo_io_v2.RateLimitClientConfig) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *RateLimitClientConfigEventHandlerFuncs) DeleteRateLimitClientConfig(obj *trafficcontrol_solo_io_v2.RateLimitClientConfig) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *RateLimitClientConfigEventHandlerFuncs) UpdateRateLimitClientConfig(objOld, objNew *trafficcontrol_solo_io_v2.RateLimitClientConfig) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *RateLimitClientConfigEventHandlerFuncs) GenericRateLimitClientConfig(obj *trafficcontrol_solo_io_v2.RateLimitClientConfig) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewRateLimitClientConfigEventWatcher(name string, mgr manager.Manager) RateLimitClientConfigEventWatcher {
	return &rateLimitClientConfigEventWatcher{
		watcher: events.NewWatcher(name, mgr, &trafficcontrol_solo_io_v2.RateLimitClientConfig{}),
	}
}
...
func (h genericRateLimitClientConfigHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*trafficcontrol_solo_io_v2.RateLimitClientConfig)
	if !ok {
		return errors.Errorf("internal error: RateLimitClientConfig handler received event for %T", old)
	}
	objNew, ok := new.(*trafficcontrol_solo_io_v2.RateLimitClientConfig)
	if !ok {
...
type HeaderManipulationPolicyEventHandler interface {
	CreateHeaderManipulationPolicy(obj *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error
	UpdateHeaderManipulationPolicy(old, new *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error
	DeleteHeaderManipulationPolicy(obj *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error
	GenericHeaderManipulationPolicy(obj *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error
}

type HeaderManipulationPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error
	OnUpdate  func(old, new *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error
	OnDelete  func(obj *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error
	OnGeneric func(obj *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error
}

func (f *HeaderManipulationPolicyEventHandlerFuncs) CreateHeaderManipulationPolicy(obj *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *HeaderManipulationPolicyEventHandlerFuncs) DeleteHeaderManipulationPolicy(obj *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *HeaderManipulationPolicyEventHandlerFuncs) UpdateHeaderManipulationPolicy(objOld, objNew *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *HeaderManipulationPolicyEventHandlerFuncs) GenericHeaderManipulationPolicy(obj *trafficcontrol_solo_io_v2.HeaderManipulationPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewHeaderManipulationPolicyEventWatcher(name string, mgr manager.Manager) HeaderManipulationPolicyEventWatcher {
	return &headerManipulationPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &trafficcontrol_solo_io_v2.HeaderManipulationPolicy{}),
	}
}
...
func (h genericHeaderManipulationPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy)
	if !ok {
		return errors.Errorf("internal error: HeaderManipulationPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy)
	if !ok {
...
type TransformationPolicyEventHandler interface {
	CreateTransformationPolicy(obj *trafficcontrol_solo_io_v2.TransformationPolicy) error
	UpdateTransformationPolicy(old, new *trafficcontrol_solo_io_v2.TransformationPolicy) error
	DeleteTransformationPolicy(obj *trafficcontrol_solo_io_v2.TransformationPolicy) error
	GenericTransformationPolicy(obj *trafficcontrol_solo_io_v2.TransformationPolicy) error
}

type TransformationPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *trafficcontrol_solo_io_v2.TransformationPolicy) error
	OnUpdate  func(old, new *trafficcontrol_solo_io_v2.TransformationPolicy) error
	OnDelete  func(obj *trafficcontrol_solo_io_v2.TransformationPolicy) error
	OnGeneric func(obj *trafficcontrol_solo_io_v2.TransformationPolicy) error
}

func (f *TransformationPolicyEventHandlerFuncs) CreateTransformationPolicy(obj *trafficcontrol_solo_io_v2.TransformationPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *TransformationPolicyEventHandlerFuncs) DeleteTransformationPolicy(obj *trafficcontrol_solo_io_v2.TransformationPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *TransformationPolicyEventHandlerFuncs) UpdateTransformationPolicy(objOld, objNew *trafficcontrol_solo_io_v2.TransformationPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *TransformationPolicyEventHandlerFuncs) GenericTransformationPolicy(obj *trafficcontrol_solo_io_v2.TransformationPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewTransformationPolicyEventWatcher(name string, mgr manager.Manager) TransformationPolicyEventWatcher {
	return &transformationPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &trafficcontrol_solo_io_v2.TransformationPolicy{}),
	}
}
...
func (h genericTransformationPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*trafficcontrol_solo_io_v2.TransformationPolicy)
	if !ok {
		return errors.Errorf("internal error: TransformationPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*trafficcontrol_solo_io_v2.TransformationPolicy)
	if !ok {
...
type ProxyProtocolPolicyEventHandler interface {
	CreateProxyProtocolPolicy(obj *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error
	UpdateProxyProtocolPolicy(old, new *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error
	DeleteProxyProtocolPolicy(obj *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error
	GenericProxyProtocolPolicy(obj *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error
}

type ProxyProtocolPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error
	OnUpdate  func(old, new *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error
	OnDelete  func(obj *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error
	OnGeneric func(obj *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error
}

func (f *ProxyProtocolPolicyEventHandlerFuncs) CreateProxyProtocolPolicy(obj *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *ProxyProtocolPolicyEventHandlerFuncs) DeleteProxyProtocolPolicy(obj *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *ProxyProtocolPolicyEventHandlerFuncs) UpdateProxyProtocolPolicy(objOld, objNew *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *ProxyProtocolPolicyEventHandlerFuncs) GenericProxyProtocolPolicy(obj *trafficcontrol_solo_io_v2.ProxyProtocolPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewProxyProtocolPolicyEventWatcher(name string, mgr manager.Manager) ProxyProtocolPolicyEventWatcher {
	return &proxyProtocolPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &trafficcontrol_solo_io_v2.ProxyProtocolPolicy{}),
	}
}
...
func (h genericProxyProtocolPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy)
	if !ok {
		return errors.Errorf("internal error: ProxyProtocolPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy)
	if !ok {
