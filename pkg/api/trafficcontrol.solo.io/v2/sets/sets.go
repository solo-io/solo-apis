...
type MirrorPolicySet interface {
	...
	List(filterResource ...func(*trafficcontrol_solo_io_v2.MirrorPolicy) bool) []*trafficcontrol_solo_io_v2.MirrorPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.MirrorPolicy) bool) []*trafficcontrol_solo_io_v2.MirrorPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*trafficcontrol_solo_io_v2.MirrorPolicy
	// Insert a resource into the set.
	Insert(mirrorPolicy ...*trafficcontrol_solo_io_v2.MirrorPolicy)
	...
	Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.MirrorPolicy, error)
...
func makeGenericMirrorPolicySet(mirrorPolicyList []*trafficcontrol_solo_io_v2.MirrorPolicy) sksets.ResourceSet {
...
func NewMirrorPolicySet(mirrorPolicyList ...*trafficcontrol_solo_io_v2.MirrorPolicy) MirrorPolicySet {
	return &mirrorPolicySet{set: makeGenericMirrorPolicySet(mirrorPolicyList)}
}

func NewMirrorPolicySetFromList(mirrorPolicyList *trafficcontrol_solo_io_v2.MirrorPolicyList) MirrorPolicySet {
	list := make([]*trafficcontrol_solo_io_v2.MirrorPolicy, 0, len(mirrorPolicyList.Items))
...
func (s *mirrorPolicySet) List(filterResource ...func(*trafficcontrol_solo_io_v2.MirrorPolicy) bool) []*trafficcontrol_solo_io_v2.MirrorPolicy {
	if s == nil {
		return nil
	}
	...
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*trafficcontrol_solo_io_v2.MirrorPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	mirrorPolicyList := make([]*trafficcontrol_solo_io_v2.MirrorPolicy, 0, len(objs))
	for _, obj := range objs {
		mirrorPolicyList = append(mirrorPolicyList, obj.(*trafficcontrol_solo_io_v2.MirrorPolicy))
	}
	return mirrorPolicyList
}

func (s *mirrorPolicySet) UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.MirrorPolicy) bool) []*trafficcontrol_solo_io_v2.MirrorPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var mirrorPolicyList []*trafficcontrol_solo_io_v2.MirrorPolicy
...
func (s *mirrorPolicySet) Map() map[string]*trafficcontrol_solo_io_v2.MirrorPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*trafficcontrol_solo_io_v2.MirrorPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*trafficcontrol_solo_io_v2.MirrorPolicy)
	}
	return newMap
}

func (s *mirrorPolicySet) Insert(
	mirrorPolicyList ...*trafficcontrol_solo_io_v2.MirrorPolicy,
) {
	if s == nil {
...
func (s *mirrorPolicySet) Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.MirrorPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find MirrorPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&trafficcontrol_solo_io_v2.MirrorPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*trafficcontrol_solo_io_v2.MirrorPolicy), nil
}
...
type RateLimitPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*trafficcontrol_solo_io_v2.RateLimitPolicy) bool) []*trafficcontrol_solo_io_v2.RateLimitPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.RateLimitPolicy) bool) []*trafficcontrol_solo_io_v2.RateLimitPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*trafficcontrol_solo_io_v2.RateLimitPolicy
	// Insert a resource into the set.
	Insert(rateLimitPolicy ...*trafficcontrol_solo_io_v2.RateLimitPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.RateLimitPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericRateLimitPolicySet(rateLimitPolicyList []*trafficcontrol_solo_io_v2.RateLimitPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewRateLimitPolicySet(rateLimitPolicyList ...*trafficcontrol_solo_io_v2.RateLimitPolicy) RateLimitPolicySet {
	return &rateLimitPolicySet{set: makeGenericRateLimitPolicySet(rateLimitPolicyList)}
}

func NewRateLimitPolicySetFromList(rateLimitPolicyList *trafficcontrol_solo_io_v2.RateLimitPolicyList) RateLimitPolicySet {
	list := make([]*trafficcontrol_solo_io_v2.RateLimitPolicy, 0, len(rateLimitPolicyList.Items))
...
func (s *rateLimitPolicySet) List(filterResource ...func(*trafficcontrol_solo_io_v2.RateLimitPolicy) bool) []*trafficcontrol_solo_io_v2.RateLimitPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*trafficcontrol_solo_io_v2.RateLimitPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	rateLimitPolicyList := make([]*trafficcontrol_solo_io_v2.RateLimitPolicy, 0, len(objs))
	for _, obj := range objs {
		rateLimitPolicyList = append(rateLimitPolicyList, obj.(*trafficcontrol_solo_io_v2.RateLimitPolicy))
	}
	return rateLimitPolicyList
}

func (s *rateLimitPolicySet) UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.RateLimitPolicy) bool) []*trafficcontrol_solo_io_v2.RateLimitPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var rateLimitPolicyList []*trafficcontrol_solo_io_v2.RateLimitPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		rateLimitPolicyList = append(rateLimitPolicyList, obj.(*trafficcontrol_solo_io_v2.RateLimitPolicy))
	}
	return rateLimitPolicyList
...
func (s *rateLimitPolicySet) Map() map[string]*trafficcontrol_solo_io_v2.RateLimitPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*trafficcontrol_solo_io_v2.RateLimitPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*trafficcontrol_solo_io_v2.RateLimitPolicy)
	}
	return newMap
}

func (s *rateLimitPolicySet) Insert(
	rateLimitPolicyList ...*trafficcontrol_solo_io_v2.RateLimitPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *rateLimitPolicySet) Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.RateLimitPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find RateLimitPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&trafficcontrol_solo_io_v2.RateLimitPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*trafficcontrol_solo_io_v2.RateLimitPolicy), nil
}
...
type RateLimitClientConfigSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*trafficcontrol_solo_io_v2.RateLimitClientConfig) bool) []*trafficcontrol_solo_io_v2.RateLimitClientConfig
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.RateLimitClientConfig) bool) []*trafficcontrol_solo_io_v2.RateLimitClientConfig
	// Return the Set as a map of key to resource.
	Map() map[string]*trafficcontrol_solo_io_v2.RateLimitClientConfig
	// Insert a resource into the set.
	Insert(rateLimitClientConfig ...*trafficcontrol_solo_io_v2.RateLimitClientConfig)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.RateLimitClientConfig, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericRateLimitClientConfigSet(rateLimitClientConfigList []*trafficcontrol_solo_io_v2.RateLimitClientConfig) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewRateLimitClientConfigSet(rateLimitClientConfigList ...*trafficcontrol_solo_io_v2.RateLimitClientConfig) RateLimitClientConfigSet {
	return &rateLimitClientConfigSet{set: makeGenericRateLimitClientConfigSet(rateLimitClientConfigList)}
}

func NewRateLimitClientConfigSetFromList(rateLimitClientConfigList *trafficcontrol_solo_io_v2.RateLimitClientConfigList) RateLimitClientConfigSet {
	list := make([]*trafficcontrol_solo_io_v2.RateLimitClientConfig, 0, len(rateLimitClientConfigList.Items))
...
func (s *rateLimitClientConfigSet) List(filterResource ...func(*trafficcontrol_solo_io_v2.RateLimitClientConfig) bool) []*trafficcontrol_solo_io_v2.RateLimitClientConfig {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*trafficcontrol_solo_io_v2.RateLimitClientConfig))
		})
	}

	objs := s.Generic().List(genericFilters...)
	rateLimitClientConfigList := make([]*trafficcontrol_solo_io_v2.RateLimitClientConfig, 0, len(objs))
	for _, obj := range objs {
		rateLimitClientConfigList = append(rateLimitClientConfigList, obj.(*trafficcontrol_solo_io_v2.RateLimitClientConfig))
	}
	return rateLimitClientConfigList
}

func (s *rateLimitClientConfigSet) UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.RateLimitClientConfig) bool) []*trafficcontrol_solo_io_v2.RateLimitClientConfig {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var rateLimitClientConfigList []*trafficcontrol_solo_io_v2.RateLimitClientConfig
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		rateLimitClientConfigList = append(rateLimitClientConfigList, obj.(*trafficcontrol_solo_io_v2.RateLimitClientConfig))
	}
	return rateLimitClientConfigList
...
func (s *rateLimitClientConfigSet) Map() map[string]*trafficcontrol_solo_io_v2.RateLimitClientConfig {
	if s == nil {
		return nil
	}

	newMap := map[string]*trafficcontrol_solo_io_v2.RateLimitClientConfig{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*trafficcontrol_solo_io_v2.RateLimitClientConfig)
	}
	return newMap
}

func (s *rateLimitClientConfigSet) Insert(
	rateLimitClientConfigList ...*trafficcontrol_solo_io_v2.RateLimitClientConfig,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *rateLimitClientConfigSet) Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.RateLimitClientConfig, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find RateLimitClientConfig %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&trafficcontrol_solo_io_v2.RateLimitClientConfig{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*trafficcontrol_solo_io_v2.RateLimitClientConfig), nil
}
...
type HeaderManipulationPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy) bool) []*trafficcontrol_solo_io_v2.HeaderManipulationPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy) bool) []*trafficcontrol_solo_io_v2.HeaderManipulationPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*trafficcontrol_solo_io_v2.HeaderManipulationPolicy
	// Insert a resource into the set.
	Insert(headerManipulationPolicy ...*trafficcontrol_solo_io_v2.HeaderManipulationPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.HeaderManipulationPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericHeaderManipulationPolicySet(headerManipulationPolicyList []*trafficcontrol_solo_io_v2.HeaderManipulationPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewHeaderManipulationPolicySet(headerManipulationPolicyList ...*trafficcontrol_solo_io_v2.HeaderManipulationPolicy) HeaderManipulationPolicySet {
	return &headerManipulationPolicySet{set: makeGenericHeaderManipulationPolicySet(headerManipulationPolicyList)}
}

func NewHeaderManipulationPolicySetFromList(headerManipulationPolicyList *trafficcontrol_solo_io_v2.HeaderManipulationPolicyList) HeaderManipulationPolicySet {
	list := make([]*trafficcontrol_solo_io_v2.HeaderManipulationPolicy, 0, len(headerManipulationPolicyList.Items))
...
func (s *headerManipulationPolicySet) List(filterResource ...func(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy) bool) []*trafficcontrol_solo_io_v2.HeaderManipulationPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	headerManipulationPolicyList := make([]*trafficcontrol_solo_io_v2.HeaderManipulationPolicy, 0, len(objs))
	for _, obj := range objs {
		headerManipulationPolicyList = append(headerManipulationPolicyList, obj.(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy))
	}
	return headerManipulationPolicyList
}

func (s *headerManipulationPolicySet) UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy) bool) []*trafficcontrol_solo_io_v2.HeaderManipulationPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var headerManipulationPolicyList []*trafficcontrol_solo_io_v2.HeaderManipulationPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		headerManipulationPolicyList = append(headerManipulationPolicyList, obj.(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy))
	}
	return headerManipulationPolicyList
...
func (s *headerManipulationPolicySet) Map() map[string]*trafficcontrol_solo_io_v2.HeaderManipulationPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*trafficcontrol_solo_io_v2.HeaderManipulationPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy)
	}
	return newMap
}

func (s *headerManipulationPolicySet) Insert(
	headerManipulationPolicyList ...*trafficcontrol_solo_io_v2.HeaderManipulationPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *headerManipulationPolicySet) Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.HeaderManipulationPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find HeaderManipulationPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&trafficcontrol_solo_io_v2.HeaderManipulationPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*trafficcontrol_solo_io_v2.HeaderManipulationPolicy), nil
}
...
type TransformationPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*trafficcontrol_solo_io_v2.TransformationPolicy) bool) []*trafficcontrol_solo_io_v2.TransformationPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.TransformationPolicy) bool) []*trafficcontrol_solo_io_v2.TransformationPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*trafficcontrol_solo_io_v2.TransformationPolicy
	// Insert a resource into the set.
	Insert(transformationPolicy ...*trafficcontrol_solo_io_v2.TransformationPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.TransformationPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericTransformationPolicySet(transformationPolicyList []*trafficcontrol_solo_io_v2.TransformationPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewTransformationPolicySet(transformationPolicyList ...*trafficcontrol_solo_io_v2.TransformationPolicy) TransformationPolicySet {
	return &transformationPolicySet{set: makeGenericTransformationPolicySet(transformationPolicyList)}
}

func NewTransformationPolicySetFromList(transformationPolicyList *trafficcontrol_solo_io_v2.TransformationPolicyList) TransformationPolicySet {
	list := make([]*trafficcontrol_solo_io_v2.TransformationPolicy, 0, len(transformationPolicyList.Items))
...
func (s *transformationPolicySet) List(filterResource ...func(*trafficcontrol_solo_io_v2.TransformationPolicy) bool) []*trafficcontrol_solo_io_v2.TransformationPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*trafficcontrol_solo_io_v2.TransformationPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	transformationPolicyList := make([]*trafficcontrol_solo_io_v2.TransformationPolicy, 0, len(objs))
	for _, obj := range objs {
		transformationPolicyList = append(transformationPolicyList, obj.(*trafficcontrol_solo_io_v2.TransformationPolicy))
	}
	return transformationPolicyList
}

func (s *transformationPolicySet) UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.TransformationPolicy) bool) []*trafficcontrol_solo_io_v2.TransformationPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var transformationPolicyList []*trafficcontrol_solo_io_v2.TransformationPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		transformationPolicyList = append(transformationPolicyList, obj.(*trafficcontrol_solo_io_v2.TransformationPolicy))
	}
	return transformationPolicyList
...
func (s *transformationPolicySet) Map() map[string]*trafficcontrol_solo_io_v2.TransformationPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*trafficcontrol_solo_io_v2.TransformationPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*trafficcontrol_solo_io_v2.TransformationPolicy)
	}
	return newMap
}

func (s *transformationPolicySet) Insert(
	transformationPolicyList ...*trafficcontrol_solo_io_v2.TransformationPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *transformationPolicySet) Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.TransformationPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find TransformationPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&trafficcontrol_solo_io_v2.TransformationPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*trafficcontrol_solo_io_v2.TransformationPolicy), nil
}
...
type ProxyProtocolPolicySet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy) bool) []*trafficcontrol_solo_io_v2.ProxyProtocolPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy) bool) []*trafficcontrol_solo_io_v2.ProxyProtocolPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*trafficcontrol_solo_io_v2.ProxyProtocolPolicy
	// Insert a resource into the set.
	Insert(proxyProtocolPolicy ...*trafficcontrol_solo_io_v2.ProxyProtocolPolicy)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.ProxyProtocolPolicy, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericProxyProtocolPolicySet(proxyProtocolPolicyList []*trafficcontrol_solo_io_v2.ProxyProtocolPolicy) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewProxyProtocolPolicySet(proxyProtocolPolicyList ...*trafficcontrol_solo_io_v2.ProxyProtocolPolicy) ProxyProtocolPolicySet {
	return &proxyProtocolPolicySet{set: makeGenericProxyProtocolPolicySet(proxyProtocolPolicyList)}
}

func NewProxyProtocolPolicySetFromList(proxyProtocolPolicyList *trafficcontrol_solo_io_v2.ProxyProtocolPolicyList) ProxyProtocolPolicySet {
	list := make([]*trafficcontrol_solo_io_v2.ProxyProtocolPolicy, 0, len(proxyProtocolPolicyList.Items))
...
func (s *proxyProtocolPolicySet) List(filterResource ...func(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy) bool) []*trafficcontrol_solo_io_v2.ProxyProtocolPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	proxyProtocolPolicyList := make([]*trafficcontrol_solo_io_v2.ProxyProtocolPolicy, 0, len(objs))
	for _, obj := range objs {
		proxyProtocolPolicyList = append(proxyProtocolPolicyList, obj.(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy))
	}
	return proxyProtocolPolicyList
}

func (s *proxyProtocolPolicySet) UnsortedList(filterResource ...func(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy) bool) []*trafficcontrol_solo_io_v2.ProxyProtocolPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var proxyProtocolPolicyList []*trafficcontrol_solo_io_v2.ProxyProtocolPolicy
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		proxyProtocolPolicyList = append(proxyProtocolPolicyList, obj.(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy))
	}
	return proxyProtocolPolicyList
...
func (s *proxyProtocolPolicySet) Map() map[string]*trafficcontrol_solo_io_v2.ProxyProtocolPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*trafficcontrol_solo_io_v2.ProxyProtocolPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy)
	}
	return newMap
}

func (s *proxyProtocolPolicySet) Insert(
	proxyProtocolPolicyList ...*trafficcontrol_solo_io_v2.ProxyProtocolPolicy,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *proxyProtocolPolicySet) Find(id ezkube.ResourceId) (*trafficcontrol_solo_io_v2.ProxyProtocolPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find ProxyProtocolPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&trafficcontrol_solo_io_v2.ProxyProtocolPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*trafficcontrol_solo_io_v2.ProxyProtocolPolicy), nil
}
