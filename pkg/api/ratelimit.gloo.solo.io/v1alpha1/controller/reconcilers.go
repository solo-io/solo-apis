...
type RateLimitConfigReconciler interface {
	ReconcileRateLimitConfig(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) (reconcile.Result, error)
}
...
type RateLimitConfigReconcilerFuncs struct {
	OnReconcileRateLimitConfig         func(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) (reconcile.Result, error)
	OnReconcileRateLimitConfigDeletion func(req reconcile.Request) error
}

func (f *RateLimitConfigReconcilerFuncs) ReconcileRateLimitConfig(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) (reconcile.Result, error) {
...
type RateLimitConfigFinalizer interface {
	...
	FinalizeRateLimitConfig(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error
}
...
func NewRateLimitConfigReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) RateLimitConfigReconcileLoop {
	return &rateLimitConfigReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig{}, options),
	}
}
