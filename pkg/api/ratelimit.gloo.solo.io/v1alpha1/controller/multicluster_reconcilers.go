...
type MulticlusterRateLimitConfigReconciler interface {
	ReconcileRateLimitConfig(clusterName string, obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) (reconcile.Result, error)
}
...
type MulticlusterRateLimitConfigReconcilerFuncs struct {
	OnReconcileRateLimitConfig         func(clusterName string, obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) (reconcile.Result, error)
	OnReconcileRateLimitConfigDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterRateLimitConfigReconcilerFuncs) ReconcileRateLimitConfig(clusterName string, obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) (reconcile.Result, error) {
...
func NewMulticlusterRateLimitConfigReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRateLimitConfigReconcileLoop {
	return &multiclusterRateLimitConfigReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig{}, options)}
}
