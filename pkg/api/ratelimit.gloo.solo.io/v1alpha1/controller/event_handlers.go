...
type RateLimitConfigEventHandler interface {
	CreateRateLimitConfig(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error
	UpdateRateLimitConfig(old, new *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error
	DeleteRateLimitConfig(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error
	GenericRateLimitConfig(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error
}

type RateLimitConfigEventHandlerFuncs struct {
	OnCreate  func(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error
	OnUpdate  func(old, new *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error
	OnDelete  func(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error
	OnGeneric func(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error
}

func (f *RateLimitConfigEventHandlerFuncs) CreateRateLimitConfig(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *RateLimitConfigEventHandlerFuncs) DeleteRateLimitConfig(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *RateLimitConfigEventHandlerFuncs) UpdateRateLimitConfig(objOld, objNew *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *RateLimitConfigEventHandlerFuncs) GenericRateLimitConfig(obj *ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewRateLimitConfigEventWatcher(name string, mgr manager.Manager) RateLimitConfigEventWatcher {
	return &rateLimitConfigEventWatcher{
		watcher: events.NewWatcher(name, mgr, &ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig{}),
	}
}
...
func (h genericRateLimitConfigHandler) Create(object client.Object) error {
	obj, ok := object.(*ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig)
	if !ok {
...
func (h genericRateLimitConfigHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig)
	if !ok {
		return errors.Errorf("internal error: RateLimitConfig handler received event for %T", old)
	}
	objNew, ok := new.(*ratelimit_gloo_solo_io_v1alpha1.RateLimitConfig)
	if !ok {
