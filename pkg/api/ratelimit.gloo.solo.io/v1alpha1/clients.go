...
// MulticlusterClientset for the ratelimit.gloo.solo.io/v1alpha1 APIs
...
// clienset for the ratelimit.gloo.solo.io/v1alpha1 APIs
type Clientset interface {
	// clienset for the ratelimit.gloo.solo.io/v1alpha1/v1alpha1 APIs
