...
type WasmDeploymentPolicyReconciler interface {
	ReconcileWasmDeploymentPolicy(obj *extensions_gloo_solo_io_v2.WasmDeploymentPolicy) (reconcile.Result, error)
}
...
type WasmDeploymentPolicyReconcilerFuncs struct {
	OnReconcileWasmDeploymentPolicy         func(obj *extensions_gloo_solo_io_v2.WasmDeploymentPolicy) (reconcile.Result, error)
	OnReconcileWasmDeploymentPolicyDeletion func(req reconcile.Request) error
}

func (f *WasmDeploymentPolicyReconcilerFuncs) ReconcileWasmDeploymentPolicy(obj *extensions_gloo_solo_io_v2.WasmDeploymentPolicy) (reconcile.Result, error) {
...
type WasmDeploymentPolicyFinalizer interface {
	...
	FinalizeWasmDeploymentPolicy(obj *extensions_gloo_solo_io_v2.WasmDeploymentPolicy) error
}
...
func NewWasmDeploymentPolicyReconcileLoop(name string, mgr manager.Manager, options reconcile.Options) WasmDeploymentPolicyReconcileLoop {
	return &wasmDeploymentPolicyReconcileLoop{
		...
		loop: reconcile.NewLoop(name, "", mgr, &extensions_gloo_solo_io_v2.WasmDeploymentPolicy{}, options),
	}
}
