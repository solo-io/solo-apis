...
type MulticlusterWasmDeploymentPolicyReconciler interface {
	ReconcileWasmDeploymentPolicy(clusterName string, obj *extensions_gloo_solo_io_v2.WasmDeploymentPolicy) (reconcile.Result, error)
}
...
type MulticlusterWasmDeploymentPolicyReconcilerFuncs struct {
	OnReconcileWasmDeploymentPolicy         func(clusterName string, obj *extensions_gloo_solo_io_v2.WasmDeploymentPolicy) (reconcile.Result, error)
	OnReconcileWasmDeploymentPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterWasmDeploymentPolicyReconcilerFuncs) ReconcileWasmDeploymentPolicy(clusterName string, obj *extensions_gloo_solo_io_v2.WasmDeploymentPolicy) (reconcile.Result, error) {
...
func NewMulticlusterWasmDeploymentPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterWasmDeploymentPolicyReconcileLoop {
	return &multiclusterWasmDeploymentPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &extensions_gloo_solo_io_v2.WasmDeploymentPolicy{}, options)}
}
