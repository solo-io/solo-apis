...
type WasmDeploymentPolicySet interface {
	...
	List(filterResource ...func(*extensions_gloo_solo_io_v2.WasmDeploymentPolicy) bool) []*extensions_gloo_solo_io_v2.WasmDeploymentPolicy
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*extensions_gloo_solo_io_v2.WasmDeploymentPolicy) bool) []*extensions_gloo_solo_io_v2.WasmDeploymentPolicy
	// Return the Set as a map of key to resource.
	Map() map[string]*extensions_gloo_solo_io_v2.WasmDeploymentPolicy
	// Insert a resource into the set.
	Insert(wasmDeploymentPolicy ...*extensions_gloo_solo_io_v2.WasmDeploymentPolicy)
	...
	Find(id ezkube.ResourceId) (*extensions_gloo_solo_io_v2.WasmDeploymentPolicy, error)
...
func makeGenericWasmDeploymentPolicySet(wasmDeploymentPolicyList []*extensions_gloo_solo_io_v2.WasmDeploymentPolicy) sksets.ResourceSet {
...
func NewWasmDeploymentPolicySet(wasmDeploymentPolicyList ...*extensions_gloo_solo_io_v2.WasmDeploymentPolicy) WasmDeploymentPolicySet {
	return &wasmDeploymentPolicySet{set: makeGenericWasmDeploymentPolicySet(wasmDeploymentPolicyList)}
}

func NewWasmDeploymentPolicySetFromList(wasmDeploymentPolicyList *extensions_gloo_solo_io_v2.WasmDeploymentPolicyList) WasmDeploymentPolicySet {
	list := make([]*extensions_gloo_solo_io_v2.WasmDeploymentPolicy, 0, len(wasmDeploymentPolicyList.Items))
...
func (s *wasmDeploymentPolicySet) List(filterResource ...func(*extensions_gloo_solo_io_v2.WasmDeploymentPolicy) bool) []*extensions_gloo_solo_io_v2.WasmDeploymentPolicy {
	if s == nil {
		return nil
	}
	...
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*extensions_gloo_solo_io_v2.WasmDeploymentPolicy))
		})
	}

	objs := s.Generic().List(genericFilters...)
	wasmDeploymentPolicyList := make([]*extensions_gloo_solo_io_v2.WasmDeploymentPolicy, 0, len(objs))
	for _, obj := range objs {
		wasmDeploymentPolicyList = append(wasmDeploymentPolicyList, obj.(*extensions_gloo_solo_io_v2.WasmDeploymentPolicy))
	}
	return wasmDeploymentPolicyList
}

func (s *wasmDeploymentPolicySet) UnsortedList(filterResource ...func(*extensions_gloo_solo_io_v2.WasmDeploymentPolicy) bool) []*extensions_gloo_solo_io_v2.WasmDeploymentPolicy {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var wasmDeploymentPolicyList []*extensions_gloo_solo_io_v2.WasmDeploymentPolicy
...
func (s *wasmDeploymentPolicySet) Map() map[string]*extensions_gloo_solo_io_v2.WasmDeploymentPolicy {
	if s == nil {
		return nil
	}

	newMap := map[string]*extensions_gloo_solo_io_v2.WasmDeploymentPolicy{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*extensions_gloo_solo_io_v2.WasmDeploymentPolicy)
	}
	return newMap
}

func (s *wasmDeploymentPolicySet) Insert(
	wasmDeploymentPolicyList ...*extensions_gloo_solo_io_v2.WasmDeploymentPolicy,
) {
	if s == nil {
...
func (s *wasmDeploymentPolicySet) Find(id ezkube.ResourceId) (*extensions_gloo_solo_io_v2.WasmDeploymentPolicy, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find WasmDeploymentPolicy %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&extensions_gloo_solo_io_v2.WasmDeploymentPolicy{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*extensions_gloo_solo_io_v2.WasmDeploymentPolicy), nil
}
