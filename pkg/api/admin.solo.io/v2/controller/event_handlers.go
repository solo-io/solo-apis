...
type WorkspaceEventHandler interface {
	CreateWorkspace(obj *admin_solo_io_v2.Workspace) error
	UpdateWorkspace(old, new *admin_solo_io_v2.Workspace) error
	DeleteWorkspace(obj *admin_solo_io_v2.Workspace) error
	GenericWorkspace(obj *admin_solo_io_v2.Workspace) error
}

type WorkspaceEventHandlerFuncs struct {
	OnCreate  func(obj *admin_solo_io_v2.Workspace) error
	OnUpdate  func(old, new *admin_solo_io_v2.Workspace) error
	OnDelete  func(obj *admin_solo_io_v2.Workspace) error
	OnGeneric func(obj *admin_solo_io_v2.Workspace) error
}

func (f *WorkspaceEventHandlerFuncs) CreateWorkspace(obj *admin_solo_io_v2.Workspace) error {
	if f.OnCreate == nil {
		return nil
	}
...
func (f *WorkspaceEventHandlerFuncs) DeleteWorkspace(obj *admin_solo_io_v2.Workspace) error {
	if f.OnDelete == nil {
		return nil
	}
...
func (f *WorkspaceEventHandlerFuncs) UpdateWorkspace(objOld, objNew *admin_solo_io_v2.Workspace) error {
	if f.OnUpdate == nil {
		return nil
	}
...
func (f *WorkspaceEventHandlerFuncs) GenericWorkspace(obj *admin_solo_io_v2.Workspace) error {
	if f.OnGeneric == nil {
		return nil
	}
...
func NewWorkspaceEventWatcher(name string, mgr manager.Manager) WorkspaceEventWatcher {
	return &workspaceEventWatcher{
		watcher: events.NewWatcher(name, mgr, &admin_solo_io_v2.Workspace{}),
	}
}
...
func (h genericWorkspaceHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*admin_solo_io_v2.Workspace)
	if !ok {
		return errors.Errorf("internal error: Workspace handler received event for %T", old)
	}
	objNew, ok := new.(*admin_solo_io_v2.Workspace)
	if !ok {
...
type WorkspaceSettingsEventHandler interface {
	CreateWorkspaceSettings(obj *admin_solo_io_v2.WorkspaceSettings) error
	UpdateWorkspaceSettings(old, new *admin_solo_io_v2.WorkspaceSettings) error
	DeleteWorkspaceSettings(obj *admin_solo_io_v2.WorkspaceSettings) error
	GenericWorkspaceSettings(obj *admin_solo_io_v2.WorkspaceSettings) error
}

type WorkspaceSettingsEventHandlerFuncs struct {
	OnCreate  func(obj *admin_solo_io_v2.WorkspaceSettings) error
	OnUpdate  func(old, new *admin_solo_io_v2.WorkspaceSettings) error
	OnDelete  func(obj *admin_solo_io_v2.WorkspaceSettings) error
	OnGeneric func(obj *admin_solo_io_v2.WorkspaceSettings) error
}

func (f *WorkspaceSettingsEventHandlerFuncs) CreateWorkspaceSettings(obj *admin_solo_io_v2.WorkspaceSettings) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *WorkspaceSettingsEventHandlerFuncs) DeleteWorkspaceSettings(obj *admin_solo_io_v2.WorkspaceSettings) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *WorkspaceSettingsEventHandlerFuncs) UpdateWorkspaceSettings(objOld, objNew *admin_solo_io_v2.WorkspaceSettings) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *WorkspaceSettingsEventHandlerFuncs) GenericWorkspaceSettings(obj *admin_solo_io_v2.WorkspaceSettings) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewWorkspaceSettingsEventWatcher(name string, mgr manager.Manager) WorkspaceSettingsEventWatcher {
	return &workspaceSettingsEventWatcher{
		watcher: events.NewWatcher(name, mgr, &admin_solo_io_v2.WorkspaceSettings{}),
	}
}
...
func (h genericWorkspaceSettingsHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*admin_solo_io_v2.WorkspaceSettings)
	if !ok {
		return errors.Errorf("internal error: WorkspaceSettings handler received event for %T", old)
	}
	objNew, ok := new.(*admin_solo_io_v2.WorkspaceSettings)
	if !ok {
...
type KubernetesClusterEventHandler interface {
	CreateKubernetesCluster(obj *admin_solo_io_v2.KubernetesCluster) error
	UpdateKubernetesCluster(old, new *admin_solo_io_v2.KubernetesCluster) error
	DeleteKubernetesCluster(obj *admin_solo_io_v2.KubernetesCluster) error
	GenericKubernetesCluster(obj *admin_solo_io_v2.KubernetesCluster) error
}

type KubernetesClusterEventHandlerFuncs struct {
	OnCreate  func(obj *admin_solo_io_v2.KubernetesCluster) error
	OnUpdate  func(old, new *admin_solo_io_v2.KubernetesCluster) error
	OnDelete  func(obj *admin_solo_io_v2.KubernetesCluster) error
	OnGeneric func(obj *admin_solo_io_v2.KubernetesCluster) error
}

func (f *KubernetesClusterEventHandlerFuncs) CreateKubernetesCluster(obj *admin_solo_io_v2.KubernetesCluster) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *KubernetesClusterEventHandlerFuncs) DeleteKubernetesCluster(obj *admin_solo_io_v2.KubernetesCluster) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *KubernetesClusterEventHandlerFuncs) UpdateKubernetesCluster(objOld, objNew *admin_solo_io_v2.KubernetesCluster) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *KubernetesClusterEventHandlerFuncs) GenericKubernetesCluster(obj *admin_solo_io_v2.KubernetesCluster) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewKubernetesClusterEventWatcher(name string, mgr manager.Manager) KubernetesClusterEventWatcher {
	return &kubernetesClusterEventWatcher{
		watcher: events.NewWatcher(name, mgr, &admin_solo_io_v2.KubernetesCluster{}),
	}
}
...
func (h genericKubernetesClusterHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*admin_solo_io_v2.KubernetesCluster)
	if !ok {
		return errors.Errorf("internal error: KubernetesCluster handler received event for %T", old)
	}
	objNew, ok := new.(*admin_solo_io_v2.KubernetesCluster)
	if !ok {
...
type RootTrustPolicyEventHandler interface {
	CreateRootTrustPolicy(obj *admin_solo_io_v2.RootTrustPolicy) error
	UpdateRootTrustPolicy(old, new *admin_solo_io_v2.RootTrustPolicy) error
	DeleteRootTrustPolicy(obj *admin_solo_io_v2.RootTrustPolicy) error
	GenericRootTrustPolicy(obj *admin_solo_io_v2.RootTrustPolicy) error
}

type RootTrustPolicyEventHandlerFuncs struct {
	OnCreate  func(obj *admin_solo_io_v2.RootTrustPolicy) error
	OnUpdate  func(old, new *admin_solo_io_v2.RootTrustPolicy) error
	OnDelete  func(obj *admin_solo_io_v2.RootTrustPolicy) error
	OnGeneric func(obj *admin_solo_io_v2.RootTrustPolicy) error
}

func (f *RootTrustPolicyEventHandlerFuncs) CreateRootTrustPolicy(obj *admin_solo_io_v2.RootTrustPolicy) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *RootTrustPolicyEventHandlerFuncs) DeleteRootTrustPolicy(obj *admin_solo_io_v2.RootTrustPolicy) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *RootTrustPolicyEventHandlerFuncs) UpdateRootTrustPolicy(objOld, objNew *admin_solo_io_v2.RootTrustPolicy) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *RootTrustPolicyEventHandlerFuncs) GenericRootTrustPolicy(obj *admin_solo_io_v2.RootTrustPolicy) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewRootTrustPolicyEventWatcher(name string, mgr manager.Manager) RootTrustPolicyEventWatcher {
	return &rootTrustPolicyEventWatcher{
		watcher: events.NewWatcher(name, mgr, &admin_solo_io_v2.RootTrustPolicy{}),
	}
}
...
func (h genericRootTrustPolicyHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*admin_solo_io_v2.RootTrustPolicy)
	if !ok {
		return errors.Errorf("internal error: RootTrustPolicy handler received event for %T", old)
	}
	objNew, ok := new.(*admin_solo_io_v2.RootTrustPolicy)
	if !ok {
...
type ExtAuthServerEventHandler interface {
	CreateExtAuthServer(obj *admin_solo_io_v2.ExtAuthServer) error
	UpdateExtAuthServer(old, new *admin_solo_io_v2.ExtAuthServer) error
	DeleteExtAuthServer(obj *admin_solo_io_v2.ExtAuthServer) error
	GenericExtAuthServer(obj *admin_solo_io_v2.ExtAuthServer) error
}

type ExtAuthServerEventHandlerFuncs struct {
	OnCreate  func(obj *admin_solo_io_v2.ExtAuthServer) error
	OnUpdate  func(old, new *admin_solo_io_v2.ExtAuthServer) error
	OnDelete  func(obj *admin_solo_io_v2.ExtAuthServer) error
	OnGeneric func(obj *admin_solo_io_v2.ExtAuthServer) error
}

func (f *ExtAuthServerEventHandlerFuncs) CreateExtAuthServer(obj *admin_solo_io_v2.ExtAuthServer) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *ExtAuthServerEventHandlerFuncs) DeleteExtAuthServer(obj *admin_solo_io_v2.ExtAuthServer) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *ExtAuthServerEventHandlerFuncs) UpdateExtAuthServer(objOld, objNew *admin_solo_io_v2.ExtAuthServer) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *ExtAuthServerEventHandlerFuncs) GenericExtAuthServer(obj *admin_solo_io_v2.ExtAuthServer) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewExtAuthServerEventWatcher(name string, mgr manager.Manager) ExtAuthServerEventWatcher {
	return &extAuthServerEventWatcher{
		watcher: events.NewWatcher(name, mgr, &admin_solo_io_v2.ExtAuthServer{}),
	}
}
...
func (h genericExtAuthServerHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*admin_solo_io_v2.ExtAuthServer)
	if !ok {
		return errors.Errorf("internal error: ExtAuthServer handler received event for %T", old)
	}
	objNew, ok := new.(*admin_solo_io_v2.ExtAuthServer)
	if !ok {
...
type RateLimitServerSettingsEventHandler interface {
	CreateRateLimitServerSettings(obj *admin_solo_io_v2.RateLimitServerSettings) error
	UpdateRateLimitServerSettings(old, new *admin_solo_io_v2.RateLimitServerSettings) error
	DeleteRateLimitServerSettings(obj *admin_solo_io_v2.RateLimitServerSettings) error
	GenericRateLimitServerSettings(obj *admin_solo_io_v2.RateLimitServerSettings) error
}

type RateLimitServerSettingsEventHandlerFuncs struct {
	OnCreate  func(obj *admin_solo_io_v2.RateLimitServerSettings) error
	OnUpdate  func(old, new *admin_solo_io_v2.RateLimitServerSettings) error
	OnDelete  func(obj *admin_solo_io_v2.RateLimitServerSettings) error
	OnGeneric func(obj *admin_solo_io_v2.RateLimitServerSettings) error
}

func (f *RateLimitServerSettingsEventHandlerFuncs) CreateRateLimitServerSettings(obj *admin_solo_io_v2.RateLimitServerSettings) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *RateLimitServerSettingsEventHandlerFuncs) DeleteRateLimitServerSettings(obj *admin_solo_io_v2.RateLimitServerSettings) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *RateLimitServerSettingsEventHandlerFuncs) UpdateRateLimitServerSettings(objOld, objNew *admin_solo_io_v2.RateLimitServerSettings) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *RateLimitServerSettingsEventHandlerFuncs) GenericRateLimitServerSettings(obj *admin_solo_io_v2.RateLimitServerSettings) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewRateLimitServerSettingsEventWatcher(name string, mgr manager.Manager) RateLimitServerSettingsEventWatcher {
	return &rateLimitServerSettingsEventWatcher{
		watcher: events.NewWatcher(name, mgr, &admin_solo_io_v2.RateLimitServerSettings{}),
	}
}
...
func (h genericRateLimitServerSettingsHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*admin_solo_io_v2.RateLimitServerSettings)
	if !ok {
		return errors.Errorf("internal error: RateLimitServerSettings handler received event for %T", old)
	}
	objNew, ok := new.(*admin_solo_io_v2.RateLimitServerSettings)
	if !ok {
...
type RateLimitServerConfigEventHandler interface {
	CreateRateLimitServerConfig(obj *admin_solo_io_v2.RateLimitServerConfig) error
	UpdateRateLimitServerConfig(old, new *admin_solo_io_v2.RateLimitServerConfig) error
	DeleteRateLimitServerConfig(obj *admin_solo_io_v2.RateLimitServerConfig) error
	GenericRateLimitServerConfig(obj *admin_solo_io_v2.RateLimitServerConfig) error
}

type RateLimitServerConfigEventHandlerFuncs struct {
	OnCreate  func(obj *admin_solo_io_v2.RateLimitServerConfig) error
	OnUpdate  func(old, new *admin_solo_io_v2.RateLimitServerConfig) error
	OnDelete  func(obj *admin_solo_io_v2.RateLimitServerConfig) error
	OnGeneric func(obj *admin_solo_io_v2.RateLimitServerConfig) error
}

func (f *RateLimitServerConfigEventHandlerFuncs) CreateRateLimitServerConfig(obj *admin_solo_io_v2.RateLimitServerConfig) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *RateLimitServerConfigEventHandlerFuncs) DeleteRateLimitServerConfig(obj *admin_solo_io_v2.RateLimitServerConfig) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *RateLimitServerConfigEventHandlerFuncs) UpdateRateLimitServerConfig(objOld, objNew *admin_solo_io_v2.RateLimitServerConfig) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *RateLimitServerConfigEventHandlerFuncs) GenericRateLimitServerConfig(obj *admin_solo_io_v2.RateLimitServerConfig) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewRateLimitServerConfigEventWatcher(name string, mgr manager.Manager) RateLimitServerConfigEventWatcher {
	return &rateLimitServerConfigEventWatcher{
		watcher: events.NewWatcher(name, mgr, &admin_solo_io_v2.RateLimitServerConfig{}),
	}
}
...
func (h genericRateLimitServerConfigHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*admin_solo_io_v2.RateLimitServerConfig)
	if !ok {
		return errors.Errorf("internal error: RateLimitServerConfig handler received event for %T", old)
	}
	objNew, ok := new.(*admin_solo_io_v2.RateLimitServerConfig)
	if !ok {
...
type DashboardEventHandler interface {
	CreateDashboard(obj *admin_solo_io_v2.Dashboard) error
	UpdateDashboard(old, new *admin_solo_io_v2.Dashboard) error
	DeleteDashboard(obj *admin_solo_io_v2.Dashboard) error
	GenericDashboard(obj *admin_solo_io_v2.Dashboard) error
}

type DashboardEventHandlerFuncs struct {
	OnCreate  func(obj *admin_solo_io_v2.Dashboard) error
	OnUpdate  func(old, new *admin_solo_io_v2.Dashboard) error
	OnDelete  func(obj *admin_solo_io_v2.Dashboard) error
	OnGeneric func(obj *admin_solo_io_v2.Dashboard) error
}

func (f *DashboardEventHandlerFuncs) CreateDashboard(obj *admin_solo_io_v2.Dashboard) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *DashboardEventHandlerFuncs) DeleteDashboard(obj *admin_solo_io_v2.Dashboard) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *DashboardEventHandlerFuncs) UpdateDashboard(objOld, objNew *admin_solo_io_v2.Dashboard) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *DashboardEventHandlerFuncs) GenericDashboard(obj *admin_solo_io_v2.Dashboard) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewDashboardEventWatcher(name string, mgr manager.Manager) DashboardEventWatcher {
	return &dashboardEventWatcher{
		watcher: events.NewWatcher(name, mgr, &admin_solo_io_v2.Dashboard{}),
	}
}
...
func (h genericDashboardHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*admin_solo_io_v2.Dashboard)
	if !ok {
		return errors.Errorf("internal error: Dashboard handler received event for %T", old)
	}
	objNew, ok := new.(*admin_solo_io_v2.Dashboard)
	if !ok {
...
type IstioLifecycleManagerEventHandler interface {
	CreateIstioLifecycleManager(obj *admin_solo_io_v2.IstioLifecycleManager) error
	UpdateIstioLifecycleManager(old, new *admin_solo_io_v2.IstioLifecycleManager) error
	DeleteIstioLifecycleManager(obj *admin_solo_io_v2.IstioLifecycleManager) error
	GenericIstioLifecycleManager(obj *admin_solo_io_v2.IstioLifecycleManager) error
}

type IstioLifecycleManagerEventHandlerFuncs struct {
	OnCreate  func(obj *admin_solo_io_v2.IstioLifecycleManager) error
	OnUpdate  func(old, new *admin_solo_io_v2.IstioLifecycleManager) error
	OnDelete  func(obj *admin_solo_io_v2.IstioLifecycleManager) error
	OnGeneric func(obj *admin_solo_io_v2.IstioLifecycleManager) error
}

func (f *IstioLifecycleManagerEventHandlerFuncs) CreateIstioLifecycleManager(obj *admin_solo_io_v2.IstioLifecycleManager) error {
	if f.OnCreate == nil {
		return nil
	}
	return f.OnCreate(obj)
...
func (f *IstioLifecycleManagerEventHandlerFuncs) DeleteIstioLifecycleManager(obj *admin_solo_io_v2.IstioLifecycleManager) error {
	if f.OnDelete == nil {
		return nil
	}
	return f.OnDelete(obj)
...
func (f *IstioLifecycleManagerEventHandlerFuncs) UpdateIstioLifecycleManager(objOld, objNew *admin_solo_io_v2.IstioLifecycleManager) error {
	if f.OnUpdate == nil {
		return nil
	}
	return f.OnUpdate(objOld, objNew)
...
func (f *IstioLifecycleManagerEventHandlerFuncs) GenericIstioLifecycleManager(obj *admin_solo_io_v2.IstioLifecycleManager) error {
	if f.OnGeneric == nil {
		return nil
	}
	return f.OnGeneric(obj)
...
func NewIstioLifecycleManagerEventWatcher(name string, mgr manager.Manager) IstioLifecycleManagerEventWatcher {
	return &istioLifecycleManagerEventWatcher{
		watcher: events.NewWatcher(name, mgr, &admin_solo_io_v2.IstioLifecycleManager{}),
	}
}
...
func (h genericIstioLifecycleManagerHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*admin_solo_io_v2.IstioLifecycleManager)
	if !ok {
		return errors.Errorf("internal error: IstioLifecycleManager handler received event for %T", old)
	}
	objNew, ok := new.(*admin_solo_io_v2.IstioLifecycleManager)
	if !ok {
