...
type MulticlusterWorkspaceReconciler interface {
	ReconcileWorkspace(clusterName string, obj *admin_solo_io_v2.Workspace) (reconcile.Result, error)
}
...
type MulticlusterWorkspaceReconcilerFuncs struct {
	OnReconcileWorkspace         func(clusterName string, obj *admin_solo_io_v2.Workspace) (reconcile.Result, error)
	OnReconcileWorkspaceDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterWorkspaceReconcilerFuncs) ReconcileWorkspace(clusterName string, obj *admin_solo_io_v2.Workspace) (reconcile.Result, error) {
...
func NewMulticlusterWorkspaceReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterWorkspaceReconcileLoop {
	return &multiclusterWorkspaceReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &admin_solo_io_v2.Workspace{}, options)}
}
...
type MulticlusterWorkspaceSettingsReconciler interface {
	ReconcileWorkspaceSettings(clusterName string, obj *admin_solo_io_v2.WorkspaceSettings) (reconcile.Result, error)
}
...
type MulticlusterWorkspaceSettingsReconcilerFuncs struct {
	OnReconcileWorkspaceSettings         func(clusterName string, obj *admin_solo_io_v2.WorkspaceSettings) (reconcile.Result, error)
	OnReconcileWorkspaceSettingsDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterWorkspaceSettingsReconcilerFuncs) ReconcileWorkspaceSettings(clusterName string, obj *admin_solo_io_v2.WorkspaceSettings) (reconcile.Result, error) {
...
func NewMulticlusterWorkspaceSettingsReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterWorkspaceSettingsReconcileLoop {
	return &multiclusterWorkspaceSettingsReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &admin_solo_io_v2.WorkspaceSettings{}, options)}
}
...
type MulticlusterKubernetesClusterReconciler interface {
	ReconcileKubernetesCluster(clusterName string, obj *admin_solo_io_v2.KubernetesCluster) (reconcile.Result, error)
}
...
type MulticlusterKubernetesClusterReconcilerFuncs struct {
	OnReconcileKubernetesCluster         func(clusterName string, obj *admin_solo_io_v2.KubernetesCluster) (reconcile.Result, error)
	OnReconcileKubernetesClusterDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterKubernetesClusterReconcilerFuncs) ReconcileKubernetesCluster(clusterName string, obj *admin_solo_io_v2.KubernetesCluster) (reconcile.Result, error) {
...
func NewMulticlusterKubernetesClusterReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterKubernetesClusterReconcileLoop {
	return &multiclusterKubernetesClusterReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &admin_solo_io_v2.KubernetesCluster{}, options)}
}
...
type MulticlusterRootTrustPolicyReconciler interface {
	ReconcileRootTrustPolicy(clusterName string, obj *admin_solo_io_v2.RootTrustPolicy) (reconcile.Result, error)
}
...
type MulticlusterRootTrustPolicyReconcilerFuncs struct {
	OnReconcileRootTrustPolicy         func(clusterName string, obj *admin_solo_io_v2.RootTrustPolicy) (reconcile.Result, error)
	OnReconcileRootTrustPolicyDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterRootTrustPolicyReconcilerFuncs) ReconcileRootTrustPolicy(clusterName string, obj *admin_solo_io_v2.RootTrustPolicy) (reconcile.Result, error) {
...
func NewMulticlusterRootTrustPolicyReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRootTrustPolicyReconcileLoop {
	return &multiclusterRootTrustPolicyReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &admin_solo_io_v2.RootTrustPolicy{}, options)}
}
...
type MulticlusterExtAuthServerReconciler interface {
	ReconcileExtAuthServer(clusterName string, obj *admin_solo_io_v2.ExtAuthServer) (reconcile.Result, error)
}
...
type MulticlusterExtAuthServerReconcilerFuncs struct {
	OnReconcileExtAuthServer         func(clusterName string, obj *admin_solo_io_v2.ExtAuthServer) (reconcile.Result, error)
	OnReconcileExtAuthServerDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterExtAuthServerReconcilerFuncs) ReconcileExtAuthServer(clusterName string, obj *admin_solo_io_v2.ExtAuthServer) (reconcile.Result, error) {
...
func NewMulticlusterExtAuthServerReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterExtAuthServerReconcileLoop {
	return &multiclusterExtAuthServerReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &admin_solo_io_v2.ExtAuthServer{}, options)}
}
...
type MulticlusterRateLimitServerSettingsReconciler interface {
	ReconcileRateLimitServerSettings(clusterName string, obj *admin_solo_io_v2.RateLimitServerSettings) (reconcile.Result, error)
}
...
type MulticlusterRateLimitServerSettingsReconcilerFuncs struct {
	OnReconcileRateLimitServerSettings         func(clusterName string, obj *admin_solo_io_v2.RateLimitServerSettings) (reconcile.Result, error)
	OnReconcileRateLimitServerSettingsDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterRateLimitServerSettingsReconcilerFuncs) ReconcileRateLimitServerSettings(clusterName string, obj *admin_solo_io_v2.RateLimitServerSettings) (reconcile.Result, error) {
...
func NewMulticlusterRateLimitServerSettingsReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRateLimitServerSettingsReconcileLoop {
	return &multiclusterRateLimitServerSettingsReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &admin_solo_io_v2.RateLimitServerSettings{}, options)}
}
...
type MulticlusterRateLimitServerConfigReconciler interface {
	ReconcileRateLimitServerConfig(clusterName string, obj *admin_solo_io_v2.RateLimitServerConfig) (reconcile.Result, error)
}
...
type MulticlusterRateLimitServerConfigReconcilerFuncs struct {
	OnReconcileRateLimitServerConfig         func(clusterName string, obj *admin_solo_io_v2.RateLimitServerConfig) (reconcile.Result, error)
	OnReconcileRateLimitServerConfigDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterRateLimitServerConfigReconcilerFuncs) ReconcileRateLimitServerConfig(clusterName string, obj *admin_solo_io_v2.RateLimitServerConfig) (reconcile.Result, error) {
...
func NewMulticlusterRateLimitServerConfigReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterRateLimitServerConfigReconcileLoop {
	return &multiclusterRateLimitServerConfigReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &admin_solo_io_v2.RateLimitServerConfig{}, options)}
}
...
type MulticlusterDashboardReconciler interface {
	ReconcileDashboard(clusterName string, obj *admin_solo_io_v2.Dashboard) (reconcile.Result, error)
}
...
type MulticlusterDashboardReconcilerFuncs struct {
	OnReconcileDashboard         func(clusterName string, obj *admin_solo_io_v2.Dashboard) (reconcile.Result, error)
	OnReconcileDashboardDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterDashboardReconcilerFuncs) ReconcileDashboard(clusterName string, obj *admin_solo_io_v2.Dashboard) (reconcile.Result, error) {
...
func NewMulticlusterDashboardReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterDashboardReconcileLoop {
	return &multiclusterDashboardReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &admin_solo_io_v2.Dashboard{}, options)}
}
...
type MulticlusterIstioLifecycleManagerReconciler interface {
	ReconcileIstioLifecycleManager(clusterName string, obj *admin_solo_io_v2.IstioLifecycleManager) (reconcile.Result, error)
}
...
type MulticlusterIstioLifecycleManagerReconcilerFuncs struct {
	OnReconcileIstioLifecycleManager         func(clusterName string, obj *admin_solo_io_v2.IstioLifecycleManager) (reconcile.Result, error)
	OnReconcileIstioLifecycleManagerDeletion func(clusterName string, req reconcile.Request) error
}

func (f *MulticlusterIstioLifecycleManagerReconcilerFuncs) ReconcileIstioLifecycleManager(clusterName string, obj *admin_solo_io_v2.IstioLifecycleManager) (reconcile.Result, error) {
...
func NewMulticlusterIstioLifecycleManagerReconcileLoop(name string, cw multicluster.ClusterWatcher, options reconcile.Options) MulticlusterIstioLifecycleManagerReconcileLoop {
	return &multiclusterIstioLifecycleManagerReconcileLoop{loop: mc_reconcile.NewLoop(name, cw, &admin_solo_io_v2.IstioLifecycleManager{}, options)}
}
