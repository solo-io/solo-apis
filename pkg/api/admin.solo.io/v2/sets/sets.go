...
type IstioLifecycleManagerSet interface {
	...
	Keys() sets.String
	// List of resources stored in the set. Pass an optional filter function to filter on the list.
	List(filterResource ...func(*admin_solo_io_v2.IstioLifecycleManager) bool) []*admin_solo_io_v2.IstioLifecycleManager
	// Unsorted list of resources stored in the set. Pass an optional filter function to filter on the list.
	UnsortedList(filterResource ...func(*admin_solo_io_v2.IstioLifecycleManager) bool) []*admin_solo_io_v2.IstioLifecycleManager
	// Return the Set as a map of key to resource.
	Map() map[string]*admin_solo_io_v2.IstioLifecycleManager
	// Insert a resource into the set.
	Insert(istioLifecycleManager ...*admin_solo_io_v2.IstioLifecycleManager)
	// Compare the equality of the keys in two sets (not the resources themselves)
	...
	// Find the resource with the given ID
	Find(id ezkube.ResourceId) (*admin_solo_io_v2.IstioLifecycleManager, error)
	// Get the length of the set
	Length() int
	// returns the generic implementation of the set
	Generic() sksets.ResourceSet
...
func makeGenericIstioLifecycleManagerSet(istioLifecycleManagerList []*admin_solo_io_v2.IstioLifecycleManager) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewIstioLifecycleManagerSet(istioLifecycleManagerList ...*admin_solo_io_v2.IstioLifecycleManager) IstioLifecycleManagerSet {
	return &istioLifecycleManagerSet{set: makeGenericIstioLifecycleManagerSet(istioLifecycleManagerList)}
}

func NewIstioLifecycleManagerSetFromList(istioLifecycleManagerList *admin_solo_io_v2.IstioLifecycleManagerList) IstioLifecycleManagerSet {
	list := make([]*admin_solo_io_v2.IstioLifecycleManager, 0, len(istioLifecycleManagerList.Items))
...
func (s *istioLifecycleManagerSet) List(filterResource ...func(*admin_solo_io_v2.IstioLifecycleManager) bool) []*admin_solo_io_v2.IstioLifecycleManager {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*admin_solo_io_v2.IstioLifecycleManager))
		})
	}

	objs := s.Generic().List(genericFilters...)
	istioLifecycleManagerList := make([]*admin_solo_io_v2.IstioLifecycleManager, 0, len(objs))
	for _, obj := range objs {
		istioLifecycleManagerList = append(istioLifecycleManagerList, obj.(*admin_solo_io_v2.IstioLifecycleManager))
	}
	return istioLifecycleManagerList
}

func (s *istioLifecycleManagerSet) UnsortedList(filterResource ...func(*admin_solo_io_v2.IstioLifecycleManager) bool) []*admin_solo_io_v2.IstioLifecycleManager {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var istioLifecycleManagerList []*admin_solo_io_v2.IstioLifecycleManager
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		istioLifecycleManagerList = append(istioLifecycleManagerList, obj.(*admin_solo_io_v2.IstioLifecycleManager))
	}
	return istioLifecycleManagerList
...
func (s *istioLifecycleManagerSet) Map() map[string]*admin_solo_io_v2.IstioLifecycleManager {
	if s == nil {
		return nil
	}

	newMap := map[string]*admin_solo_io_v2.IstioLifecycleManager{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*admin_solo_io_v2.IstioLifecycleManager)
	}
	return newMap
}

func (s *istioLifecycleManagerSet) Insert(
	istioLifecycleManagerList ...*admin_solo_io_v2.IstioLifecycleManager,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *istioLifecycleManagerSet) Find(id ezkube.ResourceId) (*admin_solo_io_v2.IstioLifecycleManager, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find IstioLifecycleManager %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&admin_solo_io_v2.IstioLifecycleManager{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*admin_solo_io_v2.IstioLifecycleManager), nil
}
